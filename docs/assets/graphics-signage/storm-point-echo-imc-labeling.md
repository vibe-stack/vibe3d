...
---
asset_id: "asset.graphics-signage.graphics-and-signage.storm-point-echo-imc-labeling"
source_label: "Storm Point ECHO/IMC labeling"
...
# Storm Point ECHO/IMC labeling

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.storm-point-echo-imc-labeling
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1864
...
![Storm Point ECHO/IMC labeling reference render](storm-point-echo-imc-labeling.png)

## Intent

The **Storm Point ECHO/IMC labeling** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Storm Point ECHO/IMC labeling** as a useful,
