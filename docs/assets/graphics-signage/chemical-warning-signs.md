...
---
asset_id: "asset.graphics-signage.graphics-and-signage.chemical-warning-signs"
source_label: "chemical warning signs"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.chemical-warning-signs
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1848
...
![chemical warning signs reference render](chemical-warning-signs.png)

## Intent

The **chemical warning signs** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **chemical warning signs** as a useful,
