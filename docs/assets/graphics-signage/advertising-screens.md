...
---
asset_id: "asset.graphics-signage.graphics-and-signage.advertising-screens"
source_label: "advertising screens"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.advertising-screens
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1856
...
![advertising screens reference render](advertising-screens.png)

## Intent

The **advertising screens** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **advertising screens** as a useful,
...
- **shared graphics system:** [IMC logo](./imc-logo.md).
