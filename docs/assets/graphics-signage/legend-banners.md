...
---
asset_id: "asset.graphics-signage.graphics-and-signage.legend-banners"
source_label: "Legend banners"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.legend-banners
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1866
...
![Legend banners reference render](legend-banners.png)

## Intent

The **Legend banners** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Legend banners** as a useful,
