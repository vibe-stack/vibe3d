...
---
asset_id: "asset.graphics-signage.graphics-and-signage.broken-moon-colony-wayfinding"
source_label: "Broken Moon colony wayfinding"
...
# Broken Moon colony wayfinding

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.broken-moon-colony-wayfinding
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1863
...
![Broken Moon colony wayfinding reference render](broken-moon-colony-wayfinding.png)

## Intent

The **Broken Moon colony wayfinding** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Broken Moon colony wayfinding** as a useful,
