...
---
asset_id: "asset.graphics-signage.graphics-and-signage.retail-branding"
source_label: "retail branding"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.retail-branding
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1857
...
![retail branding reference render](retail-branding.png)

## Intent

The **retail branding** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **retail branding** as a useful,
