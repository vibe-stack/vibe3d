...
---
asset_id: "asset.graphics-signage.graphics-and-signage.games-logo"
source_label: "Games logo"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.games-logo
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1829
...
![Games logo reference render](games-logo.png)

## Intent

The **Games logo** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Games logo** as a useful,
