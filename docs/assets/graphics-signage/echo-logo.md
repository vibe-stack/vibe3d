...
---
asset_id: "asset.graphics-signage.graphics-and-signage.echo-logo"
source_label: "ECHO logo"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.echo-logo
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1831
...
![ECHO logo reference render](echo-logo.png)

## Intent

The **ECHO logo** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **ECHO logo** as a useful,
