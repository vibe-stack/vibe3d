...
---
asset_id: "asset.graphics-signage.graphics-and-signage.industrial-serial-numbers"
source_label: "industrial serial numbers"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.industrial-serial-numbers
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1851
...
![industrial serial numbers reference render](industrial-serial-numbers.png)

## Intent

The **industrial serial numbers** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **industrial serial numbers** as a useful,
