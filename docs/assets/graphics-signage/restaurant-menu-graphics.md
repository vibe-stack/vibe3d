...
---
asset_id: "asset.graphics-signage.graphics-and-signage.restaurant-menu-graphics"
source_label: "restaurant menu graphics"
...
# restaurant menu graphics

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.restaurant-menu-graphics
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1858
...
![restaurant menu graphics reference render](restaurant-menu-graphics.png)

## Intent

The **restaurant menu graphics** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **restaurant menu graphics** as a useful,
