...
---
asset_id: "asset.graphics-signage.graphics-and-signage.facility-numbers"
source_label: "facility numbers"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.facility-numbers
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1834
...
![facility numbers reference render](facility-numbers.png)

## Intent

The **facility numbers** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **facility numbers** as a useful,
