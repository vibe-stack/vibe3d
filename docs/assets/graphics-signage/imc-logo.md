...
---
asset_id: "asset.graphics-signage.graphics-and-signage.imc-logo"
source_label: "IMC logo"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.imc-logo
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1827
...
![IMC logo reference render](imc-logo.png)

## Intent

The **IMC logo** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **IMC logo** as a useful,
