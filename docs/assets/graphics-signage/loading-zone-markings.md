...
---
asset_id: "asset.graphics-signage.graphics-and-signage.loading-zone-markings"
source_label: "loading-zone markings"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.loading-zone-markings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1840
...
![loading-zone markings reference render](loading-zone-markings.png)

## Intent

The **loading-zone markings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **loading-zone markings** as a useful,
