...
---
asset_id: "asset.graphics-signage.graphics-and-signage.container-labels"
source_label: "container labels"
source_section: "Reusable / graphics and signage"
source_group: "Graphics and signage"
source_line: 1853
level: L1
status: planned
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.container-labels
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1853
- **Family:** Reusable / graphics and signage
- **Place family:** All place families
- **Owner / story role:** All operators

## Reference render

![container labels reference render](container-labels.png)

## Intent

The **container labels** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **container labels** as a useful,
...
- **Blockout envelope:** Graphic plane or volume sized to the host surface; keep a 0.02–0.05 m offset to prevent z-fighting.
...
1. **Day / Low Emission** — recognition state and public contract.
2. **Night / Active** — state-bearing geometry, signal, decal, and collision change.
3. **Worn / Replaced** — reuse the chassis with a focused dressing or service pass.
