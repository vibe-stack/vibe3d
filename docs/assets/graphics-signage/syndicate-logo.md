...
---
asset_id: "asset.graphics-signage.graphics-and-signage.syndicate-logo"
source_label: "Syndicate logo"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.syndicate-logo
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1830
...
![Syndicate logo reference render](syndicate-logo.png)

## Intent

The **Syndicate logo** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Syndicate logo** as a useful,
