...
---
asset_id: "asset.graphics-signage.graphics-and-signage.worlds-edge-industrial-signage"
source_label: "World's Edge industrial signage"
...
# World's Edge industrial signage

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.worlds-edge-industrial-signage
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1861
...
![World's Edge industrial signage reference render](worlds-edge-industrial-signage.png)

## Intent

The **World's Edge industrial signage** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **World's Edge industrial signage** as a useful,
