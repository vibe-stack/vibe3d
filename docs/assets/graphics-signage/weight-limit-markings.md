...
---
asset_id: "asset.graphics-signage.graphics-and-signage.weight-limit-markings"
source_label: "weight-limit markings"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.weight-limit-markings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1839
...
![weight-limit markings reference render](weight-limit-markings.png)

## Intent

The **weight-limit markings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **weight-limit markings** as a useful,
