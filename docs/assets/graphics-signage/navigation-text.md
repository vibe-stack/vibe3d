...
---
asset_id: "asset.graphics-signage.graphics-and-signage.navigation-text"
source_label: "navigation text"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.navigation-text
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1844
...
![navigation text reference render](navigation-text.png)

## Intent

The **navigation text** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **navigation text** as a useful,
