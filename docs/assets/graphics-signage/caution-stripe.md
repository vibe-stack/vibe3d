...
---
asset_id: "asset.graphics-signage.graphics-and-signage.caution-stripe"
source_label: "caution stripe"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.caution-stripe
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1836
...
![caution stripe reference render](caution-stripe.png)

## Intent

The **caution stripe** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **caution stripe** as a useful,
