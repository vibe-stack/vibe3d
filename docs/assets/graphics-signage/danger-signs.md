...
---
asset_id: "asset.graphics-signage.graphics-and-signage.danger-signs"
source_label: "danger signs"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.danger-signs
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1846
...
![danger signs reference render](danger-signs.png)

## Intent

The **danger signs** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **danger signs** as a useful,
