...
---
asset_id: "asset.graphics-signage.graphics-and-signage.emergency-exit-markings"
source_label: "emergency exit markings"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.emergency-exit-markings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1845
...
![emergency exit markings reference render](emergency-exit-markings.png)

## Intent

The **emergency exit markings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **emergency exit markings** as a useful,
