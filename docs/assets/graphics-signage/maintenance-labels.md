...
---
asset_id: "asset.graphics-signage.graphics-and-signage.maintenance-labels"
source_label: "maintenance labels"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.maintenance-labels
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1850
...
![maintenance labels reference render](maintenance-labels.png)

## Intent

The **maintenance labels** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **maintenance labels** as a useful,
