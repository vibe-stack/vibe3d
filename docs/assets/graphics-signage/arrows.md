...
---
asset_id: "asset.graphics-signage.graphics-and-signage.arrows"
source_label: "arrows"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.arrows
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1843
...
![arrows reference render](arrows.png)

## Intent

The **arrows** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **arrows** as a useful,
