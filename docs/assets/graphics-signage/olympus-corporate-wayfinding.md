...
---
asset_id: "asset.graphics-signage.graphics-and-signage.olympus-corporate-wayfinding"
source_label: "Olympus corporate wayfinding"
...
# Olympus corporate wayfinding

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.olympus-corporate-wayfinding
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1860
...
![Olympus corporate wayfinding reference render](olympus-corporate-wayfinding.png)

## Intent

The **Olympus corporate wayfinding** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Olympus corporate wayfinding** as a useful,
