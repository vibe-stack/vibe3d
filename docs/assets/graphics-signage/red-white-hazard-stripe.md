...
---
asset_id: "asset.graphics-signage.graphics-and-signage.red-white-hazard-stripe"
source_label: "red/white hazard stripe"
...
# red/white hazard stripe

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.red-white-hazard-stripe
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1838
...
![red/white hazard stripe reference render](red-white-hazard-stripe.png)

## Intent

The **red/white hazard stripe** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **red/white hazard stripe** as a useful,
