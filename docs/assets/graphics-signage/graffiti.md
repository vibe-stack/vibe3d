...
---
asset_id: "asset.graphics-signage.graphics-and-signage.graffiti"
source_label: "graffiti"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.graffiti
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1854
...
![graffiti reference render](graffiti.png)

## Intent

The **graffiti** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **graffiti** as a useful,
