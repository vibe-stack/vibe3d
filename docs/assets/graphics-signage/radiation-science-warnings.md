...
---
asset_id: "asset.graphics-signage.graphics-and-signage.radiation-science-warnings"
source_label: "radiation/science warnings"
...
# radiation/science warnings

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.radiation-science-warnings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1849
...
![radiation/science warnings reference render](radiation-science-warnings.png)

## Intent

The **radiation/science warnings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **radiation/science warnings** as a useful,
