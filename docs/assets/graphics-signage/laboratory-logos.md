...
---
asset_id: "asset.graphics-signage.graphics-and-signage.laboratory-logos"
source_label: "laboratory logos"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.laboratory-logos
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1833
...
![laboratory logos reference render](laboratory-logos.png)

## Intent

The **laboratory logos** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **laboratory logos** as a useful,
