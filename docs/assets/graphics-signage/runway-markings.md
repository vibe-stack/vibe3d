...
---
asset_id: "asset.graphics-signage.graphics-and-signage.runway-markings"
source_label: "runway markings"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.runway-markings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1841
...
![runway markings reference render](runway-markings.png)

## Intent

The **runway markings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **runway markings** as a useful,
