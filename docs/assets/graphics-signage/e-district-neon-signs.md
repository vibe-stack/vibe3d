...
---
asset_id: "asset.graphics-signage.graphics-and-signage.e-district-neon-signs"
source_label: "E-District neon signs"
...
# E-District neon signs

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.e-district-neon-signs
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1859
...
![E-District neon signs reference render](e-district-neon-signs.png)

## Intent

The **E-District neon signs** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **E-District neon signs** as a useful,
