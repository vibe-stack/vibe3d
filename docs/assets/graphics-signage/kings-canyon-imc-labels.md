...
---
asset_id: "asset.graphics-signage.graphics-and-signage.kings-canyon-imc-labels"
source_label: "Kings Canyon IMC labels"
...
# Kings Canyon IMC labels

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.kings-canyon-imc-labels
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1862
...
![Kings Canyon IMC labels reference render](kings-canyon-imc-labels.png)

## Intent

The **Kings Canyon IMC labels** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Kings Canyon IMC labels** as a useful,
