...
---
asset_id: "asset.graphics-signage.graphics-and-signage.hammond-robotics-logo"
source_label: "Hammond Robotics logo"
...
# Hammond Robotics logo

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.hammond-robotics-logo
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1828
...
![Hammond Robotics logo reference render](hammond-robotics-logo.png)

## Intent

The **Hammond Robotics logo** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Hammond Robotics logo** as a useful,
