...
---
asset_id: "asset.graphics-signage.graphics-and-signage.yellow-black-hazard-stripe"
source_label: "yellow/black hazard stripe"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.yellow-black-hazard-stripe
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1837
...
![yellow/black hazard stripe reference render](yellow-black-hazard-stripe.png)

## Intent

The **yellow/black hazard stripe** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **yellow/black hazard stripe** as a useful,
