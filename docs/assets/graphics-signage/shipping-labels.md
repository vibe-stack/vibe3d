...
---
asset_id: "asset.graphics-signage.graphics-and-signage.shipping-labels"
source_label: "shipping labels"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.shipping-labels
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1852
...
![shipping labels reference render](shipping-labels.png)

## Intent

The **shipping labels** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **shipping labels** as a useful,
