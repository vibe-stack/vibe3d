...
---
asset_id: "asset.graphics-signage.graphics-and-signage.huge-legend-balloons-event-dressing"
source_label: "huge Legend balloons/event dressing"
...
# huge Legend balloons/event dressing

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.huge-legend-balloons-event-dressing
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1867
...
![huge Legend balloons/event dressing reference render](huge-legend-balloons-event-dressing.png)

## Intent

The **huge Legend balloons/event dressing** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **huge Legend balloons/event dressing** as a useful,
