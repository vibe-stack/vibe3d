...
---
asset_id: "asset.graphics-signage.graphics-and-signage.giant-building-numbers"
source_label: "giant building numbers"
...
# giant building numbers

## Identity

- **Asset ID:** asset.graphics-signage.graphics-and-signage.giant-building-numbers
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1835
...
![giant building numbers reference render](giant-building-numbers.png)

## Intent

The **giant building numbers** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **giant building numbers** as a useful,
