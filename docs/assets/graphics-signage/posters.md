...
---
asset_id: "asset.graphics-signage.graphics-and-signage.posters"
source_label: "posters"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.posters
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1855
...
![posters reference render](posters.png)

## Intent

The **posters** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **posters** as a useful,
