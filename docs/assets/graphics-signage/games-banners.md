...
---
asset_id: "asset.graphics-signage.graphics-and-signage.games-banners"
source_label: "Games banners"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.games-banners
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1865
...
![Games banners reference render](games-banners.png)

## Intent

The **Games banners** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **Games banners** as a useful,
