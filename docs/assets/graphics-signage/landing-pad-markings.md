...
---
asset_id: "asset.graphics-signage.graphics-and-signage.landing-pad-markings"
source_label: "landing-pad markings"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.landing-pad-markings
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1842
...
![landing-pad markings reference render](landing-pad-markings.png)

## Intent

The **landing-pad markings** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **landing-pad markings** as a useful,
