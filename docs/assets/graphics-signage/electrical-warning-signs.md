...
---
asset_id: "asset.graphics-signage.graphics-and-signage.electrical-warning-signs"
source_label: "electrical warning signs"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.electrical-warning-signs
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1847
...
![electrical warning signs reference render](electrical-warning-signs.png)

## Intent

The **electrical warning signs** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **electrical warning signs** as a useful,
