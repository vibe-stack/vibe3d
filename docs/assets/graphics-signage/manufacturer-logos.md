...
---
asset_id: "asset.graphics-signage.graphics-and-signage.manufacturer-logos"
source_label: "manufacturer logos"
...
- **Asset ID:** asset.graphics-signage.graphics-and-signage.manufacturer-logos
- **Type:** graphic, decal, or signage system
- **Source:** prop-list.md:1832
...
![manufacturer logos reference render](manufacturer-logos.png)

## Intent

The **manufacturer logos** is a graphic, decal, or signage system for the Axiom Relay kit. It exists to support
the graphic layer that gives ownership, navigation, state, and local identity to shared geometry. Its primary read should be **manufacturer logos** as a useful,
