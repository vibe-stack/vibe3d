...
---
asset_id: "asset.kings-canyon.repulsor.giant-destroyed-repulsor-tower"
source_label: "giant destroyed Repulsor Tower"
...
# giant destroyed Repulsor Tower

## Identity

- **Asset ID:** asset.kings-canyon.repulsor.giant-destroyed-repulsor-tower
...
![giant destroyed Repulsor Tower reference render](giant-destroyed-repulsor-tower.png)

## Intent

The **giant destroyed Repulsor Tower** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant destroyed Repulsor Tower** as a useful,
...
- **POI sibling component:** [Repulsor foundations](./repulsor-foundations.md).
