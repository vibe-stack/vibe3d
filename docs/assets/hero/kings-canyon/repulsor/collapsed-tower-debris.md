...
---
asset_id: "asset.kings-canyon.repulsor.collapsed-tower-debris"
source_label: "collapsed tower debris"
...
# collapsed tower debris

## Identity

- **Asset ID:** asset.kings-canyon.repulsor.collapsed-tower-debris
- **Type:** POI hero component
- **Source:** prop-list.md:922
...
![collapsed tower debris reference render](collapsed-tower-debris.png)

## Intent

The **collapsed tower debris** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **collapsed tower debris** as a useful,
