...
---
asset_id: "asset.kings-canyon.repulsor.repulsor-foundations"
source_label: "Repulsor foundations"
...
# Repulsor foundations

## Identity

- **Asset ID:** asset.kings-canyon.repulsor.repulsor-foundations
- **Type:** POI hero component
- **Source:** prop-list.md:919
...
![Repulsor foundations reference render](repulsor-foundations.png)

## Intent

The **Repulsor foundations** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **Repulsor foundations** as a useful,
