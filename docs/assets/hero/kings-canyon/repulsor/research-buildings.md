...
---
asset_id: "asset.kings-canyon.repulsor.research-buildings"
source_label: "research buildings"
source_section: "Hero / Kings Canyon"
source_group: "Repulsor"
source_line: 921
level: L3
status: planned
...
- **Asset ID:** asset.kings-canyon.repulsor.research-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:921
...
![research buildings reference render](research-buildings.png)

## Intent

The **research buildings** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **research buildings** as a useful,
...
- **Parent assembly:** [Repulsor assembly](./_assembly.md).

- **POI sibling component:** [giant destroyed Repulsor Tower](./giant-destroyed-repulsor-tower.md).
