...
---
assembly_id: "assembly.kings-canyon.repulsor"
source_label: "Repulsor"
...
# Repulsor — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.repulsor
...
- **Source:** prop-list.md:918

## Landmark promise

Repulsor is a landmark, not a pile of unrelated props. The full assembly
...
- [giant destroyed Repulsor Tower](./giant-destroyed-repulsor-tower.md) — component brief.
- [Repulsor foundations](./repulsor-foundations.md) — component brief.
- [three large covered pits](./three-large-covered-pits.md) — component brief.
- [research buildings](./research-buildings.md) — component brief.
- [collapsed tower debris](./collapsed-tower-debris.md) — component brief.
