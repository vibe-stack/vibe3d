...
---
asset_id: "asset.kings-canyon.repulsor.three-large-covered-pits"
source_label: "three large covered pits"
...
# three large covered pits

## Identity

- **Asset ID:** asset.kings-canyon.repulsor.three-large-covered-pits
- **Type:** POI hero component
- **Source:** prop-list.md:920
...
![three large covered pits reference render](three-large-covered-pits.png)

## Intent

The **three large covered pits** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **three large covered pits** as a useful,
