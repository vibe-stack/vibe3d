...
---
asset_id: "asset.kings-canyon.the-pit.central-crate-cover-arrangement"
source_label: "central crate/cover arrangement"
source_section: "Hero / Kings Canyon"
source_group: "The Pit"
source_line: 988
level: L3
status: planned
...
# central crate/cover arrangement

## Identity

- **Asset ID:** asset.kings-canyon.the-pit.central-crate-cover-arrangement
- **Type:** POI hero component
- **Source:** prop-list.md:988
...
![central crate/cover arrangement reference render](central-crate-cover-arrangement.png)

## Intent

The **central crate/cover arrangement** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **central crate/cover arrangement** as a useful,
...
- **Parent assembly:** [The Pit assembly](./_assembly.md).

- **stacking/handling family:** [Titanfall-style cargo crate small](../../../reusable/cargo-logistics/titanfall-style-cargo-crate-small.md).
- **POI sibling component:** [circular arena infrastructure](./circular-arena-infrastructure.md).
