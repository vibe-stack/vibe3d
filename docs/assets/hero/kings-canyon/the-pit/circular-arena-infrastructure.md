...
---
asset_id: "asset.kings-canyon.the-pit.circular-arena-infrastructure"
source_label: "circular arena infrastructure"
...
# circular arena infrastructure

## Identity

- **Asset ID:** asset.kings-canyon.the-pit.circular-arena-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:987
...
![circular arena infrastructure reference render](circular-arena-infrastructure.png)

## Intent

The **circular arena infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **circular arena infrastructure** as a useful,
...
- **POI sibling component:** [central crate/cover arrangement](./central-crate-cover-arrangement.md).
