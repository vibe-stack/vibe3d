...
---
asset_id: "asset.kings-canyon.creature-containment.wildlife-containment-compound"
source_label: "wildlife containment compound"
source_section: "Hero / Kings Canyon"
source_group: "Creature Containment"
source_line: 906
level: L3
status: planned
...
# wildlife containment compound

## Identity

- **Asset ID:** asset.kings-canyon.creature-containment.wildlife-containment-compound
- **Type:** POI hero component
- **Source:** prop-list.md:906
...
![wildlife containment compound reference render](wildlife-containment-compound.png)

## Intent

The **wildlife containment compound** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **wildlife containment compound** as a useful,
...
Favor a recognizable silhouette, believable weight/contact, and one ecological behavior cue. Surface detail should follow anatomy or growth direction.
...
- **Parent assembly:** [Creature Containment assembly](./_assembly.md).

- **POI sibling component:** [huge Flyer containment cages](./huge-flyer-containment-cages.md).
