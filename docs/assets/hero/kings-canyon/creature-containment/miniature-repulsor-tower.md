...
---
asset_id: "asset.kings-canyon.creature-containment.miniature-repulsor-tower"
source_label: "miniature Repulsor tower"
...
# miniature Repulsor tower

## Identity

- **Asset ID:** asset.kings-canyon.creature-containment.miniature-repulsor-tower
- **Type:** POI hero component
- **Source:** prop-list.md:905
...
![miniature Repulsor tower reference render](miniature-repulsor-tower.png)

## Intent

The **miniature Repulsor tower** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **miniature Repulsor tower** as a useful,
