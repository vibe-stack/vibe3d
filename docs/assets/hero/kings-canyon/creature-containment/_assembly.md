...
---
assembly_id: "assembly.kings-canyon.creature-containment"
source_label: "Creature Containment"
...
# Creature Containment — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.creature-containment
...
Creature Containment is a landmark, not a pile of unrelated props. The full assembly
...
- [huge Flyer containment cages](./huge-flyer-containment-cages.md) — component brief.
- [cage gantries](./cage-gantries.md) — component brief.
- [miniature Repulsor tower](./miniature-repulsor-tower.md) — component brief.
- [wildlife containment compound](./wildlife-containment-compound.md) — component brief.
