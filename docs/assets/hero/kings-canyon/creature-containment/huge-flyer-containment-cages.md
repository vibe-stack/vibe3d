...
---
asset_id: "asset.kings-canyon.creature-containment.huge-flyer-containment-cages"
source_label: "huge Flyer containment cages"
...
# huge Flyer containment cages

## Identity

- **Asset ID:** asset.kings-canyon.creature-containment.huge-flyer-containment-cages
- **Type:** POI hero component
- **Source:** prop-list.md:903
...
![huge Flyer containment cages reference render](huge-flyer-containment-cages.png)

## Intent

The **huge Flyer containment cages** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge Flyer containment cages** as a useful,
...
- **POI sibling component:** [cage gantries](./cage-gantries.md).
