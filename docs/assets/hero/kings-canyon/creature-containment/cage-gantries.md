...
---
asset_id: "asset.kings-canyon.creature-containment.cage-gantries"
source_label: "cage gantries"
...
- **Asset ID:** asset.kings-canyon.creature-containment.cage-gantries
- **Type:** POI hero component
- **Source:** prop-list.md:904
...
![cage gantries reference render](cage-gantries.png)

## Intent

The **cage gantries** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **cage gantries** as a useful,
