...
---
asset_id: "asset.kings-canyon.bunker-pass.giant-bunker-tunnel"
source_label: "giant bunker tunnel"
...
- **Asset ID:** asset.kings-canyon.bunker-pass.giant-bunker-tunnel
- **Type:** POI hero component
- **Source:** prop-list.md:998
...
![giant bunker tunnel reference render](giant-bunker-tunnel.png)

## Intent

The **giant bunker tunnel** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant bunker tunnel** as a useful,
...
- **POI sibling component:** [blast-door entrances](./blast-door-entrances.md).
