...
---
asset_id: "asset.kings-canyon.bunker-pass.internal-bunker-corridors"
source_label: "internal bunker corridors"
...
# internal bunker corridors

## Identity

- **Asset ID:** asset.kings-canyon.bunker-pass.internal-bunker-corridors
- **Type:** POI hero component
- **Source:** prop-list.md:1000
...
![internal bunker corridors reference render](internal-bunker-corridors.png)

## Intent

The **internal bunker corridors** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **internal bunker corridors** as a useful,
