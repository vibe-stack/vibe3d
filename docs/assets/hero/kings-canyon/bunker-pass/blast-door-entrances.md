...
---
asset_id: "asset.kings-canyon.bunker-pass.blast-door-entrances"
source_label: "blast-door entrances"
source_section: "Hero / Kings Canyon"
source_group: "Bunker Pass"
source_line: 999
level: L3
status: planned
...
# blast-door entrances

## Identity

- **Asset ID:** asset.kings-canyon.bunker-pass.blast-door-entrances
- **Type:** POI hero component
- **Source:** prop-list.md:999
...
![blast-door entrances reference render](blast-door-entrances.png)

## Intent

The **blast-door entrances** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **blast-door entrances** as a useful,
...
- **Parent assembly:** [Bunker Pass assembly](./_assembly.md).

- **shared door frame:** [door frame](../../../reusable/architecture/doors/door-frame.md).
- **POI sibling component:** [giant bunker tunnel](./giant-bunker-tunnel.md).
