...
---
asset_id: "asset.kings-canyon.runoff.sewage-treatment-building"
source_label: "sewage-treatment building"
...
- **Asset ID:** asset.kings-canyon.runoff.sewage-treatment-building
- **Type:** POI hero component
- **Source:** prop-list.md:959
...
![sewage-treatment building reference render](sewage-treatment-building.png)

## Intent

The **sewage-treatment building** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **sewage-treatment building** as a useful,
...
- **Parent assembly:** [Runoff assembly](./_assembly.md).

- **POI sibling component:** [water basins](./water-basins.md).
