...
---
asset_id: "asset.kings-canyon.runoff.bridge-connected-facilities"
source_label: "bridge-connected facilities"
...
# bridge-connected facilities

## Identity

- **Asset ID:** asset.kings-canyon.runoff.bridge-connected-facilities
- **Type:** POI hero component
- **Source:** prop-list.md:962
...
![bridge-connected facilities reference render](bridge-connected-facilities.png)

## Intent

The **bridge-connected facilities** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **bridge-connected facilities** as a useful,
...
- **POI sibling component:** [sewage-treatment building](./sewage-treatment-building.md).
