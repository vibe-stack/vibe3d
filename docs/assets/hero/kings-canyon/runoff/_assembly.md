...
---
assembly_id: "assembly.kings-canyon.runoff"
source_label: "Runoff"
...
# Runoff — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.runoff
...
Runoff is a landmark, not a pile of unrelated props. The full assembly
...
- [sewage-treatment building](./sewage-treatment-building.md) — component brief.
- [water basins](./water-basins.md) — component brief.
- [huge pipes](./huge-pipes.md) — component brief.
- [bridge-connected facilities](./bridge-connected-facilities.md) — component brief.
