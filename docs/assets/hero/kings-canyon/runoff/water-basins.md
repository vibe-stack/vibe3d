...
---
asset_id: "asset.kings-canyon.runoff.water-basins"
source_label: "water basins"
...
- **Asset ID:** asset.kings-canyon.runoff.water-basins
- **Type:** POI hero component
- **Source:** prop-list.md:960
...
![water basins reference render](water-basins.png)

## Intent

The **water basins** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **water basins** as a useful,
