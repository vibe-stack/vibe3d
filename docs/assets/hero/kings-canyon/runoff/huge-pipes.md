...
---
asset_id: "asset.kings-canyon.runoff.huge-pipes"
source_label: "huge pipes"
...
- **Asset ID:** asset.kings-canyon.runoff.huge-pipes
- **Type:** POI hero component
- **Source:** prop-list.md:961
...
![huge pipes reference render](huge-pipes.png)

## Intent

The **huge pipes** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge pipes** as a useful,
