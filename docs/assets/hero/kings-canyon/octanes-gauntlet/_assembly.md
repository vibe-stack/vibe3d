...
---
assembly_id: "assembly.kings-canyon.octanes-gauntlet"
source_label: "Octane's Gauntlet"
...
# Octane's Gauntlet — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.octanes-gauntlet
...
- **Source:** prop-list.md:943

## Landmark promise

Octane's Gauntlet is a landmark, not a pile of unrelated props. The full assembly
...
- [huge stunt ramp](./huge-stunt-ramp.md) — component brief.
- [flaming ring](./flaming-ring.md) — component brief.
- [race-course geometry](./race-course-geometry.md) — component brief.
- [built-in Jump Pads](./built-in-jump-pads.md) — component brief.
- [spectator/scaffolding structures](./spectator-scaffolding-structures.md) — component brief.
