...
---
asset_id: "asset.kings-canyon.octanes-gauntlet.huge-stunt-ramp"
source_label: "huge stunt ramp"
...
- **Asset ID:** asset.kings-canyon.octanes-gauntlet.huge-stunt-ramp
...
![huge stunt ramp reference render](huge-stunt-ramp.png)

## Intent

The **huge stunt ramp** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge stunt ramp** as a useful,
...
- **POI sibling component:** [flaming ring](./flaming-ring.md).
