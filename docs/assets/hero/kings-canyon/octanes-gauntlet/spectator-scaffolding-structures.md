...
---
asset_id: "asset.kings-canyon.octanes-gauntlet.spectator-scaffolding-structures"
source_label: "spectator/scaffolding structures"
...
# spectator/scaffolding structures

## Identity

- **Asset ID:** asset.kings-canyon.octanes-gauntlet.spectator-scaffolding-structures
- **Type:** POI hero component
- **Source:** prop-list.md:947
...
![spectator/scaffolding structures reference render](spectator-scaffolding-structures.png)

## Intent

The **spectator/scaffolding structures** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **spectator/scaffolding structures** as a useful,
