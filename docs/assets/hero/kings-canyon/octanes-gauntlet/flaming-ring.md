...
---
asset_id: "asset.kings-canyon.octanes-gauntlet.flaming-ring"
source_label: "flaming ring"
source_section: "Hero / Kings Canyon"
source_group: "Octane's Gauntlet"
source_line: 944
level: L3
status: planned
...
- **Asset ID:** asset.kings-canyon.octanes-gauntlet.flaming-ring
- **Type:** POI hero component
- **Source:** prop-list.md:944
...
![flaming ring reference render](flaming-ring.png)

## Intent

The **flaming ring** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **flaming ring** as a useful,
...
- **Parent assembly:** [Octane's Gauntlet assembly](./_assembly.md).

- **POI sibling component:** [huge stunt ramp](./huge-stunt-ramp.md).
