...
---
asset_id: "asset.kings-canyon.octanes-gauntlet.race-course-geometry"
source_label: "race-course geometry"
...
# race-course geometry

## Identity

- **Asset ID:** asset.kings-canyon.octanes-gauntlet.race-course-geometry
- **Type:** POI hero component
- **Source:** prop-list.md:945
...
![race-course geometry reference render](race-course-geometry.png)

## Intent

The **race-course geometry** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **race-course geometry** as a useful,
