...
---
asset_id: "asset.kings-canyon.octanes-gauntlet.built-in-jump-pads"
source_label: "built-in Jump Pads"
...
- **Asset ID:** asset.kings-canyon.octanes-gauntlet.built-in-jump-pads
- **Type:** POI hero component
- **Source:** prop-list.md:946
...
![built-in Jump Pads reference render](built-in-jump-pads.png)

## Intent

The **built-in Jump Pads** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **built-in Jump Pads** as a useful,
