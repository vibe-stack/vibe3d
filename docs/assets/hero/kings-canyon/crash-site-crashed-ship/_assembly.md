<!-- generated assembly brief from prop-list.md -->
---
assembly_id: "assembly.kings-canyon.crash-site-crashed-ship"
source_label: "Crash Site / Crashed Ship"
...
# Crash Site / Crashed Ship — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.crash-site-crashed-ship
- **Map family:** Hero / Kings Canyon
- **Place identity:** Old military frontier, ecological disaster, and salvage zones
- **Owner / story role:** Axiom Defense / frontier ecology
- **Source:** prop-list.md:882

## Landmark promise

Crash Site / Crashed Ship is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate aged military infrastructure, hard terrain, containment, and visible catastrophe.
...
- Use RED-500 as the dominant hero signal and
  AMBER-400 only as a supporting state or traversal cue.
...
- [IMS Thermopylae wreck](./ims-thermopylae-wreck.md) — component brief.
- [complete wrecked ship hero hull](./complete-wrecked-ship-hero-hull.md) — component brief.
- [ship engines](./ship-engines.md) — component brief.
- [broken wing sections](./broken-wing-sections.md) — component brief.
- [scaffolding surrounding ship](./scaffolding-surrounding-ship.md) — component brief.
- [fuel-leak infrastructure](./fuel-leak-infrastructure.md) — component brief.
- [ECHO monitoring stations](./echo-monitoring-stations.md) — component brief.
- [containment equipment](./containment-equipment.md) — component brief.
- [wreckage field](./wreckage-field.md) — component brief.
...
- [world concept](../../../../world/concept.md)
- [visual language](../../../../world/visual-language.md)
- [material library](../../../../world/material-library.md)
- [color system](../../../../world/color-system.md)
- [map identity](../../../../world/map-identity.md)
- [source context](../../../../world/source-context.md)
- [production rules](../../../../world/production-rules.md)
