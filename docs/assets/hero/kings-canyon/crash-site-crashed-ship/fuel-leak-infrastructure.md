...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.fuel-leak-infrastructure"
source_label: "fuel-leak infrastructure"
...
# fuel-leak infrastructure

## Identity

- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.fuel-leak-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:887
...
![fuel-leak infrastructure reference render](fuel-leak-infrastructure.png)

## Intent

The **fuel-leak infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **fuel-leak infrastructure** as a useful,
