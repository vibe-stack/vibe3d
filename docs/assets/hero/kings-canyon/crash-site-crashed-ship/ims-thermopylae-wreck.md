...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.ims-thermopylae-wreck"
source_label: "IMS Thermopylae wreck"
...
# IMS Thermopylae wreck

## Identity

- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.ims-thermopylae-wreck
...
![IMS Thermopylae wreck reference render](ims-thermopylae-wreck.png)

## Intent

The **IMS Thermopylae wreck** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **IMS Thermopylae wreck** as a useful,
...
- **POI sibling component:** [complete wrecked ship hero hull](./complete-wrecked-ship-hero-hull.md).
