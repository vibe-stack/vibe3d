...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.complete-wrecked-ship-hero-hull"
source_label: "complete wrecked ship hero hull"
...
# complete wrecked ship hero hull

## Identity

- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.complete-wrecked-ship-hero-hull
- **Type:** POI hero component
- **Source:** prop-list.md:883
...
![complete wrecked ship hero hull reference render](complete-wrecked-ship-hero-hull.png)

## Intent

The **complete wrecked ship hero hull** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **complete wrecked ship hero hull** as a useful,
