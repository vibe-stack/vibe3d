...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.containment-equipment"
source_label: "containment equipment"
...
- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.containment-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:889
...
![containment equipment reference render](containment-equipment.png)

## Intent

The **containment equipment** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **containment equipment** as a useful,
