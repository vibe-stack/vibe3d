...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.wreckage-field"
source_label: "wreckage field"
...
- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.wreckage-field
- **Type:** POI hero component
- **Source:** prop-list.md:890
...
![wreckage field reference render](wreckage-field.png)

## Intent

The **wreckage field** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **wreckage field** as a useful,
