...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.broken-wing-sections"
source_label: "broken wing sections"
...
- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.broken-wing-sections
- **Type:** POI hero component
- **Source:** prop-list.md:885
...
![broken wing sections reference render](broken-wing-sections.png)

## Intent

The **broken wing sections** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **broken wing sections** as a useful,
