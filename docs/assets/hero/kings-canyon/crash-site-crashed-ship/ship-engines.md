...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.ship-engines"
source_label: "ship engines"
...
- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.ship-engines
- **Type:** POI hero component
- **Source:** prop-list.md:884
...
![ship engines reference render](ship-engines.png)

## Intent

The **ship engines** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **ship engines** as a useful,
