...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.echo-monitoring-stations"
source_label: "ECHO monitoring stations"
source_section: "Hero / Kings Canyon"
source_group: "Crash Site / Crashed Ship"
source_line: 888
level: L3
status: planned
...
# ECHO monitoring stations

## Identity

- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.echo-monitoring-stations
- **Type:** POI hero component
- **Source:** prop-list.md:888
...
![ECHO monitoring stations reference render](echo-monitoring-stations.png)

## Intent

The **ECHO monitoring stations** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **ECHO monitoring stations** as a useful,
...
- **Parent assembly:** [Crash Site / Crashed Ship assembly](./_assembly.md).

- **POI sibling component:** [IMS Thermopylae wreck](./ims-thermopylae-wreck.md).
