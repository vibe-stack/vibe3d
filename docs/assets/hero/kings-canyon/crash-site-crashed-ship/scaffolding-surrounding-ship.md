...
---
asset_id: "asset.kings-canyon.crash-site-crashed-ship.scaffolding-surrounding-ship"
source_label: "scaffolding surrounding ship"
...
# scaffolding surrounding ship

## Identity

- **Asset ID:** asset.kings-canyon.crash-site-crashed-ship.scaffolding-surrounding-ship
- **Type:** POI hero component
- **Source:** prop-list.md:886
...
![scaffolding surrounding ship reference render](scaffolding-surrounding-ship.png)

## Intent

The **scaffolding surrounding ship** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **scaffolding surrounding ship** as a useful,
