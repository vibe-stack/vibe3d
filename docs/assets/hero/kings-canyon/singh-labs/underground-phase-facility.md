...
---
asset_id: "asset.kings-canyon.singh-labs.underground-phase-facility"
source_label: "underground phase facility"
...
# underground phase facility

## Identity

- **Asset ID:** asset.kings-canyon.singh-labs.underground-phase-facility
- **Type:** POI hero component
- **Source:** prop-list.md:928
...
![underground phase facility reference render](underground-phase-facility.png)

## Intent

The **underground phase facility** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **underground phase facility** as a useful,
