...
---
asset_id: "asset.kings-canyon.singh-labs.huge-laboratory-blast-door"
source_label: "huge laboratory blast door"
source_section: "Hero / Kings Canyon"
source_group: "Singh Labs"
source_line: 929
level: L3
status: planned
...
# huge laboratory blast door

## Identity

- **Asset ID:** asset.kings-canyon.singh-labs.huge-laboratory-blast-door
- **Type:** POI hero component
- **Source:** prop-list.md:929
...
![huge laboratory blast door reference render](huge-laboratory-blast-door.png)

## Intent

The **huge laboratory blast door** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge laboratory blast door** as a useful,
...
Show the frame, gasket, hinge/track, control surface, and safe clearance zone. Moving parts need a hard stop and a readable reset state. Keep the strongest value break on the
...
- **Parent assembly:** [Singh Labs assembly](./_assembly.md).

- **shared door frame:** [door frame](../../../reusable/architecture/doors/door-frame.md).
- **POI sibling component:** [massive Phase Portal](./massive-phase-portal.md).
