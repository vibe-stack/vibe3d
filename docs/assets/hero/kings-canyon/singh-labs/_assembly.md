...
---
assembly_id: "assembly.kings-canyon.singh-labs"
source_label: "Singh Labs"
...
# Singh Labs — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.singh-labs
...
Singh Labs is a landmark, not a pile of unrelated props. The full assembly
...
- [massive Phase Portal](./massive-phase-portal.md) — component brief.
- [portal support ring](./portal-support-ring.md) — component brief.
- [underground phase facility](./underground-phase-facility.md) — component brief.
- [huge laboratory blast door](./huge-laboratory-blast-door.md) — component brief.
- [phase machinery](./phase-machinery.md) — component brief.
