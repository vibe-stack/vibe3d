...
---
asset_id: "asset.kings-canyon.singh-labs.portal-support-ring"
source_label: "portal support ring"
...
- **Asset ID:** asset.kings-canyon.singh-labs.portal-support-ring
- **Type:** POI hero component
- **Source:** prop-list.md:927
...
![portal support ring reference render](portal-support-ring.png)

## Intent

The **portal support ring** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **portal support ring** as a useful,
