...
---
asset_id: "asset.kings-canyon.singh-labs.massive-phase-portal"
source_label: "massive Phase Portal"
...
# massive Phase Portal

## Identity

- **Asset ID:** asset.kings-canyon.singh-labs.massive-phase-portal
- **Type:** POI hero component
- **Source:** prop-list.md:926
...
![massive Phase Portal reference render](massive-phase-portal.png)

## Intent

The **massive Phase Portal** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **massive Phase Portal** as a useful,
...
- **POI sibling component:** [portal support ring](./portal-support-ring.md).
