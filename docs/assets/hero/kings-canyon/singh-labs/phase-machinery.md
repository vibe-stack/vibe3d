...
---
asset_id: "asset.kings-canyon.singh-labs.phase-machinery"
source_label: "phase machinery"
...
- **Asset ID:** asset.kings-canyon.singh-labs.phase-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:930
...
![phase machinery reference render](phase-machinery.png)

## Intent

The **phase machinery** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **phase machinery** as a useful,
