...
---
asset_id: "asset.kings-canyon.cryptos-map-room.giant-satellite-radar-dish"
source_label: "giant satellite/radar dish"
...
# giant satellite/radar dish

## Identity

- **Asset ID:** asset.kings-canyon.cryptos-map-room.giant-satellite-radar-dish
- **Type:** POI hero component
- **Source:** prop-list.md:910
...
![giant satellite/radar dish reference render](giant-satellite-radar-dish.png)

## Intent

The **giant satellite/radar dish** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant satellite/radar dish** as a useful,
...
- **POI sibling component:** [central map-room building](./central-map-room-building.md).
