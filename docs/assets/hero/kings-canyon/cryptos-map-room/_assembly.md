...
---
assembly_id: "assembly.kings-canyon.cryptos-map-room"
source_label: "Crypto's Map Room"
...
# Crypto's Map Room — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.cryptos-map-room
...
Crypto's Map Room is a landmark, not a pile of unrelated props. The full assembly
...
- [giant satellite/radar dish](./giant-satellite-radar-dish.md) — component brief.
- [central map-room building](./central-map-room-building.md) — component brief.
- [full-map holographic projector](./full-map-holographic-projector.md) — component brief.
- [circular interior console](./circular-interior-console.md) — component brief.
- [intelligence screens](./intelligence-screens.md) — component brief.
