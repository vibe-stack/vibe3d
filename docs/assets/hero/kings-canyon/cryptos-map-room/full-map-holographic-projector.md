...
---
asset_id: "asset.kings-canyon.cryptos-map-room.full-map-holographic-projector"
source_label: "full-map holographic projector"
...
# full-map holographic projector

## Identity

- **Asset ID:** asset.kings-canyon.cryptos-map-room.full-map-holographic-projector
- **Type:** POI hero component
- **Source:** prop-list.md:912
...
![full-map holographic projector reference render](full-map-holographic-projector.png)

## Intent

The **full-map holographic projector** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **full-map holographic projector** as a useful,
