...
---
asset_id: "asset.kings-canyon.cryptos-map-room.intelligence-screens"
source_label: "intelligence screens"
...
- **Asset ID:** asset.kings-canyon.cryptos-map-room.intelligence-screens
- **Type:** POI hero component
- **Source:** prop-list.md:914
...
![intelligence screens reference render](intelligence-screens.png)

## Intent

The **intelligence screens** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **intelligence screens** as a useful,
...
- **shared graphics system:** [IMC logo](../../../graphics-signage/imc-logo.md).
