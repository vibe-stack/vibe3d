...
---
asset_id: "asset.kings-canyon.cryptos-map-room.circular-interior-console"
source_label: "circular interior console"
...
# circular interior console

## Identity

- **Asset ID:** asset.kings-canyon.cryptos-map-room.circular-interior-console
- **Type:** POI hero component
- **Source:** prop-list.md:913
...
![circular interior console reference render](circular-interior-console.png)

## Intent

The **circular interior console** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **circular interior console** as a useful,
