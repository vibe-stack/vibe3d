...
---
asset_id: "asset.kings-canyon.cryptos-map-room.central-map-room-building"
source_label: "central map-room building"
source_section: "Hero / Kings Canyon"
source_group: "Crypto's Map Room"
source_line: 911
level: L3
status: planned
...
# central map-room building

## Identity

- **Asset ID:** asset.kings-canyon.cryptos-map-room.central-map-room-building
- **Type:** POI hero component
- **Source:** prop-list.md:911
...
![central map-room building reference render](central-map-room-building.png)

## Intent

The **central map-room building** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **central map-room building** as a useful,
...
- **Parent assembly:** [Crypto's Map Room assembly](./_assembly.md).

- **POI sibling component:** [giant satellite/radar dish](./giant-satellite-radar-dish.md).
