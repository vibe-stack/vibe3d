...
---
assembly_id: "assembly.kings-canyon.swamps"
source_label: "Swamps"
...
# Swamps — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.swamps
...
Swamps is a landmark, not a pile of unrelated props. The full assembly
...
- [stilt-building kit](./stilt-building-kit.md) — component brief.
- [partially submerged giant pipelines](./partially-submerged-giant-pipelines.md) — component brief.
- [raised bridges](./raised-bridges.md) — component brief.
- [wooden/metal boardwalk network](./wooden-metal-boardwalk-network.md) — component brief.
