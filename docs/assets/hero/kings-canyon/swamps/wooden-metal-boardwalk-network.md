...
---
asset_id: "asset.kings-canyon.swamps.wooden-metal-boardwalk-network"
source_label: "wooden/metal boardwalk network"
...
# wooden/metal boardwalk network

## Identity

- **Asset ID:** asset.kings-canyon.swamps.wooden-metal-boardwalk-network
- **Type:** POI hero component
- **Source:** prop-list.md:977
...
![wooden/metal boardwalk network reference render](wooden-metal-boardwalk-network.png)

## Intent

The **wooden/metal boardwalk network** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **wooden/metal boardwalk network** as a useful,
