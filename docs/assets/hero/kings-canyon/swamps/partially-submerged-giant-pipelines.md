...
---
asset_id: "asset.kings-canyon.swamps.partially-submerged-giant-pipelines"
source_label: "partially submerged giant pipelines"
...
# partially submerged giant pipelines

## Identity

- **Asset ID:** asset.kings-canyon.swamps.partially-submerged-giant-pipelines
- **Type:** POI hero component
- **Source:** prop-list.md:975
...
![partially submerged giant pipelines reference render](partially-submerged-giant-pipelines.png)

## Intent

The **partially submerged giant pipelines** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **partially submerged giant pipelines** as a useful,
...
- **POI sibling component:** [stilt-building kit](./stilt-building-kit.md).
