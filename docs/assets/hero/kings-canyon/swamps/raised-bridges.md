...
---
asset_id: "asset.kings-canyon.swamps.raised-bridges"
source_label: "raised bridges"
...
- **Asset ID:** asset.kings-canyon.swamps.raised-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:976
...
![raised bridges reference render](raised-bridges.png)

## Intent

The **raised bridges** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **raised bridges** as a useful,
