...
---
asset_id: "asset.kings-canyon.swamps.stilt-building-kit"
source_label: "stilt-building kit"
...
- **Asset ID:** asset.kings-canyon.swamps.stilt-building-kit
- **Type:** POI hero component
- **Source:** prop-list.md:974
...
![stilt-building kit reference render](stilt-building-kit.png)

## Intent

The **stilt-building kit** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **stilt-building kit** as a useful,
...
- **Parent assembly:** [Swamps assembly](./_assembly.md).

- **POI sibling component:** [partially submerged giant pipelines](./partially-submerged-giant-pipelines.md).
