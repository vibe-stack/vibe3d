...
---
assembly_id: "assembly.kings-canyon.offshore-rig"
source_label: "Offshore Rig"
...
# Offshore Rig — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.offshore-rig
...
Offshore Rig is a landmark, not a pile of unrelated props. The full assembly
...
- [complete offshore platform](./complete-offshore-platform.md) — component brief.
- [drilling/industrial tower](./drilling-industrial-tower.md) — component brief.
- [sea platform bridges](./sea-platform-bridges.md) — component brief.
- [cranes](./cranes.md) — component brief.
- [pipework](./pipework.md) — component brief.
