...
---
asset_id: "asset.kings-canyon.offshore-rig.complete-offshore-platform"
source_label: "complete offshore platform"
source_section: "Hero / Kings Canyon"
source_group: "Offshore Rig"
source_line: 966
level: L3
status: planned
...
# complete offshore platform

## Identity

- **Asset ID:** asset.kings-canyon.offshore-rig.complete-offshore-platform
- **Type:** POI hero component
- **Source:** prop-list.md:966
...
![complete offshore platform reference render](complete-offshore-platform.png)

## Intent

The **complete offshore platform** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **complete offshore platform** as a useful,
...
- **blocking:** [floor slab tile](../../../reusable/architecture/modular-building-connectors/floor-slab-tile.md) — repeatable structural surface.
- **blocking:** [foundation interface](../../../reusable/architecture/modular-building-connectors/foundation-interface.md) — load and terrain interface.
- **optional:** [wall return](../../../reusable/architecture/modular-building-connectors/wall-return.md) — edge/termination module.
- **optional:** [utility enclosure](../../../reusable/architecture/building-prefab-assemblies/utility-enclosure.md) — service-room host.
...
- **Parent assembly:** [Offshore Rig assembly](./_assembly.md).

- **POI sibling component:** [drilling/industrial tower](./drilling-industrial-tower.md).
