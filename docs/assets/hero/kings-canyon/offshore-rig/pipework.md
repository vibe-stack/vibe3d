...
---
asset_id: "asset.kings-canyon.offshore-rig.pipework"
source_label: "pipework"
...
- **Asset ID:** asset.kings-canyon.offshore-rig.pipework
- **Type:** POI hero component
- **Source:** prop-list.md:970
...
![pipework reference render](pipework.png)

## Intent

The **pipework** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **pipework** as a useful,
...
- **POI sibling component:** [complete offshore platform](./complete-offshore-platform.md).
