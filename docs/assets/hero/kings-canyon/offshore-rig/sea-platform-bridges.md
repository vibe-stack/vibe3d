...
---
asset_id: "asset.kings-canyon.offshore-rig.sea-platform-bridges"
source_label: "sea platform bridges"
...
# sea platform bridges

## Identity

- **Asset ID:** asset.kings-canyon.offshore-rig.sea-platform-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:968
...
![sea platform bridges reference render](sea-platform-bridges.png)

## Intent

The **sea platform bridges** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **sea platform bridges** as a useful,
