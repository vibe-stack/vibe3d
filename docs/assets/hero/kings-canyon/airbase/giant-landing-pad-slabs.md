...
---
asset_id: "asset.kings-canyon.airbase.giant-landing-pad-slabs"
source_label: "giant landing-pad slabs"
...
# giant landing-pad slabs

## Identity

- **Asset ID:** asset.kings-canyon.airbase.giant-landing-pad-slabs
- **Type:** POI hero component
- **Source:** prop-list.md:858
...
![giant landing-pad slabs reference render](giant-landing-pad-slabs.png)

## Intent

The **giant landing-pad slabs** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant landing-pad slabs** as a useful,
