...
---
asset_id: "asset.kings-canyon.airbase.airbase-hangars"
source_label: "Airbase hangars"
source_section: "Hero / Kings Canyon"
source_group: "Airbase"
source_line: 860
level: L3
status: planned
...
- **Asset ID:** asset.kings-canyon.airbase.airbase-hangars
- **Type:** POI hero component
- **Source:** prop-list.md:860
...
![Airbase hangars reference render](airbase-hangars.png)

## Intent

The **Airbase hangars** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **Airbase hangars** as a useful,
...
- **Parent assembly:** [Airbase assembly](./_assembly.md).

- **POI sibling component:** [huge paired runway platforms](./huge-paired-runway-platforms.md).
