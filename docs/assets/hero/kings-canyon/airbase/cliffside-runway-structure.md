...
---
asset_id: "asset.kings-canyon.airbase.cliffside-runway-structure"
source_label: "cliffside runway structure"
...
# cliffside runway structure

## Identity

- **Asset ID:** asset.kings-canyon.airbase.cliffside-runway-structure
- **Type:** POI hero component
- **Source:** prop-list.md:861
...
![cliffside runway structure reference render](cliffside-runway-structure.png)

## Intent

The **cliffside runway structure** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **cliffside runway structure** as a useful,
