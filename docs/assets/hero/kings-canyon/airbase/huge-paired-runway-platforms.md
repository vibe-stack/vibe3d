...
---
asset_id: "asset.kings-canyon.airbase.huge-paired-runway-platforms"
source_label: "huge paired runway platforms"
...
# huge paired runway platforms

## Identity

- **Asset ID:** asset.kings-canyon.airbase.huge-paired-runway-platforms
...
![huge paired runway platforms reference render](huge-paired-runway-platforms.png)

## Intent

The **huge paired runway platforms** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge paired runway platforms** as a useful,
...
- **POI sibling component:** [runway bridges](./runway-bridges.md).
