...
---
asset_id: "asset.kings-canyon.airbase.runway-bridges"
source_label: "runway bridges"
...
- **Asset ID:** asset.kings-canyon.airbase.runway-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:857
...
![runway bridges reference render](runway-bridges.png)

## Intent

The **runway bridges** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **runway bridges** as a useful,
