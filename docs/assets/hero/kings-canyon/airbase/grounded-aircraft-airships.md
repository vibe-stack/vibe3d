...
---
asset_id: "asset.kings-canyon.airbase.grounded-aircraft-airships"
source_label: "grounded aircraft/airships"
...
# grounded aircraft/airships

## Identity

- **Asset ID:** asset.kings-canyon.airbase.grounded-aircraft-airships
- **Type:** POI hero component
- **Source:** prop-list.md:859
...
![grounded aircraft/airships reference render](grounded-aircraft-airships.png)

## Intent

The **grounded aircraft/airships** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **grounded aircraft/airships** as a useful,
