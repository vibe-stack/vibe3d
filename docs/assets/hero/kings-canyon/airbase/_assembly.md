...
---
assembly_id: "assembly.kings-canyon.airbase"
source_label: "Airbase"
...
# Airbase — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.airbase
...
- **Source:** prop-list.md:856

## Landmark promise

Airbase is a landmark, not a pile of unrelated props. The full assembly
...
- [huge paired runway platforms](./huge-paired-runway-platforms.md) — component brief.
- [runway bridges](./runway-bridges.md) — component brief.
- [giant landing-pad slabs](./giant-landing-pad-slabs.md) — component brief.
- [grounded aircraft/airships](./grounded-aircraft-airships.md) — component brief.
- [Airbase hangars](./airbase-hangars.md) — component brief.
- [cliffside runway structure](./cliffside-runway-structure.md) — component brief.
