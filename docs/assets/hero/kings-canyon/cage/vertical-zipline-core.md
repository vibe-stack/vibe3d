...
---
asset_id: "asset.kings-canyon.cage.vertical-zipline-core"
source_label: "vertical zipline core"
...
# vertical zipline core

## Identity

- **Asset ID:** asset.kings-canyon.cage.vertical-zipline-core
- **Type:** POI hero component
- **Source:** prop-list.md:983
...
![vertical zipline core reference render](vertical-zipline-core.png)

## Intent

The **vertical zipline core** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **vertical zipline core** as a useful,
...
- **POI sibling component:** [enormous multi-storey cage tower](./enormous-multi-storey-cage-tower.md).
