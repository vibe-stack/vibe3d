...
---
assembly_id: "assembly.kings-canyon.cage"
source_label: "Cage"
...
- **Assembly ID:** assembly.kings-canyon.cage
...
Cage is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous multi-storey cage tower](./enormous-multi-storey-cage-tower.md) — component brief.
- [enclosed corridors](./enclosed-corridors.md) — component brief.
- [vertical zipline core](./vertical-zipline-core.md) — component brief.
