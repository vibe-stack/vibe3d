...
---
asset_id: "asset.kings-canyon.cage.enclosed-corridors"
source_label: "enclosed corridors"
...
- **Asset ID:** asset.kings-canyon.cage.enclosed-corridors
- **Type:** POI hero component
- **Source:** prop-list.md:982
...
![enclosed corridors reference render](enclosed-corridors.png)

## Intent

The **enclosed corridors** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **enclosed corridors** as a useful,
