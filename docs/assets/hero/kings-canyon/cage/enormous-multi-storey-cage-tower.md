...
---
asset_id: "asset.kings-canyon.cage.enormous-multi-storey-cage-tower"
source_label: "enormous multi-storey cage tower"
...
# enormous multi-storey cage tower

## Identity

- **Asset ID:** asset.kings-canyon.cage.enormous-multi-storey-cage-tower
- **Type:** POI hero component
- **Source:** prop-list.md:981
...
![enormous multi-storey cage tower reference render](enormous-multi-storey-cage-tower.png)

## Intent

The **enormous multi-storey cage tower** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **enormous multi-storey cage tower** as a useful,
...
- **Parent assembly:** [Cage assembly](./_assembly.md).

- **POI sibling component:** [enclosed corridors](./enclosed-corridors.md).
