...
---
asset_id: "asset.kings-canyon.spotted-lake.echo-research-camps"
source_label: "ECHO research camps"
...
- **Asset ID:** asset.kings-canyon.spotted-lake.echo-research-camps
- **Type:** POI hero component
- **Source:** prop-list.md:897
...
![ECHO research camps reference render](echo-research-camps.png)

## Intent

The **ECHO research camps** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **ECHO research camps** as a useful,
