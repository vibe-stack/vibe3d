...
---
asset_id: "asset.kings-canyon.spotted-lake.filtration-machinery"
source_label: "filtration machinery"
source_section: "Hero / Kings Canyon"
source_group: "Spotted Lake"
source_line: 895
level: L3
status: planned
...
- **Asset ID:** asset.kings-canyon.spotted-lake.filtration-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:895
...
![filtration machinery reference render](filtration-machinery.png)

## Intent

The **filtration machinery** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **filtration machinery** as a useful,
...
- **Parent assembly:** [Spotted Lake assembly](./_assembly.md).

- **POI sibling component:** [giant Filtration Dam](./giant-filtration-dam.md).
