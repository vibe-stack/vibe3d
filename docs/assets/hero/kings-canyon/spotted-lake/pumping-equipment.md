...
---
asset_id: "asset.kings-canyon.spotted-lake.pumping-equipment"
source_label: "pumping equipment"
...
- **Asset ID:** asset.kings-canyon.spotted-lake.pumping-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:899
...
![pumping equipment reference render](pumping-equipment.png)

## Intent

The **pumping equipment** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **pumping equipment** as a useful,
