...
---
asset_id: "asset.kings-canyon.spotted-lake.water-treatment-structures"
source_label: "water-treatment structures"
...
- **Asset ID:** asset.kings-canyon.spotted-lake.water-treatment-structures
- **Type:** POI hero component
- **Source:** prop-list.md:898
...
![water-treatment structures reference render](water-treatment-structures.png)

## Intent

The **water-treatment structures** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **water-treatment structures** as a useful,
