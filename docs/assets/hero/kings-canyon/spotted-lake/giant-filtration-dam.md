...
---
asset_id: "asset.kings-canyon.spotted-lake.giant-filtration-dam"
source_label: "giant Filtration Dam"
...
# giant Filtration Dam

## Identity

- **Asset ID:** asset.kings-canyon.spotted-lake.giant-filtration-dam
...
![giant Filtration Dam reference render](giant-filtration-dam.png)

## Intent

The **giant Filtration Dam** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant Filtration Dam** as a useful,
...
- **POI sibling component:** [filtration machinery](./filtration-machinery.md).
