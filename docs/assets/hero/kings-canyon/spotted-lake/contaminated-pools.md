...
---
asset_id: "asset.kings-canyon.spotted-lake.contaminated-pools"
source_label: "contaminated pools"
...
- **Asset ID:** asset.kings-canyon.spotted-lake.contaminated-pools
- **Type:** POI hero component
- **Source:** prop-list.md:896
...
![contaminated pools reference render](contaminated-pools.png)

## Intent

The **contaminated pools** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **contaminated pools** as a useful,
