...
---
assembly_id: "assembly.kings-canyon.spotted-lake"
source_label: "Spotted Lake"
...
# Spotted Lake — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.spotted-lake
...
- **Source:** prop-list.md:894

## Landmark promise

Spotted Lake is a landmark, not a pile of unrelated props. The full assembly
...
- [giant Filtration Dam](./giant-filtration-dam.md) — component brief.
- [filtration machinery](./filtration-machinery.md) — component brief.
- [contaminated pools](./contaminated-pools.md) — component brief.
- [ECHO research camps](./echo-research-camps.md) — component brief.
- [water-treatment structures](./water-treatment-structures.md) — component brief.
- [pumping equipment](./pumping-equipment.md) — component brief.
