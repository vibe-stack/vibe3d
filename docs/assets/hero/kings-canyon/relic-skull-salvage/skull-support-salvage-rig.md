...
---
asset_id: "asset.kings-canyon.relic-skull-salvage.skull-support-salvage-rig"
source_label: "skull-support/salvage rig"
source_section: "Hero / Kings Canyon"
source_group: "Relic / Skull Salvage"
source_line: 952
level: L3
status: planned
...
# skull-support/salvage rig

## Identity

- **Asset ID:** asset.kings-canyon.relic-skull-salvage.skull-support-salvage-rig
- **Type:** POI hero component
- **Source:** prop-list.md:952
...
![skull-support/salvage rig reference render](skull-support-salvage-rig.png)

## Intent

The **skull-support/salvage rig** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **skull-support/salvage rig** as a useful,
...
- **Parent assembly:** [Relic / Skull Salvage assembly](./_assembly.md).

- **base supply-bin state:** [standard Supply Bin](../../../reusable/universal-gameplay/loot/standard-supply-bin.md).
- **POI sibling component:** [giant Leviathan skull](./giant-leviathan-skull.md).
