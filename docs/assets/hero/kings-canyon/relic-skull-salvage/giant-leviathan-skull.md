...
---
asset_id: "asset.kings-canyon.relic-skull-salvage.giant-leviathan-skull"
source_label: "giant Leviathan skull"
...
# giant Leviathan skull

## Identity

- **Asset ID:** asset.kings-canyon.relic-skull-salvage.giant-leviathan-skull
- **Type:** POI hero component
- **Source:** prop-list.md:951
...
![giant Leviathan skull reference render](giant-leviathan-skull.png)

## Intent

The **giant Leviathan skull** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant Leviathan skull** as a useful,
...
- **POI sibling component:** [skull-support/salvage rig](./skull-support-salvage-rig.md).
