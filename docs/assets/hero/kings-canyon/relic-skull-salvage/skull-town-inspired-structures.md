...
---
asset_id: "asset.kings-canyon.relic-skull-salvage.skull-town-inspired-structures"
source_label: "Skull Town-inspired structures"
...
# Skull Town-inspired structures

## Identity

- **Asset ID:** asset.kings-canyon.relic-skull-salvage.skull-town-inspired-structures
- **Type:** POI hero component
- **Source:** prop-list.md:953
...
![Skull Town-inspired structures reference render](skull-town-inspired-structures.png)

## Intent

The **Skull Town-inspired structures** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **Skull Town-inspired structures** as a useful,
