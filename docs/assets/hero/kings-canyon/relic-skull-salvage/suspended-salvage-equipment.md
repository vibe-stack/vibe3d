...
---
asset_id: "asset.kings-canyon.relic-skull-salvage.suspended-salvage-equipment"
source_label: "suspended salvage equipment"
...
# suspended salvage equipment

## Identity

- **Asset ID:** asset.kings-canyon.relic-skull-salvage.suspended-salvage-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:955
...
![suspended salvage equipment reference render](suspended-salvage-equipment.png)

## Intent

The **suspended salvage equipment** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **suspended salvage equipment** as a useful,
