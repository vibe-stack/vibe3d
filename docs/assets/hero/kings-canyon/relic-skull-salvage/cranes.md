...
---
asset_id: "asset.kings-canyon.relic-skull-salvage.cranes"
source_label: "cranes"
...
- **Asset ID:** asset.kings-canyon.relic-skull-salvage.cranes
- **Type:** POI hero component
- **Source:** prop-list.md:954
...
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **cranes** as a useful,
