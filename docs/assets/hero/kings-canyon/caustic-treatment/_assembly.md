...
---
assembly_id: "assembly.kings-canyon.caustic-treatment"
source_label: "Caustic Treatment"
...
# Caustic Treatment — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.caustic-treatment
...
Caustic Treatment is a landmark, not a pile of unrelated props. The full assembly
...
- [toxic-treatment complex](./toxic-treatment-complex.md) — component brief.
- [enormous chemical tanks](./enormous-chemical-tanks.md) — component brief.
- [toxin-processing machinery](./toxin-processing-machinery.md) — component brief.
- [treatment basin](./treatment-basin.md) — component brief.
- [central lab/control structure](./central-lab-control-structure.md) — component brief.
- [pipe forest](./pipe-forest.md) — component brief.
