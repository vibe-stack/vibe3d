...
---
asset_id: "asset.kings-canyon.caustic-treatment.toxin-processing-machinery"
source_label: "toxin-processing machinery"
...
# toxin-processing machinery

## Identity

- **Asset ID:** asset.kings-canyon.caustic-treatment.toxin-processing-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:936
...
![toxin-processing machinery reference render](toxin-processing-machinery.png)

## Intent

The **toxin-processing machinery** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **toxin-processing machinery** as a useful,
