...
---
asset_id: "asset.kings-canyon.caustic-treatment.enormous-chemical-tanks"
source_label: "enormous chemical tanks"
...
# enormous chemical tanks

## Identity

- **Asset ID:** asset.kings-canyon.caustic-treatment.enormous-chemical-tanks
- **Type:** POI hero component
- **Source:** prop-list.md:935
...
![enormous chemical tanks reference render](enormous-chemical-tanks.png)

## Intent

The **enormous chemical tanks** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **enormous chemical tanks** as a useful,
