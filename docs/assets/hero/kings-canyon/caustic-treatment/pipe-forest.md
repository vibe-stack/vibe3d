...
---
asset_id: "asset.kings-canyon.caustic-treatment.pipe-forest"
source_label: "pipe forest"
...
- **Asset ID:** asset.kings-canyon.caustic-treatment.pipe-forest
- **Type:** POI hero component
- **Source:** prop-list.md:939
...
![pipe forest reference render](pipe-forest.png)

## Intent

The **pipe forest** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **pipe forest** as a useful,
