...
---
asset_id: "asset.kings-canyon.caustic-treatment.central-lab-control-structure"
source_label: "central lab/control structure"
...
# central lab/control structure

## Identity

- **Asset ID:** asset.kings-canyon.caustic-treatment.central-lab-control-structure
- **Type:** POI hero component
- **Source:** prop-list.md:938
...
![central lab/control structure reference render](central-lab-control-structure.png)

## Intent

The **central lab/control structure** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **central lab/control structure** as a useful,
...
- **POI sibling component:** [toxic-treatment complex](./toxic-treatment-complex.md).
