...
---
asset_id: "asset.kings-canyon.caustic-treatment.toxic-treatment-complex"
source_label: "toxic-treatment complex"
source_section: "Hero / Kings Canyon"
source_group: "Caustic Treatment"
source_line: 934
level: L3
status: planned
place_family: "Old military frontier, ecological disaster, and salvage zones"
owner: "Axiom Defense / frontier ecology"
---

# toxic-treatment complex

## Identity

- **Asset ID:** asset.kings-canyon.caustic-treatment.toxic-treatment-complex
- **Type:** POI hero component
- **Source:** prop-list.md:934
- **Family:** Hero / Kings Canyon
- **Place family:** Old military frontier, ecological disaster, and salvage zones
- **Owner / story role:** Axiom Defense / frontier ecology

## Reference render

![toxic-treatment complex reference render](toxic-treatment-complex.png)

## Intent

The **toxic-treatment complex** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **toxic-treatment complex** as a useful,
...
Use RED-500 as the dominant signal token and AMBER-400 only
...
- **Parent assembly:** [Caustic Treatment assembly](./_assembly.md).

- **POI sibling component:** [enormous chemical tanks](./enormous-chemical-tanks.md).
