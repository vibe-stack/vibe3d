...
---
asset_id: "asset.kings-canyon.caustic-treatment.treatment-basin"
source_label: "treatment basin"
...
- **Asset ID:** asset.kings-canyon.caustic-treatment.treatment-basin
- **Type:** POI hero component
- **Source:** prop-list.md:937
...
![treatment basin reference render](treatment-basin.png)

## Intent

The **treatment basin** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **treatment basin** as a useful,
