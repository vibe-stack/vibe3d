...
---
asset_id: "asset.kings-canyon.ares-capacitor.underground-industrial-access-structure"
source_label: "underground/industrial access structure"
...
# underground/industrial access structure

## Identity

- **Asset ID:** asset.kings-canyon.ares-capacitor.underground-industrial-access-structure
- **Type:** POI hero component
- **Source:** prop-list.md:878
...
![underground/industrial access structure reference render](underground-industrial-access-structure.png)

## Intent

The **underground/industrial access structure** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **underground/industrial access structure** as a useful,
