...
---
asset_id: "asset.kings-canyon.ares-capacitor.giant-sunken-capacitor-compound"
source_label: "giant sunken capacitor compound"
source_section: "Hero / Kings Canyon"
source_group: "ARES Capacitor"
source_line: 874
level: L3
status: planned
...
# giant sunken capacitor compound

## Identity

- **Asset ID:** asset.kings-canyon.ares-capacitor.giant-sunken-capacitor-compound
- **Type:** POI hero component
- **Source:** prop-list.md:874
...
![giant sunken capacitor compound reference render](giant-sunken-capacitor-compound.png)

## Intent

The **giant sunken capacitor compound** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **giant sunken capacitor compound** as a useful,
...
- **Parent assembly:** [ARES Capacitor assembly](./_assembly.md).

- **POI sibling component:** [huge steel containment walls](./huge-steel-containment-walls.md).
