...
---
asset_id: "asset.kings-canyon.ares-capacitor.huge-steel-containment-walls"
source_label: "huge steel containment walls"
...
# huge steel containment walls

## Identity

- **Asset ID:** asset.kings-canyon.ares-capacitor.huge-steel-containment-walls
- **Type:** POI hero component
- **Source:** prop-list.md:875
...
![huge steel containment walls reference render](huge-steel-containment-walls.png)

## Intent

The **huge steel containment walls** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge steel containment walls** as a useful,
