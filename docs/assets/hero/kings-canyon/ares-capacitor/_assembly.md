...
---
assembly_id: "assembly.kings-canyon.ares-capacitor"
source_label: "ARES Capacitor"
...
# ARES Capacitor — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.ares-capacitor
...
ARES Capacitor is a landmark, not a pile of unrelated props. The full assembly
...
- [giant sunken capacitor compound](./giant-sunken-capacitor-compound.md) — component brief.
- [huge steel containment walls](./huge-steel-containment-walls.md) — component brief.
- [capacitor machinery](./capacitor-machinery.md) — component brief.
- [three Charge Towers](./three-charge-towers.md) — component brief.
- [underground/industrial access structure](./underground-industrial-access-structure.md) — component brief.
