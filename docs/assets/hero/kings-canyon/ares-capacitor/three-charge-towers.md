...
---
asset_id: "asset.kings-canyon.ares-capacitor.three-charge-towers"
source_label: "three Charge Towers"
...
- **Asset ID:** asset.kings-canyon.ares-capacitor.three-charge-towers
- **Type:** POI hero component
- **Source:** prop-list.md:877
...
![three Charge Towers reference render](three-charge-towers.png)

## Intent

The **three Charge Towers** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **three Charge Towers** as a useful,
