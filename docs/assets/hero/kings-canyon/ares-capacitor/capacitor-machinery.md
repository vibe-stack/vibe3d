...
---
asset_id: "asset.kings-canyon.ares-capacitor.capacitor-machinery"
source_label: "capacitor machinery"
...
- **Asset ID:** asset.kings-canyon.ares-capacitor.capacitor-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:876
...
![capacitor machinery reference render](capacitor-machinery.png)

## Intent

The **capacitor machinery** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **capacitor machinery** as a useful,
...
- **POI sibling component:** [giant sunken capacitor compound](./giant-sunken-capacitor-compound.md).
