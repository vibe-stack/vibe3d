...
---
assembly_id: "assembly.kings-canyon.artillery-battery"
source_label: "Artillery Battery"
...
# Artillery Battery — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.artillery-battery
...
Artillery Battery is a landmark, not a pile of unrelated props. The full assembly
...
- [huge fortified IMC compound](./huge-fortified-imc-compound.md) — component brief.
- [main Artillery buildings](./main-artillery-buildings.md) — component brief.
- [northern hangar](./northern-hangar.md) — component brief.
- [reinforced perimeter walls](./reinforced-perimeter-walls.md) — component brief.
- [tunnel system](./tunnel-system.md) — component brief.
- [destroyed hangar opening](./destroyed-hangar-opening.md) — component brief.
