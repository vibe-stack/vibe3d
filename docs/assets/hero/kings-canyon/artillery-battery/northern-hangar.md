...
---
asset_id: "asset.kings-canyon.artillery-battery.northern-hangar"
source_label: "northern hangar"
...
- **Asset ID:** asset.kings-canyon.artillery-battery.northern-hangar
- **Type:** POI hero component
- **Source:** prop-list.md:867
...
![northern hangar reference render](northern-hangar.png)

## Intent

The **northern hangar** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **northern hangar** as a useful,
