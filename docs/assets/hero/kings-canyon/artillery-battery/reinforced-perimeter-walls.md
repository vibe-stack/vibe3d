...
---
asset_id: "asset.kings-canyon.artillery-battery.reinforced-perimeter-walls"
source_label: "reinforced perimeter walls"
...
- **Asset ID:** asset.kings-canyon.artillery-battery.reinforced-perimeter-walls
- **Type:** POI hero component
- **Source:** prop-list.md:868
...
![reinforced perimeter walls reference render](reinforced-perimeter-walls.png)

## Intent

The **reinforced perimeter walls** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **reinforced perimeter walls** as a useful,
