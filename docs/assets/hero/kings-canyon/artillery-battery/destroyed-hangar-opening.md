...
---
asset_id: "asset.kings-canyon.artillery-battery.destroyed-hangar-opening"
source_label: "destroyed hangar opening"
source_section: "Hero / Kings Canyon"
source_group: "Artillery Battery"
source_line: 870
level: L3
status: planned
...
# destroyed hangar opening

## Identity

- **Asset ID:** asset.kings-canyon.artillery-battery.destroyed-hangar-opening
- **Type:** POI hero component
- **Source:** prop-list.md:870
...
![destroyed hangar opening reference render](destroyed-hangar-opening.png)

## Intent

The **destroyed hangar opening** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **destroyed hangar opening** as a useful,
...
- **Parent assembly:** [Artillery Battery assembly](./_assembly.md).

- **base supply-bin state:** [standard Supply Bin](../../../reusable/universal-gameplay/loot/standard-supply-bin.md).
- **POI sibling component:** [huge fortified IMC compound](./huge-fortified-imc-compound.md).
