...
---
asset_id: "asset.kings-canyon.artillery-battery.huge-fortified-imc-compound"
source_label: "huge fortified IMC compound"
...
# huge fortified IMC compound

## Identity

- **Asset ID:** asset.kings-canyon.artillery-battery.huge-fortified-imc-compound
- **Type:** POI hero component
- **Source:** prop-list.md:865
...
![huge fortified IMC compound reference render](huge-fortified-imc-compound.png)

## Intent

The **huge fortified IMC compound** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **huge fortified IMC compound** as a useful,
...
- **POI sibling component:** [main Artillery buildings](./main-artillery-buildings.md).
