...
---
asset_id: "asset.kings-canyon.artillery-battery.main-artillery-buildings"
source_label: "main Artillery buildings"
...
# main Artillery buildings

## Identity

- **Asset ID:** asset.kings-canyon.artillery-battery.main-artillery-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:866
...
![main Artillery buildings reference render](main-artillery-buildings.png)

## Intent

The **main Artillery buildings** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **main Artillery buildings** as a useful,
