...
---
asset_id: "asset.kings-canyon.artillery-battery.tunnel-system"
source_label: "tunnel system"
...
- **Asset ID:** asset.kings-canyon.artillery-battery.tunnel-system
- **Type:** POI hero component
- **Source:** prop-list.md:869
...
![tunnel system reference render](tunnel-system.png)

## Intent

The **tunnel system** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **tunnel system** as a useful,
