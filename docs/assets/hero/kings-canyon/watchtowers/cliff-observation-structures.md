...
---
asset_id: "asset.kings-canyon.watchtowers.cliff-observation-structures"
source_label: "cliff observation structures"
source_section: "Hero / Kings Canyon"
source_group: "Watchtowers"
source_line: 994
level: L3
status: planned
...
# cliff observation structures

## Identity

- **Asset ID:** asset.kings-canyon.watchtowers.cliff-observation-structures
- **Type:** POI hero component
- **Source:** prop-list.md:994
...
![cliff observation structures reference render](cliff-observation-structures.png)

## Intent

The **cliff observation structures** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **cliff observation structures** as a useful,
...
- **Parent assembly:** [Watchtowers assembly](./_assembly.md).

- **POI sibling component:** [North Watchtower](./north-watchtower.md).
