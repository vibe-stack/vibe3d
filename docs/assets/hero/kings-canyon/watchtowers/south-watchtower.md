...
---
asset_id: "asset.kings-canyon.watchtowers.south-watchtower"
source_label: "South Watchtower"
...
- **Asset ID:** asset.kings-canyon.watchtowers.south-watchtower
- **Type:** POI hero component
- **Source:** prop-list.md:993
...
![South Watchtower reference render](south-watchtower.png)

## Intent

The **South Watchtower** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **South Watchtower** as a useful,
