...
---
assembly_id: "assembly.kings-canyon.watchtowers"
source_label: "Watchtowers"
...
# Watchtowers — hero assembly

## Identity

- **Assembly ID:** assembly.kings-canyon.watchtowers
...
- **Source:** prop-list.md:992

## Landmark promise

Watchtowers is a landmark, not a pile of unrelated props. The full assembly
...
- [North Watchtower](./north-watchtower.md) — component brief.
- [South Watchtower](./south-watchtower.md) — component brief.
- [cliff observation structures](./cliff-observation-structures.md) — component brief.
