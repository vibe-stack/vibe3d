...
---
asset_id: "asset.kings-canyon.watchtowers.north-watchtower"
source_label: "North Watchtower"
...
- **Asset ID:** asset.kings-canyon.watchtowers.north-watchtower
...
![North Watchtower reference render](north-watchtower.png)

## Intent

The **North Watchtower** is a POI hero component for the Axiom Relay kit. It exists to support
aged military infrastructure, hard terrain, containment, and visible catastrophe. Its primary read should be **North Watchtower** as a useful,
...
- **POI sibling component:** [South Watchtower](./south-watchtower.md).
