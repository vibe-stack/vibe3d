...
---
asset_id: "asset.e-district.shipyard-arcade.giant-ship-converted-into-an-arcade"
source_label: "giant ship converted into an arcade"
source_section: "Hero / E-District"
source_group: "Shipyard Arcade"
source_line: 1665
level: L3
status: planned
...
# giant ship converted into an arcade

## Identity

- **Asset ID:** asset.e-district.shipyard-arcade.giant-ship-converted-into-an-arcade
...
![giant ship converted into an arcade reference render](giant-ship-converted-into-an-arcade.png)

## Intent

The **giant ship converted into an arcade** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **giant ship converted into an arcade** as a useful,
...
- **Parent assembly:** [Shipyard Arcade assembly](./_assembly.md).

- **POI sibling component:** [drydock](./drydock.md).
