...
---
asset_id: "asset.e-district.shipyard-arcade.ship-hull"
source_label: "ship hull"
...
- **Asset ID:** asset.e-district.shipyard-arcade.ship-hull
- **Type:** POI hero component
- **Source:** prop-list.md:1667
...
![ship hull reference render](ship-hull.png)

## Intent

The **ship hull** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **ship hull** as a useful,
