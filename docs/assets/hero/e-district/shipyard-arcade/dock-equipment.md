...
---
asset_id: "asset.e-district.shipyard-arcade.dock-equipment"
source_label: "dock equipment"
...
- **Asset ID:** asset.e-district.shipyard-arcade.dock-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1672
...
![dock equipment reference render](dock-equipment.png)

## Intent

The **dock equipment** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dock equipment** as a useful,
