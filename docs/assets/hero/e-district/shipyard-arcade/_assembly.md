...
---
assembly_id: "assembly.e-district.shipyard-arcade"
source_label: "Shipyard Arcade"
...
# Shipyard Arcade — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.shipyard-arcade
...
- **Source:** prop-list.md:1665

## Landmark promise

Shipyard Arcade is a landmark, not a pile of unrelated props. The full assembly
...
- [giant ship converted into an arcade](./giant-ship-converted-into-an-arcade.md) — component brief.
- [drydock](./drydock.md) — component brief.
- [ship hull](./ship-hull.md) — component brief.
- [arcade deck](./arcade-deck.md) — component brief.
- [arcade machines](./arcade-machines.md) — component brief.
- [commercial buildings](./commercial-buildings.md) — component brief.
- [dock cranes](./dock-cranes.md) — component brief.
- [dock equipment](./dock-equipment.md) — component brief.
