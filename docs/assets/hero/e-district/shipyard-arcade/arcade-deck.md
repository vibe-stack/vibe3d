...
---
asset_id: "asset.e-district.shipyard-arcade.arcade-deck"
source_label: "arcade deck"
...
- **Asset ID:** asset.e-district.shipyard-arcade.arcade-deck
- **Type:** POI hero component
- **Source:** prop-list.md:1668
...
![arcade deck reference render](arcade-deck.png)

## Intent

The **arcade deck** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **arcade deck** as a useful,
