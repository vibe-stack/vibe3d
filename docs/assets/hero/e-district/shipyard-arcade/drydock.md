...
---
asset_id: "asset.e-district.shipyard-arcade.drydock"
source_label: "drydock"
...
- **Asset ID:** asset.e-district.shipyard-arcade.drydock
- **Type:** POI hero component
- **Source:** prop-list.md:1666
...
![drydock reference render](drydock.png)

## Intent

The **drydock** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **drydock** as a useful,
