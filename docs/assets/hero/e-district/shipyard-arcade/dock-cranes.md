...
---
asset_id: "asset.e-district.shipyard-arcade.dock-cranes"
source_label: "dock cranes"
...
- **Asset ID:** asset.e-district.shipyard-arcade.dock-cranes
- **Type:** POI hero component
- **Source:** prop-list.md:1671
...
![dock cranes reference render](dock-cranes.png)

## Intent

The **dock cranes** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dock cranes** as a useful,
