...
---
asset_id: "asset.e-district.shipyard-arcade.arcade-machines"
source_label: "arcade machines"
...
- **Asset ID:** asset.e-district.shipyard-arcade.arcade-machines
- **Type:** POI hero component
- **Source:** prop-list.md:1669
...
![arcade machines reference render](arcade-machines.png)

## Intent

The **arcade machines** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **arcade machines** as a useful,
...
- **POI sibling component:** [giant ship converted into an arcade](./giant-ship-converted-into-an-arcade.md).
