...
---
asset_id: "asset.e-district.shipyard-arcade.commercial-buildings"
source_label: "commercial buildings"
...
- **Asset ID:** asset.e-district.shipyard-arcade.commercial-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1670
...
![commercial buildings reference render](commercial-buildings.png)

## Intent

The **commercial buildings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **commercial buildings** as a useful,
