...
---
asset_id: "asset.e-district.city-hall.overturned-urban-objects"
source_label: "overturned urban objects"
...
# overturned urban objects

## Identity

- **Asset ID:** asset.e-district.city-hall.overturned-urban-objects
- **Type:** POI hero component
- **Source:** prop-list.md:1695
...
![overturned urban objects reference render](overturned-urban-objects.png)

## Intent

The **overturned urban objects** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **overturned urban objects** as a useful,
