...
---
assembly_id: "assembly.e-district.city-hall"
source_label: "City Hall"
...
# City Hall — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.city-hall
...
- **Source:** prop-list.md:1689

## Landmark promise

City Hall is a landmark, not a pile of unrelated props. The full assembly
...
- [main civic hall](./main-civic-hall.md) — component brief.
- [two supporting civic buildings](./two-supporting-civic-buildings.md) — component brief.
- [central courtyard](./central-courtyard.md) — component brief.
- [government signage](./government-signage.md) — component brief.
- [protest barriers](./protest-barriers.md) — component brief.
- [riot rubble](./riot-rubble.md) — component brief.
- [overturned urban objects](./overturned-urban-objects.md) — component brief.
