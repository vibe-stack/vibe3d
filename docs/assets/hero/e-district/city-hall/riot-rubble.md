...
---
asset_id: "asset.e-district.city-hall.riot-rubble"
source_label: "riot rubble"
...
- **Asset ID:** asset.e-district.city-hall.riot-rubble
- **Type:** POI hero component
- **Source:** prop-list.md:1694
...
![riot rubble reference render](riot-rubble.png)

## Intent

The **riot rubble** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **riot rubble** as a useful,
