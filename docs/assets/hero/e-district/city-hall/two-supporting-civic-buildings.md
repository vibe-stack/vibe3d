...
---
asset_id: "asset.e-district.city-hall.two-supporting-civic-buildings"
source_label: "two supporting civic buildings"
source_section: "Hero / E-District"
source_group: "City Hall"
source_line: 1690
level: L3
status: planned
...
# two supporting civic buildings

## Identity

- **Asset ID:** asset.e-district.city-hall.two-supporting-civic-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1690
...
![two supporting civic buildings reference render](two-supporting-civic-buildings.png)

## Intent

The **two supporting civic buildings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **two supporting civic buildings** as a useful,
...
- **Parent assembly:** [City Hall assembly](./_assembly.md).

- **base supply-bin state:** [standard Supply Bin](../../../reusable/universal-gameplay/loot/standard-supply-bin.md).
- **POI sibling component:** [main civic hall](./main-civic-hall.md).
