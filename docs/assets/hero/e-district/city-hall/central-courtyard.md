...
---
asset_id: "asset.e-district.city-hall.central-courtyard"
source_label: "central courtyard"
...
- **Asset ID:** asset.e-district.city-hall.central-courtyard
- **Type:** POI hero component
- **Source:** prop-list.md:1691
...
![central courtyard reference render](central-courtyard.png)

## Intent

The **central courtyard** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **central courtyard** as a useful,
