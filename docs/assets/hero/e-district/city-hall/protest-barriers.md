...
---
asset_id: "asset.e-district.city-hall.protest-barriers"
source_label: "protest barriers"
...
- **Asset ID:** asset.e-district.city-hall.protest-barriers
- **Type:** POI hero component
- **Source:** prop-list.md:1693
...
![protest barriers reference render](protest-barriers.png)

## Intent

The **protest barriers** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **protest barriers** as a useful,
