...
---
asset_id: "asset.e-district.city-hall.main-civic-hall"
source_label: "main civic hall"
...
- **Asset ID:** asset.e-district.city-hall.main-civic-hall
...
![main civic hall reference render](main-civic-hall.png)

## Intent

The **main civic hall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **main civic hall** as a useful,
...
- **POI sibling component:** [two supporting civic buildings](./two-supporting-civic-buildings.md).
