...
---
assembly_id: "assembly.e-district.neon-square"
source_label: "Neon Square"
...
# Neon Square — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.neon-square
...
- **Source:** prop-list.md:1786

## Landmark promise

Neon Square is a landmark, not a pile of unrelated props. The full assembly
...
- [Iwanaga Hall](./iwanaga-hall.md) — component brief.
- [huge entertainment hall](./huge-entertainment-hall.md) — component brief.
- [nightclub buildings](./nightclub-buildings.md) — component brief.
- [dense rooftops](./dense-rooftops.md) — component brief.
- [neon billboard forest](./neon-billboard-forest.md) — component brief.
- [bar/nightlife infrastructure](./bar-nightlife-infrastructure.md) — component brief.
