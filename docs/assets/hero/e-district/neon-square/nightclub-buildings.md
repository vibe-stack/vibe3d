...
---
asset_id: "asset.e-district.neon-square.nightclub-buildings"
source_label: "nightclub buildings"
source_section: "Hero / E-District"
source_group: "Neon Square"
source_line: 1788
level: L3
status: planned
...
- **Asset ID:** asset.e-district.neon-square.nightclub-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1788
...
![nightclub buildings reference render](nightclub-buildings.png)

## Intent

The **nightclub buildings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **nightclub buildings** as a useful,
...
- **Parent assembly:** [Neon Square assembly](./_assembly.md).

- **POI sibling component:** [Iwanaga Hall](./iwanaga-hall.md).
