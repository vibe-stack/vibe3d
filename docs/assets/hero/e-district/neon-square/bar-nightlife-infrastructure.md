...
---
asset_id: "asset.e-district.neon-square.bar-nightlife-infrastructure"
source_label: "bar/nightlife infrastructure"
...
# bar/nightlife infrastructure

## Identity

- **Asset ID:** asset.e-district.neon-square.bar-nightlife-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1791
...
![bar/nightlife infrastructure reference render](bar-nightlife-infrastructure.png)

## Intent

The **bar/nightlife infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **bar/nightlife infrastructure** as a useful,
