...
---
asset_id: "asset.e-district.neon-square.iwanaga-hall"
source_label: "Iwanaga Hall"
...
- **Asset ID:** asset.e-district.neon-square.iwanaga-hall
...
![Iwanaga Hall reference render](iwanaga-hall.png)

## Intent

The **Iwanaga Hall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **Iwanaga Hall** as a useful,
...
- **POI sibling component:** [huge entertainment hall](./huge-entertainment-hall.md).
