...
---
asset_id: "asset.e-district.neon-square.dense-rooftops"
source_label: "dense rooftops"
...
- **Asset ID:** asset.e-district.neon-square.dense-rooftops
- **Type:** POI hero component
- **Source:** prop-list.md:1789
...
![dense rooftops reference render](dense-rooftops.png)

## Intent

The **dense rooftops** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dense rooftops** as a useful,
