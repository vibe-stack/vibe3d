...
---
asset_id: "asset.e-district.neon-square.neon-billboard-forest"
source_label: "neon billboard forest"
...
# neon billboard forest

## Identity

- **Asset ID:** asset.e-district.neon-square.neon-billboard-forest
- **Type:** POI hero component
- **Source:** prop-list.md:1790
...
![neon billboard forest reference render](neon-billboard-forest.png)

## Intent

The **neon billboard forest** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **neon billboard forest** as a useful,
