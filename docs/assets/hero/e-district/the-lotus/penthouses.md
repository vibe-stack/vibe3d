...
---
asset_id: "asset.e-district.the-lotus.penthouses"
source_label: "penthouses"
...
- **Asset ID:** asset.e-district.the-lotus.penthouses
- **Type:** POI hero component
- **Source:** prop-list.md:1655
...
![penthouses reference render](penthouses.png)

## Intent

The **penthouses** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **penthouses** as a useful,
