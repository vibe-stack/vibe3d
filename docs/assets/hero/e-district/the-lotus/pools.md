...
---
asset_id: "asset.e-district.the-lotus.pools"
source_label: "pools"
...
- **Asset ID:** asset.e-district.the-lotus.pools
- **Type:** POI hero component
- **Source:** prop-list.md:1659
...
![pools reference render](pools.png)

## Intent

The **pools** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **pools** as a useful,
