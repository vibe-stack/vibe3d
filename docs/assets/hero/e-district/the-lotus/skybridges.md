...
---
asset_id: "asset.e-district.the-lotus.skybridges"
source_label: "skybridges"
...
- **Asset ID:** asset.e-district.the-lotus.skybridges
- **Type:** POI hero component
- **Source:** prop-list.md:1660
...
![skybridges reference render](skybridges.png)

## Intent

The **skybridges** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **skybridges** as a useful,
