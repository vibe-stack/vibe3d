...
---
assembly_id: "assembly.e-district.the-lotus"
source_label: "The Lotus"
...
# The Lotus — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.the-lotus
...
The Lotus is a landmark, not a pile of unrelated props. The full assembly
...
- [luxury high-rise complex](./luxury-high-rise-complex.md) — component brief.
- [tallest playable high-rise structures](./tallest-playable-high-rise-structures.md) — component brief.
- [penthouses](./penthouses.md) — component brief.
- [luxury lobby](./luxury-lobby.md) — component brief.
- [lounge](./lounge.md) — component brief.
- [rooftop gardens](./rooftop-gardens.md) — component brief.
- [pools](./pools.md) — component brief.
- [skybridges](./skybridges.md) — component brief.
- [Gravity Launcher](./gravity-launcher.md) — component brief.
