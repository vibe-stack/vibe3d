...
---
asset_id: "asset.e-district.the-lotus.tallest-playable-high-rise-structures"
source_label: "tallest playable high-rise structures"
...
# tallest playable high-rise structures

## Identity

- **Asset ID:** asset.e-district.the-lotus.tallest-playable-high-rise-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1654
...
![tallest playable high-rise structures reference render](tallest-playable-high-rise-structures.png)

## Intent

The **tallest playable high-rise structures** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **tallest playable high-rise structures** as a useful,
