...
---
asset_id: "asset.e-district.the-lotus.lounge"
source_label: "lounge"
...
- **Asset ID:** asset.e-district.the-lotus.lounge
- **Type:** POI hero component
- **Source:** prop-list.md:1657
...
![lounge reference render](lounge.png)

## Intent

The **lounge** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **lounge** as a useful,
