...
---
asset_id: "asset.e-district.the-lotus.rooftop-gardens"
source_label: "rooftop gardens"
...
- **Asset ID:** asset.e-district.the-lotus.rooftop-gardens
- **Type:** POI hero component
- **Source:** prop-list.md:1658
...
![rooftop gardens reference render](rooftop-gardens.png)

## Intent

The **rooftop gardens** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **rooftop gardens** as a useful,
