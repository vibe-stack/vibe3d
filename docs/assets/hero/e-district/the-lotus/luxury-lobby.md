...
---
asset_id: "asset.e-district.the-lotus.luxury-lobby"
source_label: "luxury lobby"
...
- **Asset ID:** asset.e-district.the-lotus.luxury-lobby
- **Type:** POI hero component
- **Source:** prop-list.md:1656
...
![luxury lobby reference render](luxury-lobby.png)

## Intent

The **luxury lobby** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **luxury lobby** as a useful,
