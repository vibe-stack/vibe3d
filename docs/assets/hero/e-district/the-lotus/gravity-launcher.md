...
---
asset_id: "asset.e-district.the-lotus.gravity-launcher"
source_label: "Gravity Launcher"
...
- **Asset ID:** asset.e-district.the-lotus.gravity-launcher
- **Type:** POI hero component
- **Source:** prop-list.md:1661
...
![Gravity Launcher reference render](gravity-launcher.png)

## Intent

The **Gravity Launcher** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **Gravity Launcher** as a useful,
...
- **POI sibling component:** [luxury high-rise complex](./luxury-high-rise-complex.md).
