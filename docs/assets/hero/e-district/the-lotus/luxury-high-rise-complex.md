...
---
asset_id: "asset.e-district.the-lotus.luxury-high-rise-complex"
source_label: "luxury high-rise complex"
source_section: "Hero / E-District"
source_group: "The Lotus"
source_line: 1653
level: L3
status: planned
...
# luxury high-rise complex

## Identity

- **Asset ID:** asset.e-district.the-lotus.luxury-high-rise-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1653
...
![luxury high-rise complex reference render](luxury-high-rise-complex.png)

## Intent

The **luxury high-rise complex** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **luxury high-rise complex** as a useful,
...
- **Parent assembly:** [The Lotus assembly](./_assembly.md).

- **POI sibling component:** [tallest playable high-rise structures](./tallest-playable-high-rise-structures.md).
