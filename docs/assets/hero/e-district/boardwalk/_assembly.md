...
---
assembly_id: "assembly.e-district.boardwalk"
source_label: "Boardwalk"
...
# Boardwalk — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.boardwalk
...
- **Source:** prop-list.md:1678

## Landmark promise

Boardwalk is a landmark, not a pile of unrelated props. The full assembly
...
- [ocean boardwalk](./ocean-boardwalk.md) — component brief.
- [pier](./pier.md) — component brief.
- [nightlife buildings](./nightlife-buildings.md) — component brief.
- [major nightclub](./major-nightclub.md) — component brief.
- [entertainment attractions](./entertainment-attractions.md) — component brief.
- [food kiosks](./food-kiosks.md) — component brief.
- [waterfront railings](./waterfront-railings.md) — component brief.
- [neon signage](./neon-signage.md) — component brief.
