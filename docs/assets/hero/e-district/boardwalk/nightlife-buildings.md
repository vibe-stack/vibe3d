...
---
asset_id: "asset.e-district.boardwalk.nightlife-buildings"
source_label: "nightlife buildings"
...
- **Asset ID:** asset.e-district.boardwalk.nightlife-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1680
...
![nightlife buildings reference render](nightlife-buildings.png)

## Intent

The **nightlife buildings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **nightlife buildings** as a useful,
