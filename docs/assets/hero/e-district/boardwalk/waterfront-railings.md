...
---
asset_id: "asset.e-district.boardwalk.waterfront-railings"
source_label: "waterfront railings"
...
- **Asset ID:** asset.e-district.boardwalk.waterfront-railings
- **Type:** POI hero component
- **Source:** prop-list.md:1684
...
![waterfront railings reference render](waterfront-railings.png)

## Intent

The **waterfront railings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **waterfront railings** as a useful,
