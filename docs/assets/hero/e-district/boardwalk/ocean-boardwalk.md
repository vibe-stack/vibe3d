...
---
asset_id: "asset.e-district.boardwalk.ocean-boardwalk"
source_label: "ocean boardwalk"
...
- **Asset ID:** asset.e-district.boardwalk.ocean-boardwalk
...
![ocean boardwalk reference render](ocean-boardwalk.png)

## Intent

The **ocean boardwalk** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **ocean boardwalk** as a useful,
...
- **POI sibling component:** [pier](./pier.md).
