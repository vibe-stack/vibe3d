...
---
asset_id: "asset.e-district.boardwalk.entertainment-attractions"
source_label: "entertainment attractions"
source_section: "Hero / E-District"
source_group: "Boardwalk"
source_line: 1682
level: L3
status: planned
...
- **Asset ID:** asset.e-district.boardwalk.entertainment-attractions
- **Type:** POI hero component
- **Source:** prop-list.md:1682
...
![entertainment attractions reference render](entertainment-attractions.png)

## Intent

The **entertainment attractions** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **entertainment attractions** as a useful,
...
- **Parent assembly:** [Boardwalk assembly](./_assembly.md).

- **POI sibling component:** [ocean boardwalk](./ocean-boardwalk.md).
