...
---
asset_id: "asset.e-district.boardwalk.neon-signage"
source_label: "neon signage"
...
- **Asset ID:** asset.e-district.boardwalk.neon-signage
- **Type:** POI hero component
- **Source:** prop-list.md:1685
...
![neon signage reference render](neon-signage.png)

## Intent

The **neon signage** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **neon signage** as a useful,
