...
---
asset_id: "asset.e-district.boardwalk.major-nightclub"
source_label: "major nightclub"
...
- **Asset ID:** asset.e-district.boardwalk.major-nightclub
- **Type:** POI hero component
- **Source:** prop-list.md:1681
...
![major nightclub reference render](major-nightclub.png)

## Intent

The **major nightclub** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **major nightclub** as a useful,
