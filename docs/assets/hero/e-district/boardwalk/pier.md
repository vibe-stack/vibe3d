...
---
asset_id: "asset.e-district.boardwalk.pier"
source_label: "pier"
...
- **Asset ID:** asset.e-district.boardwalk.pier
- **Type:** POI hero component
- **Source:** prop-list.md:1679
...
![pier reference render](pier.png)

## Intent

The **pier** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **pier** as a useful,
