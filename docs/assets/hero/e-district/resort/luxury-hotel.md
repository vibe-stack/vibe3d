...
---
asset_id: "asset.e-district.resort.luxury-hotel"
source_label: "luxury hotel"
...
- **Asset ID:** asset.e-district.resort.luxury-hotel
...
![luxury hotel reference render](luxury-hotel.png)

## Intent

The **luxury hotel** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **luxury hotel** as a useful,
...
- **POI sibling component:** [pool](./pool.md).
