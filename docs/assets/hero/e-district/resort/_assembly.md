...
---
assembly_id: "assembly.e-district.resort"
source_label: "Resort"
...
# Resort — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.resort
...
- **Source:** prop-list.md:1699

## Landmark promise

Resort is a landmark, not a pile of unrelated props. The full assembly
...
- [luxury hotel](./luxury-hotel.md) — component brief.
- [pool](./pool.md) — component brief.
- [cabanas](./cabanas.md) — component brief.
- [outdoor lounges](./outdoor-lounges.md) — component brief.
- [decorative landscaping](./decorative-landscaping.md) — component brief.
- [observation balconies](./observation-balconies.md) — component brief.
