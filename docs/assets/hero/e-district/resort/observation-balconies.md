...
---
asset_id: "asset.e-district.resort.observation-balconies"
source_label: "observation balconies"
...
- **Asset ID:** asset.e-district.resort.observation-balconies
- **Type:** POI hero component
- **Source:** prop-list.md:1704
...
![observation balconies reference render](observation-balconies.png)

## Intent

The **observation balconies** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **observation balconies** as a useful,
