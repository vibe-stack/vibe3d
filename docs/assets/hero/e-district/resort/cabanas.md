...
---
asset_id: "asset.e-district.resort.cabanas"
source_label: "cabanas"
...
- **Asset ID:** asset.e-district.resort.cabanas
- **Type:** POI hero component
- **Source:** prop-list.md:1701
...
![cabanas reference render](cabanas.png)

## Intent

The **cabanas** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **cabanas** as a useful,
