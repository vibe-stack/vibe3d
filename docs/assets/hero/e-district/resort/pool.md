...
---
asset_id: "asset.e-district.resort.pool"
source_label: "pool"
...
- **Asset ID:** asset.e-district.resort.pool
- **Type:** POI hero component
- **Source:** prop-list.md:1700
...
![pool reference render](pool.png)

## Intent

The **pool** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **pool** as a useful,
