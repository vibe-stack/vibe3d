...
---
asset_id: "asset.e-district.resort.decorative-landscaping"
source_label: "decorative landscaping"
...
- **Asset ID:** asset.e-district.resort.decorative-landscaping
- **Type:** POI hero component
- **Source:** prop-list.md:1703
...
![decorative landscaping reference render](decorative-landscaping.png)

## Intent

The **decorative landscaping** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **decorative landscaping** as a useful,
...
- **Parent assembly:** [Resort assembly](./_assembly.md).

- **POI sibling component:** [luxury hotel](./luxury-hotel.md).
