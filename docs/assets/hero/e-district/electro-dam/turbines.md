...
---
asset_id: "asset.e-district.electro-dam.turbines"
source_label: "turbines"
...
- **Asset ID:** asset.e-district.electro-dam.turbines
- **Type:** POI hero component
- **Source:** prop-list.md:1711
...
![turbines reference render](turbines.png)

## Intent

The **turbines** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **turbines** as a useful,
