...
---
asset_id: "asset.e-district.electro-dam.spillway"
source_label: "spillway"
...
- **Asset ID:** asset.e-district.electro-dam.spillway
- **Type:** POI hero component
- **Source:** prop-list.md:1710
...
![spillway reference render](spillway.png)

## Intent

The **spillway** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **spillway** as a useful,
