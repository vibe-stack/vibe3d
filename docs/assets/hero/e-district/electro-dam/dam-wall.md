...
---
asset_id: "asset.e-district.electro-dam.dam-wall"
source_label: "dam wall"
...
- **Asset ID:** asset.e-district.electro-dam.dam-wall
- **Type:** POI hero component
- **Source:** prop-list.md:1709
...
![dam wall reference render](dam-wall.png)

## Intent

The **dam wall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dam wall** as a useful,
