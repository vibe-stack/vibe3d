...
---
assembly_id: "assembly.e-district.electro-dam"
source_label: "Electro Dam"
...
# Electro Dam — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.electro-dam
...
- **Source:** prop-list.md:1708

## Landmark promise

Electro Dam is a landmark, not a pile of unrelated props. The full assembly
...
- [huge hydroelectric dam](./huge-hydroelectric-dam.md) — component brief.
- [dam wall](./dam-wall.md) — component brief.
- [spillway](./spillway.md) — component brief.
- [turbines](./turbines.md) — component brief.
- [hydroelectric machinery](./hydroelectric-machinery.md) — component brief.
- [maintenance gantries](./maintenance-gantries.md) — component brief.
- [Gravity Cannon at lower spillway](./gravity-cannon-at-lower-spillway.md) — component brief.
