...
---
asset_id: "asset.e-district.electro-dam.huge-hydroelectric-dam"
source_label: "huge hydroelectric dam"
...
- **Asset ID:** asset.e-district.electro-dam.huge-hydroelectric-dam
...
![huge hydroelectric dam reference render](huge-hydroelectric-dam.png)

## Intent

The **huge hydroelectric dam** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **huge hydroelectric dam** as a useful,
...
- **POI sibling component:** [dam wall](./dam-wall.md).
