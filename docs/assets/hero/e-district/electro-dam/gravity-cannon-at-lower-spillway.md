...
---
asset_id: "asset.e-district.electro-dam.gravity-cannon-at-lower-spillway"
source_label: "Gravity Cannon at lower spillway"
source_section: "Hero / E-District"
source_group: "Electro Dam"
source_line: 1714
level: L3
status: planned
...
# Gravity Cannon at lower spillway

## Identity

- **Asset ID:** asset.e-district.electro-dam.gravity-cannon-at-lower-spillway
- **Type:** POI hero component
- **Source:** prop-list.md:1714
...
![Gravity Cannon at lower spillway reference render](gravity-cannon-at-lower-spillway.png)

## Intent

The **Gravity Cannon at lower spillway** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **Gravity Cannon at lower spillway** as a useful,
...
- **Parent assembly:** [Electro Dam assembly](./_assembly.md).

- **POI sibling component:** [huge hydroelectric dam](./huge-hydroelectric-dam.md).
