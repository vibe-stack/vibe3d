...
---
asset_id: "asset.e-district.electro-dam.maintenance-gantries"
source_label: "maintenance gantries"
...
- **Asset ID:** asset.e-district.electro-dam.maintenance-gantries
- **Type:** POI hero component
- **Source:** prop-list.md:1713
...
![maintenance gantries reference render](maintenance-gantries.png)

## Intent

The **maintenance gantries** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **maintenance gantries** as a useful,
