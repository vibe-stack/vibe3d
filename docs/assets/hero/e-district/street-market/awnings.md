...
---
asset_id: "asset.e-district.street-market.awnings"
source_label: "awnings"
...
- **Asset ID:** asset.e-district.street-market.awnings
- **Type:** POI hero component
- **Source:** prop-list.md:1799
...
![awnings reference render](awnings.png)

## Intent

The **awnings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **awnings** as a useful,
