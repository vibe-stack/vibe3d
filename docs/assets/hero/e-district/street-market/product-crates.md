...
---
asset_id: "asset.e-district.street-market.product-crates"
source_label: "product crates"
...
- **Asset ID:** asset.e-district.street-market.product-crates
- **Type:** POI hero component
- **Source:** prop-list.md:1801
...
![product crates reference render](product-crates.png)

## Intent

The **product crates** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **product crates** as a useful,
...
- **POI sibling component:** [enormous multi-level open-air market](./enormous-multi-level-open-air-market.md).
