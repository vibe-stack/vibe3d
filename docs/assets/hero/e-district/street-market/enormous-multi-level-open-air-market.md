...
---
asset_id: "asset.e-district.street-market.enormous-multi-level-open-air-market"
source_label: "enormous multi-level open-air market"
source_section: "Hero / E-District"
source_group: "Street Market"
source_line: 1795
level: L3
status: planned
...
# enormous multi-level open-air market

## Identity

- **Asset ID:** asset.e-district.street-market.enormous-multi-level-open-air-market
- **Type:** POI hero component
- **Source:** prop-list.md:1795
...
![enormous multi-level open-air market reference render](enormous-multi-level-open-air-market.png)

## Intent

The **enormous multi-level open-air market** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **enormous multi-level open-air market** as a useful,
...
- **Parent assembly:** [Street Market assembly](./_assembly.md).

- **base supply-bin state:** [standard Supply Bin](../../../reusable/universal-gameplay/loot/standard-supply-bin.md).
- **POI sibling component:** [central market structure](./central-market-structure.md).
