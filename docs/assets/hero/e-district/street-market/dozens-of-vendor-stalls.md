...
---
asset_id: "asset.e-district.street-market.dozens-of-vendor-stalls"
source_label: "dozens of vendor stalls"
...
- **Asset ID:** asset.e-district.street-market.dozens-of-vendor-stalls
- **Type:** POI hero component
- **Source:** prop-list.md:1797
...
![dozens of vendor stalls reference render](dozens-of-vendor-stalls.png)

## Intent

The **dozens of vendor stalls** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dozens of vendor stalls** as a useful,
