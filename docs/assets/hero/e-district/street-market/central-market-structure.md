...
---
asset_id: "asset.e-district.street-market.central-market-structure"
source_label: "central market structure"
...
- **Asset ID:** asset.e-district.street-market.central-market-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1796
...
![central market structure reference render](central-market-structure.png)

## Intent

The **central market structure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **central market structure** as a useful,
