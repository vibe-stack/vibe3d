...
---
asset_id: "asset.e-district.street-market.decorative-lanterns"
source_label: "decorative lanterns"
...
- **Asset ID:** asset.e-district.street-market.decorative-lanterns
- **Type:** POI hero component
- **Source:** prop-list.md:1803
...
![decorative lanterns reference render](decorative-lanterns.png)

## Intent

The **decorative lanterns** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **decorative lanterns** as a useful,
