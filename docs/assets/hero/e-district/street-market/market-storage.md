...
---
asset_id: "asset.e-district.street-market.market-storage"
source_label: "market storage"
...
- **Asset ID:** asset.e-district.street-market.market-storage
- **Type:** POI hero component
- **Source:** prop-list.md:1804
...
![market storage reference render](market-storage.png)

## Intent

The **market storage** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **market storage** as a useful,
