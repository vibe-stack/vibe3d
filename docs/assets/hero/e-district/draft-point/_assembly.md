...
---
assembly_id: "assembly.e-district.draft-point"
source_label: "Draft Point"
...
# Draft Point — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.draft-point
...
Draft Point is a landmark, not a pile of unrelated props. The full assembly
...
- [working-class settlement](./working-class-settlement.md) — component brief.
- [canals](./canals.md) — component brief.
- [gigantic Mega Fan wall](./gigantic-mega-fan-wall.md) — component brief.
- [huge industrial fans](./huge-industrial-fans.md) — component brief.
- [pollution-extraction machinery](./pollution-extraction-machinery.md) — component brief.
- [utility structures](./utility-structures.md) — component brief.
