...
---
asset_id: "asset.e-district.draft-point.working-class-settlement"
source_label: "working-class settlement"
source_section: "Hero / E-District"
source_group: "Draft Point"
source_line: 1777
level: L3
status: planned
...
- **Asset ID:** asset.e-district.draft-point.working-class-settlement
- **Type:** POI hero component
- **Source:** prop-list.md:1777
...
![working-class settlement reference render](working-class-settlement.png)

## Intent

The **working-class settlement** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **working-class settlement** as a useful,
...
- **Parent assembly:** [Draft Point assembly](./_assembly.md).

- **POI sibling component:** [canals](./canals.md).
