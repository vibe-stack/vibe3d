...
---
asset_id: "asset.e-district.draft-point.gigantic-mega-fan-wall"
source_label: "gigantic Mega Fan wall"
...
# gigantic Mega Fan wall

## Identity

- **Asset ID:** asset.e-district.draft-point.gigantic-mega-fan-wall
- **Type:** POI hero component
- **Source:** prop-list.md:1779
...
![gigantic Mega Fan wall reference render](gigantic-mega-fan-wall.png)

## Intent

The **gigantic Mega Fan wall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **gigantic Mega Fan wall** as a useful,
