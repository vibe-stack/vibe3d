...
---
asset_id: "asset.e-district.draft-point.canals"
source_label: "canals"
...
- **Asset ID:** asset.e-district.draft-point.canals
- **Type:** POI hero component
- **Source:** prop-list.md:1778
...
![canals reference render](canals.png)

## Intent

The **canals** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **canals** as a useful,
