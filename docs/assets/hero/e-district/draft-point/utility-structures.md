...
---
asset_id: "asset.e-district.draft-point.utility-structures"
source_label: "utility structures"
...
- **Asset ID:** asset.e-district.draft-point.utility-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1782
...
![utility structures reference render](utility-structures.png)

## Intent

The **utility structures** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **utility structures** as a useful,
