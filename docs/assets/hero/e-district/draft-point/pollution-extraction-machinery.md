...
---
asset_id: "asset.e-district.draft-point.pollution-extraction-machinery"
source_label: "pollution-extraction machinery"
...
# pollution-extraction machinery

## Identity

- **Asset ID:** asset.e-district.draft-point.pollution-extraction-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1781
...
![pollution-extraction machinery reference render](pollution-extraction-machinery.png)

## Intent

The **pollution-extraction machinery** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **pollution-extraction machinery** as a useful,
...
- **POI sibling component:** [working-class settlement](./working-class-settlement.md).
