...
---
asset_id: "asset.e-district.blossom-drive.canal-bridges"
source_label: "canal bridges"
...
- **Asset ID:** asset.e-district.blossom-drive.canal-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:1767
...
![canal bridges reference render](canal-bridges.png)

## Intent

The **canal bridges** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **canal bridges** as a useful,
