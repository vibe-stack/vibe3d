...
---
asset_id: "asset.e-district.blossom-drive.cherry-blossom-landscaping"
source_label: "cherry blossom landscaping"
source_section: "Hero / E-District"
source_group: "Blossom Drive"
source_line: 1771
level: L3
status: planned
...
# cherry blossom landscaping

## Identity

- **Asset ID:** asset.e-district.blossom-drive.cherry-blossom-landscaping
- **Type:** POI hero component
- **Source:** prop-list.md:1771
...
![cherry blossom landscaping reference render](cherry-blossom-landscaping.png)

## Intent

The **cherry blossom landscaping** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **cherry blossom landscaping** as a useful,
...
- **Parent assembly:** [Blossom Drive assembly](./_assembly.md).
