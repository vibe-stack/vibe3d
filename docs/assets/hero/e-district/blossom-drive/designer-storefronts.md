...
---
asset_id: "asset.e-district.blossom-drive.designer-storefronts"
source_label: "designer storefronts"
...
- **Asset ID:** asset.e-district.blossom-drive.designer-storefronts
- **Type:** POI hero component
- **Source:** prop-list.md:1770
...
![designer storefronts reference render](designer-storefronts.png)

## Intent

The **designer storefronts** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **designer storefronts** as a useful,
