...
---
asset_id: "asset.e-district.blossom-drive.connecting-ziplines"
source_label: "connecting Ziplines"
...
- **Asset ID:** asset.e-district.blossom-drive.connecting-ziplines
- **Type:** POI hero component
- **Source:** prop-list.md:1773
...
![connecting Ziplines reference render](connecting-ziplines.png)

## Intent

The **connecting Ziplines** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **connecting Ziplines** as a useful,
