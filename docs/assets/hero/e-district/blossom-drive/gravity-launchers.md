...
---
asset_id: "asset.e-district.blossom-drive.gravity-launchers"
source_label: "Gravity Launchers"
...
- **Asset ID:** asset.e-district.blossom-drive.gravity-launchers
- **Type:** POI hero component
- **Source:** prop-list.md:1772
...
![Gravity Launchers reference render](gravity-launchers.png)

## Intent

The **Gravity Launchers** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **Gravity Launchers** as a useful,
