...
---
asset_id: "asset.e-district.blossom-drive.luxury-boutiques"
source_label: "luxury boutiques"
...
- **Asset ID:** asset.e-district.blossom-drive.luxury-boutiques
- **Type:** POI hero component
- **Source:** prop-list.md:1769
...
![luxury boutiques reference render](luxury-boutiques.png)

## Intent

The **luxury boutiques** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **luxury boutiques** as a useful,
