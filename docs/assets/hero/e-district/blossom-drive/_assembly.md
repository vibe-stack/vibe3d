...
---
assembly_id: "assembly.e-district.blossom-drive"
source_label: "Blossom Drive"
...
# Blossom Drive — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.blossom-drive
- **Map family:** Hero / E-District
- **Place identity:** Dense urban districts with visible socioeconomic variety
- **Owner / story role:** Local civic, commercial, and nightlife operators
- **Source:** prop-list.md:1766

## Landmark promise

Blossom Drive is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems.
...
- Use MAGENTA-400 as the dominant hero signal and
...
- [canals](./canals.md) — component brief.
- [canal bridges](./canal-bridges.md) — component brief.
- [upscale commercial buildings](./upscale-commercial-buildings.md) — component brief.
- [luxury boutiques](./luxury-boutiques.md) — component brief.
- [designer storefronts](./designer-storefronts.md) — component brief.
- [cherry blossom landscaping](./cherry-blossom-landscaping.md) — component brief.
- [Gravity Launchers](./gravity-launchers.md) — component brief.
- [connecting Ziplines](./connecting-ziplines.md) — component brief.
