...
---
asset_id: "asset.e-district.blossom-drive.upscale-commercial-buildings"
source_label: "upscale commercial buildings"
...
- **Asset ID:** asset.e-district.blossom-drive.upscale-commercial-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1768
...
![upscale commercial buildings reference render](upscale-commercial-buildings.png)

## Intent

The **upscale commercial buildings** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **upscale commercial buildings** as a useful,
