...
---
asset_id: "asset.e-district.heights.hidden-passage-behind-waterfall"
source_label: "hidden passage behind waterfall"
source_section: "Hero / E-District"
source_group: "Heights"
source_line: 1729
level: L3
status: planned
...
- **Asset ID:** asset.e-district.heights.hidden-passage-behind-waterfall
- **Type:** POI hero component
- **Source:** prop-list.md:1729
...
![hidden passage behind waterfall reference render](hidden-passage-behind-waterfall.png)

## Intent

The **hidden passage behind waterfall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **hidden passage behind waterfall** as a useful,
...
- **Parent assembly:** [Heights assembly](./_assembly.md).

- **POI sibling component:** [hilltop tower](./hilltop-tower.md).
