...
---
asset_id: "asset.e-district.heights.waterfall"
source_label: "waterfall"
...
- **Asset ID:** asset.e-district.heights.waterfall
- **Type:** POI hero component
- **Source:** prop-list.md:1728
...
![waterfall reference render](waterfall.png)

## Intent

The **waterfall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **waterfall** as a useful,
