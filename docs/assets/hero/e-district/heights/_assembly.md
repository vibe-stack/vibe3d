...
---
assembly_id: "assembly.e-district.heights"
source_label: "Heights"
...
# Heights — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.heights
...
- **Source:** prop-list.md:1727

## Landmark promise

Heights is a landmark, not a pile of unrelated props. The full assembly
...
- [hilltop tower](./hilltop-tower.md) — component brief.
- [waterfall](./waterfall.md) — component brief.
- [hidden passage behind waterfall](./hidden-passage-behind-waterfall.md) — component brief.
- [luxury residential structures](./luxury-residential-structures.md) — component brief.
