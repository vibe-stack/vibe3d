...
---
asset_id: "asset.e-district.heights.hilltop-tower"
source_label: "hilltop tower"
...
- **Asset ID:** asset.e-district.heights.hilltop-tower
...
![hilltop tower reference render](hilltop-tower.png)

## Intent

The **hilltop tower** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **hilltop tower** as a useful,
...
- **POI sibling component:** [waterfall](./waterfall.md).
