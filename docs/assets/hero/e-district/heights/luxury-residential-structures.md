...
---
asset_id: "asset.e-district.heights.luxury-residential-structures"
source_label: "luxury residential structures"
...
# luxury residential structures

## Identity

- **Asset ID:** asset.e-district.heights.luxury-residential-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1730
...
![luxury residential structures reference render](luxury-residential-structures.png)

## Intent

The **luxury residential structures** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **luxury residential structures** as a useful,
