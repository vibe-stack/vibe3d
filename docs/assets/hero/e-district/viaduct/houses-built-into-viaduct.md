...
---
asset_id: "asset.e-district.viaduct.houses-built-into-viaduct"
source_label: "houses built into viaduct"
source_section: "Hero / E-District"
source_group: "Viaduct"
source_line: 1810
level: L3
status: planned
...
# houses built into viaduct

## Identity

- **Asset ID:** asset.e-district.viaduct.houses-built-into-viaduct
- **Type:** POI hero component
- **Source:** prop-list.md:1810
...
![houses built into viaduct reference render](houses-built-into-viaduct.png)

## Intent

The **houses built into viaduct** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **houses built into viaduct** as a useful,
...
- **Parent assembly:** [Viaduct assembly](./_assembly.md).

- **adjacent utility module:** [duct straight](../../../reusable/industrial/duct-straight.md).
- **POI sibling component:** [gigantic viaduct](./gigantic-viaduct.md).
