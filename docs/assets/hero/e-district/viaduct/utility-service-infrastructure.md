...
---
asset_id: "asset.e-district.viaduct.utility-service-infrastructure"
source_label: "utility/service infrastructure"
...
- **Asset ID:** asset.e-district.viaduct.utility-service-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1813
...
![utility/service infrastructure reference render](utility-service-infrastructure.png)

## Intent

The **utility/service infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **utility/service infrastructure** as a useful,
