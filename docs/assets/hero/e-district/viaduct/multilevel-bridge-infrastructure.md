...
---
asset_id: "asset.e-district.viaduct.multilevel-bridge-infrastructure"
source_label: "multilevel bridge infrastructure"
...
# multilevel bridge infrastructure

## Identity

- **Asset ID:** asset.e-district.viaduct.multilevel-bridge-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1809
...
![multilevel bridge infrastructure reference render](multilevel-bridge-infrastructure.png)

## Intent

The **multilevel bridge infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **multilevel bridge infrastructure** as a useful,
