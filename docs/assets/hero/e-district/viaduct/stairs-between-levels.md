...
---
asset_id: "asset.e-district.viaduct.stairs-between-levels"
source_label: "stairs between levels"
...
- **Asset ID:** asset.e-district.viaduct.stairs-between-levels
- **Type:** POI hero component
- **Source:** prop-list.md:1811
...
![stairs between levels reference render](stairs-between-levels.png)

## Intent

The **stairs between levels** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **stairs between levels** as a useful,
