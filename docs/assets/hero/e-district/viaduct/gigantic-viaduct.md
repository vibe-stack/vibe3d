...
---
asset_id: "asset.e-district.viaduct.gigantic-viaduct"
source_label: "gigantic viaduct"
...
- **Asset ID:** asset.e-district.viaduct.gigantic-viaduct
...
![gigantic viaduct reference render](gigantic-viaduct.png)

## Intent

The **gigantic viaduct** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **gigantic viaduct** as a useful,
...
- **POI sibling component:** [multilevel bridge infrastructure](./multilevel-bridge-infrastructure.md).
