...
---
assembly_id: "assembly.e-district.viaduct"
source_label: "Viaduct"
...
# Viaduct — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.viaduct
...
- **Source:** prop-list.md:1808

## Landmark promise

Viaduct is a landmark, not a pile of unrelated props. The full assembly
...
- [gigantic viaduct](./gigantic-viaduct.md) — component brief.
- [multilevel bridge infrastructure](./multilevel-bridge-infrastructure.md) — component brief.
- [houses built into viaduct](./houses-built-into-viaduct.md) — component brief.
- [stairs between levels](./stairs-between-levels.md) — component brief.
- [suspended platforms](./suspended-platforms.md) — component brief.
- [utility/service infrastructure](./utility-service-infrastructure.md) — component brief.
