...
---
asset_id: "asset.e-district.galleria.huge-underground-shopping-mall"
source_label: "huge underground shopping mall"
...
- **Asset ID:** asset.e-district.galleria.huge-underground-shopping-mall
...
![huge underground shopping mall reference render](huge-underground-shopping-mall.png)

## Intent

The **huge underground shopping mall** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **huge underground shopping mall** as a useful,
...
- **POI sibling component:** [two-level mall atrium](./two-level-mall-atrium.md).
