...
---
asset_id: "asset.e-district.galleria.escalator-stair-structures"
source_label: "escalator/stair structures"
...
# escalator/stair structures

## Identity

- **Asset ID:** asset.e-district.galleria.escalator-stair-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1721
...
![escalator/stair structures reference render](escalator-stair-structures.png)

## Intent

The **escalator/stair structures** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **escalator/stair structures** as a useful,
