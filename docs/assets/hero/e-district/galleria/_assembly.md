...
---
assembly_id: "assembly.e-district.galleria"
source_label: "Galleria"
...
# Galleria — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.galleria
...
- **Source:** prop-list.md:1718

## Landmark promise

Galleria is a landmark, not a pile of unrelated props. The full assembly
...
- [huge underground shopping mall](./huge-underground-shopping-mall.md) — component brief.
- [two-level mall atrium](./two-level-mall-atrium.md) — component brief.
- [dozens of storefront kits](./dozens-of-storefront-kits.md) — component brief.
- [escalator/stair structures](./escalator-stair-structures.md) — component brief.
- [retail kiosks](./retail-kiosks.md) — component brief.
- [central mall decoration](./central-mall-decoration.md) — component brief.
