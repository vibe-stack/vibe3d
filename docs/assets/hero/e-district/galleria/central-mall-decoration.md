...
---
asset_id: "asset.e-district.galleria.central-mall-decoration"
source_label: "central mall decoration"
...
# central mall decoration

## Identity

- **Asset ID:** asset.e-district.galleria.central-mall-decoration
- **Type:** POI hero component
- **Source:** prop-list.md:1723
...
![central mall decoration reference render](central-mall-decoration.png)

## Intent

The **central mall decoration** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **central mall decoration** as a useful,
