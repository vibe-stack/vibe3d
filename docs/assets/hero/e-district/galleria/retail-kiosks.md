...
---
asset_id: "asset.e-district.galleria.retail-kiosks"
source_label: "retail kiosks"
...
- **Asset ID:** asset.e-district.galleria.retail-kiosks
- **Type:** POI hero component
- **Source:** prop-list.md:1722
...
![retail kiosks reference render](retail-kiosks.png)

## Intent

The **retail kiosks** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **retail kiosks** as a useful,
