...
---
asset_id: "asset.e-district.galleria.two-level-mall-atrium"
source_label: "two-level mall atrium"
...
# two-level mall atrium

## Identity

- **Asset ID:** asset.e-district.galleria.two-level-mall-atrium
- **Type:** POI hero component
- **Source:** prop-list.md:1719
...
![two-level mall atrium reference render](two-level-mall-atrium.png)

## Intent

The **two-level mall atrium** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **two-level mall atrium** as a useful,
