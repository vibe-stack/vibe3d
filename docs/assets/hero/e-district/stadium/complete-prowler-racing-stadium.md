...
---
asset_id: "asset.e-district.stadium.complete-prowler-racing-stadium"
source_label: "complete Prowler racing stadium"
...
# complete Prowler racing stadium

## Identity

- **Asset ID:** asset.e-district.stadium.complete-prowler-racing-stadium
- **Type:** POI hero component
- **Source:** prop-list.md:1756
...
![complete Prowler racing stadium reference render](complete-prowler-racing-stadium.png)

## Intent

The **complete Prowler racing stadium** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **complete Prowler racing stadium** as a useful,
...
- **POI sibling component:** [circular 360° bleachers](./circular-360-bleachers.md).
