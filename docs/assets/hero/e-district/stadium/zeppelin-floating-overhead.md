...
---
asset_id: "asset.e-district.stadium.zeppelin-floating-overhead"
source_label: "zeppelin floating overhead"
...
# zeppelin floating overhead

## Identity

- **Asset ID:** asset.e-district.stadium.zeppelin-floating-overhead
- **Type:** POI hero component
- **Source:** prop-list.md:1761
...
![zeppelin floating overhead reference render](zeppelin-floating-overhead.png)

## Intent

The **zeppelin floating overhead** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **zeppelin floating overhead** as a useful,
