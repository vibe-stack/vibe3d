...
---
asset_id: "asset.e-district.stadium.settlement-inserted-into-arena"
source_label: "settlement inserted into arena"
source_section: "Hero / E-District"
source_group: "Stadium"
source_line: 1759
level: L3
status: planned
...
# settlement inserted into arena

## Identity

- **Asset ID:** asset.e-district.stadium.settlement-inserted-into-arena
- **Type:** POI hero component
- **Source:** prop-list.md:1759
...
![settlement inserted into arena reference render](settlement-inserted-into-arena.png)

## Intent

The **settlement inserted into arena** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **settlement inserted into arena** as a useful,
...
- **Parent assembly:** [Stadium assembly](./_assembly.md).

- **POI sibling component:** [complete Prowler racing stadium](./complete-prowler-racing-stadium.md).
