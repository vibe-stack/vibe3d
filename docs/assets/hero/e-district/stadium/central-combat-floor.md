...
---
asset_id: "asset.e-district.stadium.central-combat-floor"
source_label: "central combat floor"
...
- **Asset ID:** asset.e-district.stadium.central-combat-floor
- **Type:** POI hero component
- **Source:** prop-list.md:1760
...
![central combat floor reference render](central-combat-floor.png)

## Intent

The **central combat floor** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **central combat floor** as a useful,
