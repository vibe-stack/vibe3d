...
---
asset_id: "asset.e-district.stadium.former-racetrack"
source_label: "former racetrack"
...
- **Asset ID:** asset.e-district.stadium.former-racetrack
- **Type:** POI hero component
- **Source:** prop-list.md:1758
...
![former racetrack reference render](former-racetrack.png)

## Intent

The **former racetrack** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **former racetrack** as a useful,
