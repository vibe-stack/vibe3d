...
---
asset_id: "asset.e-district.stadium.zeppelin-power-infrastructure"
source_label: "zeppelin power infrastructure"
...
# zeppelin power infrastructure

## Identity

- **Asset ID:** asset.e-district.stadium.zeppelin-power-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1762
...
![zeppelin power infrastructure reference render](zeppelin-power-infrastructure.png)

## Intent

The **zeppelin power infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **zeppelin power infrastructure** as a useful,
