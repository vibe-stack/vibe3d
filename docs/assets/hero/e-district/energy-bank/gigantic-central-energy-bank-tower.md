...
---
asset_id: "asset.e-district.energy-bank.gigantic-central-energy-bank-tower"
source_label: "gigantic central Energy Bank tower"
...
# gigantic central Energy Bank tower

## Identity

- **Asset ID:** asset.e-district.energy-bank.gigantic-central-energy-bank-tower
...
![gigantic central Energy Bank tower reference render](gigantic-central-energy-bank-tower.png)

## Intent

The **gigantic central Energy Bank tower** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **gigantic central Energy Bank tower** as a useful,
...
- **POI sibling component:** [huge circular tower crown](./huge-circular-tower-crown.md).
