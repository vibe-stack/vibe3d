...
---
asset_id: "asset.e-district.energy-bank.ground-floor-power-station"
source_label: "ground-floor power station"
...
# ground-floor power station

## Identity

- **Asset ID:** asset.e-district.energy-bank.ground-floor-power-station
- **Type:** POI hero component
- **Source:** prop-list.md:1646
...
![ground-floor power station reference render](ground-floor-power-station.png)

## Intent

The **ground-floor power station** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **ground-floor power station** as a useful,
