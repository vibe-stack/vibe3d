...
---
asset_id: "asset.e-district.energy-bank.massive-power-conduits"
source_label: "massive power conduits"
...
- **Asset ID:** asset.e-district.energy-bank.massive-power-conduits
- **Type:** POI hero component
- **Source:** prop-list.md:1649
...
![massive power conduits reference render](massive-power-conduits.png)

## Intent

The **massive power conduits** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **massive power conduits** as a useful,
