...
---
asset_id: "asset.e-district.energy-bank.electrical-substations"
source_label: "electrical substations"
...
- **Asset ID:** asset.e-district.energy-bank.electrical-substations
- **Type:** POI hero component
- **Source:** prop-list.md:1648
...
![electrical substations reference render](electrical-substations.png)

## Intent

The **electrical substations** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **electrical substations** as a useful,
