...
---
asset_id: "asset.e-district.energy-bank.surrounding-transformer-machinery"
source_label: "surrounding transformer machinery"
source_section: "Hero / E-District"
source_group: "Energy Bank"
source_line: 1647
level: L3
status: planned
...
# surrounding transformer machinery

## Identity

- **Asset ID:** asset.e-district.energy-bank.surrounding-transformer-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1647
...
![surrounding transformer machinery reference render](surrounding-transformer-machinery.png)

## Intent

The **surrounding transformer machinery** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **surrounding transformer machinery** as a useful,
...
- **Parent assembly:** [Energy Bank assembly](./_assembly.md).

- **POI sibling component:** [gigantic central Energy Bank tower](./gigantic-central-energy-bank-tower.md).
