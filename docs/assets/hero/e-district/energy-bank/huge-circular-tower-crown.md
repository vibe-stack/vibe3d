...
---
asset_id: "asset.e-district.energy-bank.huge-circular-tower-crown"
source_label: "huge circular tower crown"
...
# huge circular tower crown

## Identity

- **Asset ID:** asset.e-district.energy-bank.huge-circular-tower-crown
- **Type:** POI hero component
- **Source:** prop-list.md:1645
...
![huge circular tower crown reference render](huge-circular-tower-crown.png)

## Intent

The **huge circular tower crown** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **huge circular tower crown** as a useful,
