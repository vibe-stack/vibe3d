...
---
assembly_id: "assembly.e-district.energy-bank"
source_label: "Energy Bank"
...
# Energy Bank — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.energy-bank
...
- **Source:** prop-list.md:1644

## Landmark promise

Energy Bank is a landmark, not a pile of unrelated props. The full assembly
...
- Use VIOLET-500 as the dominant hero signal and
...
- [gigantic central Energy Bank tower](./gigantic-central-energy-bank-tower.md) — component brief.
- [huge circular tower crown](./huge-circular-tower-crown.md) — component brief.
- [ground-floor power station](./ground-floor-power-station.md) — component brief.
- [surrounding transformer machinery](./surrounding-transformer-machinery.md) — component brief.
- [electrical substations](./electrical-substations.md) — component brief.
- [massive power conduits](./massive-power-conduits.md) — component brief.
