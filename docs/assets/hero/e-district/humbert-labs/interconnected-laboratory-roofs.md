...
---
asset_id: "asset.e-district.humbert-labs.interconnected-laboratory-roofs"
source_label: "interconnected laboratory roofs"
...
# interconnected laboratory roofs

## Identity

- **Asset ID:** asset.e-district.humbert-labs.interconnected-laboratory-roofs
- **Type:** POI hero component
- **Source:** prop-list.md:1738
...
![interconnected laboratory roofs reference render](interconnected-laboratory-roofs.png)

## Intent

The **interconnected laboratory roofs** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **interconnected laboratory roofs** as a useful,
...
- **POI sibling component:** [agricultural chemical laboratory](./agricultural-chemical-laboratory.md).
