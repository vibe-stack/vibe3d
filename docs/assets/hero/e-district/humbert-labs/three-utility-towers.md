...
---
asset_id: "asset.e-district.humbert-labs.three-utility-towers"
source_label: "three utility towers"
...
- **Asset ID:** asset.e-district.humbert-labs.three-utility-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1736
...
![three utility towers reference render](three-utility-towers.png)

## Intent

The **three utility towers** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **three utility towers** as a useful,
