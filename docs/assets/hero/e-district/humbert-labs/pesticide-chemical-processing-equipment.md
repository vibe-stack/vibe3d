...
---
asset_id: "asset.e-district.humbert-labs.pesticide-chemical-processing-equipment"
source_label: "pesticide/chemical processing equipment"
...
# pesticide/chemical processing equipment

## Identity

- **Asset ID:** asset.e-district.humbert-labs.pesticide-chemical-processing-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1739
...
![pesticide/chemical processing equipment reference render](pesticide-chemical-processing-equipment.png)

## Intent

The **pesticide/chemical processing equipment** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **pesticide/chemical processing equipment** as a useful,
