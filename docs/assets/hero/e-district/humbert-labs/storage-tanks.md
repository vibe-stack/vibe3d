...
---
asset_id: "asset.e-district.humbert-labs.storage-tanks"
source_label: "storage tanks"
...
- **Asset ID:** asset.e-district.humbert-labs.storage-tanks
- **Type:** POI hero component
- **Source:** prop-list.md:1740
...
![storage tanks reference render](storage-tanks.png)

## Intent

The **storage tanks** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **storage tanks** as a useful,
