...
---
asset_id: "asset.e-district.humbert-labs.agricultural-chemical-laboratory"
source_label: "agricultural chemical laboratory"
source_section: "Hero / E-District"
source_group: "Humbert Labs"
source_line: 1735
level: L3
status: planned
...
- **Asset ID:** asset.e-district.humbert-labs.agricultural-chemical-laboratory
- **Type:** POI hero component
- **Source:** prop-list.md:1735
...
![agricultural chemical laboratory reference render](agricultural-chemical-laboratory.png)

## Intent

The **agricultural chemical laboratory** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **agricultural chemical laboratory** as a useful,
...
- **Parent assembly:** [Humbert Labs assembly](./_assembly.md).

- **POI sibling component:** [three utility towers](./three-utility-towers.md).
