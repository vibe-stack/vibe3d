...
---
asset_id: "asset.e-district.humbert-labs.rotating-wall-surrounding-them"
source_label: "rotating wall surrounding them"
...
# rotating wall surrounding them

## Identity

- **Asset ID:** asset.e-district.humbert-labs.rotating-wall-surrounding-them
- **Type:** POI hero component
- **Source:** prop-list.md:1737
...
![rotating wall surrounding them reference render](rotating-wall-surrounding-them.png)

## Intent

The **rotating wall surrounding them** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **rotating wall surrounding them** as a useful,
