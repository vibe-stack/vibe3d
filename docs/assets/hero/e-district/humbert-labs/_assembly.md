...
---
assembly_id: "assembly.e-district.humbert-labs"
source_label: "Humbert Labs"
...
# Humbert Labs — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.humbert-labs
...
Humbert Labs is a landmark, not a pile of unrelated props. The full assembly
...
- [agricultural chemical laboratory](./agricultural-chemical-laboratory.md) — component brief.
- [three utility towers](./three-utility-towers.md) — component brief.
- [rotating wall surrounding them](./rotating-wall-surrounding-them.md) — component brief.
- [interconnected laboratory roofs](./interconnected-laboratory-roofs.md) — component brief.
- [pesticide/chemical processing equipment](./pesticide-chemical-processing-equipment.md) — component brief.
- [storage tanks](./storage-tanks.md) — component brief.
