...
---
assembly_id: "assembly.e-district.old-town"
source_label: "Old Town"
...
# Old Town — hero assembly

## Identity

- **Assembly ID:** assembly.e-district.old-town
...
Old Town is a landmark, not a pile of unrelated props. The full assembly
...
- [dense old-city building kit](./dense-old-city-building-kit.md) — component brief.
- [narrow streets](./narrow-streets.md) — component brief.
- [multi-storey residences](./multi-storey-residences.md) — component brief.
- [rooftop infrastructure](./rooftop-infrastructure.md) — component brief.
- [central-street Gravity Launcher](./central-street-gravity-launcher.md) — component brief.
- [aged storefronts](./aged-storefronts.md) — component brief.
- [dense utility clutter](./dense-utility-clutter.md) — component brief.
