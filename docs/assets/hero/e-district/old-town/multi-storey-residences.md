...
---
asset_id: "asset.e-district.old-town.multi-storey-residences"
source_label: "multi-storey residences"
source_section: "Hero / E-District"
source_group: "Old Town"
source_line: 1748
level: L3
status: planned
...
- **Asset ID:** asset.e-district.old-town.multi-storey-residences
- **Type:** POI hero component
- **Source:** prop-list.md:1748
...
![multi-storey residences reference render](multi-storey-residences.png)

## Intent

The **multi-storey residences** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **multi-storey residences** as a useful,
...
- **Parent assembly:** [Old Town assembly](./_assembly.md).

- **POI sibling component:** [dense old-city building kit](./dense-old-city-building-kit.md).
