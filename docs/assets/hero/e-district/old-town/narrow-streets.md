...
---
asset_id: "asset.e-district.old-town.narrow-streets"
source_label: "narrow streets"
...
- **Asset ID:** asset.e-district.old-town.narrow-streets
- **Type:** POI hero component
- **Source:** prop-list.md:1747
...
![narrow streets reference render](narrow-streets.png)

## Intent

The **narrow streets** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **narrow streets** as a useful,
