...
---
asset_id: "asset.e-district.old-town.aged-storefronts"
source_label: "aged storefronts"
...
- **Asset ID:** asset.e-district.old-town.aged-storefronts
- **Type:** POI hero component
- **Source:** prop-list.md:1751
...
![aged storefronts reference render](aged-storefronts.png)

## Intent

The **aged storefronts** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **aged storefronts** as a useful,
