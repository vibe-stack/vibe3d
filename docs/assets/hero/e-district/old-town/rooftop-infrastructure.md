...
---
asset_id: "asset.e-district.old-town.rooftop-infrastructure"
source_label: "rooftop infrastructure"
...
- **Asset ID:** asset.e-district.old-town.rooftop-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1749
...
![rooftop infrastructure reference render](rooftop-infrastructure.png)

## Intent

The **rooftop infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **rooftop infrastructure** as a useful,
