...
---
asset_id: "asset.e-district.old-town.dense-utility-clutter"
source_label: "dense utility clutter"
...
# dense utility clutter

## Identity

- **Asset ID:** asset.e-district.old-town.dense-utility-clutter
- **Type:** POI hero component
- **Source:** prop-list.md:1752
...
![dense utility clutter reference render](dense-utility-clutter.png)

## Intent

The **dense utility clutter** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dense utility clutter** as a useful,
