...
---
asset_id: "asset.e-district.old-town.dense-old-city-building-kit"
source_label: "dense old-city building kit"
...
# dense old-city building kit

## Identity

- **Asset ID:** asset.e-district.old-town.dense-old-city-building-kit
- **Type:** POI hero component
- **Source:** prop-list.md:1746
...
![dense old-city building kit reference render](dense-old-city-building-kit.png)

## Intent

The **dense old-city building kit** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **dense old-city building kit** as a useful,
...
- **POI sibling component:** [narrow streets](./narrow-streets.md).
