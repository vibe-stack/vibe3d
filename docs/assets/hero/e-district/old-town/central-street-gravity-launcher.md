...
---
asset_id: "asset.e-district.old-town.central-street-gravity-launcher"
source_label: "central-street Gravity Launcher"
...
# central-street Gravity Launcher

## Identity

- **Asset ID:** asset.e-district.old-town.central-street-gravity-launcher
- **Type:** POI hero component
- **Source:** prop-list.md:1750
...
![central-street Gravity Launcher reference render](central-street-gravity-launcher.png)

## Intent

The **central-street Gravity Launcher** is a POI hero component for the Axiom Relay kit. It exists to support
layered city life: high-rises, markets, entertainment, civic unrest, utilities, and water systems. Its primary read should be **central-street Gravity Launcher** as a useful,
