...
---
assembly_id: "assembly.olympus.icarus"
source_label: "Icarus"
...
# Icarus — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.icarus
...
Icarus is a landmark, not a pile of unrelated props. The full assembly
...
- [huge Icarus ship](./huge-icarus-ship.md) — component brief.
- [ship docking structure](./ship-docking-structure.md) — component brief.
- [infested/organic growth elements](./infested-organic-growth-elements.md) — component brief.
- [ship interiors](./ship-interiors.md) — component brief.
