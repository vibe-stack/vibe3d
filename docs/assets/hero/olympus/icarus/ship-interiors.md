...
---
asset_id: "asset.olympus.icarus.ship-interiors"
source_label: "ship interiors"
...
- **Asset ID:** asset.olympus.icarus.ship-interiors
- **Type:** POI hero component
- **Source:** prop-list.md:1257
- **Family:** Hero / Olympus
...
![ship interiors reference render](ship-interiors.png)

## Intent

The **ship interiors** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **ship interiors** as a useful,
