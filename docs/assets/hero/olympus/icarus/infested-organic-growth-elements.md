...
---
asset_id: "asset.olympus.icarus.infested-organic-growth-elements"
source_label: "infested/organic growth elements"
...
# infested/organic growth elements

## Identity

- **Asset ID:** asset.olympus.icarus.infested-organic-growth-elements
- **Type:** POI hero component
- **Source:** prop-list.md:1256
- **Family:** Hero / Olympus
...
![infested/organic growth elements reference render](infested-organic-growth-elements.png)

## Intent

The **infested/organic growth elements** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **infested/organic growth elements** as a useful,
...
- **Parent assembly:** [Icarus assembly](./_assembly.md).

- **POI sibling component:** [huge Icarus ship](./huge-icarus-ship.md).
