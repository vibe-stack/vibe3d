...
---
asset_id: "asset.olympus.icarus.huge-icarus-ship"
source_label: "huge Icarus ship"
...
- **Asset ID:** asset.olympus.icarus.huge-icarus-ship
- **Type:** POI hero component
- **Source:** prop-list.md:1254
- **Family:** Hero / Olympus
...
![huge Icarus ship reference render](huge-icarus-ship.png)

## Intent

The **huge Icarus ship** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **huge Icarus ship** as a useful,
...
- **POI sibling component:** [ship docking structure](./ship-docking-structure.md).
