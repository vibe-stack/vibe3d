...
---
asset_id: "asset.olympus.icarus.ship-docking-structure"
source_label: "ship docking structure"
...
# ship docking structure

## Identity

- **Asset ID:** asset.olympus.icarus.ship-docking-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1255
- **Family:** Hero / Olympus
...
![ship docking structure reference render](ship-docking-structure.png)

## Intent

The **ship docking structure** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **ship docking structure** as a useful,
