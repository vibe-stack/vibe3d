...
---
asset_id: "asset.olympus.somers-university.academic-interiors"
source_label: "academic interiors"
...
- **Asset ID:** asset.olympus.somers-university.academic-interiors
- **Type:** POI hero component
- **Source:** prop-list.md:1289
- **Family:** Hero / Olympus
...
![academic interiors reference render](academic-interiors.png)

## Intent

The **academic interiors** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **academic interiors** as a useful,
