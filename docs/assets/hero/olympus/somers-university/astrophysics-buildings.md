...
---
asset_id: "asset.olympus.somers-university.astrophysics-buildings"
source_label: "astrophysics buildings"
...
# astrophysics buildings

## Identity

- **Asset ID:** asset.olympus.somers-university.astrophysics-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1286
- **Family:** Hero / Olympus
...
![astrophysics buildings reference render](astrophysics-buildings.png)

## Intent

The **astrophysics buildings** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **astrophysics buildings** as a useful,
