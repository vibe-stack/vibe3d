...
---
assembly_id: "assembly.olympus.somers-university"
source_label: "Somers University"
...
# Somers University — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.somers-university
- **Map family:** Hero / Olympus
- **Place identity:** Clean luxury utopia, research campuses, gardens, and phase transit
- **Owner / story role:** Axiom Civic / scientific megastructure
- **Source:** prop-list.md:1285

## Landmark promise

Somers University is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate precise civic megastructures with bright shells, glass, controlled greenery, and quiet power.
...
- [university campus](./university-campus.md) — component brief.
- [astrophysics buildings](./astrophysics-buildings.md) — component brief.
- [observatory/scientific equipment](./observatory-scientific-equipment.md) — component brief.
- [campus plazas](./campus-plazas.md) — component brief.
- [academic interiors](./academic-interiors.md) — component brief.
