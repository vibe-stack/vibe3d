...
---
asset_id: "asset.olympus.somers-university.university-campus"
source_label: "university campus"
source_section: "Hero / Olympus"
source_group: "Somers University"
source_line: 1285
level: L3
status: planned
...
- **Asset ID:** asset.olympus.somers-university.university-campus
- **Type:** POI hero component
- **Source:** prop-list.md:1285
- **Family:** Hero / Olympus
...
![university campus reference render](university-campus.png)

## Intent

The **university campus** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **university campus** as a useful,
...
- **Parent assembly:** [Somers University assembly](./_assembly.md).

- **POI sibling component:** [astrophysics buildings](./astrophysics-buildings.md).
