...
---
asset_id: "asset.olympus.somers-university.campus-plazas"
source_label: "campus plazas"
...
- **Asset ID:** asset.olympus.somers-university.campus-plazas
- **Type:** POI hero component
- **Source:** prop-list.md:1288
- **Family:** Hero / Olympus
...
![campus plazas reference render](campus-plazas.png)

## Intent

The **campus plazas** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **campus plazas** as a useful,
...
- **POI sibling component:** [university campus](./university-campus.md).
