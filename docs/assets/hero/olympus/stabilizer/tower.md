...
---
asset_id: "asset.olympus.stabilizer.tower"
source_label: "tower"
...
- **Asset ID:** asset.olympus.stabilizer.tower
- **Type:** POI hero component
- **Source:** prop-list.md:1302
- **Family:** Hero / Olympus
...
![tower reference render](tower.png)

## Intent

The **tower** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **tower** as a useful,
