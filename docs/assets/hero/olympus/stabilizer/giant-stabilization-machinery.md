...
---
asset_id: "asset.olympus.stabilizer.giant-stabilization-machinery"
source_label: "giant stabilization machinery"
source_section: "Hero / Olympus"
source_group: "Stabilizer"
source_line: 1301
level: L3
status: planned
...
# giant stabilization machinery

## Identity

- **Asset ID:** asset.olympus.stabilizer.giant-stabilization-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1301
- **Family:** Hero / Olympus
...
![giant stabilization machinery reference render](giant-stabilization-machinery.png)

## Intent

The **giant stabilization machinery** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **giant stabilization machinery** as a useful,
...
- **Parent assembly:** [Stabilizer assembly](./_assembly.md).

- **POI sibling component:** [tower](./tower.md).
