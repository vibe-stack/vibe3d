...
---
assembly_id: "assembly.olympus.stabilizer"
...
# Stabilizer — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.stabilizer
...
Stabilizer is a landmark, not a pile of unrelated props. The full assembly
...
- [giant stabilization machinery](./giant-stabilization-machinery.md) — component brief.
- [tower](./tower.md) — component brief.
- [power infrastructure](./power-infrastructure.md) — component brief.
