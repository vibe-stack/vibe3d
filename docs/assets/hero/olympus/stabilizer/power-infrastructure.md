...
---
asset_id: "asset.olympus.stabilizer.power-infrastructure"
source_label: "power infrastructure"
...
- **Asset ID:** asset.olympus.stabilizer.power-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1303
- **Family:** Hero / Olympus
...
![power infrastructure reference render](power-infrastructure.png)

## Intent

The **power infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **power infrastructure** as a useful,
...
- **POI sibling component:** [giant stabilization machinery](./giant-stabilization-machinery.md).
