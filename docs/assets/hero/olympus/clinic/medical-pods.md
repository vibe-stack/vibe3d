...
---
asset_id: "asset.olympus.clinic.medical-pods"
source_label: "medical pods"
...
- **Asset ID:** asset.olympus.clinic.medical-pods
- **Type:** POI hero component
- **Source:** prop-list.md:1273
- **Family:** Hero / Olympus
...
![medical pods reference render](medical-pods.png)

## Intent

The **medical pods** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **medical pods** as a useful,
