...
---
asset_id: "asset.olympus.clinic.medical-reception"
source_label: "medical reception"
...
- **Asset ID:** asset.olympus.clinic.medical-reception
- **Type:** POI hero component
- **Source:** prop-list.md:1271
- **Family:** Hero / Olympus
...
![medical reception reference render](medical-reception.png)

## Intent

The **medical reception** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **medical reception** as a useful,
