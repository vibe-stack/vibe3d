...
---
asset_id: "asset.olympus.clinic.lifeline-clinic"
source_label: "Lifeline Clinic"
...
- **Asset ID:** asset.olympus.clinic.lifeline-clinic
- **Type:** POI hero component
- **Source:** prop-list.md:1270
- **Family:** Hero / Olympus
...
![Lifeline Clinic reference render](lifeline-clinic.png)

## Intent

The **Lifeline Clinic** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **Lifeline Clinic** as a useful,
...
- **Parent assembly:** [Clinic assembly](./_assembly.md).

- **POI sibling component:** [medical reception](./medical-reception.md).
