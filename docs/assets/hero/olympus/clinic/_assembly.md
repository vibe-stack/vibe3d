...
---
assembly_id: "assembly.olympus.clinic"
source_label: "Clinic"
...
# Clinic — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.clinic
...
Clinic is a landmark, not a pile of unrelated props. The full assembly
...
- [Lifeline Clinic](./lifeline-clinic.md) — component brief.
- [medical reception](./medical-reception.md) — component brief.
- [treatment rooms](./treatment-rooms.md) — component brief.
- [medical pods](./medical-pods.md) — component brief.
- [high-tech medical equipment](./high-tech-medical-equipment.md) — component brief.
