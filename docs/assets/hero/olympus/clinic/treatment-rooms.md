...
---
asset_id: "asset.olympus.clinic.treatment-rooms"
source_label: "treatment rooms"
...
- **Asset ID:** asset.olympus.clinic.treatment-rooms
- **Type:** POI hero component
- **Source:** prop-list.md:1272
- **Family:** Hero / Olympus
...
![treatment rooms reference render](treatment-rooms.png)

## Intent

The **treatment rooms** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **treatment rooms** as a useful,
