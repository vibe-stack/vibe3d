...
---
asset_id: "asset.olympus.solar-array.massive-solar-panels"
source_label: "massive solar panels"
...
- **Asset ID:** asset.olympus.solar-array.massive-solar-panels
...
![massive solar panels reference render](massive-solar-panels.png)

## Intent

The **massive solar panels** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **massive solar panels** as a useful,
...
- **POI sibling component:** [solar-tracking structures](./solar-tracking-structures.md).
