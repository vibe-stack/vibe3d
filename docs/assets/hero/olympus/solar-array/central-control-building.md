...
---
asset_id: "asset.olympus.solar-array.central-control-building"
source_label: "central control building"
source_section: "Hero / Olympus"
source_group: "Solar Array"
source_line: 1243
level: L3
status: planned
...
- **Asset ID:** asset.olympus.solar-array.central-control-building
- **Type:** POI hero component
- **Source:** prop-list.md:1243
- **Family:** Hero / Olympus
...
![central control building reference render](central-control-building.png)

## Intent

The **central control building** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **central control building** as a useful,
...
- **Parent assembly:** [Solar Array assembly](./_assembly.md).

- **POI sibling component:** [massive solar panels](./massive-solar-panels.md).
