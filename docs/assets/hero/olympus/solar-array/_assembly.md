...
---
assembly_id: "assembly.olympus.solar-array"
source_label: "Solar Array"
...
# Solar Array — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.solar-array
...
- **Source:** prop-list.md:1241

## Landmark promise

Solar Array is a landmark, not a pile of unrelated props. The full assembly
...
- [massive solar panels](./massive-solar-panels.md) — component brief.
- [solar-tracking structures](./solar-tracking-structures.md) — component brief.
- [central control building](./central-control-building.md) — component brief.
