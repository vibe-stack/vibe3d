...
---
asset_id: "asset.olympus.solar-array.solar-tracking-structures"
source_label: "solar-tracking structures"
...
- **Asset ID:** asset.olympus.solar-array.solar-tracking-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1242
- **Family:** Hero / Olympus
...
![solar-tracking structures reference render](solar-tracking-structures.png)

## Intent

The **solar-tracking structures** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **solar-tracking structures** as a useful,
