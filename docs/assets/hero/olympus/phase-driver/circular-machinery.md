...
---
asset_id: "asset.olympus.phase-driver.circular-machinery"
source_label: "circular machinery"
...
- **Asset ID:** asset.olympus.phase-driver.circular-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1280
- **Family:** Hero / Olympus
...
![circular machinery reference render](circular-machinery.png)

## Intent

The **circular machinery** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **circular machinery** as a useful,
