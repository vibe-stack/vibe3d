...
---
asset_id: "asset.olympus.phase-driver.control-buildings"
source_label: "control buildings"
source_section: "Hero / Olympus"
source_group: "Phase Driver"
source_line: 1281
level: L3
status: planned
...
- **Asset ID:** asset.olympus.phase-driver.control-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1281
- **Family:** Hero / Olympus
...
![control buildings reference render](control-buildings.png)

## Intent

The **control buildings** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **control buildings** as a useful,
...
- **Parent assembly:** [Phase Driver assembly](./_assembly.md).

- **POI sibling component:** [enormous Phase Driver](./enormous-phase-driver.md).
