...
---
asset_id: "asset.olympus.phase-driver.central-phase-apparatus"
source_label: "central phase apparatus"
...
# central phase apparatus

## Identity

- **Asset ID:** asset.olympus.phase-driver.central-phase-apparatus
- **Type:** POI hero component
- **Source:** prop-list.md:1279
- **Family:** Hero / Olympus
...
![central phase apparatus reference render](central-phase-apparatus.png)

## Intent

The **central phase apparatus** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **central phase apparatus** as a useful,
