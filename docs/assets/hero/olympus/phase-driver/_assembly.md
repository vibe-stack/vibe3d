...
---
assembly_id: "assembly.olympus.phase-driver"
source_label: "Phase Driver"
...
# Phase Driver — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.phase-driver
...
Phase Driver is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous Phase Driver](./enormous-phase-driver.md) — component brief.
- [central phase apparatus](./central-phase-apparatus.md) — component brief.
- [circular machinery](./circular-machinery.md) — component brief.
- [control buildings](./control-buildings.md) — component brief.
