...
---
asset_id: "asset.olympus.phase-driver.enormous-phase-driver"
source_label: "enormous Phase Driver"
...
# enormous Phase Driver

## Identity

- **Asset ID:** asset.olympus.phase-driver.enormous-phase-driver
- **Type:** POI hero component
- **Source:** prop-list.md:1278
- **Family:** Hero / Olympus
...
![enormous Phase Driver reference render](enormous-phase-driver.png)

## Intent

The **enormous Phase Driver** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **enormous Phase Driver** as a useful,
...
- **POI sibling component:** [central phase apparatus](./central-phase-apparatus.md).
