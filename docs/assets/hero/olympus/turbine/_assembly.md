...
---
assembly_id: "assembly.olympus.turbine"
...
# Turbine — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.turbine
...
Turbine is a landmark, not a pile of unrelated props. The full assembly
...
- [giant central turbine](./giant-central-turbine.md) — component brief.
- [huge rotor](./huge-rotor.md) — component brief.
- [turbine tunnel](./turbine-tunnel.md) — component brief.
- [maintenance galleries](./maintenance-galleries.md) — component brief.
