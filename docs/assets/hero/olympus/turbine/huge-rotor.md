...
---
asset_id: "asset.olympus.turbine.huge-rotor"
source_label: "huge rotor"
...
- **Asset ID:** asset.olympus.turbine.huge-rotor
- **Type:** POI hero component
- **Source:** prop-list.md:1190
- **Family:** Hero / Olympus
...
![huge rotor reference render](huge-rotor.png)

## Intent

The **huge rotor** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **huge rotor** as a useful,
