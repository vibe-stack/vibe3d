...
---
asset_id: "asset.olympus.turbine.giant-central-turbine"
source_label: "giant central turbine"
source_section: "Hero / Olympus"
source_group: "Turbine"
source_line: 1189
level: L3
status: planned
...
# giant central turbine

## Identity

- **Asset ID:** asset.olympus.turbine.giant-central-turbine
- **Type:** POI hero component
- **Source:** prop-list.md:1189
- **Family:** Hero / Olympus
...
![giant central turbine reference render](giant-central-turbine.png)

## Intent

The **giant central turbine** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **giant central turbine** as a useful,
...
- **Parent assembly:** [Turbine assembly](./_assembly.md).

- **POI sibling component:** [huge rotor](./huge-rotor.md).
