...
---
asset_id: "asset.olympus.turbine.turbine-tunnel"
source_label: "turbine tunnel"
...
- **Asset ID:** asset.olympus.turbine.turbine-tunnel
- **Type:** POI hero component
- **Source:** prop-list.md:1191
- **Family:** Hero / Olympus
...
![turbine tunnel reference render](turbine-tunnel.png)

## Intent

The **turbine tunnel** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **turbine tunnel** as a useful,
...
- **POI sibling component:** [giant central turbine](./giant-central-turbine.md).
