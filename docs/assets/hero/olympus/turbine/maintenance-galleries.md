...
---
asset_id: "asset.olympus.turbine.maintenance-galleries"
source_label: "maintenance galleries"
...
- **Asset ID:** asset.olympus.turbine.maintenance-galleries
- **Type:** POI hero component
- **Source:** prop-list.md:1192
- **Family:** Hero / Olympus
...
![maintenance galleries reference render](maintenance-galleries.png)

## Intent

The **maintenance galleries** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **maintenance galleries** as a useful,
