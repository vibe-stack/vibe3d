...
---
assembly_id: "assembly.olympus.gravity-engine"
source_label: "Gravity Engine"
...
# Gravity Engine — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.gravity-engine
...
Gravity Engine is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous gravity-control apparatus](./enormous-gravity-control-apparatus.md) — component brief.
- [central engine tower](./central-engine-tower.md) — component brief.
- [gravity machinery](./gravity-machinery.md) — component brief.
- [huge exterior pipes](./huge-exterior-pipes.md) — component brief.
- [service platforms](./service-platforms.md) — component brief.
