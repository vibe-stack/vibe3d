...
---
asset_id: "asset.olympus.gravity-engine.gravity-machinery"
source_label: "gravity machinery"
...
- **Asset ID:** asset.olympus.gravity-engine.gravity-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1295
- **Family:** Hero / Olympus
...
![gravity machinery reference render](gravity-machinery.png)

## Intent

The **gravity machinery** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **gravity machinery** as a useful,
