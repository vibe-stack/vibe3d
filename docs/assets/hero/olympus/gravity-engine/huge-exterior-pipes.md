...
---
asset_id: "asset.olympus.gravity-engine.huge-exterior-pipes"
source_label: "huge exterior pipes"
source_section: "Hero / Olympus"
source_group: "Gravity Engine"
source_line: 1296
level: L3
status: planned
...
- **Asset ID:** asset.olympus.gravity-engine.huge-exterior-pipes
- **Type:** POI hero component
- **Source:** prop-list.md:1296
- **Family:** Hero / Olympus
...
![huge exterior pipes reference render](huge-exterior-pipes.png)

## Intent

The **huge exterior pipes** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **huge exterior pipes** as a useful,
...
- **Parent assembly:** [Gravity Engine assembly](./_assembly.md).

- **adjacent utility module:** [duct straight](../../../reusable/industrial/duct-straight.md).
- **POI sibling component:** [enormous gravity-control apparatus](./enormous-gravity-control-apparatus.md).
