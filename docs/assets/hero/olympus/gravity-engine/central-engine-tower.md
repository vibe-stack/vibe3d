...
---
asset_id: "asset.olympus.gravity-engine.central-engine-tower"
source_label: "central engine tower"
...
# central engine tower

## Identity

- **Asset ID:** asset.olympus.gravity-engine.central-engine-tower
- **Type:** POI hero component
- **Source:** prop-list.md:1294
- **Family:** Hero / Olympus
...
![central engine tower reference render](central-engine-tower.png)

## Intent

The **central engine tower** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **central engine tower** as a useful,
