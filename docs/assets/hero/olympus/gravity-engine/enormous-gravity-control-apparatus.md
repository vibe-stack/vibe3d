...
---
asset_id: "asset.olympus.gravity-engine.enormous-gravity-control-apparatus"
source_label: "enormous gravity-control apparatus"
...
# enormous gravity-control apparatus

## Identity

- **Asset ID:** asset.olympus.gravity-engine.enormous-gravity-control-apparatus
- **Type:** POI hero component
- **Source:** prop-list.md:1293
- **Family:** Hero / Olympus
...
![enormous gravity-control apparatus reference render](enormous-gravity-control-apparatus.png)

## Intent

The **enormous gravity-control apparatus** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **enormous gravity-control apparatus** as a useful,
...
- **POI sibling component:** [central engine tower](./central-engine-tower.md).
