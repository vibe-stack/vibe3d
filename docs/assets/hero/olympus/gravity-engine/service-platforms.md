...
---
asset_id: "asset.olympus.gravity-engine.service-platforms"
source_label: "service platforms"
...
- **Asset ID:** asset.olympus.gravity-engine.service-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1297
- **Family:** Hero / Olympus
...
![service platforms reference render](service-platforms.png)

## Intent

The **service platforms** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **service platforms** as a useful,
