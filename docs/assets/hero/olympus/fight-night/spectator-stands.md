...
---
asset_id: "asset.olympus.fight-night.spectator-stands"
source_label: "spectator stands"
...
- **Asset ID:** asset.olympus.fight-night.spectator-stands
- **Type:** POI hero component
- **Source:** prop-list.md:1263
- **Family:** Hero / Olympus
...
![spectator stands reference render](spectator-stands.png)

## Intent

The **spectator stands** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **spectator stands** as a useful,
