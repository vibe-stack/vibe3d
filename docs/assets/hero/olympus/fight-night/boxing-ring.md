...
---
asset_id: "asset.olympus.fight-night.boxing-ring"
source_label: "boxing ring"
...
- **Asset ID:** asset.olympus.fight-night.boxing-ring
- **Type:** POI hero component
- **Source:** prop-list.md:1262
- **Family:** Hero / Olympus
...
![boxing ring reference render](boxing-ring.png)

## Intent

The **boxing ring** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **boxing ring** as a useful,
