...
---
asset_id: "asset.olympus.fight-night.boxing-gym-dressing"
source_label: "boxing gym dressing"
...
- **Asset ID:** asset.olympus.fight-night.boxing-gym-dressing
- **Type:** POI hero component
- **Source:** prop-list.md:1265
- **Family:** Hero / Olympus
...
![boxing gym dressing reference render](boxing-gym-dressing.png)

## Intent

The **boxing gym dressing** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **boxing gym dressing** as a useful,
...
- **POI sibling component:** [Pathfinder boxing arena](./pathfinder-boxing-arena.md).
