...
---
asset_id: "asset.olympus.fight-night.holographic-signage"
source_label: "holographic signage"
...
- **Asset ID:** asset.olympus.fight-night.holographic-signage
- **Type:** POI hero component
- **Source:** prop-list.md:1266
- **Family:** Hero / Olympus
...
![holographic signage reference render](holographic-signage.png)

## Intent

The **holographic signage** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **holographic signage** as a useful,
