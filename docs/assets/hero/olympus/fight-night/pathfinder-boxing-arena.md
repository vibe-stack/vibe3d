...
---
asset_id: "asset.olympus.fight-night.pathfinder-boxing-arena"
source_label: "Pathfinder boxing arena"
source_section: "Hero / Olympus"
source_group: "Fight Night"
source_line: 1261
level: L3
status: planned
...
# Pathfinder boxing arena

## Identity

- **Asset ID:** asset.olympus.fight-night.pathfinder-boxing-arena
- **Type:** POI hero component
- **Source:** prop-list.md:1261
- **Family:** Hero / Olympus
...
![Pathfinder boxing arena reference render](pathfinder-boxing-arena.png)

## Intent

The **Pathfinder boxing arena** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **Pathfinder boxing arena** as a useful,
...
- **Parent assembly:** [Fight Night assembly](./_assembly.md).

- **POI sibling component:** [boxing ring](./boxing-ring.md).
