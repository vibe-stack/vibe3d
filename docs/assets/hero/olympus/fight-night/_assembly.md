...
---
assembly_id: "assembly.olympus.fight-night"
source_label: "Fight Night"
...
# Fight Night — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.fight-night
...
Fight Night is a landmark, not a pile of unrelated props. The full assembly
...
- [Pathfinder boxing arena](./pathfinder-boxing-arena.md) — component brief.
- [boxing ring](./boxing-ring.md) — component brief.
- [spectator stands](./spectator-stands.md) — component brief.
- [scoreboards](./scoreboards.md) — component brief.
- [boxing gym dressing](./boxing-gym-dressing.md) — component brief.
- [holographic signage](./holographic-signage.md) — component brief.
