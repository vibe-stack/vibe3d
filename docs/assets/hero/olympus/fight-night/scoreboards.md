...
---
asset_id: "asset.olympus.fight-night.scoreboards"
source_label: "scoreboards"
...
- **Asset ID:** asset.olympus.fight-night.scoreboards
- **Type:** POI hero component
- **Source:** prop-list.md:1264
- **Family:** Hero / Olympus
...
![scoreboards reference render](scoreboards.png)

## Intent

The **scoreboards** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **scoreboards** as a useful,
