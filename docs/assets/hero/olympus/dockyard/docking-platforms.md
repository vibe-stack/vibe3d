...
---
asset_id: "asset.olympus.dockyard.docking-platforms"
source_label: "docking platforms"
...
- **Asset ID:** asset.olympus.dockyard.docking-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1308
- **Family:** Hero / Olympus
...
![docking platforms reference render](docking-platforms.png)

## Intent

The **docking platforms** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **docking platforms** as a useful,
