...
---
asset_id: "asset.olympus.dockyard.industrial-shipside-structures"
source_label: "industrial shipside structures"
...
# industrial shipside structures

## Identity

- **Asset ID:** asset.olympus.dockyard.industrial-shipside-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1311
- **Family:** Hero / Olympus
...
![industrial shipside structures reference render](industrial-shipside-structures.png)

## Intent

The **industrial shipside structures** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **industrial shipside structures** as a useful,
