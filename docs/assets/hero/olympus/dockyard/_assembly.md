...
---
assembly_id: "assembly.olympus.dockyard"
source_label: "Dockyard"
...
# Dockyard — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.dockyard
...
Dockyard is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous clean-future docking facility](./enormous-clean-future-docking-facility.md) — component brief.
- [docking platforms](./docking-platforms.md) — component brief.
- [loading cranes](./loading-cranes.md) — component brief.
- [cargo handling](./cargo-handling.md) — component brief.
- [industrial shipside structures](./industrial-shipside-structures.md) — component brief.
