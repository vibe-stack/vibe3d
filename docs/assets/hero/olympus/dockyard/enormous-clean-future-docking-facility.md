...
---
asset_id: "asset.olympus.dockyard.enormous-clean-future-docking-facility"
source_label: "enormous clean-future docking facility"
source_section: "Hero / Olympus"
source_group: "Dockyard"
source_line: 1307
level: L3
status: planned
place_family: "Clean luxury utopia, research campuses, gardens, and phase transit"
owner: "Axiom Civic / scientific megastructure"
---

# enormous clean-future docking facility

## Identity

- **Asset ID:** asset.olympus.dockyard.enormous-clean-future-docking-facility
- **Type:** POI hero component
- **Source:** prop-list.md:1307
- **Family:** Hero / Olympus
- **Place family:** Clean luxury utopia, research campuses, gardens, and phase transit
- **Owner / story role:** Axiom Civic / scientific megastructure

## Reference render

![enormous clean-future docking facility reference render](enormous-clean-future-docking-facility.png)

## Intent

The **enormous clean-future docking facility** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **enormous clean-future docking facility** as a useful,
...
Use COBALT-500 as the dominant signal token and CYAN-400 only
...
- **Parent assembly:** [Dockyard assembly](./_assembly.md).

- **POI sibling component:** [docking platforms](./docking-platforms.md).
