...
---
asset_id: "asset.olympus.dockyard.cargo-handling"
source_label: "cargo handling"
...
- **Asset ID:** asset.olympus.dockyard.cargo-handling
- **Type:** POI hero component
- **Source:** prop-list.md:1310
- **Family:** Hero / Olympus
...
![cargo handling reference render](cargo-handling.png)

## Intent

The **cargo handling** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **cargo handling** as a useful,
