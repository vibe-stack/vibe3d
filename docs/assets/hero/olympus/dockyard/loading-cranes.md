...
---
asset_id: "asset.olympus.dockyard.loading-cranes"
source_label: "loading cranes"
...
- **Asset ID:** asset.olympus.dockyard.loading-cranes
- **Type:** POI hero component
- **Source:** prop-list.md:1309
- **Family:** Hero / Olympus
...
![loading cranes reference render](loading-cranes.png)

## Intent

The **loading cranes** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **loading cranes** as a useful,
...
- **POI sibling component:** [enormous clean-future docking facility](./enormous-clean-future-docking-facility.md).
