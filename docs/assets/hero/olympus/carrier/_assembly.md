...
---
assembly_id: "assembly.olympus.carrier"
...
# Carrier — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.carrier
...
Carrier is a landmark, not a pile of unrelated props. The full assembly
...
- [giant floating/grounded carrier vessel](./giant-floating-grounded-carrier-vessel.md) — component brief.
- [carrier deck](./carrier-deck.md) — component brief.
- [interior compartments](./interior-compartments.md) — component brief.
- [aircraft/cargo deck details](./aircraft-cargo-deck-details.md) — component brief.
