...
---
asset_id: "asset.olympus.carrier.aircraft-cargo-deck-details"
source_label: "aircraft/cargo deck details"
...
# aircraft/cargo deck details

## Identity

- **Asset ID:** asset.olympus.carrier.aircraft-cargo-deck-details
- **Type:** POI hero component
- **Source:** prop-list.md:1230
- **Family:** Hero / Olympus
...
![aircraft/cargo deck details reference render](aircraft-cargo-deck-details.png)

## Intent

The **aircraft/cargo deck details** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **aircraft/cargo deck details** as a useful,
