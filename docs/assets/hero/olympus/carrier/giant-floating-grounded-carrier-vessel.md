...
---
asset_id: "asset.olympus.carrier.giant-floating-grounded-carrier-vessel"
source_label: "giant floating/grounded carrier vessel"
...
# giant floating/grounded carrier vessel

## Identity

- **Asset ID:** asset.olympus.carrier.giant-floating-grounded-carrier-vessel
- **Type:** POI hero component
- **Source:** prop-list.md:1227
- **Family:** Hero / Olympus
...
![giant floating/grounded carrier vessel reference render](giant-floating-grounded-carrier-vessel.png)

## Intent

The **giant floating/grounded carrier vessel** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **giant floating/grounded carrier vessel** as a useful,
...
- **POI sibling component:** [carrier deck](./carrier-deck.md).
