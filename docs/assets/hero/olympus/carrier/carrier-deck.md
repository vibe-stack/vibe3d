...
---
asset_id: "asset.olympus.carrier.carrier-deck"
source_label: "carrier deck"
...
- **Asset ID:** asset.olympus.carrier.carrier-deck
- **Type:** POI hero component
- **Source:** prop-list.md:1228
- **Family:** Hero / Olympus
...
![carrier deck reference render](carrier-deck.png)

## Intent

The **carrier deck** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **carrier deck** as a useful,
