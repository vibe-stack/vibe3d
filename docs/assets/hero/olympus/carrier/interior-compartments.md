...
---
asset_id: "asset.olympus.carrier.interior-compartments"
source_label: "interior compartments"
...
- **Asset ID:** asset.olympus.carrier.interior-compartments
- **Type:** POI hero component
- **Source:** prop-list.md:1229
- **Family:** Hero / Olympus
...
![interior compartments reference render](interior-compartments.png)

## Intent

The **interior compartments** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **interior compartments** as a useful,
...
- **Parent assembly:** [Carrier assembly](./_assembly.md).

- **base supply-bin state:** [standard Supply Bin](../../../reusable/universal-gameplay/loot/standard-supply-bin.md).
- **POI sibling component:** [giant floating/grounded carrier vessel](./giant-floating-grounded-carrier-vessel.md).
