...
---
asset_id: "asset.olympus.hammond-labs.complete-research-complex"
source_label: "complete research complex"
source_section: "Hero / Olympus"
source_group: "Hammond Labs"
source_line: 1196
level: L3
status: planned
...
# complete research complex

## Identity

- **Asset ID:** asset.olympus.hammond-labs.complete-research-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1196
- **Family:** Hero / Olympus
...
![complete research complex reference render](complete-research-complex.png)

## Intent

The **complete research complex** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **complete research complex** as a useful,
...
- **Parent assembly:** [Hammond Labs assembly](./_assembly.md).

- **POI sibling component:** [central atrium](./central-atrium.md).
