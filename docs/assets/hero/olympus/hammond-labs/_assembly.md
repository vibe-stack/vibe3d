...
---
assembly_id: "assembly.olympus.hammond-labs"
source_label: "Hammond Labs"
...
# Hammond Labs — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.hammond-labs
...
Hammond Labs is a landmark, not a pile of unrelated props. The full assembly
...
- [complete research complex](./complete-research-complex.md) — component brief.
- [central atrium](./central-atrium.md) — component brief.
- [scientific machinery](./scientific-machinery.md) — component brief.
- [Hammond labs interiors](./hammond-labs-interiors.md) — component brief.
