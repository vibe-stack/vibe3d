...
---
asset_id: "asset.olympus.hammond-labs.central-atrium"
source_label: "central atrium"
...
- **Asset ID:** asset.olympus.hammond-labs.central-atrium
- **Type:** POI hero component
- **Source:** prop-list.md:1197
- **Family:** Hero / Olympus
...
![central atrium reference render](central-atrium.png)

## Intent

The **central atrium** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **central atrium** as a useful,
