...
---
asset_id: "asset.olympus.hammond-labs.scientific-machinery"
source_label: "scientific machinery"
...
- **Asset ID:** asset.olympus.hammond-labs.scientific-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1198
- **Family:** Hero / Olympus
...
![scientific machinery reference render](scientific-machinery.png)

## Intent

The **scientific machinery** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **scientific machinery** as a useful,
...
- **POI sibling component:** [complete research complex](./complete-research-complex.md).
