...
---
asset_id: "asset.olympus.hammond-labs.hammond-labs-interiors"
source_label: "Hammond labs interiors"
...
# Hammond labs interiors

## Identity

- **Asset ID:** asset.olympus.hammond-labs.hammond-labs-interiors
- **Type:** POI hero component
- **Source:** prop-list.md:1199
- **Family:** Hero / Olympus
...
![Hammond labs interiors reference render](hammond-labs-interiors.png)

## Intent

The **Hammond labs interiors** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **Hammond labs interiors** as a useful,
