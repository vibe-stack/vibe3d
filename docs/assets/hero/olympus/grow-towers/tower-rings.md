...
---
asset_id: "asset.olympus.grow-towers.tower-rings"
source_label: "tower rings"
...
- **Asset ID:** asset.olympus.grow-towers.tower-rings
- **Type:** POI hero component
- **Source:** prop-list.md:1235
- **Family:** Hero / Olympus
...
![tower rings reference render](tower-rings.png)

## Intent

The **tower rings** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **tower rings** as a useful,
