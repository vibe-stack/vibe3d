...
---
assembly_id: "assembly.olympus.grow-towers"
source_label: "Grow Towers"
...
# Grow Towers — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.grow-towers
...
Grow Towers is a landmark, not a pile of unrelated props. The full assembly
...
- [huge rotating agricultural towers](./huge-rotating-agricultural-towers.md) — component brief.
- [tower rings](./tower-rings.md) — component brief.
- [hydroponic plant systems](./hydroponic-plant-systems.md) — component brief.
- [rotating platforms](./rotating-platforms.md) — component brief.
