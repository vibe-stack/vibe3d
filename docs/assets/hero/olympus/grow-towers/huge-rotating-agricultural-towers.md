...
---
asset_id: "asset.olympus.grow-towers.huge-rotating-agricultural-towers"
source_label: "huge rotating agricultural towers"
source_section: "Hero / Olympus"
source_group: "Grow Towers"
source_line: 1234
level: L3
status: planned
...
# huge rotating agricultural towers

## Identity

- **Asset ID:** asset.olympus.grow-towers.huge-rotating-agricultural-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1234
- **Family:** Hero / Olympus
...
![huge rotating agricultural towers reference render](huge-rotating-agricultural-towers.png)

## Intent

The **huge rotating agricultural towers** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **huge rotating agricultural towers** as a useful,
...
- **Parent assembly:** [Grow Towers assembly](./_assembly.md).

- **POI sibling component:** [tower rings](./tower-rings.md).
