...
---
asset_id: "asset.olympus.grow-towers.rotating-platforms"
source_label: "rotating platforms"
...
- **Asset ID:** asset.olympus.grow-towers.rotating-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1237
- **Family:** Hero / Olympus
...
![rotating platforms reference render](rotating-platforms.png)

## Intent

The **rotating platforms** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **rotating platforms** as a useful,
