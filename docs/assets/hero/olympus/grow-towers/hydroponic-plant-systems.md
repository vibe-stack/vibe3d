...
---
asset_id: "asset.olympus.grow-towers.hydroponic-plant-systems"
source_label: "hydroponic plant systems"
...
- **Asset ID:** asset.olympus.grow-towers.hydroponic-plant-systems
- **Type:** POI hero component
- **Source:** prop-list.md:1236
- **Family:** Hero / Olympus
...
![hydroponic plant systems reference render](hydroponic-plant-systems.png)

## Intent

The **hydroponic plant systems** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **hydroponic plant systems** as a useful,
...
- **POI sibling component:** [huge rotating agricultural towers](./huge-rotating-agricultural-towers.md).
