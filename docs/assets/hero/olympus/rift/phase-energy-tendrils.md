...
---
asset_id: "asset.olympus.rift.phase-energy-tendrils"
source_label: "phase-energy tendrils"
...
# phase-energy tendrils

## Identity

- **Asset ID:** asset.olympus.rift.phase-energy-tendrils
- **Type:** POI hero component
- **Source:** prop-list.md:1177
- **Family:** Hero / Olympus
...
![phase-energy tendrils reference render](phase-energy-tendrils.png)

## Intent

The **phase-energy tendrils** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **phase-energy tendrils** as a useful,
...
- **POI sibling component:** [giant Phase Rift sphere](./giant-phase-rift-sphere.md).
