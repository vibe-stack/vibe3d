...
---
assembly_id: "assembly.olympus.rift"
source_label: "Rift"
...
- **Assembly ID:** assembly.olympus.rift
...
Rift is a landmark, not a pile of unrelated props. The full assembly
...
- [giant Phase Rift sphere](./giant-phase-rift-sphere.md) — component brief.
- [phase-energy tendrils](./phase-energy-tendrils.md) — component brief.
- [Rift containment structures](./rift-containment-structures.md) — component brief.
