...
---
asset_id: "asset.olympus.rift.giant-phase-rift-sphere"
source_label: "giant Phase Rift sphere"
...
# giant Phase Rift sphere

## Identity

- **Asset ID:** asset.olympus.rift.giant-phase-rift-sphere
- **Type:** POI hero component
- **Source:** prop-list.md:1176
- **Family:** Hero / Olympus
...
![giant Phase Rift sphere reference render](giant-phase-rift-sphere.png)

## Intent

The **giant Phase Rift sphere** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **giant Phase Rift sphere** as a useful,
...
- **Parent assembly:** [Rift assembly](./_assembly.md).

- **POI sibling component:** [phase-energy tendrils](./phase-energy-tendrils.md).
