...
---
asset_id: "asset.olympus.rift.rift-containment-structures"
source_label: "Rift containment structures"
...
# Rift containment structures

## Identity

- **Asset ID:** asset.olympus.rift.rift-containment-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1178
- **Family:** Hero / Olympus
...
![Rift containment structures reference render](rift-containment-structures.png)

## Intent

The **Rift containment structures** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **Rift containment structures** as a useful,
