...
---
asset_id: "asset.olympus.bonsai-plaza.luxury-interiors"
source_label: "luxury interiors"
...
- **Asset ID:** asset.olympus.bonsai-plaza.luxury-interiors
- **Type:** POI hero component
- **Source:** prop-list.md:1207
- **Family:** Hero / Olympus
...
![luxury interiors reference render](luxury-interiors.png)

## Intent

The **luxury interiors** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **luxury interiors** as a useful,
