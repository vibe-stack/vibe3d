...
---
asset_id: "asset.olympus.bonsai-plaza.twin-luxury-skyscrapers"
source_label: "twin luxury skyscrapers"
...
# twin luxury skyscrapers

## Identity

- **Asset ID:** asset.olympus.bonsai-plaza.twin-luxury-skyscrapers
- **Type:** POI hero component
- **Source:** prop-list.md:1203
- **Family:** Hero / Olympus
...
![twin luxury skyscrapers reference render](twin-luxury-skyscrapers.png)

## Intent

The **twin luxury skyscrapers** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **twin luxury skyscrapers** as a useful,
...
- **POI sibling component:** [elevated plaza](./elevated-plaza.md).
