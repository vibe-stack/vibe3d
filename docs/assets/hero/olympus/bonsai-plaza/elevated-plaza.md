...
---
asset_id: "asset.olympus.bonsai-plaza.elevated-plaza"
source_label: "elevated plaza"
...
- **Asset ID:** asset.olympus.bonsai-plaza.elevated-plaza
- **Type:** POI hero component
- **Source:** prop-list.md:1204
- **Family:** Hero / Olympus
...
![elevated plaza reference render](elevated-plaza.png)

## Intent

The **elevated plaza** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **elevated plaza** as a useful,
