...
---
asset_id: "asset.olympus.bonsai-plaza.connecting-bridge"
source_label: "connecting bridge"
...
- **Asset ID:** asset.olympus.bonsai-plaza.connecting-bridge
- **Type:** POI hero component
- **Source:** prop-list.md:1206
- **Family:** Hero / Olympus
...
![connecting bridge reference render](connecting-bridge.png)

## Intent

The **connecting bridge** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **connecting bridge** as a useful,
