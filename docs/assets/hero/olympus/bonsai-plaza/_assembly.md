...
---
assembly_id: "assembly.olympus.bonsai-plaza"
source_label: "Bonsai Plaza"
...
# Bonsai Plaza — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.bonsai-plaza
...
Bonsai Plaza is a landmark, not a pile of unrelated props. The full assembly
...
- [twin luxury skyscrapers](./twin-luxury-skyscrapers.md) — component brief.
- [elevated plaza](./elevated-plaza.md) — component brief.
- [huge decorative bonsai/landscaping](./huge-decorative-bonsai-landscaping.md) — component brief.
- [connecting bridge](./connecting-bridge.md) — component brief.
- [luxury interiors](./luxury-interiors.md) — component brief.
