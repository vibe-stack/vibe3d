...
---
asset_id: "asset.olympus.bonsai-plaza.huge-decorative-bonsai-landscaping"
source_label: "huge decorative bonsai/landscaping"
source_section: "Hero / Olympus"
source_group: "Bonsai Plaza"
source_line: 1205
level: L3
status: planned
...
# huge decorative bonsai/landscaping

## Identity

- **Asset ID:** asset.olympus.bonsai-plaza.huge-decorative-bonsai-landscaping
- **Type:** POI hero component
- **Source:** prop-list.md:1205
- **Family:** Hero / Olympus
...
![huge decorative bonsai/landscaping reference render](huge-decorative-bonsai-landscaping.png)

## Intent

The **huge decorative bonsai/landscaping** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **huge decorative bonsai/landscaping** as a useful,
...
- **Parent assembly:** [Bonsai Plaza assembly](./_assembly.md).

- **POI sibling component:** [twin luxury skyscrapers](./twin-luxury-skyscrapers.md).
