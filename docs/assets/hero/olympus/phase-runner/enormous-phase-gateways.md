...
---
asset_id: "asset.olympus.phase-runner.enormous-phase-gateways"
source_label: "enormous phase gateways"
...
# enormous phase gateways

## Identity

- **Asset ID:** asset.olympus.phase-runner.enormous-phase-gateways
- **Type:** POI hero component
- **Source:** prop-list.md:1182
- **Family:** Hero / Olympus
...
![enormous phase gateways reference render](enormous-phase-gateways.png)

## Intent

The **enormous phase gateways** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **enormous phase gateways** as a useful,
...
- **POI sibling component:** [gateway rings](./gateway-rings.md).
