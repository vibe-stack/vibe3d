...
---
asset_id: "asset.olympus.phase-runner.gateway-rings"
source_label: "gateway rings"
...
- **Asset ID:** asset.olympus.phase-runner.gateway-rings
- **Type:** POI hero component
- **Source:** prop-list.md:1183
- **Family:** Hero / Olympus
...
![gateway rings reference render](gateway-rings.png)

## Intent

The **gateway rings** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **gateway rings** as a useful,
