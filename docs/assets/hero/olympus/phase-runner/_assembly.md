...
---
assembly_id: "assembly.olympus.phase-runner"
source_label: "Phase Runner"
...
# Phase Runner — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.phase-runner
...
Phase Runner is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous phase gateways](./enormous-phase-gateways.md) — component brief.
- [gateway rings](./gateway-rings.md) — component brief.
- [Phase Runner tunnel/energy tube](./phase-runner-tunnel-energy-tube.md) — component brief.
- [raised transit platforms](./raised-transit-platforms.md) — component brief.
