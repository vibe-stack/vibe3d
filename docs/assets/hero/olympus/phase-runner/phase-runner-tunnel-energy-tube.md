...
---
asset_id: "asset.olympus.phase-runner.phase-runner-tunnel-energy-tube"
source_label: "Phase Runner tunnel/energy tube"
source_section: "Hero / Olympus"
source_group: "Phase Runner"
source_line: 1184
level: L3
status: planned
...
# Phase Runner tunnel/energy tube

## Identity

- **Asset ID:** asset.olympus.phase-runner.phase-runner-tunnel-energy-tube
- **Type:** POI hero component
- **Source:** prop-list.md:1184
- **Family:** Hero / Olympus
...
![Phase Runner tunnel/energy tube reference render](phase-runner-tunnel-energy-tube.png)

## Intent

The **Phase Runner tunnel/energy tube** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **Phase Runner tunnel/energy tube** as a useful,
...
- **Parent assembly:** [Phase Runner assembly](./_assembly.md).

- **POI sibling component:** [enormous phase gateways](./enormous-phase-gateways.md).
