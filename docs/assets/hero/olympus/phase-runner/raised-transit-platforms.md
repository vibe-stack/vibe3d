...
---
asset_id: "asset.olympus.phase-runner.raised-transit-platforms"
source_label: "raised transit platforms"
...
# raised transit platforms

## Identity

- **Asset ID:** asset.olympus.phase-runner.raised-transit-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1185
- **Family:** Hero / Olympus
...
![raised transit platforms reference render](raised-transit-platforms.png)

## Intent

The **raised transit platforms** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **raised transit platforms** as a useful,
