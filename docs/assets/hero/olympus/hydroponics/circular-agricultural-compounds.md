...
---
asset_id: "asset.olympus.hydroponics.circular-agricultural-compounds"
source_label: "circular agricultural compounds"
source_section: "Hero / Olympus"
source_group: "Hydroponics"
source_line: 1247
level: L3
status: planned
...
# circular agricultural compounds

## Identity

- **Asset ID:** asset.olympus.hydroponics.circular-agricultural-compounds
- **Type:** POI hero component
- **Source:** prop-list.md:1247
- **Family:** Hero / Olympus
...
![circular agricultural compounds reference render](circular-agricultural-compounds.png)

## Intent

The **circular agricultural compounds** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **circular agricultural compounds** as a useful,
...
- **Parent assembly:** [Hydroponics assembly](./_assembly.md).

- **POI sibling component:** [greenhouse interiors](./greenhouse-interiors.md).
