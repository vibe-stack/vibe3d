...
---
assembly_id: "assembly.olympus.hydroponics"
source_label: "Hydroponics"
...
# Hydroponics — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.hydroponics
...
Hydroponics is a landmark, not a pile of unrelated props. The full assembly
...
- [circular agricultural compounds](./circular-agricultural-compounds.md) — component brief.
- [greenhouse interiors](./greenhouse-interiors.md) — component brief.
- [planters](./planters.md) — component brief.
- [crop infrastructure](./crop-infrastructure.md) — component brief.
