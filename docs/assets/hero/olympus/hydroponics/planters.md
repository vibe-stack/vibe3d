...
---
asset_id: "asset.olympus.hydroponics.planters"
source_label: "planters"
...
- **Asset ID:** asset.olympus.hydroponics.planters
- **Type:** POI hero component
- **Source:** prop-list.md:1249
- **Family:** Hero / Olympus
...
![planters reference render](planters.png)

## Intent

The **planters** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **planters** as a useful,
