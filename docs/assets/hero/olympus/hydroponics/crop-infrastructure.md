...
---
asset_id: "asset.olympus.hydroponics.crop-infrastructure"
source_label: "crop infrastructure"
...
- **Asset ID:** asset.olympus.hydroponics.crop-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1250
- **Family:** Hero / Olympus
...
![crop infrastructure reference render](crop-infrastructure.png)

## Intent

The **crop infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **crop infrastructure** as a useful,
