...
---
asset_id: "asset.olympus.hydroponics.greenhouse-interiors"
source_label: "greenhouse interiors"
...
- **Asset ID:** asset.olympus.hydroponics.greenhouse-interiors
- **Type:** POI hero component
- **Source:** prop-list.md:1248
- **Family:** Hero / Olympus
...
![greenhouse interiors reference render](greenhouse-interiors.png)

## Intent

The **greenhouse interiors** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **greenhouse interiors** as a useful,
...
- **POI sibling component:** [circular agricultural compounds](./circular-agricultural-compounds.md).
