...
---
asset_id: "asset.olympus.elysium.tether-zipline-connections"
source_label: "tether/zipline connections"
source_section: "Hero / Olympus"
source_group: "Elysium"
source_line: 1223
level: L3
status: planned
...
# tether/zipline connections

## Identity

- **Asset ID:** asset.olympus.elysium.tether-zipline-connections
- **Type:** POI hero component
- **Source:** prop-list.md:1223
- **Family:** Hero / Olympus
...
![tether/zipline connections reference render](tether-zipline-connections.png)

## Intent

The **tether/zipline connections** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **tether/zipline connections** as a useful,
...
- **Parent assembly:** [Elysium assembly](./_assembly.md).

- **POI sibling component:** [complete floating circular platform](./complete-floating-circular-platform.md).
