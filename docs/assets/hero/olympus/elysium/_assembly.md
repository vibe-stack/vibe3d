...
---
assembly_id: "assembly.olympus.elysium"
source_label: "Elysium"
...
# Elysium — hero assembly

## Identity

- **Assembly ID:** assembly.olympus.elysium
...
Elysium is a landmark, not a pile of unrelated props. The full assembly
...
- [complete floating circular platform](./complete-floating-circular-platform.md) — component brief.
- [garden](./garden.md) — component brief.
- [central structure](./central-structure.md) — component brief.
- [outer ring](./outer-ring.md) — component brief.
- [tether/zipline connections](./tether-zipline-connections.md) — component brief.
