...
---
asset_id: "asset.olympus.elysium.complete-floating-circular-platform"
source_label: "complete floating circular platform"
...
# complete floating circular platform

## Identity

- **Asset ID:** asset.olympus.elysium.complete-floating-circular-platform
- **Type:** POI hero component
- **Source:** prop-list.md:1219
- **Family:** Hero / Olympus
...
![complete floating circular platform reference render](complete-floating-circular-platform.png)

## Intent

The **complete floating circular platform** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **complete floating circular platform** as a useful,
...
- **POI sibling component:** [garden](./garden.md).
