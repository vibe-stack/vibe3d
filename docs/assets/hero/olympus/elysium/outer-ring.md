...
---
asset_id: "asset.olympus.elysium.outer-ring"
source_label: "outer ring"
...
- **Asset ID:** asset.olympus.elysium.outer-ring
- **Type:** POI hero component
- **Source:** prop-list.md:1222
- **Family:** Hero / Olympus
...
![outer ring reference render](outer-ring.png)

## Intent

The **outer ring** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **outer ring** as a useful,
