...
---
asset_id: "asset.olympus.elysium.garden"
source_label: "garden"
...
- **Asset ID:** asset.olympus.elysium.garden
- **Type:** POI hero component
- **Source:** prop-list.md:1220
- **Family:** Hero / Olympus
...
![garden reference render](garden.png)

## Intent

The **garden** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **garden** as a useful,
