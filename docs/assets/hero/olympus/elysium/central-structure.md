...
---
asset_id: "asset.olympus.elysium.central-structure"
source_label: "central structure"
...
- **Asset ID:** asset.olympus.elysium.central-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1221
- **Family:** Hero / Olympus
...
![central structure reference render](central-structure.png)

## Intent

The **central structure** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **central structure** as a useful,
