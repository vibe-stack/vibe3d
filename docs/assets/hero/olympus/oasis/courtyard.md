...
---
asset_id: "asset.olympus.oasis.courtyard"
source_label: "courtyard"
...
- **Asset ID:** asset.olympus.oasis.courtyard
- **Type:** POI hero component
- **Source:** prop-list.md:1212
- **Family:** Hero / Olympus
...
![courtyard reference render](courtyard.png)

## Intent

The **courtyard** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **courtyard** as a useful,
