...
---
asset_id: "asset.olympus.oasis.twin-luxury-towers"
source_label: "twin luxury towers"
...
- **Asset ID:** asset.olympus.oasis.twin-luxury-towers
...
![twin luxury towers reference render](twin-luxury-towers.png)

## Intent

The **twin luxury towers** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **twin luxury towers** as a useful,
...
- **POI sibling component:** [courtyard](./courtyard.md).
