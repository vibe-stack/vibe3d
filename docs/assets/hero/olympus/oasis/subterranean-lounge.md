...
---
asset_id: "asset.olympus.oasis.subterranean-lounge"
source_label: "subterranean lounge"
...
- **Asset ID:** asset.olympus.oasis.subterranean-lounge
- **Type:** POI hero component
- **Source:** prop-list.md:1214
- **Family:** Hero / Olympus
...
![subterranean lounge reference render](subterranean-lounge.png)

## Intent

The **subterranean lounge** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **subterranean lounge** as a useful,
