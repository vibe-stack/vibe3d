...
---
assembly_id: "assembly.olympus.oasis"
source_label: "Oasis"
...
- **Assembly ID:** assembly.olympus.oasis
...
- **Source:** prop-list.md:1211

## Landmark promise

Oasis is a landmark, not a pile of unrelated props. The full assembly
...
- [twin luxury towers](./twin-luxury-towers.md) — component brief.
- [courtyard](./courtyard.md) — component brief.
- [pools/water features](./pools-water-features.md) — component brief.
- [subterranean lounge](./subterranean-lounge.md) — component brief.
- [glass elevator/vertical elements](./glass-elevator-vertical-elements.md) — component brief.
