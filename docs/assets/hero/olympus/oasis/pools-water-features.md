...
---
asset_id: "asset.olympus.oasis.pools-water-features"
source_label: "pools/water features"
...
- **Asset ID:** asset.olympus.oasis.pools-water-features
- **Type:** POI hero component
- **Source:** prop-list.md:1213
- **Family:** Hero / Olympus
...
![pools/water features reference render](pools-water-features.png)

## Intent

The **pools/water features** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **pools/water features** as a useful,
