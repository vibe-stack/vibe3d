...
---
asset_id: "asset.olympus.oasis.glass-elevator-vertical-elements"
source_label: "glass elevator/vertical elements"
...
# glass elevator/vertical elements

## Identity

- **Asset ID:** asset.olympus.oasis.glass-elevator-vertical-elements
- **Type:** POI hero component
- **Source:** prop-list.md:1215
- **Family:** Hero / Olympus
...
![glass elevator/vertical elements reference render](glass-elevator-vertical-elements.png)

## Intent

The **glass elevator/vertical elements** is a POI hero component for the Axiom Relay kit. It exists to support
precise civic megastructures with bright shells, glass, controlled greenery, and quiet power. Its primary read should be **glass elevator/vertical elements** as a useful,
...
- **Parent assembly:** [Oasis assembly](./_assembly.md).

- **POI sibling component:** [twin luxury towers](./twin-luxury-towers.md).
