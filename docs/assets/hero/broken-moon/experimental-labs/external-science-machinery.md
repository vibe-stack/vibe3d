...
---
asset_id: "asset.broken-moon.experimental-labs.external-science-machinery"
source_label: "external science machinery"
...
# external science machinery

## Identity

- **Asset ID:** asset.broken-moon.experimental-labs.external-science-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1618
...
![external science machinery reference render](external-science-machinery.png)

## Intent

The **external science machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **external science machinery** as a useful,
...
Expose intake, output, access, maintenance, and safety zones. Use brackets, pipe runs, or cable glands to connect it to the surrounding system. Keep the strongest value break on the
