...
---
asset_id: "asset.broken-moon.experimental-labs.experimental-science-buildings"
source_label: "experimental science buildings"
...
# experimental science buildings

## Identity

- **Asset ID:** asset.broken-moon.experimental-labs.experimental-science-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1616
...
![experimental science buildings reference render](experimental-science-buildings.png)

## Intent

The **experimental science buildings** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **experimental science buildings** as a useful,
...
- **POI sibling component:** [laboratory rooftops](./laboratory-rooftops.md).
