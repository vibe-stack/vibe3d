...
---
asset_id: "asset.broken-moon.experimental-labs.modular-lab-structures"
source_label: "modular lab structures"
source_section: "Hero / Broken Moon"
source_group: "Experimental Labs"
source_line: 1619
level: L3
status: planned
...
# modular lab structures

## Identity

- **Asset ID:** asset.broken-moon.experimental-labs.modular-lab-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1619
...
![modular lab structures reference render](modular-lab-structures.png)

## Intent

The **modular lab structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **modular lab structures** as a useful,
...
- **Parent assembly:** [Experimental Labs assembly](./_assembly.md).

- **POI sibling component:** [experimental science buildings](./experimental-science-buildings.md).
