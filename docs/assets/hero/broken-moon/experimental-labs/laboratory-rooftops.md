...
---
asset_id: "asset.broken-moon.experimental-labs.laboratory-rooftops"
source_label: "laboratory rooftops"
...
- **Asset ID:** asset.broken-moon.experimental-labs.laboratory-rooftops
- **Type:** POI hero component
- **Source:** prop-list.md:1617
...
![laboratory rooftops reference render](laboratory-rooftops.png)

## Intent

The **laboratory rooftops** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **laboratory rooftops** as a useful,
