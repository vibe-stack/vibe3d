...
---
assembly_id: "assembly.broken-moon.experimental-labs"
source_label: "Experimental Labs"
...
# Experimental Labs — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.experimental-labs
...
Experimental Labs is a landmark, not a pile of unrelated props. The full assembly
...
- [experimental science buildings](./experimental-science-buildings.md) — component brief.
- [laboratory rooftops](./laboratory-rooftops.md) — component brief.
- [external science machinery](./external-science-machinery.md) — component brief.
- [modular lab structures](./modular-lab-structures.md) — component brief.
