...
---
assembly_id: "assembly.broken-moon.solar-pods"
source_label: "Solar Pods"
...
# Solar Pods — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.solar-pods
...
Solar Pods is a landmark, not a pile of unrelated props. The full assembly
...
- [distinctive Lunar habitat pods](./distinctive-lunar-habitat-pods.md) — component brief.
- [solar infrastructure](./solar-infrastructure.md) — component brief.
- [connecting bridges](./connecting-bridges.md) — component brief.
