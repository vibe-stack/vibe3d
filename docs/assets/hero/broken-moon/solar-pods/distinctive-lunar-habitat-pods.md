...
---
asset_id: "asset.broken-moon.solar-pods.distinctive-lunar-habitat-pods"
source_label: "distinctive Lunar habitat pods"
source_section: "Hero / Broken Moon"
source_group: "Solar Pods"
source_line: 1603
level: L3
status: planned
...
# distinctive Lunar habitat pods

## Identity

- **Asset ID:** asset.broken-moon.solar-pods.distinctive-lunar-habitat-pods
- **Type:** POI hero component
- **Source:** prop-list.md:1603
...
![distinctive Lunar habitat pods reference render](distinctive-lunar-habitat-pods.png)

## Intent

The **distinctive Lunar habitat pods** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **distinctive Lunar habitat pods** as a useful,
...
- **Parent assembly:** [Solar Pods assembly](./_assembly.md).

- **POI sibling component:** [solar infrastructure](./solar-infrastructure.md).
