...
---
asset_id: "asset.broken-moon.solar-pods.solar-infrastructure"
source_label: "solar infrastructure"
...
- **Asset ID:** asset.broken-moon.solar-pods.solar-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1604
...
![solar infrastructure reference render](solar-infrastructure.png)

## Intent

The **solar infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **solar infrastructure** as a useful,
...
- **POI sibling component:** [distinctive Lunar habitat pods](./distinctive-lunar-habitat-pods.md).
