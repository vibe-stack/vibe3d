...
---
asset_id: "asset.broken-moon.solar-pods.connecting-bridges"
source_label: "connecting bridges"
...
- **Asset ID:** asset.broken-moon.solar-pods.connecting-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:1605
...
![connecting bridges reference render](connecting-bridges.png)

## Intent

The **connecting bridges** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **connecting bridges** as a useful,
