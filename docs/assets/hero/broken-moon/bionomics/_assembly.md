...
---
assembly_id: "assembly.broken-moon.bionomics"
source_label: "Bionomics"
...
# Bionomics — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.bionomics
...
Bionomics is a landmark, not a pile of unrelated props. The full assembly
...
- [giant agricultural/science complex](./giant-agricultural-science-complex.md) — component brief.
- [glass growing structures](./glass-growing-structures.md) — component brief.
- [biological lab](./biological-lab.md) — component brief.
- [plant-growth machinery](./plant-growth-machinery.md) — component brief.
