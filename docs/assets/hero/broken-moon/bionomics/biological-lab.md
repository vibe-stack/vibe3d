...
---
asset_id: "asset.broken-moon.bionomics.biological-lab"
source_label: "biological lab"
...
- **Asset ID:** asset.broken-moon.bionomics.biological-lab
- **Type:** POI hero component
- **Source:** prop-list.md:1537
...
![biological lab reference render](biological-lab.png)

## Intent

The **biological lab** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **biological lab** as a useful,
...
- **POI sibling component:** [giant agricultural/science complex](./giant-agricultural-science-complex.md).
