...
---
asset_id: "asset.broken-moon.bionomics.giant-agricultural-science-complex"
source_label: "giant agricultural/science complex"
source_section: "Hero / Broken Moon"
source_group: "Bionomics"
source_line: 1535
level: L3
status: planned
...
# giant agricultural/science complex

## Identity

- **Asset ID:** asset.broken-moon.bionomics.giant-agricultural-science-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1535
...
![giant agricultural/science complex reference render](giant-agricultural-science-complex.png)

## Intent

The **giant agricultural/science complex** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **giant agricultural/science complex** as a useful,
...
Treat this as a landmark component: one unmistakable macro form, a supporting service rhythm, and a focal state signal. It must be modular enough to assemble with the POI parent without losing its identity.
...
- **Parent assembly:** [Bionomics assembly](./_assembly.md).

- **POI sibling component:** [glass growing structures](./glass-growing-structures.md).
