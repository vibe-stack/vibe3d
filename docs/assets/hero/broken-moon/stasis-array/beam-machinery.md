...
---
asset_id: "asset.broken-moon.stasis-array.beam-machinery"
source_label: "beam machinery"
source_section: "Hero / Broken Moon"
source_group: "Stasis Array"
source_line: 1501
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.stasis-array.beam-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1501
...
![beam machinery reference render](beam-machinery.png)

## Intent

The **beam machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **beam machinery** as a useful,
...
- **Parent assembly:** [Stasis Array assembly](./_assembly.md).

- **POI sibling component:** [huge Stasis Array installation](./huge-stasis-array-installation.md).
