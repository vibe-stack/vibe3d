...
---
asset_id: "asset.broken-moon.stasis-array.energy-emitter"
source_label: "energy emitter"
...
- **Asset ID:** asset.broken-moon.stasis-array.energy-emitter
- **Type:** POI hero component
- **Source:** prop-list.md:1498
...
![energy emitter reference render](energy-emitter.png)

## Intent

The **energy emitter** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **energy emitter** as a useful,
