...
---
asset_id: "asset.broken-moon.stasis-array.huge-stasis-array-installation"
source_label: "huge Stasis Array installation"
...
# huge Stasis Array installation

## Identity

- **Asset ID:** asset.broken-moon.stasis-array.huge-stasis-array-installation
- **Type:** POI hero component
- **Source:** prop-list.md:1497
...
![huge Stasis Array installation reference render](huge-stasis-array-installation.png)

## Intent

The **huge Stasis Array installation** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge Stasis Array installation** as a useful,
...
- **POI sibling component:** [energy emitter](./energy-emitter.md).
