...
---
assembly_id: "assembly.broken-moon.stasis-array"
source_label: "Stasis Array"
...
# Stasis Array — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.stasis-array
...
Stasis Array is a landmark, not a pile of unrelated props. The full assembly
...
- [huge Stasis Array installation](./huge-stasis-array-installation.md) — component brief.
- [energy emitter](./energy-emitter.md) — component brief.
- [satellite/node structure](./satellite-node-structure.md) — component brief.
- [gigantic supports](./gigantic-supports.md) — component brief.
- [beam machinery](./beam-machinery.md) — component brief.
