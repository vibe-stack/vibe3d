...
---
asset_id: "asset.broken-moon.stasis-array.satellite-node-structure"
source_label: "satellite/node structure"
...
# satellite/node structure

## Identity

- **Asset ID:** asset.broken-moon.stasis-array.satellite-node-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1499
...
![satellite/node structure reference render](satellite-node-structure.png)

## Intent

The **satellite/node structure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **satellite/node structure** as a useful,
