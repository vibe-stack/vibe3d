...
---
asset_id: "asset.broken-moon.stasis-array.gigantic-supports"
source_label: "gigantic supports"
...
- **Asset ID:** asset.broken-moon.stasis-array.gigantic-supports
- **Type:** POI hero component
- **Source:** prop-list.md:1500
...
![gigantic supports reference render](gigantic-supports.png)

## Intent

The **gigantic supports** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **gigantic supports** as a useful,
