...
---
asset_id: "asset.broken-moon.terraformer.central-tower"
source_label: "central tower"
...
- **Asset ID:** asset.broken-moon.terraformer.central-tower
- **Type:** POI hero component
- **Source:** prop-list.md:1488
...
![central tower reference render](central-tower.png)

## Intent

The **central tower** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **central tower** as a useful,
