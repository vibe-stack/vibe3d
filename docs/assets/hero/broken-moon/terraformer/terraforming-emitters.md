...
---
asset_id: "asset.broken-moon.terraformer.terraforming-emitters"
source_label: "terraforming emitters"
...
- **Asset ID:** asset.broken-moon.terraformer.terraforming-emitters
- **Type:** POI hero component
- **Source:** prop-list.md:1491
...
![terraforming emitters reference render](terraforming-emitters.png)

## Intent

The **terraforming emitters** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **terraforming emitters** as a useful,
