...
---
asset_id: "asset.broken-moon.terraformer.service-structures"
source_label: "service structures"
...
- **Asset ID:** asset.broken-moon.terraformer.service-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1493
...
![service structures reference render](service-structures.png)

## Intent

The **service structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **service structures** as a useful,
