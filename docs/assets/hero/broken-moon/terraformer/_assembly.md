...
---
assembly_id: "assembly.broken-moon.terraformer"
source_label: "Terraformer"
...
# Terraformer — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.terraformer
...
Terraformer is a landmark, not a pile of unrelated props. The full assembly
...
- Use COBALT-500 as the dominant hero signal and
  VIOLET-500 only as a supporting state or traversal cue.
...
- [gigantic Terraformer](./gigantic-terraformer.md) — component brief.
- [central tower](./central-tower.md) — component brief.
- [radial arms](./radial-arms.md) — component brief.
- [rotating machinery](./rotating-machinery.md) — component brief.
- [terraforming emitters](./terraforming-emitters.md) — component brief.
- [giant foundation](./giant-foundation.md) — component brief.
- [service structures](./service-structures.md) — component brief.
