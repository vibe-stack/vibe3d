...
---
asset_id: "asset.broken-moon.terraformer.giant-foundation"
source_label: "giant foundation"
...
- **Asset ID:** asset.broken-moon.terraformer.giant-foundation
- **Type:** POI hero component
- **Source:** prop-list.md:1492
...
![giant foundation reference render](giant-foundation.png)

## Intent

The **giant foundation** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **giant foundation** as a useful,
