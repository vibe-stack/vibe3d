...
---
asset_id: "asset.broken-moon.terraformer.gigantic-terraformer"
source_label: "gigantic Terraformer"
...
# gigantic Terraformer

## Identity

- **Asset ID:** asset.broken-moon.terraformer.gigantic-terraformer
- **Type:** POI hero component
- **Source:** prop-list.md:1487
...
![gigantic Terraformer reference render](gigantic-terraformer.png)

## Intent

The **gigantic Terraformer** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **gigantic Terraformer** as a useful,
...
- **POI sibling component:** [central tower](./central-tower.md).
