...
---
asset_id: "asset.broken-moon.terraformer.rotating-machinery"
source_label: "rotating machinery"
source_section: "Hero / Broken Moon"
source_group: "Terraformer"
source_line: 1490
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.terraformer.rotating-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1490
...
![rotating machinery reference render](rotating-machinery.png)

## Intent

The **rotating machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **rotating machinery** as a useful,
...
- **Parent assembly:** [Terraformer assembly](./_assembly.md).

- **POI sibling component:** [gigantic Terraformer](./gigantic-terraformer.md).
