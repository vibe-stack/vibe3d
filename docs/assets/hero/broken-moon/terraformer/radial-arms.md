...
---
asset_id: "asset.broken-moon.terraformer.radial-arms"
source_label: "radial arms"
...
- **Asset ID:** asset.broken-moon.terraformer.radial-arms
- **Type:** POI hero component
- **Source:** prop-list.md:1489
...
![radial arms reference render](radial-arms.png)

## Intent

The **radial arms** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **radial arms** as a useful,
