...
---
asset_id: "asset.broken-moon.quarantine-zone.huge-quarantine-enclosure"
source_label: "huge quarantine enclosure"
...
# huge quarantine enclosure

## Identity

- **Asset ID:** asset.broken-moon.quarantine-zone.huge-quarantine-enclosure
- **Type:** POI hero component
- **Source:** prop-list.md:1579
...
![huge quarantine enclosure reference render](huge-quarantine-enclosure.png)

## Intent

The **huge quarantine enclosure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge quarantine enclosure** as a useful,
