...
---
asset_id: "asset.broken-moon.quarantine-zone.biological-contamination-props"
source_label: "biological contamination props"
source_section: "Hero / Broken Moon"
source_group: "Quarantine Zone"
source_line: 1582
level: L3
status: planned
...
# biological contamination props

## Identity

- **Asset ID:** asset.broken-moon.quarantine-zone.biological-contamination-props
- **Type:** POI hero component
- **Source:** prop-list.md:1582
...
![biological contamination props reference render](biological-contamination-props.png)

## Intent

The **biological contamination props** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **biological contamination props** as a useful,
...
- **Parent assembly:** [Quarantine Zone assembly](./_assembly.md).

- **POI sibling component:** [crashed Stasis Array node/debris](./crashed-stasis-array-node-debris.md).
