...
---
asset_id: "asset.broken-moon.quarantine-zone.meteor-crash-debris"
source_label: "meteor/crash debris"
...
- **Asset ID:** asset.broken-moon.quarantine-zone.meteor-crash-debris
- **Type:** POI hero component
- **Source:** prop-list.md:1581
...
![meteor/crash debris reference render](meteor-crash-debris.png)

## Intent

The **meteor/crash debris** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **meteor/crash debris** as a useful,
