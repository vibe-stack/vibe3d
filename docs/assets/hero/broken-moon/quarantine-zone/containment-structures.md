...
---
asset_id: "asset.broken-moon.quarantine-zone.containment-structures"
source_label: "containment structures"
...
- **Asset ID:** asset.broken-moon.quarantine-zone.containment-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1580
...
![containment structures reference render](containment-structures.png)

## Intent

The **containment structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **containment structures** as a useful,
