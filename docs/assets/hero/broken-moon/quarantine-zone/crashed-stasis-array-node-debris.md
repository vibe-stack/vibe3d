...
---
asset_id: "asset.broken-moon.quarantine-zone.crashed-stasis-array-node-debris"
source_label: "crashed Stasis Array node/debris"
...
# crashed Stasis Array node/debris

## Identity

- **Asset ID:** asset.broken-moon.quarantine-zone.crashed-stasis-array-node-debris
- **Type:** POI hero component
- **Source:** prop-list.md:1578
...
![crashed Stasis Array node/debris reference render](crashed-stasis-array-node-debris.png)

## Intent

The **crashed Stasis Array node/debris** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **crashed Stasis Array node/debris** as a useful,
...
- **POI sibling component:** [huge quarantine enclosure](./huge-quarantine-enclosure.md).
