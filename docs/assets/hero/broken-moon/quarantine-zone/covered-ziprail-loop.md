...
---
asset_id: "asset.broken-moon.quarantine-zone.covered-ziprail-loop"
source_label: "covered Ziprail loop"
...
# covered Ziprail loop

## Identity

- **Asset ID:** asset.broken-moon.quarantine-zone.covered-ziprail-loop
- **Type:** POI hero component
- **Source:** prop-list.md:1583
...
![covered Ziprail loop reference render](covered-ziprail-loop.png)

## Intent

The **covered Ziprail loop** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **covered Ziprail loop** as a useful,
