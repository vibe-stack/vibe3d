...
---
assembly_id: "assembly.broken-moon.quarantine-zone"
source_label: "Quarantine Zone"
...
# Quarantine Zone — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.quarantine-zone
- **Map family:** Hero / Broken Moon
- **Place identity:** Lunar colony, terraforming megatech, civic gardens, and meteor disaster
- **Owner / story role:** Axiom Lunar Colony / terraforming operations
- **Source:** prop-list.md:1578

## Landmark promise

Quarantine Zone is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate low-gravity habitats and monumental terraforming machines grounded by dust and fracture.
...
- [crashed Stasis Array node/debris](./crashed-stasis-array-node-debris.md) — component brief.
- [huge quarantine enclosure](./huge-quarantine-enclosure.md) — component brief.
- [containment structures](./containment-structures.md) — component brief.
- [meteor/crash debris](./meteor-crash-debris.md) — component brief.
- [biological contamination props](./biological-contamination-props.md) — component brief.
- [covered Ziprail loop](./covered-ziprail-loop.md) — component brief.
