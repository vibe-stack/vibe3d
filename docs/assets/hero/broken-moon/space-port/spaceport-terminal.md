...
---
asset_id: "asset.broken-moon.space-port.spaceport-terminal"
source_label: "spaceport terminal"
source_section: "Hero / Broken Moon"
source_group: "Space Port"
source_line: 1590
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.space-port.spaceport-terminal
- **Type:** POI hero component
- **Source:** prop-list.md:1590
...
![spaceport terminal reference render](spaceport-terminal.png)

## Intent

The **spaceport terminal** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **spaceport terminal** as a useful,
...
- **Parent assembly:** [Space Port assembly](./_assembly.md).

- **POI sibling component:** [landing pads](./landing-pads.md).
