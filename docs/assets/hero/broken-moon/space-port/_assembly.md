...
---
assembly_id: "assembly.broken-moon.space-port"
source_label: "Space Port"
...
# Space Port — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.space-port
...
Space Port is a landmark, not a pile of unrelated props. The full assembly
...
- [landing pads](./landing-pads.md) — component brief.
- [spaceport terminal](./spaceport-terminal.md) — component brief.
- [cargo equipment](./cargo-equipment.md) — component brief.
- [lunar shuttle infrastructure](./lunar-shuttle-infrastructure.md) — component brief.
- [launch machinery](./launch-machinery.md) — component brief.
