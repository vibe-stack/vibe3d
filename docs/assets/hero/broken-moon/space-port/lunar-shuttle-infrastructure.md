...
---
asset_id: "asset.broken-moon.space-port.lunar-shuttle-infrastructure"
source_label: "lunar shuttle infrastructure"
...
# lunar shuttle infrastructure

## Identity

- **Asset ID:** asset.broken-moon.space-port.lunar-shuttle-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1592
...
![lunar shuttle infrastructure reference render](lunar-shuttle-infrastructure.png)

## Intent

The **lunar shuttle infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **lunar shuttle infrastructure** as a useful,
