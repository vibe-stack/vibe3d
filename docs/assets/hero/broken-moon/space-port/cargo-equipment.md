...
---
asset_id: "asset.broken-moon.space-port.cargo-equipment"
source_label: "cargo equipment"
...
- **Asset ID:** asset.broken-moon.space-port.cargo-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1591
...
![cargo equipment reference render](cargo-equipment.png)

## Intent

The **cargo equipment** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **cargo equipment** as a useful,
