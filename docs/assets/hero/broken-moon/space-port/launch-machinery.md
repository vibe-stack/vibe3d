...
---
asset_id: "asset.broken-moon.space-port.launch-machinery"
source_label: "launch machinery"
...
- **Asset ID:** asset.broken-moon.space-port.launch-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1593
...
![launch machinery reference render](launch-machinery.png)

## Intent

The **launch machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **launch machinery** as a useful,
