...
---
asset_id: "asset.broken-moon.space-port.landing-pads"
...
- **Asset ID:** asset.broken-moon.space-port.landing-pads
- **Type:** POI hero component
- **Source:** prop-list.md:1589
...
- **POI sibling component:** [spaceport terminal](./spaceport-terminal.md).
