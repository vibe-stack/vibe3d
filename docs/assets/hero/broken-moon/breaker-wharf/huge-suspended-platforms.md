...
---
asset_id: "asset.broken-moon.breaker-wharf.huge-suspended-platforms"
source_label: "huge suspended platforms"
...
# huge suspended platforms

## Identity

- **Asset ID:** asset.broken-moon.breaker-wharf.huge-suspended-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1571
...
![huge suspended platforms reference render](huge-suspended-platforms.png)

## Intent

The **huge suspended platforms** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge suspended platforms** as a useful,
