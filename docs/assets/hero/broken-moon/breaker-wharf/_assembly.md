...
---
assembly_id: "assembly.broken-moon.breaker-wharf"
source_label: "Breaker Wharf"
...
# Breaker Wharf — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.breaker-wharf
...
Breaker Wharf is a landmark, not a pile of unrelated props. The full assembly
...
- [industrial wharf](./industrial-wharf.md) — component brief.
- [huge suspended platforms](./huge-suspended-platforms.md) — component brief.
- [cranes](./cranes.md) — component brief.
- [loading equipment](./loading-equipment.md) — component brief.
- [industrial buildings](./industrial-buildings.md) — component brief.
