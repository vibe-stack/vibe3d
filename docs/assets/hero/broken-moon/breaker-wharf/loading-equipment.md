...
---
asset_id: "asset.broken-moon.breaker-wharf.loading-equipment"
source_label: "loading equipment"
...
- **Asset ID:** asset.broken-moon.breaker-wharf.loading-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1573
...
![loading equipment reference render](loading-equipment.png)

## Intent

The **loading equipment** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **loading equipment** as a useful,
