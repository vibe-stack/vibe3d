...
---
asset_id: "asset.broken-moon.underpass.vertical-traversal-structures"
source_label: "vertical traversal structures"
...
- **Asset ID:** asset.broken-moon.underpass.vertical-traversal-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1612
...
![vertical traversal structures reference render](vertical-traversal-structures.png)

## Intent

The **vertical traversal structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **vertical traversal structures** as a useful,
