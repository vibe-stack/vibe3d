...
---
asset_id: "asset.broken-moon.underpass.industrial-underpass"
source_label: "industrial underpass"
source_section: "Hero / Broken Moon"
source_group: "Underpass"
source_line: 1610
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.underpass.industrial-underpass
- **Type:** POI hero component
- **Source:** prop-list.md:1610
...
![industrial underpass reference render](industrial-underpass.png)

## Intent

The **industrial underpass** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **industrial underpass** as a useful,
...
- **Parent assembly:** [Underpass assembly](./_assembly.md).

- **POI sibling component:** [giant raised roadway/platform system](./giant-raised-roadway-platform-system.md).
