...
---
assembly_id: "assembly.broken-moon.underpass"
source_label: "Underpass"
...
# Underpass — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.underpass
...
Underpass is a landmark, not a pile of unrelated props. The full assembly
...
- [giant raised roadway/platform system](./giant-raised-roadway-platform-system.md) — component brief.
- [industrial underpass](./industrial-underpass.md) — component brief.
- [landing pads](./landing-pads.md) — component brief.
- [vertical traversal structures](./vertical-traversal-structures.md) — component brief.
