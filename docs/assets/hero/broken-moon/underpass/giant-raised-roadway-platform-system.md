...
---
asset_id: "asset.broken-moon.underpass.giant-raised-roadway-platform-system"
source_label: "giant raised roadway/platform system"
...
# giant raised roadway/platform system

## Identity

- **Asset ID:** asset.broken-moon.underpass.giant-raised-roadway-platform-system
- **Type:** POI hero component
- **Source:** prop-list.md:1609
...
![giant raised roadway/platform system reference render](giant-raised-roadway-platform-system.png)

## Intent

The **giant raised roadway/platform system** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **giant raised roadway/platform system** as a useful,
...
- **POI sibling component:** [industrial underpass](./industrial-underpass.md).
