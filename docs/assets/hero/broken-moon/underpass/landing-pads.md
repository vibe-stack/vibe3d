...
---
asset_id: "asset.broken-moon.underpass.landing-pads"
source_label: "landing pads"
...
- **Asset ID:** asset.broken-moon.underpass.landing-pads
- **Type:** POI hero component
- **Source:** prop-list.md:1611
...
![landing pads reference render](landing-pads.png)

## Intent

The **landing pads** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **landing pads** as a useful,
