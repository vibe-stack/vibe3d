...
---
assembly_id: "assembly.broken-moon.cliff-side"
source_label: "Cliff Side"
...
# Cliff Side — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.cliff-side
...
Cliff Side is a landmark, not a pile of unrelated props. The full assembly
...
- [huge cliffside cranes](./huge-cliffside-cranes.md) — component brief.
- [cliff platforms](./cliff-platforms.md) — component brief.
- [construction/repair structures](./construction-repair-structures.md) — component brief.
