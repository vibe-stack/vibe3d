...
---
asset_id: "asset.broken-moon.cliff-side.cliff-platforms"
source_label: "cliff platforms"
...
- **Asset ID:** asset.broken-moon.cliff-side.cliff-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1598
...
![cliff platforms reference render](cliff-platforms.png)

## Intent

The **cliff platforms** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **cliff platforms** as a useful,
