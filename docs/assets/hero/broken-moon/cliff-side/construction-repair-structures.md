...
---
asset_id: "asset.broken-moon.cliff-side.construction-repair-structures"
source_label: "construction/repair structures"
...
# construction/repair structures

## Identity

- **Asset ID:** asset.broken-moon.cliff-side.construction-repair-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1599
...
![construction/repair structures reference render](construction-repair-structures.png)

## Intent

The **construction/repair structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **construction/repair structures** as a useful,
...
- **POI sibling component:** [huge cliffside cranes](./huge-cliffside-cranes.md).
