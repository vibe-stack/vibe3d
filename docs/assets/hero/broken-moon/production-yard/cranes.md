...
---
asset_id: "asset.broken-moon.production-yard.cranes"
source_label: "cranes"
...
- **Asset ID:** asset.broken-moon.production-yard.cranes
- **Type:** POI hero component
- **Source:** prop-list.md:1521
...
![cranes reference render](cranes.png)

## Intent

The **cranes** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **cranes** as a useful,
