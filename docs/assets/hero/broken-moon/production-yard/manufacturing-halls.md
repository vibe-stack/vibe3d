...
---
asset_id: "asset.broken-moon.production-yard.manufacturing-halls"
source_label: "manufacturing halls"
...
- **Asset ID:** asset.broken-moon.production-yard.manufacturing-halls
- **Type:** POI hero component
- **Source:** prop-list.md:1522
...
![manufacturing halls reference render](manufacturing-halls.png)

## Intent

The **manufacturing halls** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **manufacturing halls** as a useful,
