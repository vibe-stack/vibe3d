...
---
asset_id: "asset.broken-moon.production-yard.loading-platforms"
source_label: "loading platforms"
...
- **Asset ID:** asset.broken-moon.production-yard.loading-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1523
...
![loading platforms reference render](loading-platforms.png)

## Intent

The **loading platforms** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **loading platforms** as a useful,
