...
---
asset_id: "asset.broken-moon.production-yard.production-machinery"
source_label: "production machinery"
...
- **Asset ID:** asset.broken-moon.production-yard.production-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1524
...
![production machinery reference render](production-machinery.png)

## Intent

The **production machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **production machinery** as a useful,
...
- **POI sibling component:** [huge industrial production facility](./huge-industrial-production-facility.md).
