...
---
asset_id: "asset.broken-moon.production-yard.huge-industrial-production-facility"
source_label: "huge industrial production facility"
source_section: "Hero / Broken Moon"
source_group: "Production Yard"
source_line: 1520
level: L3
status: planned
place_family: "Lunar colony, terraforming megatech, civic gardens, and meteor disaster"
owner: "Axiom Lunar Colony / terraforming operations"
---

# huge industrial production facility

## Identity

- **Asset ID:** asset.broken-moon.production-yard.huge-industrial-production-facility
- **Type:** POI hero component
- **Source:** prop-list.md:1520
- **Family:** Hero / Broken Moon
- **Place family:** Lunar colony, terraforming megatech, civic gardens, and meteor disaster
- **Owner / story role:** Axiom Lunar Colony / terraforming operations

## Reference render

![huge industrial production facility reference render](huge-industrial-production-facility.png)

## Intent

The **huge industrial production facility** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge industrial production facility** as a useful,
...
- **Blockout envelope:** Assembly-derived; dimension the component in whole-metre increments against its POI parent before modeling.
...
Build the primary run first, then add repeatable collars, brackets, flanges, and a service break at each change in direction. The run must communicate where it starts, terminates, and is supported.

The construction follows the shared **chassis → service → signal** order.
Service logic is the asset: include supports at regular spans, a coupling at each module boundary, and a believable connection to a larger utility run. Keep the strongest value break on the
...
Use COBALT-500 as the dominant signal token and VIOLET-500 only
...
- **blocking:** [small building shell](../../../reusable/architecture/building-prefab-assemblies/small-building-shell.md) — primary reusable shell.
- **blocking:** [floor slab tile](../../../reusable/architecture/modular-building-connectors/floor-slab-tile.md) — repeatable floor surface.
...
- **blocking:** [door bay](../../../reusable/architecture/modular-building-connectors/door-bay.md) — standard access opening.
- **optional:** [window bay](../../../reusable/architecture/modular-building-connectors/window-bay.md) — glazing/observation opening.
- **blocking:** [roof/floor edge module](../../../reusable/architecture/modular-building-connectors/roof-floor-edge-module.md) — roof and slab closure.
- **optional:** [utility enclosure](../../../reusable/architecture/building-prefab-assemblies/utility-enclosure.md) — service-building host.
...
- dominant signal: COBALT-500;
- supporting signal: VIOLET-500;
...
- **Parent assembly:** [Production Yard assembly](./_assembly.md).

- **adjacent utility module:** [duct straight](../../../reusable/industrial/duct-straight.md).
- **POI sibling component:** [cranes](./cranes.md).
