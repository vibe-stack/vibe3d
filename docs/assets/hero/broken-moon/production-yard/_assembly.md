...
---
assembly_id: "assembly.broken-moon.production-yard"
source_label: "Production Yard"
...
# Production Yard — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.production-yard
...
Production Yard is a landmark, not a pile of unrelated props. The full assembly
...
- [huge industrial production facility](./huge-industrial-production-facility.md) — component brief.
- [cranes](./cranes.md) — component brief.
- [manufacturing halls](./manufacturing-halls.md) — component brief.
- [loading platforms](./loading-platforms.md) — component brief.
- [production machinery](./production-machinery.md) — component brief.
