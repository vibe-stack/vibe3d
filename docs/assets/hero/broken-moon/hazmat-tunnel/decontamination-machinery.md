...
---
asset_id: "asset.broken-moon.hazmat-tunnel.decontamination-machinery"
source_label: "decontamination machinery"
source_section: "Hero / Broken Moon"
source_group: "Hazmat Tunnel"
source_line: 1625
level: L3
status: planned
...
# decontamination machinery

## Identity

- **Asset ID:** asset.broken-moon.hazmat-tunnel.decontamination-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1625
...
![decontamination machinery reference render](decontamination-machinery.png)

## Intent

The **decontamination machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **decontamination machinery** as a useful,
...
- **Parent assembly:** [Hazmat Tunnel assembly](./_assembly.md).

- **POI sibling component:** [huge sealed hazardous-material tunnel](./huge-sealed-hazardous-material-tunnel.md).
