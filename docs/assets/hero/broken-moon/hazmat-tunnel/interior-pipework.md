...
---
asset_id: "asset.broken-moon.hazmat-tunnel.interior-pipework"
source_label: "interior pipework"
...
- **Asset ID:** asset.broken-moon.hazmat-tunnel.interior-pipework
- **Type:** POI hero component
- **Source:** prop-list.md:1626
...
![interior pipework reference render](interior-pipework.png)

## Intent

The **interior pipework** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **interior pipework** as a useful,
