...
---
asset_id: "asset.broken-moon.hazmat-tunnel.blast-doors"
source_label: "blast doors"
...
- **Asset ID:** asset.broken-moon.hazmat-tunnel.blast-doors
- **Type:** POI hero component
- **Source:** prop-list.md:1624
...
![blast doors reference render](blast-doors.png)

## Intent

The **blast doors** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **blast doors** as a useful,
