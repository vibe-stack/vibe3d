...
---
assembly_id: "assembly.broken-moon.hazmat-tunnel"
source_label: "Hazmat Tunnel"
...
# Hazmat Tunnel — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.hazmat-tunnel
...
Hazmat Tunnel is a landmark, not a pile of unrelated props. The full assembly
...
- [huge sealed hazardous-material tunnel](./huge-sealed-hazardous-material-tunnel.md) — component brief.
- [blast doors](./blast-doors.md) — component brief.
- [decontamination machinery](./decontamination-machinery.md) — component brief.
- [interior pipework](./interior-pipework.md) — component brief.
