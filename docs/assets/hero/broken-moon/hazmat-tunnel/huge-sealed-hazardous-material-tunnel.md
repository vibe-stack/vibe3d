...
---
asset_id: "asset.broken-moon.hazmat-tunnel.huge-sealed-hazardous-material-tunnel"
source_label: "huge sealed hazardous-material tunnel"
...
# huge sealed hazardous-material tunnel

## Identity

- **Asset ID:** asset.broken-moon.hazmat-tunnel.huge-sealed-hazardous-material-tunnel
- **Type:** POI hero component
- **Source:** prop-list.md:1623
...
![huge sealed hazardous-material tunnel reference render](huge-sealed-hazardous-material-tunnel.png)

## Intent

The **huge sealed hazardous-material tunnel** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge sealed hazardous-material tunnel** as a useful,
...
- **POI sibling component:** [blast doors](./blast-doors.md).
