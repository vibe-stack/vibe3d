...
---
asset_id: "asset.broken-moon.the-core.enormous-energy-core"
source_label: "enormous energy Core"
...
# enormous energy Core

## Identity

- **Asset ID:** asset.broken-moon.the-core.enormous-energy-core
- **Type:** POI hero component
- **Source:** prop-list.md:1505
...
![enormous energy Core reference render](enormous-energy-core.png)

## Intent

The **enormous energy Core** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **enormous energy Core** as a useful,
...
- **POI sibling component:** [central reactor](./central-reactor.md).
