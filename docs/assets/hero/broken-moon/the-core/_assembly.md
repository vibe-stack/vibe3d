...
---
assembly_id: "assembly.broken-moon.the-core"
source_label: "The Core"
...
# The Core — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.the-core
...
The Core is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous energy Core](./enormous-energy-core.md) — component brief.
- [central reactor](./central-reactor.md) — component brief.
- [concentric machinery](./concentric-machinery.md) — component brief.
- [observation/service decks](./observation-service-decks.md) — component brief.
