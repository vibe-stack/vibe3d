...
---
asset_id: "asset.broken-moon.the-core.concentric-machinery"
source_label: "concentric machinery"
source_section: "Hero / Broken Moon"
source_group: "The Core"
source_line: 1507
level: L3
status: planned
...
# concentric machinery

## Identity

- **Asset ID:** asset.broken-moon.the-core.concentric-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1507
...
![concentric machinery reference render](concentric-machinery.png)

## Intent

The **concentric machinery** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **concentric machinery** as a useful,
...
- **Parent assembly:** [The Core assembly](./_assembly.md).

- **POI sibling component:** [enormous energy Core](./enormous-energy-core.md).
