...
---
asset_id: "asset.broken-moon.the-core.central-reactor"
source_label: "central reactor"
...
- **Asset ID:** asset.broken-moon.the-core.central-reactor
- **Type:** POI hero component
- **Source:** prop-list.md:1506
...
![central reactor reference render](central-reactor.png)

## Intent

The **central reactor** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **central reactor** as a useful,
