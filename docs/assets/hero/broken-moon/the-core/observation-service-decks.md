...
---
asset_id: "asset.broken-moon.the-core.observation-service-decks"
source_label: "observation/service decks"
...
# observation/service decks

## Identity

- **Asset ID:** asset.broken-moon.the-core.observation-service-decks
- **Type:** POI hero component
- **Source:** prop-list.md:1508
...
![observation/service decks reference render](observation-service-decks.png)

## Intent

The **observation/service decks** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **observation/service decks** as a useful,
