...
---
assembly_id: "assembly.broken-moon.atmostation"
source_label: "Atmostation"
...
# Atmostation — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.atmostation
...
Atmostation is a landmark, not a pile of unrelated props. The full assembly
...
- [huge atmospheric-processing station](./huge-atmospheric-processing-station.md) — component brief.
- [atmospheric towers](./atmospheric-towers.md) — component brief.
- [compressors](./compressors.md) — component brief.
- [pipes](./pipes.md) — component brief.
- [control structures](./control-structures.md) — component brief.
