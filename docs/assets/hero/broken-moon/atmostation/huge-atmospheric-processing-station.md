...
---
asset_id: "asset.broken-moon.atmostation.huge-atmospheric-processing-station"
source_label: "huge atmospheric-processing station"
...
# huge atmospheric-processing station

## Identity

- **Asset ID:** asset.broken-moon.atmostation.huge-atmospheric-processing-station
- **Type:** POI hero component
- **Source:** prop-list.md:1512
...
![huge atmospheric-processing station reference render](huge-atmospheric-processing-station.png)

## Intent

The **huge atmospheric-processing station** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge atmospheric-processing station** as a useful,
...
- **POI sibling component:** [atmospheric towers](./atmospheric-towers.md).
