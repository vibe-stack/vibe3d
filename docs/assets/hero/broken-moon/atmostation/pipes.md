...
---
asset_id: "asset.broken-moon.atmostation.pipes"
source_label: "pipes"
source_section: "Hero / Broken Moon"
source_group: "Atmostation"
source_line: 1515
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.atmostation.pipes
- **Type:** POI hero component
- **Source:** prop-list.md:1515
...
![pipes reference render](pipes.png)

## Intent

The **pipes** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **pipes** as a useful,
...
- **Parent assembly:** [Atmostation assembly](./_assembly.md).

- **adjacent utility module:** [duct straight](../../../reusable/industrial/duct-straight.md).
- **POI sibling component:** [huge atmospheric-processing station](./huge-atmospheric-processing-station.md).
