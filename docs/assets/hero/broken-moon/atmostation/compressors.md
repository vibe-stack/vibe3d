...
---
asset_id: "asset.broken-moon.atmostation.compressors"
source_label: "compressors"
...
- **Asset ID:** asset.broken-moon.atmostation.compressors
- **Type:** POI hero component
- **Source:** prop-list.md:1514
...
![compressors reference render](compressors.png)

## Intent

The **compressors** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **compressors** as a useful,
