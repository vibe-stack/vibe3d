...
---
asset_id: "asset.broken-moon.atmostation.atmospheric-towers"
source_label: "atmospheric towers"
...
- **Asset ID:** asset.broken-moon.atmostation.atmospheric-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1513
...
![atmospheric towers reference render](atmospheric-towers.png)

## Intent

The **atmospheric towers** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **atmospheric towers** as a useful,
