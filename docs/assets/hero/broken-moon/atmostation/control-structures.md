...
---
asset_id: "asset.broken-moon.atmostation.control-structures"
source_label: "control structures"
...
- **Asset ID:** asset.broken-moon.atmostation.control-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1516
...
![control structures reference render](control-structures.png)

## Intent

The **control structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **control structures** as a useful,
