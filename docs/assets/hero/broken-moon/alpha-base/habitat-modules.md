...
---
asset_id: "asset.broken-moon.alpha-base.habitat-modules"
source_label: "habitat modules"
source_section: "Hero / Broken Moon"
source_group: "Alpha Base"
source_line: 1565
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.alpha-base.habitat-modules
- **Type:** POI hero component
- **Source:** prop-list.md:1565
...
![habitat modules reference render](habitat-modules.png)

## Intent

The **habitat modules** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **habitat modules** as a useful,
...
- **Parent assembly:** [Alpha Base assembly](./_assembly.md).

- **POI sibling component:** [lunar colony base](./lunar-colony-base.md).
