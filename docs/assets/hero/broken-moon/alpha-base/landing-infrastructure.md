...
---
asset_id: "asset.broken-moon.alpha-base.landing-infrastructure"
source_label: "landing infrastructure"
...
- **Asset ID:** asset.broken-moon.alpha-base.landing-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1566
...
![landing infrastructure reference render](landing-infrastructure.png)

## Intent

The **landing infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **landing infrastructure** as a useful,
