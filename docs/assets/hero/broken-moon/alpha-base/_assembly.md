...
---
assembly_id: "assembly.broken-moon.alpha-base"
source_label: "Alpha Base"
...
# Alpha Base — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.alpha-base
...
Alpha Base is a landmark, not a pile of unrelated props. The full assembly
...
- [lunar colony base](./lunar-colony-base.md) — component brief.
- [domes](./domes.md) — component brief.
- [habitat modules](./habitat-modules.md) — component brief.
- [landing infrastructure](./landing-infrastructure.md) — component brief.
