...
---
asset_id: "asset.broken-moon.alpha-base.lunar-colony-base"
source_label: "lunar colony base"
...
- **Asset ID:** asset.broken-moon.alpha-base.lunar-colony-base
- **Type:** POI hero component
- **Source:** prop-list.md:1563
...
![lunar colony base reference render](lunar-colony-base.png)

## Intent

The **lunar colony base** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **lunar colony base** as a useful,
...
- **POI sibling component:** [domes](./domes.md).
