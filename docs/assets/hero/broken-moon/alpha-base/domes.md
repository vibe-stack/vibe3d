...
---
asset_id: "asset.broken-moon.alpha-base.domes"
source_label: "domes"
...
- **Asset ID:** asset.broken-moon.alpha-base.domes
- **Type:** POI hero component
- **Source:** prop-list.md:1564
...
![domes reference render](domes.png)

## Intent

The **domes** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **domes** as a useful,
