...
---
asset_id: "asset.broken-moon.eternal-gardens.ceremonial-central-structure"
source_label: "ceremonial central structure"
...
# ceremonial central structure

## Identity

- **Asset ID:** asset.broken-moon.eternal-gardens.ceremonial-central-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1550
...
![ceremonial central structure reference render](ceremonial-central-structure.png)

## Intent

The **ceremonial central structure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **ceremonial central structure** as a useful,
