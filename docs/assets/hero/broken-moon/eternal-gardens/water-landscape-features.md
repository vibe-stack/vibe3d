...
---
asset_id: "asset.broken-moon.eternal-gardens.water-landscape-features"
source_label: "water/landscape features"
...
- **Asset ID:** asset.broken-moon.eternal-gardens.water-landscape-features
- **Type:** POI hero component
- **Source:** prop-list.md:1551
...
![water/landscape features reference render](water-landscape-features.png)

## Intent

The **water/landscape features** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **water/landscape features** as a useful,
