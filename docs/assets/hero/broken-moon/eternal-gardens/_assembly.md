...
---
assembly_id: "assembly.broken-moon.eternal-gardens"
source_label: "Eternal Gardens"
...
# Eternal Gardens — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.eternal-gardens
...
- **Source:** prop-list.md:1549

## Landmark promise

Eternal Gardens is a landmark, not a pile of unrelated props. The full assembly
...
- Use LIME-400 as the dominant hero signal and
  FIELD-500 only as a supporting state or traversal cue.
...
- [gigantic formal garden](./gigantic-formal-garden.md) — component brief.
- [ceremonial central structure](./ceremonial-central-structure.md) — component brief.
- [water/landscape features](./water-landscape-features.md) — component brief.
- [sculptural trees](./sculptural-trees.md) — component brief.
- [memorial/civic architecture](./memorial-civic-architecture.md) — component brief.
