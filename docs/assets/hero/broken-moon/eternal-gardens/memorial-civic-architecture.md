...
---
asset_id: "asset.broken-moon.eternal-gardens.memorial-civic-architecture"
source_label: "memorial/civic architecture"
source_section: "Hero / Broken Moon"
source_group: "Eternal Gardens"
source_line: 1553
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.eternal-gardens.memorial-civic-architecture
- **Type:** POI hero component
- **Source:** prop-list.md:1553
...
![memorial/civic architecture reference render](memorial-civic-architecture.png)

## Intent

The **memorial/civic architecture** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **memorial/civic architecture** as a useful,
...
- **Parent assembly:** [Eternal Gardens assembly](./_assembly.md).

- **POI sibling component:** [gigantic formal garden](./gigantic-formal-garden.md).
