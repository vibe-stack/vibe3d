...
---
asset_id: "asset.broken-moon.eternal-gardens.gigantic-formal-garden"
source_label: "gigantic formal garden"
...
# gigantic formal garden

## Identity

- **Asset ID:** asset.broken-moon.eternal-gardens.gigantic-formal-garden
...
![gigantic formal garden reference render](gigantic-formal-garden.png)

## Intent

The **gigantic formal garden** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **gigantic formal garden** as a useful,
...
- **POI sibling component:** [ceremonial central structure](./ceremonial-central-structure.md).
