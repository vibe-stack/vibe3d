...
---
asset_id: "asset.broken-moon.eternal-gardens.sculptural-trees"
source_label: "sculptural trees"
...
- **Asset ID:** asset.broken-moon.eternal-gardens.sculptural-trees
- **Type:** POI hero component
- **Source:** prop-list.md:1552
...
![sculptural trees reference render](sculptural-trees.png)

## Intent

The **sculptural trees** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **sculptural trees** as a useful,
