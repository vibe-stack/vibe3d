...
---
asset_id: "asset.broken-moon.cultivation.crop-terraces"
source_label: "crop terraces"
...
- **Asset ID:** asset.broken-moon.cultivation.crop-terraces
- **Type:** POI hero component
- **Source:** prop-list.md:1543
...
![crop terraces reference render](crop-terraces.png)

## Intent

The **crop terraces** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **crop terraces** as a useful,
