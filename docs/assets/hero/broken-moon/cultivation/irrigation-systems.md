...
---
asset_id: "asset.broken-moon.cultivation.irrigation-systems"
source_label: "irrigation systems"
...
- **Asset ID:** asset.broken-moon.cultivation.irrigation-systems
- **Type:** POI hero component
- **Source:** prop-list.md:1545
...
![irrigation systems reference render](irrigation-systems.png)

## Intent

The **irrigation systems** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **irrigation systems** as a useful,
