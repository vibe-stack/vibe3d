...
---
assembly_id: "assembly.broken-moon.cultivation"
source_label: "Cultivation"
...
# Cultivation — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.cultivation
...
Cultivation is a landmark, not a pile of unrelated props. The full assembly
...
- [agricultural research buildings](./agricultural-research-buildings.md) — component brief.
- [crop terraces](./crop-terraces.md) — component brief.
- [greenhouse modules](./greenhouse-modules.md) — component brief.
- [irrigation systems](./irrigation-systems.md) — component brief.
