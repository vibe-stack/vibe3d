...
---
assembly_id: "assembly.broken-moon.the-divide"
source_label: "The Divide"
...
# The Divide — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.the-divide
...
The Divide is a landmark, not a pile of unrelated props. The full assembly
...
- [huge canyon divide](./huge-canyon-divide.md) — component brief.
- [bridge system](./bridge-system.md) — component brief.
- [suspended structures](./suspended-structures.md) — component brief.
