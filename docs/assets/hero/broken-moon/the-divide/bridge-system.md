...
---
asset_id: "asset.broken-moon.the-divide.bridge-system"
source_label: "bridge system"
...
- **Asset ID:** asset.broken-moon.the-divide.bridge-system
- **Type:** POI hero component
- **Source:** prop-list.md:1558
...
![bridge system reference render](bridge-system.png)

## Intent

The **bridge system** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **bridge system** as a useful,
