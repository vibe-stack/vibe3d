...
---
asset_id: "asset.broken-moon.the-divide.suspended-structures"
source_label: "suspended structures"
...
- **Asset ID:** asset.broken-moon.the-divide.suspended-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1559
...
![suspended structures reference render](suspended-structures.png)

## Intent

The **suspended structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **suspended structures** as a useful,
...
- **POI sibling component:** [huge canyon divide](./huge-canyon-divide.md).
