...
---
asset_id: "asset.broken-moon.the-divide.huge-canyon-divide"
source_label: "huge canyon divide"
source_section: "Hero / Broken Moon"
source_group: "The Divide"
source_line: 1557
level: L3
status: planned
...
- **Asset ID:** asset.broken-moon.the-divide.huge-canyon-divide
- **Type:** POI hero component
- **Source:** prop-list.md:1557
...
![huge canyon divide reference render](huge-canyon-divide.png)

## Intent

The **huge canyon divide** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge canyon divide** as a useful,
...
- **Parent assembly:** [The Divide assembly](./_assembly.md).

- **POI sibling component:** [bridge system](./bridge-system.md).
