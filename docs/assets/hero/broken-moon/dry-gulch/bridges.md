...
---
asset_id: "asset.broken-moon.dry-gulch.bridges"
source_label: "bridges"
...
- **Asset ID:** asset.broken-moon.dry-gulch.bridges
- **Type:** POI hero component
- **Source:** prop-list.md:1631
...
![bridges reference render](bridges.png)

## Intent

The **bridges** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **bridges** as a useful,
