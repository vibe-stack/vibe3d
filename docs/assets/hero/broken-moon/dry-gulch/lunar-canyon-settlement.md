...
---
asset_id: "asset.broken-moon.dry-gulch.lunar-canyon-settlement"
source_label: "lunar canyon settlement"
source_section: "Hero / Broken Moon"
source_group: "Dry Gulch"
source_line: 1630
level: L3
status: planned
...
# lunar canyon settlement

## Identity

- **Asset ID:** asset.broken-moon.dry-gulch.lunar-canyon-settlement
- **Type:** POI hero component
- **Source:** prop-list.md:1630
...
![lunar canyon settlement reference render](lunar-canyon-settlement.png)

## Intent

The **lunar canyon settlement** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **lunar canyon settlement** as a useful,
...
- **Parent assembly:** [Dry Gulch assembly](./_assembly.md).

- **POI sibling component:** [bridges](./bridges.md).
