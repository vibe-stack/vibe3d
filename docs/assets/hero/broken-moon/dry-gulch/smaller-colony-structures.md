...
---
asset_id: "asset.broken-moon.dry-gulch.smaller-colony-structures"
source_label: "smaller colony structures"
...
# smaller colony structures

## Identity

- **Asset ID:** asset.broken-moon.dry-gulch.smaller-colony-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1632
...
![smaller colony structures reference render](smaller-colony-structures.png)

## Intent

The **smaller colony structures** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **smaller colony structures** as a useful,
...
- **POI sibling component:** [lunar canyon settlement](./lunar-canyon-settlement.md).
