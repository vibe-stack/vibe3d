...
---
asset_id: "asset.broken-moon.foundry.giant-industrial-foundry"
source_label: "giant industrial foundry"
...
# giant industrial foundry

## Identity

- **Asset ID:** asset.broken-moon.foundry.giant-industrial-foundry
- **Type:** POI hero component
- **Source:** prop-list.md:1528
...
![giant industrial foundry reference render](giant-industrial-foundry.png)

## Intent

The **giant industrial foundry** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **giant industrial foundry** as a useful,
...
- **POI sibling component:** [smelting/processing equipment](./smelting-processing-equipment.md).
