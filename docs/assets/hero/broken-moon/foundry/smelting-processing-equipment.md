...
---
asset_id: "asset.broken-moon.foundry.smelting-processing-equipment"
source_label: "smelting/processing equipment"
source_section: "Hero / Broken Moon"
source_group: "Foundry"
source_line: 1529
level: L3
status: planned
...
# smelting/processing equipment

## Identity

- **Asset ID:** asset.broken-moon.foundry.smelting-processing-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1529
...
![smelting/processing equipment reference render](smelting-processing-equipment.png)

## Intent

The **smelting/processing equipment** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **smelting/processing equipment** as a useful,
...
- **Parent assembly:** [Foundry assembly](./_assembly.md).

- **POI sibling component:** [giant industrial foundry](./giant-industrial-foundry.md).
