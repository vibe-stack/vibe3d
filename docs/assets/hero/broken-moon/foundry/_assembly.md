...
---
assembly_id: "assembly.broken-moon.foundry"
source_label: "Foundry"
...
# Foundry — hero assembly

## Identity

- **Assembly ID:** assembly.broken-moon.foundry
...
Foundry is a landmark, not a pile of unrelated props. The full assembly
...
- [giant industrial foundry](./giant-industrial-foundry.md) — component brief.
- [smelting/processing equipment](./smelting-processing-equipment.md) — component brief.
- [huge furnaces](./huge-furnaces.md) — component brief.
- [crane infrastructure](./crane-infrastructure.md) — component brief.
