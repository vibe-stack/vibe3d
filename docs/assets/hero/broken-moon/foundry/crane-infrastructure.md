...
---
asset_id: "asset.broken-moon.foundry.crane-infrastructure"
source_label: "crane infrastructure"
...
- **Asset ID:** asset.broken-moon.foundry.crane-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1531
...
![crane infrastructure reference render](crane-infrastructure.png)

## Intent

The **crane infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **crane infrastructure** as a useful,
