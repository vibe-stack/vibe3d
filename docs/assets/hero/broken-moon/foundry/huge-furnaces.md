...
---
asset_id: "asset.broken-moon.foundry.huge-furnaces"
source_label: "huge furnaces"
...
- **Asset ID:** asset.broken-moon.foundry.huge-furnaces
- **Type:** POI hero component
- **Source:** prop-list.md:1530
...
![huge furnaces reference render](huge-furnaces.png)

## Intent

The **huge furnaces** is a POI hero component for the Axiom Relay kit. It exists to support
low-gravity habitats and monumental terraforming machines grounded by dust and fracture. Its primary read should be **huge furnaces** as a useful,
