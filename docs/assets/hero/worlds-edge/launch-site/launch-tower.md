...
---
asset_id: "asset.worlds-edge.launch-site.launch-tower"
source_label: "launch tower"
...
- **Asset ID:** asset.worlds-edge.launch-site.launch-tower
...
![launch tower reference render](launch-tower.png)

## Intent

The **launch tower** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **launch tower** as a useful,
...
- **POI sibling component:** [rocket/spaceflight infrastructure](./rocket-spaceflight-infrastructure.md).
