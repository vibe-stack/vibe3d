...
---
asset_id: "asset.worlds-edge.launch-site.service-buildings"
source_label: "service buildings"
source_section: "Hero / World's Edge"
source_group: "Launch Site"
source_line: 1098
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.launch-site.service-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1098
...
![service buildings reference render](service-buildings.png)

## Intent

The **service buildings** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **service buildings** as a useful,
...
- **Parent assembly:** [Launch Site assembly](./_assembly.md).

- **POI sibling component:** [launch tower](./launch-tower.md).
