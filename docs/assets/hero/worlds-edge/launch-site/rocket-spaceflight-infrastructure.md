...
---
asset_id: "asset.worlds-edge.launch-site.rocket-spaceflight-infrastructure"
source_label: "rocket/spaceflight infrastructure"
...
# rocket/spaceflight infrastructure

## Identity

- **Asset ID:** asset.worlds-edge.launch-site.rocket-spaceflight-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1096
...
![rocket/spaceflight infrastructure reference render](rocket-spaceflight-infrastructure.png)

## Intent

The **rocket/spaceflight infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **rocket/spaceflight infrastructure** as a useful,
