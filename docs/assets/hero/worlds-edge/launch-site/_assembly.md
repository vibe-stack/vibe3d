...
---
assembly_id: "assembly.worlds-edge.launch-site"
source_label: "Launch Site"
...
# Launch Site — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.launch-site
...
- **Source:** prop-list.md:1095

## Landmark promise

Launch Site is a landmark, not a pile of unrelated props. The full assembly
...
- [launch tower](./launch-tower.md) — component brief.
- [rocket/spaceflight infrastructure](./rocket-spaceflight-infrastructure.md) — component brief.
- [huge landing/launch platforms](./huge-landing-launch-platforms.md) — component brief.
- [service buildings](./service-buildings.md) — component brief.
