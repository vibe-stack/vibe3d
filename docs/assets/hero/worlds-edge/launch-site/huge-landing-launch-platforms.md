...
---
asset_id: "asset.worlds-edge.launch-site.huge-landing-launch-platforms"
source_label: "huge landing/launch platforms"
...
# huge landing/launch platforms

## Identity

- **Asset ID:** asset.worlds-edge.launch-site.huge-landing-launch-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1097
...
![huge landing/launch platforms reference render](huge-landing-launch-platforms.png)

## Intent

The **huge landing/launch platforms** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **huge landing/launch platforms** as a useful,
