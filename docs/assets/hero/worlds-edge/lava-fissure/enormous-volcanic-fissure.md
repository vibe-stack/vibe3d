...
---
asset_id: "asset.worlds-edge.lava-fissure.enormous-volcanic-fissure"
source_label: "enormous volcanic fissure"
...
# enormous volcanic fissure

## Identity

- **Asset ID:** asset.worlds-edge.lava-fissure.enormous-volcanic-fissure
- **Type:** POI hero component
- **Source:** prop-list.md:1129
...
![enormous volcanic fissure reference render](enormous-volcanic-fissure.png)

## Intent

The **enormous volcanic fissure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **enormous volcanic fissure** as a useful,
...
- **POI sibling component:** [bridge network](./bridge-network.md).
