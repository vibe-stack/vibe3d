...
---
asset_id: "asset.worlds-edge.lava-fissure.suspended-buildings-platforms"
source_label: "suspended buildings/platforms"
source_section: "Hero / World's Edge"
source_group: "Lava Fissure"
source_line: 1131
level: L3
status: planned
...
# suspended buildings/platforms

## Identity

- **Asset ID:** asset.worlds-edge.lava-fissure.suspended-buildings-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1131
...
![suspended buildings/platforms reference render](suspended-buildings-platforms.png)

## Intent

The **suspended buildings/platforms** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **suspended buildings/platforms** as a useful,
...
- **Parent assembly:** [Lava Fissure assembly](./_assembly.md).

- **POI sibling component:** [enormous volcanic fissure](./enormous-volcanic-fissure.md).
