...
---
assembly_id: "assembly.worlds-edge.lava-fissure"
source_label: "Lava Fissure"
...
# Lava Fissure — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.lava-fissure
...
Lava Fissure is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous volcanic fissure](./enormous-volcanic-fissure.md) — component brief.
- [bridge network](./bridge-network.md) — component brief.
- [suspended buildings/platforms](./suspended-buildings-platforms.md) — component brief.
