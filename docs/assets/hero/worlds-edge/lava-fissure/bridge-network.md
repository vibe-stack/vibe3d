...
---
asset_id: "asset.worlds-edge.lava-fissure.bridge-network"
source_label: "bridge network"
...
- **Asset ID:** asset.worlds-edge.lava-fissure.bridge-network
- **Type:** POI hero component
- **Source:** prop-list.md:1130
...
![bridge network reference render](bridge-network.png)

## Intent

The **bridge network** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **bridge network** as a useful,
