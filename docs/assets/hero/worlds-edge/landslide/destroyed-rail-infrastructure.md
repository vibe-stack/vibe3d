...
---
asset_id: "asset.worlds-edge.landslide.destroyed-rail-infrastructure"
source_label: "destroyed rail infrastructure"
...
# destroyed rail infrastructure

## Identity

- **Asset ID:** asset.worlds-edge.landslide.destroyed-rail-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1122
...
![destroyed rail infrastructure reference render](destroyed-rail-infrastructure.png)

## Intent

The **destroyed rail infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **destroyed rail infrastructure** as a useful,
...
- **POI sibling component:** [collapsed tunnel](./collapsed-tunnel.md).
