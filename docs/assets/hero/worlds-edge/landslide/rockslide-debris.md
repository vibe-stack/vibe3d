...
---
asset_id: "asset.worlds-edge.landslide.rockslide-debris"
source_label: "rockslide debris"
...
- **Asset ID:** asset.worlds-edge.landslide.rockslide-debris
- **Type:** POI hero component
- **Source:** prop-list.md:1124
...
![rockslide debris reference render](rockslide-debris.png)

## Intent

The **rockslide debris** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **rockslide debris** as a useful,
