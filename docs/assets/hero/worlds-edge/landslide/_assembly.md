...
---
assembly_id: "assembly.worlds-edge.landslide"
source_label: "Landslide"
...
# Landslide — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.landslide
...
Landslide is a landmark, not a pile of unrelated props. The full assembly
...
- [destroyed rail infrastructure](./destroyed-rail-infrastructure.md) — component brief.
- [collapsed tunnel](./collapsed-tunnel.md) — component brief.
- [rockslide debris](./rockslide-debris.md) — component brief.
- [rail wreckage](./rail-wreckage.md) — component brief.
