...
---
asset_id: "asset.worlds-edge.landslide.collapsed-tunnel"
source_label: "collapsed tunnel"
source_section: "Hero / World's Edge"
source_group: "Landslide"
source_line: 1123
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.landslide.collapsed-tunnel
- **Type:** POI hero component
- **Source:** prop-list.md:1123
...
![collapsed tunnel reference render](collapsed-tunnel.png)

## Intent

The **collapsed tunnel** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **collapsed tunnel** as a useful,
...
- **Parent assembly:** [Landslide assembly](./_assembly.md).

- **POI sibling component:** [destroyed rail infrastructure](./destroyed-rail-infrastructure.md).
