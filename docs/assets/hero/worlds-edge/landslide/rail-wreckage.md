...
---
asset_id: "asset.worlds-edge.landslide.rail-wreckage"
source_label: "rail wreckage"
...
- **Asset ID:** asset.worlds-edge.landslide.rail-wreckage
- **Type:** POI hero component
- **Source:** prop-list.md:1125
...
![rail wreckage reference render](rail-wreckage.png)

## Intent

The **rail wreckage** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **rail wreckage** as a useful,
