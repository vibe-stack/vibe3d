...
---
assembly_id: "assembly.worlds-edge.mirage-trois"
source_label: "Mirage à Trois"
...
# Mirage à Trois — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.mirage-trois
...
- **Source:** prop-list.md:1087

## Landmark promise

Mirage à Trois is a landmark, not a pile of unrelated props. The full assembly
...
- [Mirage party vessel](./mirage-party-vessel.md) — component brief.
- [party deck](./party-deck.md) — component brief.
- [hologram emitters](./hologram-emitters.md) — component brief.
- [bar](./bar.md) — component brief.
- [performance/entertainment props](./performance-entertainment-props.md) — component brief.
