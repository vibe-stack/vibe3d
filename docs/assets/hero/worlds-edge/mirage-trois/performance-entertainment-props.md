...
---
asset_id: "asset.worlds-edge.mirage-trois.performance-entertainment-props"
source_label: "performance/entertainment props"
source_section: "Hero / World's Edge"
source_group: "Mirage à Trois"
source_line: 1091
level: L3
status: planned
...
# performance/entertainment props

## Identity

- **Asset ID:** asset.worlds-edge.mirage-trois.performance-entertainment-props
- **Type:** POI hero component
- **Source:** prop-list.md:1091
...
![performance/entertainment props reference render](performance-entertainment-props.png)

## Intent

The **performance/entertainment props** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **performance/entertainment props** as a useful,
...
- **Parent assembly:** [Mirage à Trois assembly](./_assembly.md).

- **POI sibling component:** [Mirage party vessel](./mirage-party-vessel.md).
