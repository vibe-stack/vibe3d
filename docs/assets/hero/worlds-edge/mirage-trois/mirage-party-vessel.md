...
---
asset_id: "asset.worlds-edge.mirage-trois.mirage-party-vessel"
source_label: "Mirage party vessel"
...
- **Asset ID:** asset.worlds-edge.mirage-trois.mirage-party-vessel
...
![Mirage party vessel reference render](mirage-party-vessel.png)

## Intent

The **Mirage party vessel** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Mirage party vessel** as a useful,
...
- **POI sibling component:** [party deck](./party-deck.md).
