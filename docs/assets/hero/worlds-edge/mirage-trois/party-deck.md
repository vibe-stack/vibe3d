...
---
asset_id: "asset.worlds-edge.mirage-trois.party-deck"
source_label: "party deck"
...
- **Asset ID:** asset.worlds-edge.mirage-trois.party-deck
- **Type:** POI hero component
- **Source:** prop-list.md:1088
...
![party deck reference render](party-deck.png)

## Intent

The **party deck** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **party deck** as a useful,
