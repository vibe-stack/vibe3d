...
---
asset_id: "asset.worlds-edge.mirage-trois.bar"
source_label: "bar"
...
- **Asset ID:** asset.worlds-edge.mirage-trois.bar
- **Type:** POI hero component
- **Source:** prop-list.md:1090
...
![bar reference render](bar.png)

## Intent

The **bar** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **bar** as a useful,
