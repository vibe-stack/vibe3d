...
---
asset_id: "asset.worlds-edge.mirage-trois.hologram-emitters"
source_label: "hologram emitters"
...
- **Asset ID:** asset.worlds-edge.mirage-trois.hologram-emitters
- **Type:** POI hero component
- **Source:** prop-list.md:1089
...
![hologram emitters reference render](hologram-emitters.png)

## Intent

The **hologram emitters** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **hologram emitters** as a useful,
