...
---
asset_id: "asset.worlds-edge.the-epicenter.frozen-machinery"
source_label: "frozen machinery"
source_section: "Hero / World's Edge"
source_group: "The Epicenter"
source_line: 1050
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.the-epicenter.frozen-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1050
...
![frozen machinery reference render](frozen-machinery.png)

## Intent

The **frozen machinery** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **frozen machinery** as a useful,
...
- **Parent assembly:** [The Epicenter assembly](./_assembly.md).

- **POI sibling component:** [giant flash-freeze structure](./giant-flash-freeze-structure.md).
