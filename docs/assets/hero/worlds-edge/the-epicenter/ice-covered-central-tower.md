...
---
asset_id: "asset.worlds-edge.the-epicenter.ice-covered-central-tower"
source_label: "ice-covered central tower"
...
# ice-covered central tower

## Identity

- **Asset ID:** asset.worlds-edge.the-epicenter.ice-covered-central-tower
- **Type:** POI hero component
- **Source:** prop-list.md:1049
...
![ice-covered central tower reference render](ice-covered-central-tower.png)

## Intent

The **ice-covered central tower** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **ice-covered central tower** as a useful,
