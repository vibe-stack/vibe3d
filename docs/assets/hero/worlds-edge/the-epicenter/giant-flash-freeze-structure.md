...
---
asset_id: "asset.worlds-edge.the-epicenter.giant-flash-freeze-structure"
source_label: "giant flash-freeze structure"
...
# giant flash-freeze structure

## Identity

- **Asset ID:** asset.worlds-edge.the-epicenter.giant-flash-freeze-structure
...
![giant flash-freeze structure reference render](giant-flash-freeze-structure.png)

## Intent

The **giant flash-freeze structure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **giant flash-freeze structure** as a useful,
...
- **POI sibling component:** [ice-covered central tower](./ice-covered-central-tower.md).
