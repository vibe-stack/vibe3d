...
---
asset_id: "asset.worlds-edge.the-epicenter.gigantic-ice-formations"
source_label: "gigantic ice formations"
...
# gigantic ice formations

## Identity

- **Asset ID:** asset.worlds-edge.the-epicenter.gigantic-ice-formations
- **Type:** POI hero component
- **Source:** prop-list.md:1051
...
![gigantic ice formations reference render](gigantic-ice-formations.png)

## Intent

The **gigantic ice formations** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gigantic ice formations** as a useful,
