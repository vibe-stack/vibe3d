...
---
assembly_id: "assembly.worlds-edge.the-epicenter"
source_label: "The Epicenter"
...
# The Epicenter — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.the-epicenter
...
- **Source:** prop-list.md:1048

## Landmark promise

The Epicenter is a landmark, not a pile of unrelated props. The full assembly
...
- [giant flash-freeze structure](./giant-flash-freeze-structure.md) — component brief.
- [ice-covered central tower](./ice-covered-central-tower.md) — component brief.
- [frozen machinery](./frozen-machinery.md) — component brief.
- [gigantic ice formations](./gigantic-ice-formations.md) — component brief.
