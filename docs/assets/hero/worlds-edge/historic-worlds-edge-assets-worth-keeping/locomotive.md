...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.locomotive"
source_label: "locomotive"
...
- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.locomotive
- **Type:** POI hero component
- **Source:** prop-list.md:1159
...
![locomotive reference render](locomotive.png)

## Intent

The **locomotive** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **locomotive** as a useful,
