...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.passenger-freight-cars"
source_label: "passenger/freight cars"
...
- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.passenger-freight-cars
- **Type:** POI hero component
- **Source:** prop-list.md:1160
...
![passenger/freight cars reference render](passenger-freight-cars.png)

## Intent

The **passenger/freight cars** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **passenger/freight cars** as a useful,
