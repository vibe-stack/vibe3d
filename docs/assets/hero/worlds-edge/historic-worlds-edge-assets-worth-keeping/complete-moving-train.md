...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.complete-moving-train"
source_label: "complete moving Train"
...
# complete moving Train

## Identity

- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.complete-moving-train
...
![complete moving Train reference render](complete-moving-train.png)

## Intent

The **complete moving Train** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **complete moving Train** as a useful,
...
- **POI sibling component:** [locomotive](./locomotive.md).
