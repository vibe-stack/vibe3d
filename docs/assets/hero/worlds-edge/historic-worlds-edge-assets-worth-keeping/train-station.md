...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.train-station"
source_label: "train station"
...
- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.train-station
- **Type:** POI hero component
- **Source:** prop-list.md:1161
...
![train station reference render](train-station.png)

## Intent

The **train station** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **train station** as a useful,
