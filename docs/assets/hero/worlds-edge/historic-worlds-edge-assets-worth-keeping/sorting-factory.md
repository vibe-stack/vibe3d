...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.sorting-factory"
source_label: "Sorting Factory"
...
- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.sorting-factory
- **Type:** POI hero component
- **Source:** prop-list.md:1163
...
![Sorting Factory reference render](sorting-factory.png)

## Intent

The **Sorting Factory** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Sorting Factory** as a useful,
