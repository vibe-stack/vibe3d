...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.rail-tracks"
source_label: "rail tracks"
source_section: "Hero / World's Edge"
source_group: "Historic World's Edge assets worth keeping"
source_line: 1162
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.rail-tracks
- **Type:** POI hero component
- **Source:** prop-list.md:1162
...
![rail tracks reference render](rail-tracks.png)

## Intent

The **rail tracks** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **rail tracks** as a useful,
...
- **Parent assembly:** [Historic World's Edge assets worth keeping assembly](./_assembly.md).

- **POI sibling component:** [complete moving Train](./complete-moving-train.md).
