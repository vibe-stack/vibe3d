...
---
asset_id: "asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.original-capitol-city-structures"
source_label: "original Capitol City structures"
...
# original Capitol City structures

## Identity

- **Asset ID:** asset.worlds-edge.historic-worlds-edge-assets-worth-keeping.original-capitol-city-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1164
...
![original Capitol City structures reference render](original-capitol-city-structures.png)

## Intent

The **original Capitol City structures** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **original Capitol City structures** as a useful,
