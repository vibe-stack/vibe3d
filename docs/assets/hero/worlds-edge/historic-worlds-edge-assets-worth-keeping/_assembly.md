...
---
assembly_id: "assembly.worlds-edge.historic-worlds-edge-assets-worth-keeping"
source_label: "Historic World's Edge assets worth keeping"
...
# Historic World's Edge assets worth keeping — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.historic-worlds-edge-assets-worth-keeping
- **Map family:** Hero / World's Edge
- **Place identity:** Volcanic industry, frozen disaster, and dense worker city
- **Owner / story role:** Axiom Works / megatech extraction
- **Source:** prop-list.md:1158

## Landmark promise

Historic World's Edge assets worth keeping is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate thermal power and resource extraction framed by hard weather, ice, and industrial scale.
...
- Use AMBER-400 as the dominant hero signal and
  CYAN-400 only as a supporting state or traversal cue.
...
- [complete moving Train](./complete-moving-train.md) — component brief.
- [locomotive](./locomotive.md) — component brief.
- [passenger/freight cars](./passenger-freight-cars.md) — component brief.
- [train station](./train-station.md) — component brief.
- [rail tracks](./rail-tracks.md) — component brief.
- [Sorting Factory](./sorting-factory.md) — component brief.
- [original Capitol City structures](./original-capitol-city-structures.md) — component brief.
