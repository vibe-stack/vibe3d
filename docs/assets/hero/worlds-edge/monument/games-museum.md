...
---
asset_id: "asset.worlds-edge.monument.games-museum"
source_label: "Games Museum"
...
- **Asset ID:** asset.worlds-edge.monument.games-museum
- **Type:** POI hero component
- **Source:** prop-list.md:1068
...
![Games Museum reference render](games-museum.png)

## Intent

The **Games Museum** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Games Museum** as a useful,
...
- **POI sibling component:** [museum building](./museum-building.md).
