...
---
asset_id: "asset.worlds-edge.monument.thunderdome-exhibition"
source_label: "Thunderdome exhibition"
...
# Thunderdome exhibition

## Identity

- **Asset ID:** asset.worlds-edge.monument.thunderdome-exhibition
- **Type:** POI hero component
- **Source:** prop-list.md:1070
...
![Thunderdome exhibition reference render](thunderdome-exhibition.png)

## Intent

The **Thunderdome exhibition** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Thunderdome exhibition** as a useful,
