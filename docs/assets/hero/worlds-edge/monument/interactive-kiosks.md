...
---
asset_id: "asset.worlds-edge.monument.interactive-kiosks"
source_label: "interactive kiosks"
...
- **Asset ID:** asset.worlds-edge.monument.interactive-kiosks
- **Type:** POI hero component
- **Source:** prop-list.md:1071
...
![interactive kiosks reference render](interactive-kiosks.png)

## Intent

The **interactive kiosks** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **interactive kiosks** as a useful,
