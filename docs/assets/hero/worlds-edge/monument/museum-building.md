...
---
asset_id: "asset.worlds-edge.monument.museum-building"
source_label: "museum building"
source_section: "Hero / World's Edge"
source_group: "Monument"
source_line: 1069
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.monument.museum-building
- **Type:** POI hero component
- **Source:** prop-list.md:1069
...
![museum building reference render](museum-building.png)

## Intent

The **museum building** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **museum building** as a useful,
...
- **Parent assembly:** [Monument assembly](./_assembly.md).

- **POI sibling component:** [Games Museum](./games-museum.md).
