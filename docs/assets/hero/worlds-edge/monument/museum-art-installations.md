...
---
asset_id: "asset.worlds-edge.monument.museum-art-installations"
source_label: "museum art installations"
...
- **Asset ID:** asset.worlds-edge.monument.museum-art-installations
- **Type:** POI hero component
- **Source:** prop-list.md:1072
...
![museum art installations reference render](museum-art-installations.png)

## Intent

The **museum art installations** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **museum art installations** as a useful,
