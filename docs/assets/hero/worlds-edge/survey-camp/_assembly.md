...
---
assembly_id: "assembly.worlds-edge.survey-camp"
source_label: "Survey Camp"
...
# Survey Camp — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.survey-camp
...
Survey Camp is a landmark, not a pile of unrelated props. The full assembly
...
- [elevated survey stations](./elevated-survey-stations.md) — component brief.
- [research huts](./research-huts.md) — component brief.
- [sensor arrays](./sensor-arrays.md) — component brief.
