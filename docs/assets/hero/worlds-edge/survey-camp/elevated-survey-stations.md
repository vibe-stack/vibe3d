...
---
asset_id: "asset.worlds-edge.survey-camp.elevated-survey-stations"
source_label: "elevated survey stations"
source_section: "Hero / World's Edge"
source_group: "Survey Camp"
source_line: 1152
level: L3
status: planned
...
# elevated survey stations

## Identity

- **Asset ID:** asset.worlds-edge.survey-camp.elevated-survey-stations
- **Type:** POI hero component
- **Source:** prop-list.md:1152
...
![elevated survey stations reference render](elevated-survey-stations.png)

## Intent

The **elevated survey stations** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **elevated survey stations** as a useful,
...
- **Parent assembly:** [Survey Camp assembly](./_assembly.md).

- **POI sibling component:** [research huts](./research-huts.md).
