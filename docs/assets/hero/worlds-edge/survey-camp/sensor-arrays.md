...
---
asset_id: "asset.worlds-edge.survey-camp.sensor-arrays"
source_label: "sensor arrays"
...
- **Asset ID:** asset.worlds-edge.survey-camp.sensor-arrays
- **Type:** POI hero component
- **Source:** prop-list.md:1154
...
![sensor arrays reference render](sensor-arrays.png)

## Intent

The **sensor arrays** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **sensor arrays** as a useful,
...
- **POI sibling component:** [elevated survey stations](./elevated-survey-stations.md).
