...
---
asset_id: "asset.worlds-edge.survey-camp.research-huts"
source_label: "research huts"
...
- **Asset ID:** asset.worlds-edge.survey-camp.research-huts
- **Type:** POI hero component
- **Source:** prop-list.md:1153
...
![research huts reference render](research-huts.png)

## Intent

The **research huts** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **research huts** as a useful,
