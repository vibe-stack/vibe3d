...
---
asset_id: "asset.worlds-edge.big-maude.exterior-weapons-signage"
source_label: "exterior weapons signage"
...
# exterior weapons signage

## Identity

- **Asset ID:** asset.worlds-edge.big-maude.exterior-weapons-signage
- **Type:** POI hero component
- **Source:** prop-list.md:1083
...
![exterior weapons signage reference render](exterior-weapons-signage.png)

## Intent

The **exterior weapons signage** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **exterior weapons signage** as a useful,
