...
---
asset_id: "asset.worlds-edge.big-maude.big-maude-hull"
source_label: "Big Maude hull"
...
- **Asset ID:** asset.worlds-edge.big-maude.big-maude-hull
- **Type:** POI hero component
- **Source:** prop-list.md:1080
...
![Big Maude hull reference render](big-maude-hull.png)

## Intent

The **Big Maude hull** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Big Maude hull** as a useful,
