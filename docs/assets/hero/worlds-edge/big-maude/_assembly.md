...
---
assembly_id: "assembly.worlds-edge.big-maude"
source_label: "Big Maude"
...
# Big Maude — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.big-maude
...
- **Source:** prop-list.md:1079

## Landmark promise

Big Maude is a landmark, not a pile of unrelated props. The full assembly
...
- [Rampart's giant mobile-shop/vehicle structure](./ramparts-giant-mobile-shop-vehicle-structure.md) — component brief.
- [Big Maude hull](./big-maude-hull.md) — component brief.
- [shop interior](./shop-interior.md) — component brief.
- [paintball/mod machinery](./paintball-mod-machinery.md) — component brief.
- [exterior weapons signage](./exterior-weapons-signage.md) — component brief.
