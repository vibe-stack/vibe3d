...
---
asset_id: "asset.worlds-edge.big-maude.shop-interior"
source_label: "shop interior"
...
- **Asset ID:** asset.worlds-edge.big-maude.shop-interior
- **Type:** POI hero component
- **Source:** prop-list.md:1081
...
![shop interior reference render](shop-interior.png)

## Intent

The **shop interior** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **shop interior** as a useful,
