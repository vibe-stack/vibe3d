...
---
asset_id: "asset.worlds-edge.big-maude.paintball-mod-machinery"
source_label: "paintball/mod machinery"
source_section: "Hero / World's Edge"
source_group: "Big Maude"
source_line: 1082
level: L3
status: planned
...
# paintball/mod machinery

## Identity

- **Asset ID:** asset.worlds-edge.big-maude.paintball-mod-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1082
...
![paintball/mod machinery reference render](paintball-mod-machinery.png)

## Intent

The **paintball/mod machinery** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **paintball/mod machinery** as a useful,
...
- **Parent assembly:** [Big Maude assembly](./_assembly.md).

- **POI sibling component:** [Rampart's giant mobile-shop/vehicle structure](./ramparts-giant-mobile-shop-vehicle-structure.md).
