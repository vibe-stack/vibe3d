...
---
asset_id: "asset.worlds-edge.big-maude.ramparts-giant-mobile-shop-vehicle-structure"
source_label: "Rampart's giant mobile-shop/vehicle structure"
...
# Rampart's giant mobile-shop/vehicle structure

## Identity

- **Asset ID:** asset.worlds-edge.big-maude.ramparts-giant-mobile-shop-vehicle-structure
...
![Rampart's giant mobile-shop/vehicle structure reference render](ramparts-giant-mobile-shop-vehicle-structure.png)

## Intent

The **Rampart's giant mobile-shop/vehicle structure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **Rampart's giant mobile-shop/vehicle structure** as a useful,
...
- **POI sibling component:** [Big Maude hull](./big-maude-hull.md).
