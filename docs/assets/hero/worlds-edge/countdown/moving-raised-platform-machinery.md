...
---
asset_id: "asset.worlds-edge.countdown.moving-raised-platform-machinery"
source_label: "moving/raised platform machinery"
source_section: "Hero / World's Edge"
source_group: "Countdown"
source_line: 1104
level: L3
status: planned
...
# moving/raised platform machinery

## Identity

- **Asset ID:** asset.worlds-edge.countdown.moving-raised-platform-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1104
...
![moving/raised platform machinery reference render](moving-raised-platform-machinery.png)

## Intent

The **moving/raised platform machinery** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **moving/raised platform machinery** as a useful,
...
- **Parent assembly:** [Countdown assembly](./_assembly.md).

- **POI sibling component:** [central mechanical arena](./central-mechanical-arena.md).
