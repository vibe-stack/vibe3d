...
---
asset_id: "asset.worlds-edge.countdown.blast-walls"
source_label: "blast walls"
...
- **Asset ID:** asset.worlds-edge.countdown.blast-walls
- **Type:** POI hero component
- **Source:** prop-list.md:1103
...
![blast walls reference render](blast-walls.png)

## Intent

The **blast walls** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **blast walls** as a useful,
