...
---
asset_id: "asset.worlds-edge.countdown.central-mechanical-arena"
source_label: "central mechanical arena"
...
# central mechanical arena

## Identity

- **Asset ID:** asset.worlds-edge.countdown.central-mechanical-arena
- **Type:** POI hero component
- **Source:** prop-list.md:1102
...
![central mechanical arena reference render](central-mechanical-arena.png)

## Intent

The **central mechanical arena** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **central mechanical arena** as a useful,
...
- **POI sibling component:** [blast walls](./blast-walls.md).
