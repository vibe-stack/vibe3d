...
---
assembly_id: "assembly.worlds-edge.countdown"
source_label: "Countdown"
...
# Countdown — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.countdown
...
Countdown is a landmark, not a pile of unrelated props. The full assembly
...
- [central mechanical arena](./central-mechanical-arena.md) — component brief.
- [blast walls](./blast-walls.md) — component brief.
- [moving/raised platform machinery](./moving-raised-platform-machinery.md) — component brief.
- [industrial service structures](./industrial-service-structures.md) — component brief.
