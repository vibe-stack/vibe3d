...
---
asset_id: "asset.worlds-edge.countdown.industrial-service-structures"
source_label: "industrial service structures"
...
- **Asset ID:** asset.worlds-edge.countdown.industrial-service-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1105
...
![industrial service structures reference render](industrial-service-structures.png)

## Intent

The **industrial service structures** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **industrial service structures** as a useful,
