...
---
asset_id: "asset.worlds-edge.the-tree.thermal-ground-infrastructure"
source_label: "thermal ground infrastructure"
source_section: "Hero / World's Edge"
source_group: "The Tree"
source_line: 1141
level: L3
status: planned
...
# thermal ground infrastructure

## Identity

- **Asset ID:** asset.worlds-edge.the-tree.thermal-ground-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1141
...
![thermal ground infrastructure reference render](thermal-ground-infrastructure.png)

## Intent

The **thermal ground infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **thermal ground infrastructure** as a useful,
...
- **Parent assembly:** [The Tree assembly](./_assembly.md).

- **POI sibling component:** [gigantic central tree](./gigantic-central-tree.md).
