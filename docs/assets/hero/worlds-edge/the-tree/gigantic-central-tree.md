...
---
asset_id: "asset.worlds-edge.the-tree.gigantic-central-tree"
source_label: "gigantic central tree"
...
# gigantic central tree

## Identity

- **Asset ID:** asset.worlds-edge.the-tree.gigantic-central-tree
- **Type:** POI hero component
- **Source:** prop-list.md:1140
...
![gigantic central tree reference render](gigantic-central-tree.png)

## Intent

The **gigantic central tree** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gigantic central tree** as a useful,
...
- **POI sibling component:** [thermal ground infrastructure](./thermal-ground-infrastructure.md).
