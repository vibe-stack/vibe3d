...
---
assembly_id: "assembly.worlds-edge.the-tree"
source_label: "The Tree"
...
# The Tree — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.the-tree
...
The Tree is a landmark, not a pile of unrelated props. The full assembly
...
- [gigantic central tree](./gigantic-central-tree.md) — component brief.
- [thermal ground infrastructure](./thermal-ground-infrastructure.md) — component brief.
