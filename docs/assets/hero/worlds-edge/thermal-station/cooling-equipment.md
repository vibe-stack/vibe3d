...
---
asset_id: "asset.worlds-edge.thermal-station.cooling-equipment"
source_label: "cooling equipment"
...
- **Asset ID:** asset.worlds-edge.thermal-station.cooling-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1056
...
![cooling equipment reference render](cooling-equipment.png)

## Intent

The **cooling equipment** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **cooling equipment** as a useful,
