...
---
asset_id: "asset.worlds-edge.thermal-station.thermal-processing-towers"
source_label: "thermal processing towers"
...
# thermal processing towers

## Identity

- **Asset ID:** asset.worlds-edge.thermal-station.thermal-processing-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1058
...
![thermal processing towers reference render](thermal-processing-towers.png)

## Intent

The **thermal processing towers** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **thermal processing towers** as a useful,
