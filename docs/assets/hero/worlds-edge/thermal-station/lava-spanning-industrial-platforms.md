...
---
asset_id: "asset.worlds-edge.thermal-station.lava-spanning-industrial-platforms"
source_label: "lava-spanning industrial platforms"
...
# lava-spanning industrial platforms

## Identity

- **Asset ID:** asset.worlds-edge.thermal-station.lava-spanning-industrial-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1057
...
![lava-spanning industrial platforms reference render](lava-spanning-industrial-platforms.png)

## Intent

The **lava-spanning industrial platforms** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **lava-spanning industrial platforms** as a useful,
...
- **POI sibling component:** [huge geothermal turbine structures](./huge-geothermal-turbine-structures.md).
