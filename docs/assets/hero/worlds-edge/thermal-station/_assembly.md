...
---
assembly_id: "assembly.worlds-edge.thermal-station"
source_label: "Thermal Station"
...
# Thermal Station — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.thermal-station
...
Thermal Station is a landmark, not a pile of unrelated props. The full assembly
...
- [huge geothermal turbine structures](./huge-geothermal-turbine-structures.md) — component brief.
- [cooling equipment](./cooling-equipment.md) — component brief.
- [lava-spanning industrial platforms](./lava-spanning-industrial-platforms.md) — component brief.
- [thermal processing towers](./thermal-processing-towers.md) — component brief.
