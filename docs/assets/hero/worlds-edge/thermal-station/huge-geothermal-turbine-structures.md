...
---
asset_id: "asset.worlds-edge.thermal-station.huge-geothermal-turbine-structures"
source_label: "huge geothermal turbine structures"
source_section: "Hero / World's Edge"
source_group: "Thermal Station"
source_line: 1055
level: L3
status: planned
...
# huge geothermal turbine structures

## Identity

- **Asset ID:** asset.worlds-edge.thermal-station.huge-geothermal-turbine-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1055
...
![huge geothermal turbine structures reference render](huge-geothermal-turbine-structures.png)

## Intent

The **huge geothermal turbine structures** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **huge geothermal turbine structures** as a useful,
...
- **Parent assembly:** [Thermal Station assembly](./_assembly.md).

- **POI sibling component:** [cooling equipment](./cooling-equipment.md).
