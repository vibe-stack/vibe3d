...
---
asset_id: "asset.worlds-edge.climatizer.gondolas"
source_label: "gondolas"
...
- **Asset ID:** asset.worlds-edge.climatizer.gondolas
- **Type:** POI hero component
- **Source:** prop-list.md:1023
...
![gondolas reference render](gondolas.png)

## Intent

The **gondolas** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gondolas** as a useful,
