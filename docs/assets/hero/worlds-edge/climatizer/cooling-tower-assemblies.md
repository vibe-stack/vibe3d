...
---
asset_id: "asset.worlds-edge.climatizer.cooling-tower-assemblies"
source_label: "cooling tower assemblies"
source_section: "Hero / World's Edge"
source_group: "Climatizer"
source_line: 1020
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.climatizer.cooling-tower-assemblies
- **Type:** POI hero component
- **Source:** prop-list.md:1020
...
![cooling tower assemblies reference render](cooling-tower-assemblies.png)

## Intent

The **cooling tower assemblies** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **cooling tower assemblies** as a useful,
...
- **Parent assembly:** [Climatizer assembly](./_assembly.md).

- **POI sibling component:** [gigantic weather-control towers](./gigantic-weather-control-towers.md).
