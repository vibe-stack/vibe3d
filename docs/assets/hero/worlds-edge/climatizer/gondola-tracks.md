...
---
asset_id: "asset.worlds-edge.climatizer.gondola-tracks"
source_label: "gondola tracks"
...
- **Asset ID:** asset.worlds-edge.climatizer.gondola-tracks
- **Type:** POI hero component
- **Source:** prop-list.md:1024
...
![gondola tracks reference render](gondola-tracks.png)

## Intent

The **gondola tracks** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gondola tracks** as a useful,
