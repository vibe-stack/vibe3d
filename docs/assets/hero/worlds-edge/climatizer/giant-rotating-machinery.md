...
---
asset_id: "asset.worlds-edge.climatizer.giant-rotating-machinery"
source_label: "giant rotating machinery"
...
# giant rotating machinery

## Identity

- **Asset ID:** asset.worlds-edge.climatizer.giant-rotating-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1021
...
![giant rotating machinery reference render](giant-rotating-machinery.png)

## Intent

The **giant rotating machinery** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **giant rotating machinery** as a useful,
