...
---
asset_id: "asset.worlds-edge.climatizer.gigantic-weather-control-towers"
source_label: "gigantic weather-control towers"
...
# gigantic weather-control towers

## Identity

- **Asset ID:** asset.worlds-edge.climatizer.gigantic-weather-control-towers
...
![gigantic weather-control towers reference render](gigantic-weather-control-towers.png)

## Intent

The **gigantic weather-control towers** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gigantic weather-control towers** as a useful,
...
- **POI sibling component:** [cooling tower assemblies](./cooling-tower-assemblies.md).
