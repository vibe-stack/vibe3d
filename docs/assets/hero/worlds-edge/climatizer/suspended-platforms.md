...
---
asset_id: "asset.worlds-edge.climatizer.suspended-platforms"
source_label: "suspended platforms"
...
- **Asset ID:** asset.worlds-edge.climatizer.suspended-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1022
...
![suspended platforms reference render](suspended-platforms.png)

## Intent

The **suspended platforms** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **suspended platforms** as a useful,
