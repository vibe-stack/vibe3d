...
---
assembly_id: "assembly.worlds-edge.climatizer"
source_label: "Climatizer"
...
# Climatizer — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.climatizer
...
- **Source:** prop-list.md:1019

## Landmark promise

Climatizer is a landmark, not a pile of unrelated props. The full assembly
...
- [gigantic weather-control towers](./gigantic-weather-control-towers.md) — component brief.
- [cooling tower assemblies](./cooling-tower-assemblies.md) — component brief.
- [giant rotating machinery](./giant-rotating-machinery.md) — component brief.
- [suspended platforms](./suspended-platforms.md) — component brief.
- [gondolas](./gondolas.md) — component brief.
- [gondola tracks](./gondola-tracks.md) — component brief.
- [frozen industrial structures](./frozen-industrial-structures.md) — component brief.
