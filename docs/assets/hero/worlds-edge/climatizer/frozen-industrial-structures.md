...
---
asset_id: "asset.worlds-edge.climatizer.frozen-industrial-structures"
source_label: "frozen industrial structures"
...
# frozen industrial structures

## Identity

- **Asset ID:** asset.worlds-edge.climatizer.frozen-industrial-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1025
...
![frozen industrial structures reference render](frozen-industrial-structures.png)

## Intent

The **frozen industrial structures** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **frozen industrial structures** as a useful,
