...
---
asset_id: "asset.worlds-edge.the-geyser.geyser-containment-platform"
source_label: "geyser containment platform"
...
# geyser containment platform

## Identity

- **Asset ID:** asset.worlds-edge.the-geyser.geyser-containment-platform
- **Type:** POI hero component
- **Source:** prop-list.md:1063
...
![geyser containment platform reference render](geyser-containment-platform.png)

## Intent

The **geyser containment platform** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **geyser containment platform** as a useful,
