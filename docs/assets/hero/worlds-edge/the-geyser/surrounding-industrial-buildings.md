...
---
asset_id: "asset.worlds-edge.the-geyser.surrounding-industrial-buildings"
source_label: "surrounding industrial buildings"
source_section: "Hero / World's Edge"
source_group: "The Geyser"
source_line: 1064
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.the-geyser.surrounding-industrial-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1064
...
![surrounding industrial buildings reference render](surrounding-industrial-buildings.png)

## Intent

The **surrounding industrial buildings** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **surrounding industrial buildings** as a useful,
...
- **Parent assembly:** [The Geyser assembly](./_assembly.md).

- **POI sibling component:** [geothermal geyser](./geothermal-geyser.md).
