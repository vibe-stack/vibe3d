...
---
asset_id: "asset.worlds-edge.the-geyser.geothermal-geyser"
source_label: "geothermal geyser"
...
- **Asset ID:** asset.worlds-edge.the-geyser.geothermal-geyser
- **Type:** POI hero component
- **Source:** prop-list.md:1062
...
![geothermal geyser reference render](geothermal-geyser.png)

## Intent

The **geothermal geyser** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **geothermal geyser** as a useful,
...
- **POI sibling component:** [geyser containment platform](./geyser-containment-platform.md).
