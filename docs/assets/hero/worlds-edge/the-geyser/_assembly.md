...
---
assembly_id: "assembly.worlds-edge.the-geyser"
source_label: "The Geyser"
...
# The Geyser — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.the-geyser
...
The Geyser is a landmark, not a pile of unrelated props. The full assembly
...
- [geothermal geyser](./geothermal-geyser.md) — component brief.
- [geyser containment platform](./geyser-containment-platform.md) — component brief.
- [surrounding industrial buildings](./surrounding-industrial-buildings.md) — component brief.
