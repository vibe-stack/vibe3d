...
---
assembly_id: "assembly.worlds-edge.skyhook"
source_label: "Skyhook"
...
# Skyhook — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.skyhook
...
- **Source:** prop-list.md:1041

## Landmark promise

Skyhook is a landmark, not a pile of unrelated props. The full assembly
...
- [massive space-elevator/Skyhook tower](./massive-space-elevator-skyhook-tower.md) — component brief.
- [tower foundation](./tower-foundation.md) — component brief.
- [surrounding city blocks](./surrounding-city-blocks.md) — component brief.
- [vertical industrial infrastructure](./vertical-industrial-infrastructure.md) — component brief.
