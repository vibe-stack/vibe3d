...
---
asset_id: "asset.worlds-edge.skyhook.vertical-industrial-infrastructure"
source_label: "vertical industrial infrastructure"
...
# vertical industrial infrastructure

## Identity

- **Asset ID:** asset.worlds-edge.skyhook.vertical-industrial-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1044
...
![vertical industrial infrastructure reference render](vertical-industrial-infrastructure.png)

## Intent

The **vertical industrial infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **vertical industrial infrastructure** as a useful,
