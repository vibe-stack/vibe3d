...
---
asset_id: "asset.worlds-edge.skyhook.tower-foundation"
source_label: "tower foundation"
...
- **Asset ID:** asset.worlds-edge.skyhook.tower-foundation
- **Type:** POI hero component
- **Source:** prop-list.md:1042
...
![tower foundation reference render](tower-foundation.png)

## Intent

The **tower foundation** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **tower foundation** as a useful,
