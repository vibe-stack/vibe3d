...
---
asset_id: "asset.worlds-edge.skyhook.surrounding-city-blocks"
source_label: "surrounding city blocks"
source_section: "Hero / World's Edge"
source_group: "Skyhook"
source_line: 1043
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.skyhook.surrounding-city-blocks
- **Type:** POI hero component
- **Source:** prop-list.md:1043
...
![surrounding city blocks reference render](surrounding-city-blocks.png)

## Intent

The **surrounding city blocks** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **surrounding city blocks** as a useful,
...
- **Parent assembly:** [Skyhook assembly](./_assembly.md).

- **POI sibling component:** [massive space-elevator/Skyhook tower](./massive-space-elevator-skyhook-tower.md).
