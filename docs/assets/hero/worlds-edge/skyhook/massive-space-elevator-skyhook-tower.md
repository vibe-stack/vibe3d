...
---
asset_id: "asset.worlds-edge.skyhook.massive-space-elevator-skyhook-tower"
source_label: "massive space-elevator/Skyhook tower"
...
# massive space-elevator/Skyhook tower

## Identity

- **Asset ID:** asset.worlds-edge.skyhook.massive-space-elevator-skyhook-tower
...
![massive space-elevator/Skyhook tower reference render](massive-space-elevator-skyhook-tower.png)

## Intent

The **massive space-elevator/Skyhook tower** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **massive space-elevator/Skyhook tower** as a useful,
...
- **POI sibling component:** [tower foundation](./tower-foundation.md).
