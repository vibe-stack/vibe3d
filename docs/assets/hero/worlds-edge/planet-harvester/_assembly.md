...
---
assembly_id: "assembly.worlds-edge.planet-harvester"
source_label: "Planet Harvester"
...
# Planet Harvester — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.planet-harvester
...
- **Source:** prop-list.md:1010

## Landmark promise

Planet Harvester is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous Planet Harvester](./enormous-planet-harvester.md) — component brief.
- [central energy beam](./central-energy-beam.md) — component brief.
- [extraction pit](./extraction-pit.md) — component brief.
- [articulated harvester legs/supports](./articulated-harvester-legs-supports.md) — component brief.
- [rotating machinery](./rotating-machinery.md) — component brief.
- [surrounding processing facility](./surrounding-processing-facility.md) — component brief.
