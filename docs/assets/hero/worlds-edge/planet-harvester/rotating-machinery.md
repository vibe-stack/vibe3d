...
---
asset_id: "asset.worlds-edge.planet-harvester.rotating-machinery"
...
- **Asset ID:** asset.worlds-edge.planet-harvester.rotating-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1014
...
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **rotating machinery** as a useful,
