...
---
asset_id: "asset.worlds-edge.planet-harvester.extraction-pit"
source_label: "extraction pit"
...
- **Asset ID:** asset.worlds-edge.planet-harvester.extraction-pit
- **Type:** POI hero component
- **Source:** prop-list.md:1012
...
![extraction pit reference render](extraction-pit.png)

## Intent

The **extraction pit** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **extraction pit** as a useful,
