...
---
asset_id: "asset.worlds-edge.planet-harvester.surrounding-processing-facility"
source_label: "surrounding processing facility"
source_section: "Hero / World's Edge"
source_group: "Planet Harvester"
source_line: 1015
level: L3
status: planned
...
# surrounding processing facility

## Identity

- **Asset ID:** asset.worlds-edge.planet-harvester.surrounding-processing-facility
- **Type:** POI hero component
- **Source:** prop-list.md:1015
...
![surrounding processing facility reference render](surrounding-processing-facility.png)

## Intent

The **surrounding processing facility** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **surrounding processing facility** as a useful,
...
- **Parent assembly:** [Planet Harvester assembly](./_assembly.md).

- **POI sibling component:** [enormous Planet Harvester](./enormous-planet-harvester.md).
