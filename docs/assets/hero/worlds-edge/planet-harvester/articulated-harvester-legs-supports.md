...
---
asset_id: "asset.worlds-edge.planet-harvester.articulated-harvester-legs-supports"
source_label: "articulated harvester legs/supports"
...
# articulated harvester legs/supports

## Identity

- **Asset ID:** asset.worlds-edge.planet-harvester.articulated-harvester-legs-supports
- **Type:** POI hero component
- **Source:** prop-list.md:1013
...
![articulated harvester legs/supports reference render](articulated-harvester-legs-supports.png)

## Intent

The **articulated harvester legs/supports** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **articulated harvester legs/supports** as a useful,
