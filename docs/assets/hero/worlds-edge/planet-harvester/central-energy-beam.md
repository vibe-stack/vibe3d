...
---
asset_id: "asset.worlds-edge.planet-harvester.central-energy-beam"
source_label: "central energy beam"
...
- **Asset ID:** asset.worlds-edge.planet-harvester.central-energy-beam
- **Type:** POI hero component
- **Source:** prop-list.md:1011
...
![central energy beam reference render](central-energy-beam.png)

## Intent

The **central energy beam** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **central energy beam** as a useful,
