...
---
asset_id: "asset.worlds-edge.planet-harvester.enormous-planet-harvester"
source_label: "enormous Planet Harvester"
...
# enormous Planet Harvester

## Identity

- **Asset ID:** asset.worlds-edge.planet-harvester.enormous-planet-harvester
...
![enormous Planet Harvester reference render](enormous-planet-harvester.png)

## Intent

The **enormous Planet Harvester** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **enormous Planet Harvester** as a useful,
...
- **POI sibling component:** [central energy beam](./central-energy-beam.md).
