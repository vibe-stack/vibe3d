...
---
asset_id: "asset.worlds-edge.fragment.broken-apartment-blocks"
source_label: "broken apartment blocks"
...
# broken apartment blocks

## Identity

- **Asset ID:** asset.worlds-edge.fragment.broken-apartment-blocks
- **Type:** POI hero component
- **Source:** prop-list.md:1116
...
![broken apartment blocks reference render](broken-apartment-blocks.png)

## Intent

The **broken apartment blocks** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **broken apartment blocks** as a useful,
...
- **Parent assembly:** [Fragment assembly](./_assembly.md).

- **POI sibling component:** [ruined city high-rises](./ruined-city-high-rises.md).
