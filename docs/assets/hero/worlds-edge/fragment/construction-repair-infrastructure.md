...
---
asset_id: "asset.worlds-edge.fragment.construction-repair-infrastructure"
source_label: "construction/repair infrastructure"
...
# construction/repair infrastructure

## Identity

- **Asset ID:** asset.worlds-edge.fragment.construction-repair-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1118
...
![construction/repair infrastructure reference render](construction-repair-infrastructure.png)

## Intent

The **construction/repair infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **construction/repair infrastructure** as a useful,
