...
---
asset_id: "asset.worlds-edge.fragment.ruined-city-high-rises"
source_label: "ruined city high-rises"
...
# ruined city high-rises

## Identity

- **Asset ID:** asset.worlds-edge.fragment.ruined-city-high-rises
- **Type:** POI hero component
- **Source:** prop-list.md:1115
...
![ruined city high-rises reference render](ruined-city-high-rises.png)

## Intent

The **ruined city high-rises** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **ruined city high-rises** as a useful,
...
- **POI sibling component:** [broken apartment blocks](./broken-apartment-blocks.md).
