...
---
assembly_id: "assembly.worlds-edge.fragment"
...
# Fragment — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.fragment
...
Fragment is a landmark, not a pile of unrelated props. The full assembly
...
- [ruined city high-rises](./ruined-city-high-rises.md) — component brief.
- [broken apartment blocks](./broken-apartment-blocks.md) — component brief.
- [collapsed roads](./collapsed-roads.md) — component brief.
- [construction/repair infrastructure](./construction-repair-infrastructure.md) — component brief.
