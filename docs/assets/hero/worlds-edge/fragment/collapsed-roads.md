...
---
asset_id: "asset.worlds-edge.fragment.collapsed-roads"
source_label: "collapsed roads"
...
- **Asset ID:** asset.worlds-edge.fragment.collapsed-roads
- **Type:** POI hero component
- **Source:** prop-list.md:1117
...
![collapsed roads reference render](collapsed-roads.png)

## Intent

The **collapsed roads** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **collapsed roads** as a useful,
