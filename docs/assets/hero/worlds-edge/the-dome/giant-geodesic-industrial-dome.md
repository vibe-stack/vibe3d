...
---
asset_id: "asset.worlds-edge.the-dome.giant-geodesic-industrial-dome"
source_label: "giant geodesic/industrial dome"
...
# giant geodesic/industrial dome

## Identity

- **Asset ID:** asset.worlds-edge.the-dome.giant-geodesic-industrial-dome
- **Type:** POI hero component
- **Source:** prop-list.md:1135
...
![giant geodesic/industrial dome reference render](giant-geodesic-industrial-dome.png)

## Intent

The **giant geodesic/industrial dome** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **giant geodesic/industrial dome** as a useful,
...
- **POI sibling component:** [interior lava-processing facility](./interior-lava-processing-facility.md).
