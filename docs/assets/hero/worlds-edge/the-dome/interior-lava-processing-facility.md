...
---
asset_id: "asset.worlds-edge.the-dome.interior-lava-processing-facility"
source_label: "interior lava-processing facility"
source_section: "Hero / World's Edge"
source_group: "The Dome"
source_line: 1136
level: L3
status: planned
place_family: "Volcanic industry, frozen disaster, and dense worker city"
owner: "Axiom Works / megatech extraction"
---

# interior lava-processing facility

## Identity

- **Asset ID:** asset.worlds-edge.the-dome.interior-lava-processing-facility
- **Type:** POI hero component
- **Source:** prop-list.md:1136
- **Family:** Hero / World's Edge
- **Place family:** Volcanic industry, frozen disaster, and dense worker city
- **Owner / story role:** Axiom Works / megatech extraction

## Reference render

![interior lava-processing facility reference render](interior-lava-processing-facility.png)

## Intent

The **interior lava-processing facility** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **interior lava-processing facility** as a useful,
...
Use ORANGE-500 as the dominant signal token and AMBER-400 only
...
- dominant signal: ORANGE-500;
- supporting signal: AMBER-400;
...
- **Parent assembly:** [The Dome assembly](./_assembly.md).

- **POI sibling component:** [giant geodesic/industrial dome](./giant-geodesic-industrial-dome.md).
