...
---
asset_id: "asset.worlds-edge.staging.prefabricated-structures"
source_label: "prefabricated structures"
source_section: "Hero / World's Edge"
source_group: "Staging"
source_line: 1148
level: L3
status: planned
...
- **Asset ID:** asset.worlds-edge.staging.prefabricated-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1148
...
![prefabricated structures reference render](prefabricated-structures.png)

## Intent

The **prefabricated structures** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **prefabricated structures** as a useful,
...
- **Parent assembly:** [Staging assembly](./_assembly.md).

- **POI sibling component:** [large construction platform](./large-construction-platform.md).
