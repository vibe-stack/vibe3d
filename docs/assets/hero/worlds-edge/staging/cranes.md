...
---
asset_id: "asset.worlds-edge.staging.cranes"
source_label: "cranes"
...
- **Asset ID:** asset.worlds-edge.staging.cranes
- **Type:** POI hero component
- **Source:** prop-list.md:1146
...
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **cranes** as a useful,
