...
---
asset_id: "asset.worlds-edge.staging.large-construction-platform"
source_label: "large construction platform"
...
# large construction platform

## Identity

- **Asset ID:** asset.worlds-edge.staging.large-construction-platform
...
![large construction platform reference render](large-construction-platform.png)

## Intent

The **large construction platform** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **large construction platform** as a useful,
