...
---
assembly_id: "assembly.worlds-edge.staging"
...
# Staging — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.staging
...
- **Source:** prop-list.md:1145

## Landmark promise

Staging is a landmark, not a pile of unrelated props. The full assembly
...
- [large construction platform](./large-construction-platform.md) — component brief.
- [cranes](./cranes.md) — component brief.
- [staging gantries](./staging-gantries.md) — component brief.
- [prefabricated structures](./prefabricated-structures.md) — component brief.
