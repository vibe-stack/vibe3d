...
---
asset_id: "asset.worlds-edge.staging.staging-gantries"
source_label: "staging gantries"
...
- **Asset ID:** asset.worlds-edge.staging.staging-gantries
- **Type:** POI hero component
- **Source:** prop-list.md:1147
...
![staging gantries reference render](staging-gantries.png)

## Intent

The **staging gantries** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **staging gantries** as a useful,
