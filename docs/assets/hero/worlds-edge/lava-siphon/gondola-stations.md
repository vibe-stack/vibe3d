...
---
asset_id: "asset.worlds-edge.lava-siphon.gondola-stations"
source_label: "gondola stations"
...
- **Asset ID:** asset.worlds-edge.lava-siphon.gondola-stations
- **Type:** POI hero component
- **Source:** prop-list.md:1032
...
![gondola stations reference render](gondola-stations.png)

## Intent

The **gondola stations** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **gondola stations** as a useful,
