...
---
asset_id: "asset.worlds-edge.lava-siphon.lava-channels"
source_label: "lava channels"
...
- **Asset ID:** asset.worlds-edge.lava-siphon.lava-channels
- **Type:** POI hero component
- **Source:** prop-list.md:1034
...
![lava channels reference render](lava-channels.png)

## Intent

The **lava channels** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **lava channels** as a useful,
...
- **POI sibling component:** [giant siphon machinery](./giant-siphon-machinery.md).
