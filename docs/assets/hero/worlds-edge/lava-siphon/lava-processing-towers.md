...
---
asset_id: "asset.worlds-edge.lava-siphon.lava-processing-towers"
source_label: "lava-processing towers"
...
# lava-processing towers

## Identity

- **Asset ID:** asset.worlds-edge.lava-siphon.lava-processing-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1030
...
![lava-processing towers reference render](lava-processing-towers.png)

## Intent

The **lava-processing towers** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **lava-processing towers** as a useful,
