...
---
asset_id: "asset.worlds-edge.lava-siphon.elevated-walkways"
source_label: "elevated walkways"
...
- **Asset ID:** asset.worlds-edge.lava-siphon.elevated-walkways
- **Type:** POI hero component
- **Source:** prop-list.md:1033
...
![elevated walkways reference render](elevated-walkways.png)

## Intent

The **elevated walkways** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **elevated walkways** as a useful,
