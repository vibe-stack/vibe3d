...
---
asset_id: "asset.worlds-edge.lava-siphon.giant-siphon-machinery"
source_label: "giant siphon machinery"
source_section: "Hero / World's Edge"
source_group: "Lava Siphon"
source_line: 1029
level: L3
status: planned
...
# giant siphon machinery

## Identity

- **Asset ID:** asset.worlds-edge.lava-siphon.giant-siphon-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1029
...
![giant siphon machinery reference render](giant-siphon-machinery.png)

## Intent

The **giant siphon machinery** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **giant siphon machinery** as a useful,
...
- **Parent assembly:** [Lava Siphon assembly](./_assembly.md).

- **POI sibling component:** [lava-processing towers](./lava-processing-towers.md).
