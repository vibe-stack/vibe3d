...
---
assembly_id: "assembly.worlds-edge.lava-siphon"
source_label: "Lava Siphon"
...
# Lava Siphon — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.lava-siphon
...
Lava Siphon is a landmark, not a pile of unrelated props. The full assembly
...
- Use ORANGE-500 as the dominant hero signal and
...
- [giant siphon machinery](./giant-siphon-machinery.md) — component brief.
- [lava-processing towers](./lava-processing-towers.md) — component brief.
- [suspended gondolas](./suspended-gondolas.md) — component brief.
- [gondola stations](./gondola-stations.md) — component brief.
- [elevated walkways](./elevated-walkways.md) — component brief.
- [lava channels](./lava-channels.md) — component brief.
- [industrial bridges](./industrial-bridges.md) — component brief.
