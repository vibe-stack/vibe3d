...
---
asset_id: "asset.worlds-edge.lava-siphon.suspended-gondolas"
source_label: "suspended gondolas"
...
- **Asset ID:** asset.worlds-edge.lava-siphon.suspended-gondolas
- **Type:** POI hero component
- **Source:** prop-list.md:1031
...
![suspended gondolas reference render](suspended-gondolas.png)

## Intent

The **suspended gondolas** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **suspended gondolas** as a useful,
