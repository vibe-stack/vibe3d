...
---
asset_id: "asset.worlds-edge.lava-siphon.industrial-bridges"
source_label: "industrial bridges"
...
- **Asset ID:** asset.worlds-edge.lava-siphon.industrial-bridges
- **Type:** POI hero component
- **Source:** prop-list.md:1035
...
![industrial bridges reference render](industrial-bridges.png)

## Intent

The **industrial bridges** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **industrial bridges** as a useful,
