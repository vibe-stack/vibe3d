...
---
asset_id: "asset.worlds-edge.stacks.characteristic-multi-level-stacked-building-complex"
source_label: "characteristic multi-level stacked building complex"
...
# characteristic multi-level stacked building complex

## Identity

- **Asset ID:** asset.worlds-edge.stacks.characteristic-multi-level-stacked-building-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1109
...
![characteristic multi-level stacked building complex reference render](characteristic-multi-level-stacked-building-complex.png)

## Intent

The **characteristic multi-level stacked building complex** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **characteristic multi-level stacked building complex** as a useful,
...
- **Parent assembly:** [Stacks assembly](./_assembly.md).

- **POI sibling component:** [linked roofs](./linked-roofs.md).
