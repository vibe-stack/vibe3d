...
---
asset_id: "asset.worlds-edge.stacks.vertical-exterior-ladders-walkways"
source_label: "vertical exterior ladders/walkways"
...
# vertical exterior ladders/walkways

## Identity

- **Asset ID:** asset.worlds-edge.stacks.vertical-exterior-ladders-walkways
- **Type:** POI hero component
- **Source:** prop-list.md:1111
...
![vertical exterior ladders/walkways reference render](vertical-exterior-ladders-walkways.png)

## Intent

The **vertical exterior ladders/walkways** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **vertical exterior ladders/walkways** as a useful,
...
- **POI sibling component:** [characteristic multi-level stacked building complex](./characteristic-multi-level-stacked-building-complex.md).
