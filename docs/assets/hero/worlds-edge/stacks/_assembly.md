...
---
assembly_id: "assembly.worlds-edge.stacks"
source_label: "Stacks"
...
# Stacks — hero assembly

## Identity

- **Assembly ID:** assembly.worlds-edge.stacks
...
Stacks is a landmark, not a pile of unrelated props. The full assembly
...
- [characteristic multi-level stacked building complex](./characteristic-multi-level-stacked-building-complex.md) — component brief.
- [linked roofs](./linked-roofs.md) — component brief.
- [vertical exterior ladders/walkways](./vertical-exterior-ladders-walkways.md) — component brief.
