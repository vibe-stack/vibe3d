...
---
asset_id: "asset.worlds-edge.stacks.linked-roofs"
source_label: "linked roofs"
...
- **Asset ID:** asset.worlds-edge.stacks.linked-roofs
- **Type:** POI hero component
- **Source:** prop-list.md:1110
...
![linked roofs reference render](linked-roofs.png)

## Intent

The **linked roofs** is a POI hero component for the Axiom Relay kit. It exists to support
thermal power and resource extraction framed by hard weather, ice, and industrial scale. Its primary read should be **linked roofs** as a useful,
