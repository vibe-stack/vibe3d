...
---
asset_id: "asset.storm-point.forbidden-zone.wildlife-perimeter-fence"
source_label: "wildlife perimeter fence"
...
- **Asset ID:** asset.storm-point.forbidden-zone.wildlife-perimeter-fence
...
![wildlife perimeter fence reference render](wildlife-perimeter-fence.png)

## Intent

The **wildlife perimeter fence** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **wildlife perimeter fence** as a useful,
...
- **POI sibling component:** [broken fence](./broken-fence.md).
