...
---
asset_id: "asset.storm-point.forbidden-zone.containment-structures"
...
- **Asset ID:** asset.storm-point.forbidden-zone.containment-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1443
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **containment structures** as a useful,
