...
---
assembly_id: "assembly.storm-point.forbidden-zone"
source_label: "Forbidden Zone"
...
# Forbidden Zone — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.forbidden-zone
...
- **Source:** prop-list.md:1441

## Landmark promise

Forbidden Zone is a landmark, not a pile of unrelated props. The full assembly
...
- [wildlife perimeter fence](./wildlife-perimeter-fence.md) — component brief.
- [broken fence](./broken-fence.md) — component brief.
- [containment structures](./containment-structures.md) — component brief.
- [lightning-damaged infrastructure](./lightning-damaged-infrastructure.md) — component brief.
