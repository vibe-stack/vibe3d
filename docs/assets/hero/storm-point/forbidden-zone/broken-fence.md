...
---
asset_id: "asset.storm-point.forbidden-zone.broken-fence"
source_label: "broken fence"
source_section: "Hero / Storm Point"
source_group: "Forbidden Zone"
source_line: 1442
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.forbidden-zone.broken-fence
- **Type:** POI hero component
- **Source:** prop-list.md:1442
...
![broken fence reference render](broken-fence.png)

## Intent

The **broken fence** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **broken fence** as a useful,
...
- **Parent assembly:** [Forbidden Zone assembly](./_assembly.md).

- **POI sibling component:** [wildlife perimeter fence](./wildlife-perimeter-fence.md).
