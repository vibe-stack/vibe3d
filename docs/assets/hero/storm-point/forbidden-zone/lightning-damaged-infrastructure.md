...
---
asset_id: "asset.storm-point.forbidden-zone.lightning-damaged-infrastructure"
source_label: "lightning-damaged infrastructure"
...
# lightning-damaged infrastructure

## Identity

- **Asset ID:** asset.storm-point.forbidden-zone.lightning-damaged-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1444
...
![lightning-damaged infrastructure reference render](lightning-damaged-infrastructure.png)

## Intent

The **lightning-damaged infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **lightning-damaged infrastructure** as a useful,
