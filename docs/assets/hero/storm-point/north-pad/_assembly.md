...
---
assembly_id: "assembly.storm-point.north-pad"
source_label: "North Pad"
...
# North Pad — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.north-pad
...
- **Source:** prop-list.md:1458

## Landmark promise

North Pad is a landmark, not a pile of unrelated props. The full assembly
...
- [huge northern landing pad](./huge-northern-landing-pad.md) — component brief.
- [storage buildings](./storage-buildings.md) — component brief.
- [cargo infrastructure](./cargo-infrastructure.md) — component brief.
