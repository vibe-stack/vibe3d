...
---
asset_id: "asset.storm-point.north-pad.storage-buildings"
source_label: "storage buildings"
source_section: "Hero / Storm Point"
source_group: "North Pad"
source_line: 1459
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.north-pad.storage-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1459
...
![storage buildings reference render](storage-buildings.png)

## Intent

The **storage buildings** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **storage buildings** as a useful,
...
- **Parent assembly:** [North Pad assembly](./_assembly.md).

- **POI sibling component:** [huge northern landing pad](./huge-northern-landing-pad.md).
