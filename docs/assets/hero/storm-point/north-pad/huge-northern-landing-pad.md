...
---
asset_id: "asset.storm-point.north-pad.huge-northern-landing-pad"
source_label: "huge northern landing pad"
...
# huge northern landing pad

## Identity

- **Asset ID:** asset.storm-point.north-pad.huge-northern-landing-pad
...
![huge northern landing pad reference render](huge-northern-landing-pad.png)

## Intent

The **huge northern landing pad** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **huge northern landing pad** as a useful,
...
- **POI sibling component:** [storage buildings](./storage-buildings.md).
