...
---
asset_id: "asset.storm-point.north-pad.cargo-infrastructure"
source_label: "cargo infrastructure"
...
- **Asset ID:** asset.storm-point.north-pad.cargo-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1460
...
![cargo infrastructure reference render](cargo-infrastructure.png)

## Intent

The **cargo infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **cargo infrastructure** as a useful,
