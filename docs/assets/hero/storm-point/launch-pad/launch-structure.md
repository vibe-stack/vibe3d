...
---
asset_id: "asset.storm-point.launch-pad.launch-structure"
source_label: "launch structure"
...
- **Asset ID:** asset.storm-point.launch-pad.launch-structure
- **Type:** POI hero component
- **Source:** prop-list.md:1378
...
![launch structure reference render](launch-structure.png)

## Intent

The **launch structure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **launch structure** as a useful,
