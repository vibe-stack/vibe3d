...
---
asset_id: "asset.storm-point.launch-pad.suspended-platforms"
...
- **Asset ID:** asset.storm-point.launch-pad.suspended-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1380
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **suspended platforms** as a useful,
