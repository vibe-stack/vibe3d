...
---
asset_id: "asset.storm-point.launch-pad.giant-launch-landing-pad"
source_label: "giant launch/landing pad"
...
# giant launch/landing pad

## Identity

- **Asset ID:** asset.storm-point.launch-pad.giant-launch-landing-pad
...
![giant launch/landing pad reference render](giant-launch-landing-pad.png)

## Intent

The **giant launch/landing pad** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **giant launch/landing pad** as a useful,
...
- **POI sibling component:** [launch structure](./launch-structure.md).
