...
---
asset_id: "asset.storm-point.launch-pad.service-buildings"
source_label: "service buildings"
source_section: "Hero / Storm Point"
source_group: "Launch Pad"
source_line: 1379
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.launch-pad.service-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1379
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **service buildings** as a useful,
...
- **Parent assembly:** [Launch Pad assembly](./_assembly.md).

- **POI sibling component:** [giant launch/landing pad](./giant-launch-landing-pad.md).
