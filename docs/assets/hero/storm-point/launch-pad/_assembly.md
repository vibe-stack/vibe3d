...
---
assembly_id: "assembly.storm-point.launch-pad"
source_label: "Launch Pad"
...
# Launch Pad — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.launch-pad
...
- **Source:** prop-list.md:1377

## Landmark promise

Launch Pad is a landmark, not a pile of unrelated props. The full assembly
...
- [giant launch/landing pad](./giant-launch-landing-pad.md) — component brief.
- [launch structure](./launch-structure.md) — component brief.
