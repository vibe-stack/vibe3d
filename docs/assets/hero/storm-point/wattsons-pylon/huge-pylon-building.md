...
---
asset_id: "asset.storm-point.wattsons-pylon.huge-pylon-building"
source_label: "huge Pylon building"
source_section: "Hero / Storm Point"
source_group: "Wattson's Pylon"
source_line: 1384
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.wattsons-pylon.huge-pylon-building
- **Type:** POI hero component
- **Source:** prop-list.md:1384
...
![huge Pylon building reference render](huge-pylon-building.png)

## Intent

The **huge Pylon building** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **huge Pylon building** as a useful,
...
- **Parent assembly:** [Wattson's Pylon assembly](./_assembly.md).

- **POI sibling component:** [central Charge Tower](./central-charge-tower.md).
