...
---
asset_id: "asset.storm-point.wattsons-pylon.integrated-gravity-cannon"
source_label: "integrated Gravity Cannon"
...
# integrated Gravity Cannon

## Identity

- **Asset ID:** asset.storm-point.wattsons-pylon.integrated-gravity-cannon
- **Type:** POI hero component
- **Source:** prop-list.md:1387
...
![integrated Gravity Cannon reference render](integrated-gravity-cannon.png)

## Intent

The **integrated Gravity Cannon** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **integrated Gravity Cannon** as a useful,
...
- **POI sibling component:** [huge Pylon building](./huge-pylon-building.md).
