...
---
asset_id: "asset.storm-point.wattsons-pylon.central-charge-tower"
source_label: "central Charge Tower"
...
# central Charge Tower

## Identity

- **Asset ID:** asset.storm-point.wattsons-pylon.central-charge-tower
- **Type:** POI hero component
- **Source:** prop-list.md:1385
...
![central Charge Tower reference render](central-charge-tower.png)

## Intent

The **central Charge Tower** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **central Charge Tower** as a useful,
