...
---
assembly_id: "assembly.storm-point.wattsons-pylon"
source_label: "Wattson's Pylon"
...
# Wattson's Pylon — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.wattsons-pylon
...
Wattson's Pylon is a landmark, not a pile of unrelated props. The full assembly
...
- [huge Pylon building](./huge-pylon-building.md) — component brief.
- [central Charge Tower](./central-charge-tower.md) — component brief.
- [giant power equipment](./giant-power-equipment.md) — component brief.
- [integrated Gravity Cannon](./integrated-gravity-cannon.md) — component brief.
- [interior vertical atrium](./interior-vertical-atrium.md) — component brief.
