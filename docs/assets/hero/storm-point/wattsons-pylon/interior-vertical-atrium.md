...
---
asset_id: "asset.storm-point.wattsons-pylon.interior-vertical-atrium"
source_label: "interior vertical atrium"
...
# interior vertical atrium

## Identity

- **Asset ID:** asset.storm-point.wattsons-pylon.interior-vertical-atrium
- **Type:** POI hero component
- **Source:** prop-list.md:1388
...
![interior vertical atrium reference render](interior-vertical-atrium.png)

## Intent

The **interior vertical atrium** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **interior vertical atrium** as a useful,
