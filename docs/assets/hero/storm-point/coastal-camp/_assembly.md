...
---
assembly_id: "assembly.storm-point.coastal-camp"
source_label: "Coastal Camp"
...
# Coastal Camp — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.coastal-camp
...
- **Source:** prop-list.md:1471

## Landmark promise

Coastal Camp is a landmark, not a pile of unrelated props. The full assembly
...
- [ECHO/prefab coastal camp](./echo-prefab-coastal-camp.md) — component brief.
- [raised huts](./raised-huts.md) — component brief.
- [sea defenses](./sea-defenses.md) — component brief.
