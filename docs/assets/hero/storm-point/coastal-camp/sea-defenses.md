...
---
asset_id: "asset.storm-point.coastal-camp.sea-defenses"
source_label: "sea defenses"
...
- **Asset ID:** asset.storm-point.coastal-camp.sea-defenses
- **Type:** POI hero component
- **Source:** prop-list.md:1473
...
![sea defenses reference render](sea-defenses.png)

## Intent

The **sea defenses** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **sea defenses** as a useful,
...
- **POI sibling component:** [ECHO/prefab coastal camp](./echo-prefab-coastal-camp.md).
