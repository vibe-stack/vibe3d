...
---
asset_id: "asset.storm-point.coastal-camp.echo-prefab-coastal-camp"
source_label: "ECHO/prefab coastal camp"
source_section: "Hero / Storm Point"
source_group: "Coastal Camp"
source_line: 1471
level: L3
status: planned
...
# ECHO/prefab coastal camp

## Identity

- **Asset ID:** asset.storm-point.coastal-camp.echo-prefab-coastal-camp
...
![ECHO/prefab coastal camp reference render](echo-prefab-coastal-camp.png)

## Intent

The **ECHO/prefab coastal camp** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **ECHO/prefab coastal camp** as a useful,
...
- **Parent assembly:** [Coastal Camp assembly](./_assembly.md).

- **POI sibling component:** [raised huts](./raised-huts.md).
