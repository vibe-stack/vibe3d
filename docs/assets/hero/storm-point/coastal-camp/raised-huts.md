...
---
asset_id: "asset.storm-point.coastal-camp.raised-huts"
source_label: "raised huts"
...
- **Asset ID:** asset.storm-point.coastal-camp.raised-huts
- **Type:** POI hero component
- **Source:** prop-list.md:1472
...
![raised huts reference render](raised-huts.png)

## Intent

The **raised huts** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **raised huts** as a useful,
