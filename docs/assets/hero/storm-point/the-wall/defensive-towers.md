...
---
asset_id: "asset.storm-point.the-wall.defensive-towers"
source_label: "defensive towers"
...
- **Asset ID:** asset.storm-point.the-wall.defensive-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1349
...
![defensive towers reference render](defensive-towers.png)

## Intent

The **defensive towers** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **defensive towers** as a useful,
