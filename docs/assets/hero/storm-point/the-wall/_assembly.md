...
---
assembly_id: "assembly.storm-point.the-wall"
source_label: "The Wall"
...
# The Wall — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.the-wall
...
- **Source:** prop-list.md:1348

## Landmark promise

The Wall is a landmark, not a pile of unrelated props. The full assembly
...
- [huge fortified IMC wall](./huge-fortified-imc-wall.md) — component brief.
- [defensive towers](./defensive-towers.md) — component brief.
- [internal rooms](./internal-rooms.md) — component brief.
- [large gate](./large-gate.md) — component brief.
