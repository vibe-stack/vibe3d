...
---
asset_id: "asset.storm-point.the-wall.large-gate"
source_label: "large gate"
...
- **Asset ID:** asset.storm-point.the-wall.large-gate
- **Type:** POI hero component
- **Source:** prop-list.md:1351
...
![large gate reference render](large-gate.png)

## Intent

The **large gate** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **large gate** as a useful,
