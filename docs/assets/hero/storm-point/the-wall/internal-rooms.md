...
---
asset_id: "asset.storm-point.the-wall.internal-rooms"
source_label: "internal rooms"
source_section: "Hero / Storm Point"
source_group: "The Wall"
source_line: 1350
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.the-wall.internal-rooms
- **Type:** POI hero component
- **Source:** prop-list.md:1350
...
![internal rooms reference render](internal-rooms.png)

## Intent

The **internal rooms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **internal rooms** as a useful,
...
- **Parent assembly:** [The Wall assembly](./_assembly.md).

- **POI sibling component:** [huge fortified IMC wall](./huge-fortified-imc-wall.md).
