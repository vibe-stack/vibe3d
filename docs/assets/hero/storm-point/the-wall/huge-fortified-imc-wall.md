...
---
asset_id: "asset.storm-point.the-wall.huge-fortified-imc-wall"
source_label: "huge fortified IMC wall"
...
# huge fortified IMC wall

## Identity

- **Asset ID:** asset.storm-point.the-wall.huge-fortified-imc-wall
...
![huge fortified IMC wall reference render](huge-fortified-imc-wall.png)

## Intent

The **huge fortified IMC wall** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **huge fortified IMC wall** as a useful,
...
- **POI sibling component:** [defensive towers](./defensive-towers.md).
