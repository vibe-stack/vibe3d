...
---
asset_id: "asset.storm-point.checkpoint.checkpoint-machinery"
source_label: "checkpoint machinery"
...
- **Asset ID:** asset.storm-point.checkpoint.checkpoint-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1373
...
![checkpoint machinery reference render](checkpoint-machinery.png)

## Intent

The **checkpoint machinery** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **checkpoint machinery** as a useful,
