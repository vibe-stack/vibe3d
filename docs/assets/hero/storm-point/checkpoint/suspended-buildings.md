...
---
asset_id: "asset.storm-point.checkpoint.suspended-buildings"
source_label: "suspended buildings"
source_section: "Hero / Storm Point"
source_group: "Checkpoint"
source_line: 1371
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.checkpoint.suspended-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1371
...
![suspended buildings reference render](suspended-buildings.png)

## Intent

The **suspended buildings** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **suspended buildings** as a useful,
...
- **Parent assembly:** [Checkpoint assembly](./_assembly.md).

- **POI sibling component:** [elevated bridge/checkpoint structure](./elevated-bridge-checkpoint-structure.md).
