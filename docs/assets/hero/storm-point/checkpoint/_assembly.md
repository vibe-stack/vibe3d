...
---
assembly_id: "assembly.storm-point.checkpoint"
...
# Checkpoint — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.checkpoint
...
- **Source:** prop-list.md:1370

## Landmark promise

Checkpoint is a landmark, not a pile of unrelated props. The full assembly
...
- [elevated bridge/checkpoint structure](./elevated-bridge-checkpoint-structure.md) — component brief.
- [suspended buildings](./suspended-buildings.md) — component brief.
- [bridge towers](./bridge-towers.md) — component brief.
- [checkpoint machinery](./checkpoint-machinery.md) — component brief.
