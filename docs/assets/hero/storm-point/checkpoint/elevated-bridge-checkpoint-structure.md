...
---
asset_id: "asset.storm-point.checkpoint.elevated-bridge-checkpoint-structure"
source_label: "elevated bridge/checkpoint structure"
...
# elevated bridge/checkpoint structure

## Identity

- **Asset ID:** asset.storm-point.checkpoint.elevated-bridge-checkpoint-structure
...
![elevated bridge/checkpoint structure reference render](elevated-bridge-checkpoint-structure.png)

## Intent

The **elevated bridge/checkpoint structure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **elevated bridge/checkpoint structure** as a useful,
...
- **POI sibling component:** [suspended buildings](./suspended-buildings.md).
