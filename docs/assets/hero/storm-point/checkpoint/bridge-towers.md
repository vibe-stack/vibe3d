...
---
asset_id: "asset.storm-point.checkpoint.bridge-towers"
source_label: "bridge towers"
...
- **Asset ID:** asset.storm-point.checkpoint.bridge-towers
- **Type:** POI hero component
- **Source:** prop-list.md:1372
...
![bridge towers reference render](bridge-towers.png)

## Intent

The **bridge towers** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **bridge towers** as a useful,
