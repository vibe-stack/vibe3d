...
---
asset_id: "asset.storm-point.lightning-rod.elevated-platforms"
source_label: "elevated platforms"
...
- **Asset ID:** asset.storm-point.lightning-rod.elevated-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1358
...
![elevated platforms reference render](elevated-platforms.png)

## Intent

The **elevated platforms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **elevated platforms** as a useful,
