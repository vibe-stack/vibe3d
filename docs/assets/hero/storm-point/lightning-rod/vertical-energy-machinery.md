...
---
asset_id: "asset.storm-point.lightning-rod.vertical-energy-machinery"
source_label: "vertical energy machinery"
source_section: "Hero / Storm Point"
source_group: "Lightning Rod"
source_line: 1357
level: L3
status: planned
...
# vertical energy machinery

## Identity

- **Asset ID:** asset.storm-point.lightning-rod.vertical-energy-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1357
...
![vertical energy machinery reference render](vertical-energy-machinery.png)

## Intent

The **vertical energy machinery** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **vertical energy machinery** as a useful,
...
- **Parent assembly:** [Lightning Rod assembly](./_assembly.md).

- **POI sibling component:** [enormous lightning tower](./enormous-lightning-tower.md).
