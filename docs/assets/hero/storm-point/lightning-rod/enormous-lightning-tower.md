...
---
asset_id: "asset.storm-point.lightning-rod.enormous-lightning-tower"
source_label: "enormous lightning tower"
...
# enormous lightning tower

## Identity

- **Asset ID:** asset.storm-point.lightning-rod.enormous-lightning-tower
...
![enormous lightning tower reference render](enormous-lightning-tower.png)

## Intent

The **enormous lightning tower** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **enormous lightning tower** as a useful,
...
- **POI sibling component:** [vertical energy machinery](./vertical-energy-machinery.md).
