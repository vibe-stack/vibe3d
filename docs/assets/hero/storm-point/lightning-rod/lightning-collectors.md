...
---
asset_id: "asset.storm-point.lightning-rod.lightning-collectors"
source_label: "lightning collectors"
...
- **Asset ID:** asset.storm-point.lightning-rod.lightning-collectors
- **Type:** POI hero component
- **Source:** prop-list.md:1359
...
![lightning collectors reference render](lightning-collectors.png)

## Intent

The **lightning collectors** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **lightning collectors** as a useful,
