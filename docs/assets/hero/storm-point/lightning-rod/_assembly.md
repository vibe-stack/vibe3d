...
---
assembly_id: "assembly.storm-point.lightning-rod"
source_label: "Lightning Rod"
...
# Lightning Rod — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.lightning-rod
...
- **Source:** prop-list.md:1356

## Landmark promise

Lightning Rod is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous lightning tower](./enormous-lightning-tower.md) — component brief.
- [vertical energy machinery](./vertical-energy-machinery.md) — component brief.
- [elevated platforms](./elevated-platforms.md) — component brief.
- [lightning collectors](./lightning-collectors.md) — component brief.
