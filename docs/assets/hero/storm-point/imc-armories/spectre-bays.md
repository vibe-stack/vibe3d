...
---
asset_id: "asset.storm-point.imc-armories.spectre-bays"
source_label: "Spectre bays"
...
- **Asset ID:** asset.storm-point.imc-armories.spectre-bays
- **Type:** POI hero component
- **Source:** prop-list.md:1450
...
![Spectre bays reference render](spectre-bays.png)

## Intent

The **Spectre bays** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **Spectre bays** as a useful,
