...
---
asset_id: "asset.storm-point.imc-armories.loot-chamber"
source_label: "loot chamber"
...
- **Asset ID:** asset.storm-point.imc-armories.loot-chamber
- **Type:** POI hero component
- **Source:** prop-list.md:1452
...
![loot chamber reference render](loot-chamber.png)

## Intent

The **loot chamber** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **loot chamber** as a useful,
