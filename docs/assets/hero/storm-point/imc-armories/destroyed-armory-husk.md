...
---
asset_id: "asset.storm-point.imc-armories.destroyed-armory-husk"
source_label: "destroyed Armory husk"
source_section: "Hero / Storm Point"
source_group: "IMC Armories"
source_line: 1449
level: L3
status: planned
...
# destroyed Armory husk

## Identity

- **Asset ID:** asset.storm-point.imc-armories.destroyed-armory-husk
- **Type:** POI hero component
- **Source:** prop-list.md:1449
...
![destroyed Armory husk reference render](destroyed-armory-husk.png)

## Intent

The **destroyed Armory husk** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **destroyed Armory husk** as a useful,
...
- **Parent assembly:** [IMC Armories assembly](./_assembly.md).

- **POI sibling component:** [intact Armory](./intact-armory.md).
