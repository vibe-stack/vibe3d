...
---
asset_id: "asset.storm-point.imc-armories.intact-armory"
source_label: "intact Armory"
...
- **Asset ID:** asset.storm-point.imc-armories.intact-armory
...
![intact Armory reference render](intact-armory.png)

## Intent

The **intact Armory** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **intact Armory** as a useful,
...
- **POI sibling component:** [destroyed Armory husk](./destroyed-armory-husk.md).
