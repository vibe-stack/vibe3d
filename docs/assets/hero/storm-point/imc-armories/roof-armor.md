...
---
asset_id: "asset.storm-point.imc-armories.roof-armor"
source_label: "roof armor"
...
- **Asset ID:** asset.storm-point.imc-armories.roof-armor
- **Type:** POI hero component
- **Source:** prop-list.md:1451
...
![roof armor reference render](roof-armor.png)

## Intent

The **roof armor** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **roof armor** as a useful,
