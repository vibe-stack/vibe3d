...
---
assembly_id: "assembly.storm-point.imc-armories"
source_label: "IMC Armories"
...
# IMC Armories — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.imc-armories
...
- **Source:** prop-list.md:1448

## Landmark promise

IMC Armories is a landmark, not a pile of unrelated props. The full assembly
...
- [intact Armory](./intact-armory.md) — component brief.
- [destroyed Armory husk](./destroyed-armory-husk.md) — component brief.
- [Spectre bays](./spectre-bays.md) — component brief.
- [roof armor](./roof-armor.md) — component brief.
- [loot chamber](./loot-chamber.md) — component brief.
