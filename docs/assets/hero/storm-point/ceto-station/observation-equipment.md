...
---
asset_id: "asset.storm-point.ceto-station.observation-equipment"
source_label: "observation equipment"
...
- **Asset ID:** asset.storm-point.ceto-station.observation-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1397
...
![observation equipment reference render](observation-equipment.png)

## Intent

The **observation equipment** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **observation equipment** as a useful,
