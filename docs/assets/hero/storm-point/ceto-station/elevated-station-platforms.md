...
---
asset_id: "asset.storm-point.ceto-station.elevated-station-platforms"
source_label: "elevated station platforms"
...
- **Asset ID:** asset.storm-point.ceto-station.elevated-station-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1396
...
![elevated station platforms reference render](elevated-station-platforms.png)

## Intent

The **elevated station platforms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **elevated station platforms** as a useful,
