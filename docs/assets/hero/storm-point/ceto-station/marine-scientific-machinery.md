...
---
asset_id: "asset.storm-point.ceto-station.marine-scientific-machinery"
source_label: "marine/scientific machinery"
source_section: "Hero / Storm Point"
source_group: "CETO Station"
source_line: 1395
level: L3
status: planned
...
# marine/scientific machinery

## Identity

- **Asset ID:** asset.storm-point.ceto-station.marine-scientific-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1395
...
![marine/scientific machinery reference render](marine-scientific-machinery.png)

## Intent

The **marine/scientific machinery** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **marine/scientific machinery** as a useful,
...
- **Parent assembly:** [CETO Station assembly](./_assembly.md).

- **POI sibling component:** [enormous research station](./enormous-research-station.md).
