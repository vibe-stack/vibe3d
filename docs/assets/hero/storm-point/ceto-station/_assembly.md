...
---
assembly_id: "assembly.storm-point.ceto-station"
source_label: "CETO Station"
...
# CETO Station — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.ceto-station
...
- **Source:** prop-list.md:1394

## Landmark promise

CETO Station is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous research station](./enormous-research-station.md) — component brief.
- [marine/scientific machinery](./marine-scientific-machinery.md) — component brief.
- [elevated station platforms](./elevated-station-platforms.md) — component brief.
- [observation equipment](./observation-equipment.md) — component brief.
