...
---
asset_id: "asset.storm-point.ceto-station.enormous-research-station"
source_label: "enormous research station"
...
# enormous research station

## Identity

- **Asset ID:** asset.storm-point.ceto-station.enormous-research-station
...
![enormous research station reference render](enormous-research-station.png)

## Intent

The **enormous research station** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **enormous research station** as a useful,
...
- **POI sibling component:** [marine/scientific machinery](./marine-scientific-machinery.md).
