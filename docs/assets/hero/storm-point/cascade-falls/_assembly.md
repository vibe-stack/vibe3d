...
---
assembly_id: "assembly.storm-point.cascade-falls"
source_label: "Cascade Falls"
...
# Cascade Falls — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.cascade-falls
...
Cascade Falls is a landmark, not a pile of unrelated props. The full assembly
...
- [waterfall complex](./waterfall-complex.md) — component brief.
- [elevated settlement](./elevated-settlement.md) — component brief.
- [bridges](./bridges.md) — component brief.
- [cliff buildings](./cliff-buildings.md) — component brief.
