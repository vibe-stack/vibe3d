...
---
asset_id: "asset.storm-point.cascade-falls.elevated-settlement"
source_label: "elevated settlement"
source_section: "Hero / Storm Point"
source_group: "Cascade Falls"
source_line: 1465
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.cascade-falls.elevated-settlement
- **Type:** POI hero component
- **Source:** prop-list.md:1465
...
![elevated settlement reference render](elevated-settlement.png)

## Intent

The **elevated settlement** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **elevated settlement** as a useful,
...
- **Parent assembly:** [Cascade Falls assembly](./_assembly.md).

- **POI sibling component:** [waterfall complex](./waterfall-complex.md).
