...
---
asset_id: "asset.storm-point.cascade-falls.cliff-buildings"
source_label: "cliff buildings"
...
- **Asset ID:** asset.storm-point.cascade-falls.cliff-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1467
...
![cliff buildings reference render](cliff-buildings.png)

## Intent

The **cliff buildings** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **cliff buildings** as a useful,
