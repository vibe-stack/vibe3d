...
---
asset_id: "asset.storm-point.cascade-falls.waterfall-complex"
source_label: "waterfall complex"
...
- **Asset ID:** asset.storm-point.cascade-falls.waterfall-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1464
...
![waterfall complex reference render](waterfall-complex.png)

## Intent

The **waterfall complex** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **waterfall complex** as a useful,
...
- **POI sibling component:** [elevated settlement](./elevated-settlement.md).
