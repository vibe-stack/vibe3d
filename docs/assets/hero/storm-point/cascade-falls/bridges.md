...
---
asset_id: "asset.storm-point.cascade-falls.bridges"
...
- **Asset ID:** asset.storm-point.cascade-falls.bridges
- **Type:** POI hero component
- **Source:** prop-list.md:1466
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **bridges** as a useful,
