...
---
asset_id: "asset.storm-point.barometer.rotating-ring"
source_label: "rotating ring"
...
- **Asset ID:** asset.storm-point.barometer.rotating-ring
- **Type:** POI hero component
- **Source:** prop-list.md:1324
...
![rotating ring reference render](rotating-ring.png)

## Intent

The **rotating ring** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **rotating ring** as a useful,
