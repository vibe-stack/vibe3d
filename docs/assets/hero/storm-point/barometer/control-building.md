...
---
asset_id: "asset.storm-point.barometer.control-building"
source_label: "control building"
source_section: "Hero / Storm Point"
source_group: "Barometer"
source_line: 1328
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.barometer.control-building
- **Type:** POI hero component
- **Source:** prop-list.md:1328
...
![control building reference render](control-building.png)

## Intent

The **control building** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **control building** as a useful,
...
- **Parent assembly:** [Barometer assembly](./_assembly.md).

- **POI sibling component:** [gigantic circular Barometer turbine](./gigantic-circular-barometer-turbine.md).
