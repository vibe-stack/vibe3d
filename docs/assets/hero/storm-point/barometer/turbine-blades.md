...
---
asset_id: "asset.storm-point.barometer.turbine-blades"
source_label: "turbine blades"
...
- **Asset ID:** asset.storm-point.barometer.turbine-blades
- **Type:** POI hero component
- **Source:** prop-list.md:1325
...
![turbine blades reference render](turbine-blades.png)

## Intent

The **turbine blades** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **turbine blades** as a useful,
