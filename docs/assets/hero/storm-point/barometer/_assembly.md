...
---
assembly_id: "assembly.storm-point.barometer"
source_label: "Barometer"
...
# Barometer — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.barometer
...
Barometer is a landmark, not a pile of unrelated props. The full assembly
...
- [gigantic circular Barometer turbine](./gigantic-circular-barometer-turbine.md) — component brief.
- [rotating ring](./rotating-ring.md) — component brief.
- [turbine blades](./turbine-blades.md) — component brief.
- [central tower](./central-tower.md) — component brief.
- [exterior platforms](./exterior-platforms.md) — component brief.
- [control building](./control-building.md) — component brief.
