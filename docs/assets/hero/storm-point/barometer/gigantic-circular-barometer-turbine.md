...
---
asset_id: "asset.storm-point.barometer.gigantic-circular-barometer-turbine"
source_label: "gigantic circular Barometer turbine"
...
# gigantic circular Barometer turbine

## Identity

- **Asset ID:** asset.storm-point.barometer.gigantic-circular-barometer-turbine
- **Type:** POI hero component
- **Source:** prop-list.md:1323
...
![gigantic circular Barometer turbine reference render](gigantic-circular-barometer-turbine.png)

## Intent

The **gigantic circular Barometer turbine** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **gigantic circular Barometer turbine** as a useful,
...
- **POI sibling component:** [rotating ring](./rotating-ring.md).
