...
---
asset_id: "asset.storm-point.barometer.exterior-platforms"
source_label: "exterior platforms"
...
- **Asset ID:** asset.storm-point.barometer.exterior-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1327
...
![exterior platforms reference render](exterior-platforms.png)

## Intent

The **exterior platforms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **exterior platforms** as a useful,
