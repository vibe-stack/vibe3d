...
---
asset_id: "asset.storm-point.barometer.central-tower"
...
- **Asset ID:** asset.storm-point.barometer.central-tower
- **Type:** POI hero component
- **Source:** prop-list.md:1326
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **central tower** as a useful,
