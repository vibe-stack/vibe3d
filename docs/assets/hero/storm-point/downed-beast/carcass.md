...
---
asset_id: "asset.storm-point.downed-beast.carcass"
source_label: "carcass"
...
- **Asset ID:** asset.storm-point.downed-beast.carcass
- **Type:** POI hero component
- **Source:** prop-list.md:1425
...
![carcass reference render](carcass.png)

## Intent

The **carcass** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **carcass** as a useful,
