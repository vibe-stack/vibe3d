...
---
asset_id: "asset.storm-point.downed-beast.exposed-skeleton"
source_label: "exposed skeleton"
...
- **Asset ID:** asset.storm-point.downed-beast.exposed-skeleton
- **Type:** POI hero component
- **Source:** prop-list.md:1427
...
![exposed skeleton reference render](exposed-skeleton.png)

## Intent

The **exposed skeleton** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **exposed skeleton** as a useful,
