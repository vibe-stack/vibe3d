...
---
asset_id: "asset.storm-point.downed-beast.enormous-dead-sea-creature"
source_label: "enormous dead sea creature"
source_section: "Hero / Storm Point"
source_group: "Downed Beast"
source_line: 1424
level: L3
status: planned
...
# enormous dead sea creature

## Identity

- **Asset ID:** asset.storm-point.downed-beast.enormous-dead-sea-creature
...
![enormous dead sea creature reference render](enormous-dead-sea-creature.png)

## Intent

The **enormous dead sea creature** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **enormous dead sea creature** as a useful,
...
- **Parent assembly:** [Downed Beast assembly](./_assembly.md).

- **POI sibling component:** [carcass](./carcass.md).
