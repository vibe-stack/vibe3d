...
---
asset_id: "asset.storm-point.downed-beast.surrounding-camps"
source_label: "surrounding camps"
...
- **Asset ID:** asset.storm-point.downed-beast.surrounding-camps
- **Type:** POI hero component
- **Source:** prop-list.md:1429
...
![surrounding camps reference render](surrounding-camps.png)

## Intent

The **surrounding camps** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **surrounding camps** as a useful,
...
- **POI sibling component:** [enormous dead sea creature](./enormous-dead-sea-creature.md).
