...
---
asset_id: "asset.storm-point.downed-beast.ribs"
source_label: "ribs"
...
- **Asset ID:** asset.storm-point.downed-beast.ribs
- **Type:** POI hero component
- **Source:** prop-list.md:1426
...
![ribs reference render](ribs.png)

## Intent

The **ribs** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **ribs** as a useful,
