...
---
asset_id: "asset.storm-point.downed-beast.research-scavenging-infrastructure"
source_label: "research/scavenging infrastructure"
...
# research/scavenging infrastructure

## Identity

- **Asset ID:** asset.storm-point.downed-beast.research-scavenging-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1428
...
![research/scavenging infrastructure reference render](research-scavenging-infrastructure.png)

## Intent

The **research/scavenging infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **research/scavenging infrastructure** as a useful,
