...
---
assembly_id: "assembly.storm-point.downed-beast"
source_label: "Downed Beast"
...
# Downed Beast — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.downed-beast
...
- **Source:** prop-list.md:1424

## Landmark promise

Downed Beast is a landmark, not a pile of unrelated props. The full assembly
...
- [enormous dead sea creature](./enormous-dead-sea-creature.md) — component brief.
- [carcass](./carcass.md) — component brief.
- [ribs](./ribs.md) — component brief.
- [exposed skeleton](./exposed-skeleton.md) — component brief.
- [research/scavenging infrastructure](./research-scavenging-infrastructure.md) — component brief.
- [surrounding camps](./surrounding-camps.md) — component brief.
