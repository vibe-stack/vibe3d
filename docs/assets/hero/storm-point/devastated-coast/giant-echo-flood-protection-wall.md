...
---
asset_id: "asset.storm-point.devastated-coast.giant-echo-flood-protection-wall"
source_label: "giant ECHO flood-protection wall"
...
# giant ECHO flood-protection wall

## Identity

- **Asset ID:** asset.storm-point.devastated-coast.giant-echo-flood-protection-wall
- **Type:** POI hero component
- **Source:** prop-list.md:1414
...
![giant ECHO flood-protection wall reference render](giant-echo-flood-protection-wall.png)

## Intent

The **giant ECHO flood-protection wall** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **giant ECHO flood-protection wall** as a useful,
