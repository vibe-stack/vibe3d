...
---
asset_id: "asset.storm-point.devastated-coast.building-hanging-from-crane"
source_label: "building hanging from crane"
...
# building hanging from crane

## Identity

- **Asset ID:** asset.storm-point.devastated-coast.building-hanging-from-crane
- **Type:** POI hero component
- **Source:** prop-list.md:1416
...
![building hanging from crane reference render](building-hanging-from-crane.png)

## Intent

The **building hanging from crane** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **building hanging from crane** as a useful,
