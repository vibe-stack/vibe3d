...
---
asset_id: "asset.storm-point.devastated-coast.ruined-piers-buildings"
source_label: "ruined piers/buildings"
source_section: "Hero / Storm Point"
source_group: "Devastated Coast"
source_line: 1418
level: L3
status: planned
...
# ruined piers/buildings

## Identity

- **Asset ID:** asset.storm-point.devastated-coast.ruined-piers-buildings
- **Type:** POI hero component
- **Source:** prop-list.md:1418
...
![ruined piers/buildings reference render](ruined-piers-buildings.png)

## Intent

The **ruined piers/buildings** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **ruined piers/buildings** as a useful,
...
- **Parent assembly:** [Devastated Coast assembly](./_assembly.md).

- **POI sibling component:** [wrecked Fish Farms](./wrecked-fish-farms.md).
