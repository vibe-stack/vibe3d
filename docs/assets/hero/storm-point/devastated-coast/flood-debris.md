...
---
asset_id: "asset.storm-point.devastated-coast.flood-debris"
source_label: "flood debris"
...
- **Asset ID:** asset.storm-point.devastated-coast.flood-debris
- **Type:** POI hero component
- **Source:** prop-list.md:1417
...
![flood debris reference render](flood-debris.png)

## Intent

The **flood debris** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **flood debris** as a useful,
