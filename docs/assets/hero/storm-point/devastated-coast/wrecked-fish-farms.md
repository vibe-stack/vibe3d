...
---
asset_id: "asset.storm-point.devastated-coast.wrecked-fish-farms"
source_label: "wrecked Fish Farms"
...
- **Asset ID:** asset.storm-point.devastated-coast.wrecked-fish-farms
...
![wrecked Fish Farms reference render](wrecked-fish-farms.png)

## Intent

The **wrecked Fish Farms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **wrecked Fish Farms** as a useful,
...
- **POI sibling component:** [giant ECHO flood-protection wall](./giant-echo-flood-protection-wall.md).
