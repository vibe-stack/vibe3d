...
---
asset_id: "asset.storm-point.devastated-coast.enormous-crane"
source_label: "enormous crane"
...
- **Asset ID:** asset.storm-point.devastated-coast.enormous-crane
- **Type:** POI hero component
- **Source:** prop-list.md:1415
...
![enormous crane reference render](enormous-crane.png)

## Intent

The **enormous crane** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **enormous crane** as a useful,
