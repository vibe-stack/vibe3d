...
---
assembly_id: "assembly.storm-point.devastated-coast"
source_label: "Devastated Coast"
...
# Devastated Coast — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.devastated-coast
- **Map family:** Hero / Storm Point
- **Place identity:** Tropical brutalism, weather infrastructure, coastline, and wildlife
- **Owner / story role:** Axiom Defense / field ecology
- **Source:** prop-list.md:1413

## Landmark promise

Devastated Coast is a landmark, not a pile of unrelated props. The full assembly
...
world coherent. The assembly should communicate storm-worn infrastructure with strong vertical weather machinery and ecological intrusion.
...
- Use FIELD-500 as the dominant hero signal and
  LIME-400 only as a supporting state or traversal cue.
...
- [wrecked Fish Farms](./wrecked-fish-farms.md) — component brief.
- [giant ECHO flood-protection wall](./giant-echo-flood-protection-wall.md) — component brief.
- [enormous crane](./enormous-crane.md) — component brief.
- [building hanging from crane](./building-hanging-from-crane.md) — component brief.
- [flood debris](./flood-debris.md) — component brief.
- [ruined piers/buildings](./ruined-piers-buildings.md) — component brief.
