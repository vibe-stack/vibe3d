...
---
asset_id: "asset.storm-point.the-mill.raised-industrial-platforms"
source_label: "raised industrial platforms"
...
# raised industrial platforms

## Identity

- **Asset ID:** asset.storm-point.the-mill.raised-industrial-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1365
...
![raised industrial platforms reference render](raised-industrial-platforms.png)

## Intent

The **raised industrial platforms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **raised industrial platforms** as a useful,
