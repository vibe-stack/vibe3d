...
---
asset_id: "asset.storm-point.the-mill.connecting-structures"
source_label: "connecting structures"
source_section: "Hero / Storm Point"
source_group: "The Mill"
source_line: 1366
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.the-mill.connecting-structures
- **Type:** POI hero component
- **Source:** prop-list.md:1366
...
![connecting structures reference render](connecting-structures.png)

## Intent

The **connecting structures** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **connecting structures** as a useful,
...
- **Parent assembly:** [The Mill assembly](./_assembly.md).

- **POI sibling component:** [huge paired mill/turbine structures](./huge-paired-mill-turbine-structures.md).
