...
---
assembly_id: "assembly.storm-point.the-mill"
...
# The Mill — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.the-mill
...
- **Source:** prop-list.md:1363

## Landmark promise

The Mill is a landmark, not a pile of unrelated props. The full assembly
...
- [huge paired mill/turbine structures](./huge-paired-mill-turbine-structures.md) — component brief.
- [rotating machinery](./rotating-machinery.md) — component brief.
- [raised industrial platforms](./raised-industrial-platforms.md) — component brief.
- [connecting structures](./connecting-structures.md) — component brief.
