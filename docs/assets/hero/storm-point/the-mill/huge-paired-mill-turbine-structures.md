...
---
asset_id: "asset.storm-point.the-mill.huge-paired-mill-turbine-structures"
source_label: "huge paired mill/turbine structures"
...
# huge paired mill/turbine structures

## Identity

- **Asset ID:** asset.storm-point.the-mill.huge-paired-mill-turbine-structures
...
![huge paired mill/turbine structures reference render](huge-paired-mill-turbine-structures.png)

## Intent

The **huge paired mill/turbine structures** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **huge paired mill/turbine structures** as a useful,
...
- **POI sibling component:** [rotating machinery](./rotating-machinery.md).
