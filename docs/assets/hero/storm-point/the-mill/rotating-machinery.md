...
---
asset_id: "asset.storm-point.the-mill.rotating-machinery"
...
- **Asset ID:** asset.storm-point.the-mill.rotating-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1364
...
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **rotating machinery** as a useful,
