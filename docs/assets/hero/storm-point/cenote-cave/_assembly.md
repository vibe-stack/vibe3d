...
---
assembly_id: "assembly.storm-point.cenote-cave"
source_label: "Cenote Cave"
...
# Cenote Cave — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.cenote-cave
...
- **Source:** prop-list.md:1433

## Landmark promise

Cenote Cave is a landmark, not a pile of unrelated props. The full assembly
...
- [massive cave](./massive-cave.md) — component brief.
- [water pools](./water-pools.md) — component brief.
- [cave settlement](./cave-settlement.md) — component brief.
- [suspended walkways](./suspended-walkways.md) — component brief.
- [tropical cave vegetation](./tropical-cave-vegetation.md) — component brief.
