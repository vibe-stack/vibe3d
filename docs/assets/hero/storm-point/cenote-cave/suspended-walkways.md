...
---
asset_id: "asset.storm-point.cenote-cave.suspended-walkways"
source_label: "suspended walkways"
...
- **Asset ID:** asset.storm-point.cenote-cave.suspended-walkways
- **Type:** POI hero component
- **Source:** prop-list.md:1436
...
![suspended walkways reference render](suspended-walkways.png)

## Intent

The **suspended walkways** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **suspended walkways** as a useful,
