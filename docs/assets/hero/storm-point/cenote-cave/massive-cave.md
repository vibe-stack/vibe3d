...
---
asset_id: "asset.storm-point.cenote-cave.massive-cave"
source_label: "massive cave"
...
- **Asset ID:** asset.storm-point.cenote-cave.massive-cave
...
![massive cave reference render](massive-cave.png)

## Intent

The **massive cave** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **massive cave** as a useful,
...
- **POI sibling component:** [water pools](./water-pools.md).
