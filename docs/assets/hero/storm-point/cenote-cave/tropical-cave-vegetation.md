...
---
asset_id: "asset.storm-point.cenote-cave.tropical-cave-vegetation"
source_label: "tropical cave vegetation"
...
# tropical cave vegetation

## Identity

- **Asset ID:** asset.storm-point.cenote-cave.tropical-cave-vegetation
- **Type:** POI hero component
- **Source:** prop-list.md:1437
...
![tropical cave vegetation reference render](tropical-cave-vegetation.png)

## Intent

The **tropical cave vegetation** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **tropical cave vegetation** as a useful,
