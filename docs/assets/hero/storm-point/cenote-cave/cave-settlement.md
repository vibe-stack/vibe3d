...
---
asset_id: "asset.storm-point.cenote-cave.cave-settlement"
source_label: "cave settlement"
source_section: "Hero / Storm Point"
source_group: "Cenote Cave"
source_line: 1435
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.cenote-cave.cave-settlement
- **Type:** POI hero component
- **Source:** prop-list.md:1435
...
![cave settlement reference render](cave-settlement.png)

## Intent

The **cave settlement** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **cave settlement** as a useful,
...
- **Parent assembly:** [Cenote Cave assembly](./_assembly.md).

- **POI sibling component:** [massive cave](./massive-cave.md).
