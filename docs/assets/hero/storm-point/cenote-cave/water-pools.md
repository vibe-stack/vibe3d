...
---
asset_id: "asset.storm-point.cenote-cave.water-pools"
source_label: "water pools"
...
- **Asset ID:** asset.storm-point.cenote-cave.water-pools
- **Type:** POI hero component
- **Source:** prop-list.md:1434
...
![water pools reference render](water-pools.png)

## Intent

The **water pools** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **water pools** as a useful,
