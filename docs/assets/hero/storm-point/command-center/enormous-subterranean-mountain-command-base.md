...
---
asset_id: "asset.storm-point.command-center.enormous-subterranean-mountain-command-base"
source_label: "enormous subterranean/mountain command base"
...
# enormous subterranean/mountain command base

## Identity

- **Asset ID:** asset.storm-point.command-center.enormous-subterranean-mountain-command-base
- **Type:** POI hero component
- **Source:** prop-list.md:1339
...
![enormous subterranean/mountain command base reference render](enormous-subterranean-mountain-command-base.png)

## Intent

The **enormous subterranean/mountain command base** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **enormous subterranean/mountain command base** as a useful,
...
- **POI sibling component:** [bunker entrance](./bunker-entrance.md).
