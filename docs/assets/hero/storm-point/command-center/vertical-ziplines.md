...
---
asset_id: "asset.storm-point.command-center.vertical-ziplines"
source_label: "vertical ziplines"
...
- **Asset ID:** asset.storm-point.command-center.vertical-ziplines
- **Type:** POI hero component
- **Source:** prop-list.md:1343
...
![vertical ziplines reference render](vertical-ziplines.png)

## Intent

The **vertical ziplines** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **vertical ziplines** as a useful,
