...
---
asset_id: "asset.storm-point.command-center.antenna-systems"
source_label: "antenna systems"
...
- **Asset ID:** asset.storm-point.command-center.antenna-systems
- **Type:** POI hero component
- **Source:** prop-list.md:1344
...
![antenna systems reference render](antenna-systems.png)

## Intent

The **antenna systems** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **antenna systems** as a useful,
