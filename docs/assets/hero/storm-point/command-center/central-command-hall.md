...
---
asset_id: "asset.storm-point.command-center.central-command-hall"
source_label: "central command hall"
...
- **Asset ID:** asset.storm-point.command-center.central-command-hall
- **Type:** POI hero component
- **Source:** prop-list.md:1341
...
![central command hall reference render](central-command-hall.png)

## Intent

The **central command hall** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **central command hall** as a useful,
