...
---
asset_id: "asset.storm-point.command-center.deep-shafts"
source_label: "deep shafts"
...
- **Asset ID:** asset.storm-point.command-center.deep-shafts
- **Type:** POI hero component
- **Source:** prop-list.md:1342
...
![deep shafts reference render](deep-shafts.png)

## Intent

The **deep shafts** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **deep shafts** as a useful,
