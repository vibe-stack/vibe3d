...
---
asset_id: "asset.storm-point.echo-hq.communications-equipment"
source_label: "communications equipment"
...
- **Asset ID:** asset.storm-point.echo-hq.communications-equipment
- **Type:** POI hero component
- **Source:** prop-list.md:1408
...
![communications equipment reference render](communications-equipment.png)

## Intent

The **communications equipment** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **communications equipment** as a useful,
