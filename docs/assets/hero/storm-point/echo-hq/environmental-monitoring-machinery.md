...
---
asset_id: "asset.storm-point.echo-hq.environmental-monitoring-machinery"
source_label: "environmental monitoring machinery"
source_section: "Hero / Storm Point"
source_group: "ECHO HQ"
source_line: 1409
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.echo-hq.environmental-monitoring-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1409
...
![environmental monitoring machinery reference render](environmental-monitoring-machinery.png)

## Intent

The **environmental monitoring machinery** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **environmental monitoring machinery** as a useful,
...
- **Parent assembly:** [ECHO HQ assembly](./_assembly.md).

- **POI sibling component:** [complete ECHO headquarters](./complete-echo-headquarters.md).
