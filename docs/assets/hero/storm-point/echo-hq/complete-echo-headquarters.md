...
---
asset_id: "asset.storm-point.echo-hq.complete-echo-headquarters"
source_label: "complete ECHO headquarters"
...
# complete ECHO headquarters

## Identity

- **Asset ID:** asset.storm-point.echo-hq.complete-echo-headquarters
...
![complete ECHO headquarters reference render](complete-echo-headquarters.png)

## Intent

The **complete ECHO headquarters** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **complete ECHO headquarters** as a useful,
...
- **POI sibling component:** [communications equipment](./communications-equipment.md).
