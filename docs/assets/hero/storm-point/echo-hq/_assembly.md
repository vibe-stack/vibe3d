...
---
assembly_id: "assembly.storm-point.echo-hq"
source_label: "ECHO HQ"
...
# ECHO HQ — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.echo-hq
...
- **Source:** prop-list.md:1407

## Landmark promise

ECHO HQ is a landmark, not a pile of unrelated props. The full assembly
...
- [complete ECHO headquarters](./complete-echo-headquarters.md) — component brief.
- [communications equipment](./communications-equipment.md) — component brief.
- [environmental monitoring machinery](./environmental-monitoring-machinery.md) — component brief.
