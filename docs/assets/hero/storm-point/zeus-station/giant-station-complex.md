...
---
asset_id: "asset.storm-point.zeus-station.giant-station-complex"
source_label: "giant station complex"
source_section: "Hero / Storm Point"
source_group: "ZEUS Station"
source_line: 1401
level: L3
status: planned
...
# giant station complex

## Identity

- **Asset ID:** asset.storm-point.zeus-station.giant-station-complex
- **Type:** POI hero component
- **Source:** prop-list.md:1401
...
![giant station complex reference render](giant-station-complex.png)

## Intent

The **giant station complex** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **giant station complex** as a useful,
...
- **Parent assembly:** [ZEUS Station assembly](./_assembly.md).

- **POI sibling component:** [storm/power apparatus](./storm-power-apparatus.md).
