...
---
asset_id: "asset.storm-point.zeus-station.raised-industrial-infrastructure"
source_label: "raised industrial infrastructure"
...
# raised industrial infrastructure

## Identity

- **Asset ID:** asset.storm-point.zeus-station.raised-industrial-infrastructure
- **Type:** POI hero component
- **Source:** prop-list.md:1403
...
![raised industrial infrastructure reference render](raised-industrial-infrastructure.png)

## Intent

The **raised industrial infrastructure** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **raised industrial infrastructure** as a useful,
