...
---
asset_id: "asset.storm-point.zeus-station.storm-power-apparatus"
source_label: "storm/power apparatus"
...
# storm/power apparatus

## Identity

- **Asset ID:** asset.storm-point.zeus-station.storm-power-apparatus
- **Type:** POI hero component
- **Source:** prop-list.md:1402
...
![storm/power apparatus reference render](storm-power-apparatus.png)

## Intent

The **storm/power apparatus** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **storm/power apparatus** as a useful,
...
- **POI sibling component:** [giant station complex](./giant-station-complex.md).
