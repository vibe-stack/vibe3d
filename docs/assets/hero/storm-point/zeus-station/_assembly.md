...
---
assembly_id: "assembly.storm-point.zeus-station"
source_label: "ZEUS Station"
...
# ZEUS Station — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.zeus-station
...
ZEUS Station is a landmark, not a pile of unrelated props. The full assembly
...
- [giant station complex](./giant-station-complex.md) — component brief.
- [storm/power apparatus](./storm-power-apparatus.md) — component brief.
- [raised industrial infrastructure](./raised-industrial-infrastructure.md) — component brief.
