...
---
asset_id: "asset.storm-point.storm-catcher.giant-storm-energy-tower"
source_label: "giant storm-energy tower"
...
# giant storm-energy tower

## Identity

- **Asset ID:** asset.storm-point.storm-catcher.giant-storm-energy-tower
...
![giant storm-energy tower reference render](giant-storm-energy-tower.png)

## Intent

The **giant storm-energy tower** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **giant storm-energy tower** as a useful,
...
- **POI sibling component:** [power collectors](./power-collectors.md).
