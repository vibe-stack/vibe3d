...
---
asset_id: "asset.storm-point.storm-catcher.interior-machinery"
source_label: "interior machinery"
source_section: "Hero / Storm Point"
source_group: "Storm Catcher"
source_line: 1334
level: L3
status: planned
...
- **Asset ID:** asset.storm-point.storm-catcher.interior-machinery
- **Type:** POI hero component
- **Source:** prop-list.md:1334
...
![interior machinery reference render](interior-machinery.png)

## Intent

The **interior machinery** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **interior machinery** as a useful,
...
- **Parent assembly:** [Storm Catcher assembly](./_assembly.md).

- **POI sibling component:** [giant storm-energy tower](./giant-storm-energy-tower.md).
