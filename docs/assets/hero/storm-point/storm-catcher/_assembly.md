...
---
assembly_id: "assembly.storm-point.storm-catcher"
source_label: "Storm Catcher"
...
# Storm Catcher — hero assembly

## Identity

- **Assembly ID:** assembly.storm-point.storm-catcher
...
- **Source:** prop-list.md:1332

## Landmark promise

Storm Catcher is a landmark, not a pile of unrelated props. The full assembly
...
- [giant storm-energy tower](./giant-storm-energy-tower.md) — component brief.
- [power collectors](./power-collectors.md) — component brief.
- [interior machinery](./interior-machinery.md) — component brief.
- [raised platforms](./raised-platforms.md) — component brief.
