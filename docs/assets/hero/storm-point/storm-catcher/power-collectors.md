...
---
asset_id: "asset.storm-point.storm-catcher.power-collectors"
source_label: "power collectors"
...
- **Asset ID:** asset.storm-point.storm-catcher.power-collectors
- **Type:** POI hero component
- **Source:** prop-list.md:1333
...
![power collectors reference render](power-collectors.png)

## Intent

The **power collectors** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **power collectors** as a useful,
