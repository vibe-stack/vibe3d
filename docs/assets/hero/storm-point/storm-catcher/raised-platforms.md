...
---
asset_id: "asset.storm-point.storm-catcher.raised-platforms"
source_label: "raised platforms"
...
- **Asset ID:** asset.storm-point.storm-catcher.raised-platforms
- **Type:** POI hero component
- **Source:** prop-list.md:1335
...
![raised platforms reference render](raised-platforms.png)

## Intent

The **raised platforms** is a POI hero component for the Axiom Relay kit. It exists to support
storm-worn infrastructure with strong vertical weather machinery and ecological intrusion. Its primary read should be **raised platforms** as a useful,
