...
---
asset_id: "asset.interiors.medical-laboratory.microscope-science-station"
source_label: "microscope/science station"
...
- **Asset ID:** asset.interiors.medical-laboratory.microscope-science-station
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:677
...
![microscope/science station reference render](microscope-science-station.png)

## Intent

The **microscope/science station** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **microscope/science station** as a useful,
