...
---
asset_id: "asset.interiors.medical-laboratory.operating-light"
source_label: "operating light"
...
- **Asset ID:** asset.interiors.medical-laboratory.operating-light
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:686
...
![operating light reference render](operating-light.png)

## Intent

The **operating light** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **operating light** as a useful,
