...
---
asset_id: "asset.interiors.medical-laboratory.hospital-bed"
source_label: "hospital bed"
...
- **Asset ID:** asset.interiors.medical-laboratory.hospital-bed
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:672
...
![hospital bed reference render](hospital-bed.png)

## Intent

The **hospital bed** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **hospital bed** as a useful,
