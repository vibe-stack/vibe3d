...
---
asset_id: "asset.interiors.medical-laboratory.medical-cart"
source_label: "medical cart"
...
- **Asset ID:** asset.interiors.medical-laboratory.medical-cart
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:685
...
![medical cart reference render](medical-cart.png)

## Intent

The **medical cart** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **medical cart** as a useful,
