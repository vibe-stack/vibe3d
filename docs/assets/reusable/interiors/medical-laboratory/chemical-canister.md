...
---
asset_id: "asset.interiors.medical-laboratory.chemical-canister"
source_label: "chemical canister"
...
- **Asset ID:** asset.interiors.medical-laboratory.chemical-canister
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:680
...
![chemical canister reference render](chemical-canister.png)

## Intent

The **chemical canister** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **chemical canister** as a useful,
