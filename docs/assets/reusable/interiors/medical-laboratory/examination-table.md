...
---
asset_id: "asset.interiors.medical-laboratory.examination-table"
source_label: "examination table"
...
- **Asset ID:** asset.interiors.medical-laboratory.examination-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:673
...
![examination table reference render](examination-table.png)

## Intent

The **examination table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **examination table** as a useful,
