...
---
asset_id: "asset.interiors.medical-laboratory.specimen-tank"
source_label: "specimen tank"
...
- **Asset ID:** asset.interiors.medical-laboratory.specimen-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:678
...
![specimen tank reference render](specimen-tank.png)

## Intent

The **specimen tank** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **specimen tank** as a useful,
