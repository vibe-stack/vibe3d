...
---
asset_id: "asset.interiors.medical-laboratory.lab-computer"
source_label: "lab computer"
...
- **Asset ID:** asset.interiors.medical-laboratory.lab-computer
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:681
...
![lab computer reference render](lab-computer.png)

## Intent

The **lab computer** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **lab computer** as a useful,
