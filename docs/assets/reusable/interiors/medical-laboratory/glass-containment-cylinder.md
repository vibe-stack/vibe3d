...
---
asset_id: "asset.interiors.medical-laboratory.glass-containment-cylinder"
source_label: "glass containment cylinder"
...
- **Asset ID:** asset.interiors.medical-laboratory.glass-containment-cylinder
- **Type:** industrial service prop
- **Source:** prop-list.md:679
...
![glass containment cylinder reference render](glass-containment-cylinder.png)

## Intent

The **glass containment cylinder** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **glass containment cylinder** as a useful,
