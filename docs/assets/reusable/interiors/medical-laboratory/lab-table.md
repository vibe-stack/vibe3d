...
---
asset_id: "asset.interiors.medical-laboratory.lab-table"
source_label: "lab table"
...
- **Asset ID:** asset.interiors.medical-laboratory.lab-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:676
...
![lab table reference render](lab-table.png)

## Intent

The **lab table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **lab table** as a useful,
