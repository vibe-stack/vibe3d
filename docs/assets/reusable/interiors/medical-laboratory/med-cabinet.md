...
---
asset_id: "asset.interiors.medical-laboratory.med-cabinet"
source_label: "med cabinet"
...
- **Asset ID:** asset.interiors.medical-laboratory.med-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:675
...
![med cabinet reference render](med-cabinet.png)

## Intent

The **med cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **med cabinet** as a useful,
