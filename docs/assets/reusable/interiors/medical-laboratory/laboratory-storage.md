...
---
asset_id: "asset.interiors.medical-laboratory.laboratory-storage"
source_label: "laboratory storage"
...
- **Asset ID:** asset.interiors.medical-laboratory.laboratory-storage
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:682
...
![laboratory storage reference render](laboratory-storage.png)

## Intent

The **laboratory storage** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **laboratory storage** as a useful,
