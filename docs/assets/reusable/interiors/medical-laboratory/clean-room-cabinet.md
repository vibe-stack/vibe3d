...
---
asset_id: "asset.interiors.medical-laboratory.clean-room-cabinet"
source_label: "clean-room cabinet"
source_section: "Reusable / interiors"
source_group: "Medical / laboratory"
source_line: 683
level: L2
status: planned
...
- **Asset ID:** asset.interiors.medical-laboratory.clean-room-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:683
...
![clean-room cabinet reference render](clean-room-cabinet.png)

## Intent

The **clean-room cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **clean-room cabinet** as a useful,
