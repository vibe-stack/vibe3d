...
---
asset_id: "asset.interiors.medical-laboratory.medical-scanner"
source_label: "medical scanner"
...
- **Asset ID:** asset.interiors.medical-laboratory.medical-scanner
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:674
...
![medical scanner reference render](medical-scanner.png)

## Intent

The **medical scanner** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **medical scanner** as a useful,
