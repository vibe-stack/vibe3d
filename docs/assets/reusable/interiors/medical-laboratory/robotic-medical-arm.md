...
---
asset_id: "asset.interiors.medical-laboratory.robotic-medical-arm"
source_label: "robotic medical arm"
...
- **Asset ID:** asset.interiors.medical-laboratory.robotic-medical-arm
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:684
...
![robotic medical arm reference render](robotic-medical-arm.png)

## Intent

The **robotic medical arm** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **robotic medical arm** as a useful,
