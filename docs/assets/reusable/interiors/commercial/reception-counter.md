...
---
asset_id: "asset.interiors.commercial.reception-counter"
source_label: "reception counter"
...
- **Asset ID:** asset.interiors.commercial.reception-counter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:664
...
![reception counter reference render](reception-counter.png)

## Intent

The **reception counter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **reception counter** as a useful,
