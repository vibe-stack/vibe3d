...
---
asset_id: "asset.interiors.commercial.mall-planter"
source_label: "mall planter"
...
- **Asset ID:** asset.interiors.commercial.mall-planter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:668
...
![mall planter reference render](mall-planter.png)

## Intent

The **mall planter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **mall planter** as a useful,
