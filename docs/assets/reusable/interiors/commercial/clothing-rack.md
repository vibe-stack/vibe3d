...
---
asset_id: "asset.interiors.commercial.clothing-rack"
source_label: "clothing rack"
...
- **Asset ID:** asset.interiors.commercial.clothing-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:653
...
![clothing rack reference render](clothing-rack.png)

## Intent

The **clothing rack** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **clothing rack** as a useful,
