...
---
asset_id: "asset.interiors.commercial.checkout-counter"
source_label: "checkout counter"
...
- **Asset ID:** asset.interiors.commercial.checkout-counter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:650
...
![checkout counter reference render](checkout-counter.png)

## Intent

The **checkout counter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **checkout counter** as a useful,
