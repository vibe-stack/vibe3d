...
---
asset_id: "asset.interiors.commercial.kiosk"
source_label: "kiosk"
...
- **Asset ID:** asset.interiors.commercial.kiosk
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:663
...
![kiosk reference render](kiosk.png)

## Intent

The **kiosk** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **kiosk** as a useful,
