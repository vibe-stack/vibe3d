...
---
asset_id: "asset.interiors.commercial.restaurant-booth"
source_label: "restaurant booth"
...
- **Asset ID:** asset.interiors.commercial.restaurant-booth
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:655
...
![restaurant booth reference render](restaurant-booth.png)

## Intent

The **restaurant booth** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **restaurant booth** as a useful,
