...
---
asset_id: "asset.interiors.commercial.display-case"
source_label: "display case"
source_section: "Reusable / interiors"
source_group: "Commercial"
source_line: 651
level: L2
status: planned
place_family: "Industrial, residential, commercial, medical, and laboratory interiors"
owner: "Mixed by interior type"
---
...
- **Asset ID:** asset.interiors.commercial.display-case
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:651
- **Family:** Reusable / interiors
- **Place family:** Industrial, residential, commercial, medical, and laboratory interiors
- **Owner / story role:** Mixed by interior type

## Reference render

![display case reference render](display-case.png)

## Intent

The **display case** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **display case** as a useful,
...
- MAT-03 — [canonical definition](../../../../world/material-library.md).
