...
---
asset_id: "asset.interiors.commercial.lobby-seating"
source_label: "lobby seating"
...
- **Asset ID:** asset.interiors.commercial.lobby-seating
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:666
...
![lobby seating reference render](lobby-seating.png)

## Intent

The **lobby seating** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **lobby seating** as a useful,
