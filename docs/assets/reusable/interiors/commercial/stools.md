...
---
asset_id: "asset.interiors.commercial.stools"
source_label: "stools"
...
- **Asset ID:** asset.interiors.commercial.stools
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:657
...
![stools reference render](stools.png)

## Intent

The **stools** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **stools** as a useful,
