...
---
asset_id: "asset.interiors.commercial.bar"
source_label: "bar"
...
- **Asset ID:** asset.interiors.commercial.bar
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:658
...
The **bar** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **bar** as a useful,
