...
---
asset_id: "asset.interiors.commercial.bar-shelving"
source_label: "bar shelving"
...
- **Asset ID:** asset.interiors.commercial.bar-shelving
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:659
...
![bar shelving reference render](bar-shelving.png)

## Intent

The **bar shelving** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **bar shelving** as a useful,
