...
---
asset_id: "asset.interiors.commercial.hotel-reception"
source_label: "hotel reception"
...
- **Asset ID:** asset.interiors.commercial.hotel-reception
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:665
...
![hotel reception reference render](hotel-reception.png)

## Intent

The **hotel reception** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **hotel reception** as a useful,
