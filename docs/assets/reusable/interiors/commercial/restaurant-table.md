...
---
asset_id: "asset.interiors.commercial.restaurant-table"
source_label: "restaurant table"
...
- **Asset ID:** asset.interiors.commercial.restaurant-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:656
...
![restaurant table reference render](restaurant-table.png)

## Intent

The **restaurant table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **restaurant table** as a useful,
