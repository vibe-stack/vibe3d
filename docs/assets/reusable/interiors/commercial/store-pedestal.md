...
---
asset_id: "asset.interiors.commercial.store-pedestal"
source_label: "store pedestal"
...
- **Asset ID:** asset.interiors.commercial.store-pedestal
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:654
...
![store pedestal reference render](store-pedestal.png)

## Intent

The **store pedestal** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **store pedestal** as a useful,
