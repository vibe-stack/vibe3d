...
---
asset_id: "asset.interiors.commercial.vending-unit"
source_label: "vending unit"
...
- **Asset ID:** asset.interiors.commercial.vending-unit
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:662
...
![vending unit reference render](vending-unit.png)

## Intent

The **vending unit** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **vending unit** as a useful,
