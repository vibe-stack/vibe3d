...
---
asset_id: "asset.interiors.commercial.arcade-cabinet"
source_label: "arcade cabinet"
...
- **Asset ID:** asset.interiors.commercial.arcade-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:660
...
![arcade cabinet reference render](arcade-cabinet.png)

## Intent

The **arcade cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **arcade cabinet** as a useful,
