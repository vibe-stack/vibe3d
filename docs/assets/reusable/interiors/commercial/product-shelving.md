...
---
asset_id: "asset.interiors.commercial.product-shelving"
source_label: "product shelving"
...
- **Asset ID:** asset.interiors.commercial.product-shelving
- **Type:** industrial service prop
- **Source:** prop-list.md:652
...
![product shelving reference render](product-shelving.png)

## Intent

The **product shelving** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **product shelving** as a useful,
