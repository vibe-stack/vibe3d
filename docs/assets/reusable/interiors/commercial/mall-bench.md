...
---
asset_id: "asset.interiors.commercial.mall-bench"
source_label: "mall bench"
...
- **Asset ID:** asset.interiors.commercial.mall-bench
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:667
...
![mall bench reference render](mall-bench.png)

## Intent

The **mall bench** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **mall bench** as a useful,
