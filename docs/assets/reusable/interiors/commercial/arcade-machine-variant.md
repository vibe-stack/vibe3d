...
---
asset_id: "asset.interiors.commercial.arcade-machine-variant"
source_label: "arcade machine variant"
...
# arcade machine variant

## Identity

- **Asset ID:** asset.interiors.commercial.arcade-machine-variant
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:661
...
![arcade machine variant reference render](arcade-machine-variant.png)

## Intent

The **arcade machine variant** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **arcade machine variant** as a useful,
