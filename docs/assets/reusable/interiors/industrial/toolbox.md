...
---
asset_id: "asset.interiors.industrial.toolbox"
source_label: "toolbox"
...
- **Asset ID:** asset.interiors.industrial.toolbox
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:621
...
![toolbox reference render](toolbox.png)

## Intent

The **toolbox** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **toolbox** as a useful,
