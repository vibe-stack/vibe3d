...
---
asset_id: "asset.interiors.industrial.locker"
source_label: "locker"
...
- **Asset ID:** asset.interiors.industrial.locker
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:616
...
![locker reference render](locker.png)

## Intent

The **locker** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **locker** as a useful,
