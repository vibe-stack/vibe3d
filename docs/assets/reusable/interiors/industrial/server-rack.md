...
---
asset_id: "asset.interiors.industrial.server-rack"
source_label: "server rack"
...
- **Asset ID:** asset.interiors.industrial.server-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:613
...
![server rack reference render](server-rack.png)

## Intent

The **server rack** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **server rack** as a useful,
