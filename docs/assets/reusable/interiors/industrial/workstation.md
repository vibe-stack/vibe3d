...
---
asset_id: "asset.interiors.industrial.workstation"
source_label: "workstation"
...
- **Asset ID:** asset.interiors.industrial.workstation
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:608
...
![workstation reference render](workstation.png)

## Intent

The **workstation** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **workstation** as a useful,
