...
---
asset_id: "asset.interiors.industrial.control-chair"
source_label: "control chair"
...
- **Asset ID:** asset.interiors.industrial.control-chair
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:606
...
![control chair reference render](control-chair.png)

## Intent

The **control chair** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **control chair** as a useful,
