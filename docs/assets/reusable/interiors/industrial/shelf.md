...
---
asset_id: "asset.interiors.industrial.shelf"
source_label: "shelf"
...
- **Asset ID:** asset.interiors.industrial.shelf
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:619
...
![shelf reference render](shelf.png)

## Intent

The **shelf** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **shelf** as a useful,
