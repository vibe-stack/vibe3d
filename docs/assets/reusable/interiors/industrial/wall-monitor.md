...
---
asset_id: "asset.interiors.industrial.wall-monitor"
source_label: "wall monitor"
...
- **Asset ID:** asset.interiors.industrial.wall-monitor
- **Type:** architectural or traversal module
- **Source:** prop-list.md:611
...
![wall monitor reference render](wall-monitor.png)

## Intent

The **wall monitor** is a architectural or traversal module for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **wall monitor** as a useful,
