...
---
asset_id: "asset.interiors.industrial.industrial-table"
source_label: "industrial table"
...
- **Asset ID:** asset.interiors.industrial.industrial-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:618
...
![industrial table reference render](industrial-table.png)

## Intent

The **industrial table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **industrial table** as a useful,
