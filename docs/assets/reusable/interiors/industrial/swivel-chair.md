...
---
asset_id: "asset.interiors.industrial.swivel-chair"
source_label: "swivel chair"
...
- **Asset ID:** asset.interiors.industrial.swivel-chair
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:607
...
![swivel chair reference render](swivel-chair.png)

## Intent

The **swivel chair** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **swivel chair** as a useful,
