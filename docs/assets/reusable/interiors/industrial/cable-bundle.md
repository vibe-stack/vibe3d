...
---
asset_id: "asset.interiors.industrial.cable-bundle"
source_label: "cable bundle"
source_section: "Reusable / interiors"
source_group: "Industrial"
source_line: 614
level: L2
status: planned
...
- **Asset ID:** asset.interiors.industrial.cable-bundle
- **Type:** industrial service prop
- **Source:** prop-list.md:614
...
![cable bundle reference render](cable-bundle.png)

## Intent

The **cable bundle** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **cable bundle** as a useful,
