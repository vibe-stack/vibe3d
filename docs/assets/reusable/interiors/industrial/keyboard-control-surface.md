...
---
asset_id: "asset.interiors.industrial.keyboard-control-surface"
source_label: "keyboard/control surface"
...
- **Asset ID:** asset.interiors.industrial.keyboard-control-surface
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:610
...
![keyboard/control surface reference render](keyboard-control-surface.png)

## Intent

The **keyboard/control surface** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **keyboard/control surface** as a useful,
