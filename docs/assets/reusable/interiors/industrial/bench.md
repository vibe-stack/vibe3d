...
---
asset_id: "asset.interiors.industrial.bench"
source_label: "bench"
...
- **Asset ID:** asset.interiors.industrial.bench
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:617
...
![bench reference render](bench.png)

## Intent

The **bench** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **bench** as a useful,
