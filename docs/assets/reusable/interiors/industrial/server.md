...
---
asset_id: "asset.interiors.industrial.server"
source_label: "server"
...
- **Asset ID:** asset.interiors.industrial.server
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:612
...
![server reference render](server.png)

## Intent

The **server** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **server** as a useful,
