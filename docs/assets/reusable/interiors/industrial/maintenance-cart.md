...
---
asset_id: "asset.interiors.industrial.maintenance-cart"
source_label: "maintenance cart"
...
- **Asset ID:** asset.interiors.industrial.maintenance-cart
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:622
...
![maintenance cart reference render](maintenance-cart.png)

## Intent

The **maintenance cart** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **maintenance cart** as a useful,
