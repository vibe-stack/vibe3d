...
---
asset_id: "asset.interiors.industrial.computer-monitor"
source_label: "computer monitor"
...
- **Asset ID:** asset.interiors.industrial.computer-monitor
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:609
...
![computer monitor reference render](computer-monitor.png)

## Intent

The **computer monitor** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **computer monitor** as a useful,
