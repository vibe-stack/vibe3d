...
---
asset_id: "asset.interiors.industrial.machinery-cabinet"
source_label: "machinery cabinet"
...
- **Asset ID:** asset.interiors.industrial.machinery-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:615
...
![machinery cabinet reference render](machinery-cabinet.png)

## Intent

The **machinery cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **machinery cabinet** as a useful,
