...
---
asset_id: "asset.interiors.industrial.rack"
source_label: "rack"
...
- **Asset ID:** asset.interiors.industrial.rack
- **Type:** industrial service prop
- **Source:** prop-list.md:620
...
![rack reference render](rack.png)

## Intent

The **rack** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **rack** as a useful,
