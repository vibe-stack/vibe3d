...
---
asset_id: "asset.interiors.residential.sofa"
source_label: "sofa"
...
- **Asset ID:** asset.interiors.residential.sofa
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:626
...
![sofa reference render](sofa.png)

## Intent

The **sofa** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **sofa** as a useful,
