...
---
asset_id: "asset.interiors.residential.shelving"
source_label: "shelving"
...
- **Asset ID:** asset.interiors.residential.shelving
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:639
...
![shelving reference render](shelving.png)

## Intent

The **shelving** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **shelving** as a useful,
