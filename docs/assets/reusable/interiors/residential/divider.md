...
---
asset_id: "asset.interiors.residential.divider"
source_label: "divider"
...
- **Asset ID:** asset.interiors.residential.divider
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:644
...
![divider reference render](divider.png)

## Intent

The **divider** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **divider** as a useful,
