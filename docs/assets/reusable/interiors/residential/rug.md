...
---
asset_id: "asset.interiors.residential.rug"
source_label: "rug"
...
- **Asset ID:** asset.interiors.residential.rug
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:645
...
![rug reference render](rug.png)

## Intent

The **rug** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **rug** as a useful,
