...
---
asset_id: "asset.interiors.residential.kitchen-counter"
source_label: "kitchen counter"
...
- **Asset ID:** asset.interiors.residential.kitchen-counter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:636
...
![kitchen counter reference render](kitchen-counter.png)

## Intent

The **kitchen counter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **kitchen counter** as a useful,
