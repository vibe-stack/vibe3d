...
---
asset_id: "asset.interiors.residential.wall-art"
source_label: "wall art"
...
- **Asset ID:** asset.interiors.residential.wall-art
- **Type:** architectural or traversal module
- **Source:** prop-list.md:643
...
![wall art reference render](wall-art.png)

## Intent

The **wall art** is a architectural or traversal module for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **wall art** as a useful,
