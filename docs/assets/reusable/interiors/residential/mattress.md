...
---
asset_id: "asset.interiors.residential.mattress"
source_label: "mattress"
...
- **Asset ID:** asset.interiors.residential.mattress
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:633
...
![mattress reference render](mattress.png)

## Intent

The **mattress** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **mattress** as a useful,
