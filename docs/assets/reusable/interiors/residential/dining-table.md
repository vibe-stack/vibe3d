...
---
asset_id: "asset.interiors.residential.dining-table"
source_label: "dining table"
...
- **Asset ID:** asset.interiors.residential.dining-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:629
...
![dining table reference render](dining-table.png)

## Intent

The **dining table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **dining table** as a useful,
