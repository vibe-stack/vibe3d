...
---
asset_id: "asset.interiors.residential.dining-chair"
source_label: "dining chair"
...
- **Asset ID:** asset.interiors.residential.dining-chair
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:630
...
![dining chair reference render](dining-chair.png)

## Intent

The **dining chair** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **dining chair** as a useful,
