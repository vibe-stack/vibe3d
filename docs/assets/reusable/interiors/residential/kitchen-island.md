...
---
asset_id: "asset.interiors.residential.kitchen-island"
source_label: "kitchen island"
...
- **Asset ID:** asset.interiors.residential.kitchen-island
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:637
...
![kitchen island reference render](kitchen-island.png)

## Intent

The **kitchen island** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **kitchen island** as a useful,
