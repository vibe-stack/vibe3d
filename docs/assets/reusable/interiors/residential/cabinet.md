...
---
asset_id: "asset.interiors.residential.cabinet"
source_label: "cabinet"
...
- **Asset ID:** asset.interiors.residential.cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:634
...
![cabinet reference render](cabinet.png)

## Intent

The **cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **cabinet** as a useful,
