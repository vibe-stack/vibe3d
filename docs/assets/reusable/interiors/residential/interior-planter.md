...
---
asset_id: "asset.interiors.residential.interior-planter"
source_label: "interior planter"
...
- **Asset ID:** asset.interiors.residential.interior-planter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:640
...
![interior planter reference render](interior-planter.png)

## Intent

The **interior planter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **interior planter** as a useful,
