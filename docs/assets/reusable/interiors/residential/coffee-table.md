...
---
asset_id: "asset.interiors.residential.coffee-table"
source_label: "coffee table"
...
- **Asset ID:** asset.interiors.residential.coffee-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:628
...
![coffee table reference render](coffee-table.png)

## Intent

The **coffee table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **coffee table** as a useful,
