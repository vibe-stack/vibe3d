...
---
asset_id: "asset.interiors.residential.floor-lamp"
source_label: "floor lamp"
...
- **Asset ID:** asset.interiors.residential.floor-lamp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:642
...
![floor lamp reference render](floor-lamp.png)

## Intent

The **floor lamp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **floor lamp** as a useful,
