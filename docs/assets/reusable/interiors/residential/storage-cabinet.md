...
---
asset_id: "asset.interiors.residential.storage-cabinet"
source_label: "storage cabinet"
source_section: "Reusable / interiors"
source_group: "Residential"
source_line: 638
level: L2
status: planned
...
- **Asset ID:** asset.interiors.residential.storage-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:638
...
![storage cabinet reference render](storage-cabinet.png)

## Intent

The **storage cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **storage cabinet** as a useful,
