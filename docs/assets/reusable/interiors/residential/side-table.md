...
---
asset_id: "asset.interiors.residential.side-table"
source_label: "side table"
...
- **Asset ID:** asset.interiors.residential.side-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:631
...
![side table reference render](side-table.png)

## Intent

The **side table** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **side table** as a useful,
