...
---
asset_id: "asset.interiors.residential.bed"
source_label: "bed"
...
- **Asset ID:** asset.interiors.residential.bed
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:632
...
![bed reference render](bed.png)

## Intent

The **bed** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **bed** as a useful,
