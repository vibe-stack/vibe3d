...
---
asset_id: "asset.interiors.residential.decorative-light"
source_label: "decorative light"
...
- **Asset ID:** asset.interiors.residential.decorative-light
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:641
...
![decorative light reference render](decorative-light.png)

## Intent

The **decorative light** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **decorative light** as a useful,
