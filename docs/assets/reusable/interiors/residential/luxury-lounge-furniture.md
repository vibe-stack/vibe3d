...
---
asset_id: "asset.interiors.residential.luxury-lounge-furniture"
source_label: "luxury lounge furniture"
...
- **Asset ID:** asset.interiors.residential.luxury-lounge-furniture
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:646
...
![luxury lounge furniture reference render](luxury-lounge-furniture.png)

## Intent

The **luxury lounge furniture** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **luxury lounge furniture** as a useful,
