...
---
asset_id: "asset.interiors.residential.armchair"
source_label: "armchair"
...
- **Asset ID:** asset.interiors.residential.armchair
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:627
...
![armchair reference render](armchair.png)

## Intent

The **armchair** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **armchair** as a useful,
