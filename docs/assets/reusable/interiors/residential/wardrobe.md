...
---
asset_id: "asset.interiors.residential.wardrobe"
source_label: "wardrobe"
...
- **Asset ID:** asset.interiors.residential.wardrobe
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:635
...
![wardrobe reference render](wardrobe.png)

## Intent

The **wardrobe** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
interior objects that communicate occupancy, workflow, status, and local wealth level. Its primary read should be **wardrobe** as a useful,
