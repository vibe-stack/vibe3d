...
---
asset_id: "asset.streets-infrastructure.general.tree-planter"
source_label: "tree planter"
...
- **Asset ID:** asset.streets-infrastructure.general.tree-planter
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:514
...
![tree planter reference render](tree-planter.png)

## Intent

The **tree planter** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **tree planter** as a useful,
