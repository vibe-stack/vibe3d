...
---
asset_id: "asset.streets-infrastructure.general.pier-module"
source_label: "pier module"
...
- **Asset ID:** asset.streets-infrastructure.general.pier-module
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:531
...
![pier module reference render](pier-module.png)

## Intent

The **pier module** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **pier module** as a useful,
