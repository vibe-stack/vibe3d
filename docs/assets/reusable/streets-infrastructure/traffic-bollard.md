...
---
asset_id: "asset.streets-infrastructure.general.traffic-bollard"
source_label: "traffic bollard"
...
- **Asset ID:** asset.streets-infrastructure.general.traffic-bollard
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:495
...
![traffic bollard reference render](traffic-bollard.png)

## Intent

The **traffic bollard** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **traffic bollard** as a useful,
