...
---
asset_id: "asset.streets-infrastructure.general.recycling-bin"
source_label: "recycling bin"
...
- **Asset ID:** asset.streets-infrastructure.general.recycling-bin
- **Type:** gameplay system prop
- **Source:** prop-list.md:518
...
![recycling bin reference render](recycling-bin.png)

## Intent

The **recycling bin** is a gameplay system prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **recycling bin** as a useful,
