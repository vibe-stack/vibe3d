...
---
asset_id: "asset.streets-infrastructure.general.trash-can"
source_label: "trash can"
...
- **Asset ID:** asset.streets-infrastructure.general.trash-can
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:515
...
![trash can reference render](trash-can.png)

## Intent

The **trash can** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **trash can** as a useful,
