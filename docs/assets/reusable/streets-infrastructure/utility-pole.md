...
---
asset_id: "asset.streets-infrastructure.general.utility-pole"
source_label: "utility pole"
...
- **Asset ID:** asset.streets-infrastructure.general.utility-pole
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:519
...
![utility pole reference render](utility-pole.png)

## Intent

The **utility pole** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **utility pole** as a useful,
