...
---
asset_id: "asset.streets-infrastructure.general.drainage-pipe"
source_label: "drainage pipe"
...
- **Asset ID:** asset.streets-infrastructure.general.drainage-pipe
- **Type:** industrial service prop
- **Source:** prop-list.md:523
...
![drainage pipe reference render](drainage-pipe.png)

## Intent

The **drainage pipe** is a industrial service prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **drainage pipe** as a useful,
