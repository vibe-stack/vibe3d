...
---
asset_id: "asset.streets-infrastructure.general.holographic-billboard"
source_label: "holographic billboard"
...
- **Asset ID:** asset.streets-infrastructure.general.holographic-billboard
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:508
...
![holographic billboard reference render](holographic-billboard.png)

## Intent

The **holographic billboard** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **holographic billboard** as a useful,
