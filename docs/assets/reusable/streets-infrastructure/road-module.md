...
---
asset_id: "asset.streets-infrastructure.general.road-module"
source_label: "road module"
...
- **Asset ID:** asset.streets-infrastructure.general.road-module
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:481
...
![road module reference render](road-module.png)

## Intent

The **road module** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **road module** as a useful,
