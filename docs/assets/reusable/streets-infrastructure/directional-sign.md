...
---
asset_id: "asset.streets-infrastructure.general.directional-sign"
source_label: "directional sign"
...
- **Asset ID:** asset.streets-infrastructure.general.directional-sign
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:505
...
![directional sign reference render](directional-sign.png)

## Intent

The **directional sign** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **directional sign** as a useful,
