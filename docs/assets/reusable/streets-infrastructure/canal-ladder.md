...
---
asset_id: "asset.streets-infrastructure.general.canal-ladder"
source_label: "canal ladder"
...
- **Asset ID:** asset.streets-infrastructure.general.canal-ladder
- **Type:** architectural or traversal module
- **Source:** prop-list.md:526
...
![canal ladder reference render](canal-ladder.png)

## Intent

The **canal ladder** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **canal ladder** as a useful,
