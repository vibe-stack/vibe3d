...
---
asset_id: "asset.streets-infrastructure.general.industrial-dumpster"
source_label: "industrial dumpster"
...
- **Asset ID:** asset.streets-infrastructure.general.industrial-dumpster
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:517
...
![industrial dumpster reference render](industrial-dumpster.png)

## Intent

The **industrial dumpster** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **industrial dumpster** as a useful,
