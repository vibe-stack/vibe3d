...
---
asset_id: "asset.streets-infrastructure.general.road-junction"
source_label: "road junction"
...
- **Asset ID:** asset.streets-infrastructure.general.road-junction
- **Type:** architectural or traversal module
- **Source:** prop-list.md:482
...
![road junction reference render](road-junction.png)

## Intent

The **road junction** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **road junction** as a useful,
