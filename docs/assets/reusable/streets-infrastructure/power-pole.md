...
---
asset_id: "asset.streets-infrastructure.general.power-pole"
source_label: "power pole"
...
- **Asset ID:** asset.streets-infrastructure.general.power-pole
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:520
...
![power pole reference render](power-pole.png)

## Intent

The **power pole** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **power pole** as a useful,
