...
---
asset_id: "asset.streets-infrastructure.general.traffic-signal"
source_label: "traffic signal"
...
- **Asset ID:** asset.streets-infrastructure.general.traffic-signal
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:502
...
![traffic signal reference render](traffic-signal.png)

## Intent

The **traffic signal** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **traffic signal** as a useful,
