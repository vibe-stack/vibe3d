...
---
asset_id: "asset.streets-infrastructure.general.canal-railing"
source_label: "canal railing"
...
- **Asset ID:** asset.streets-infrastructure.general.canal-railing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:525
...
![canal railing reference render](canal-railing.png)

## Intent

The **canal railing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **canal railing** as a useful,
