...
---
asset_id: "asset.streets-infrastructure.general.decorative-street-lamp"
source_label: "decorative street lamp"
...
- **Asset ID:** asset.streets-infrastructure.general.decorative-street-lamp
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:499
...
![decorative street lamp reference render](decorative-street-lamp.png)

## Intent

The **decorative street lamp** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **decorative street lamp** as a useful,
