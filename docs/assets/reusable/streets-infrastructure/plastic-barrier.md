...
---
asset_id: "asset.streets-infrastructure.general.plastic-barrier"
source_label: "plastic barrier"
...
- **Asset ID:** asset.streets-infrastructure.general.plastic-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:494
...
![plastic barrier reference render](plastic-barrier.png)

## Intent

The **plastic barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **plastic barrier** as a useful,
