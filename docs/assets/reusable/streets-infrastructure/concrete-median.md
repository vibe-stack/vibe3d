...
---
asset_id: "asset.streets-infrastructure.general.concrete-median"
source_label: "concrete median"
...
- **Asset ID:** asset.streets-infrastructure.general.concrete-median
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:492
...
![concrete median reference render](concrete-median.png)

## Intent

The **concrete median** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **concrete median** as a useful,
