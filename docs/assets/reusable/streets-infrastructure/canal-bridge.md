...
---
asset_id: "asset.streets-infrastructure.general.canal-bridge"
source_label: "canal bridge"
...
- **Asset ID:** asset.streets-infrastructure.general.canal-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:527
...
![canal bridge reference render](canal-bridge.png)

## Intent

The **canal bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **canal bridge** as a useful,
