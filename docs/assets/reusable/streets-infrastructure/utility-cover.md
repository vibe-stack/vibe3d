...
---
asset_id: "asset.streets-infrastructure.general.utility-cover"
source_label: "utility cover"
...
- **Asset ID:** asset.streets-infrastructure.general.utility-cover
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:490
...
![utility cover reference render](utility-cover.png)

## Intent

The **utility cover** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **utility cover** as a useful,
