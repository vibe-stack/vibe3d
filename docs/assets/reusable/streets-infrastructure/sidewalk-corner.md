...
---
asset_id: "asset.streets-infrastructure.general.sidewalk-corner"
source_label: "sidewalk corner"
...
- **Asset ID:** asset.streets-infrastructure.general.sidewalk-corner
- **Type:** architectural or traversal module
- **Source:** prop-list.md:486
...
![sidewalk corner reference render](sidewalk-corner.png)

## Intent

The **sidewalk corner** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **sidewalk corner** as a useful,
