...
---
asset_id: "asset.streets-infrastructure.general.sidewalk-drainage"
source_label: "sidewalk drainage"
...
- **Asset ID:** asset.streets-infrastructure.general.sidewalk-drainage
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:487
...
![sidewalk drainage reference render](sidewalk-drainage.png)

## Intent

The **sidewalk drainage** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **sidewalk drainage** as a useful,
