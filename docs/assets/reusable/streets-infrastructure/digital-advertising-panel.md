...
---
asset_id: "asset.streets-infrastructure.general.digital-advertising-panel"
source_label: "digital advertising panel"
...
- **Asset ID:** asset.streets-infrastructure.general.digital-advertising-panel
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:509
...
![digital advertising panel reference render](digital-advertising-panel.png)

## Intent

The **digital advertising panel** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **digital advertising panel** as a useful,
