...
---
asset_id: "asset.streets-infrastructure.general.pedestrian-signal"
source_label: "pedestrian signal"
...
- **Asset ID:** asset.streets-infrastructure.general.pedestrian-signal
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:503
...
![pedestrian signal reference render](pedestrian-signal.png)

## Intent

The **pedestrian signal** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **pedestrian signal** as a useful,
