...
---
asset_id: "asset.streets-infrastructure.general.road-barrier"
source_label: "road barrier"
...
- **Asset ID:** asset.streets-infrastructure.general.road-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:493
...
![road barrier reference render](road-barrier.png)

## Intent

The **road barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **road barrier** as a useful,
