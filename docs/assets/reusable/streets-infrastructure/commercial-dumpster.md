...
---
asset_id: "asset.streets-infrastructure.general.commercial-dumpster"
source_label: "commercial dumpster"
...
- **Asset ID:** asset.streets-infrastructure.general.commercial-dumpster
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:516
...
![commercial dumpster reference render](commercial-dumpster.png)

## Intent

The **commercial dumpster** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **commercial dumpster** as a useful,
