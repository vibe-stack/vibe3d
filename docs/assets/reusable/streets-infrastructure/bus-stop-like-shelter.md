...
---
asset_id: "asset.streets-infrastructure.general.bus-stop-like-shelter"
source_label: "bus-stop-like shelter"
...
- **Asset ID:** asset.streets-infrastructure.general.bus-stop-like-shelter
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:510
...
![bus-stop-like shelter reference render](bus-stop-like-shelter.png)

## Intent

The **bus-stop-like shelter** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **bus-stop-like shelter** as a useful,
