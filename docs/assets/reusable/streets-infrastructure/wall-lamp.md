...
---
asset_id: "asset.streets-infrastructure.general.wall-lamp"
source_label: "wall lamp"
...
- **Asset ID:** asset.streets-infrastructure.general.wall-lamp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:500
...
![wall lamp reference render](wall-lamp.png)

## Intent

The **wall lamp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **wall lamp** as a useful,
