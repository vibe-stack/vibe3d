...
---
asset_id: "asset.streets-infrastructure.general.waterfront-barrier"
source_label: "waterfront barrier"
...
- **Asset ID:** asset.streets-infrastructure.general.waterfront-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:528
...
![waterfront barrier reference render](waterfront-barrier.png)

## Intent

The **waterfront barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **waterfront barrier** as a useful,
