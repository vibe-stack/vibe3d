...
---
asset_id: "asset.streets-infrastructure.general.storm-drain"
source_label: "storm drain"
...
- **Asset ID:** asset.streets-infrastructure.general.storm-drain
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:488
...
![storm drain reference render](storm-drain.png)

## Intent

The **storm drain** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **storm drain** as a useful,
