...
---
asset_id: "asset.streets-infrastructure.general.road-curb"
source_label: "road curb"
...
- **Asset ID:** asset.streets-infrastructure.general.road-curb
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:483
...
![road curb reference render](road-curb.png)

## Intent

The **road curb** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **road curb** as a useful,
