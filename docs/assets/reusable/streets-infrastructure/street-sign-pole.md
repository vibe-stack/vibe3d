...
---
asset_id: "asset.streets-infrastructure.general.street-sign-pole"
source_label: "street sign pole"
...
- **Asset ID:** asset.streets-infrastructure.general.street-sign-pole
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:504
...
![street sign pole reference render](street-sign-pole.png)

## Intent

The **street sign pole** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **street sign pole** as a useful,
