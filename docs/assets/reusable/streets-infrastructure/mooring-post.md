...
---
asset_id: "asset.streets-infrastructure.general.mooring-post"
source_label: "mooring post"
...
- **Asset ID:** asset.streets-infrastructure.general.mooring-post
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:530
...
![mooring post reference render](mooring-post.png)

## Intent

The **mooring post** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **mooring post** as a useful,
