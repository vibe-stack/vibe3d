...
---
asset_id: "asset.streets-infrastructure.general.neon-street-lamp"
source_label: "neon street lamp"
...
- **Asset ID:** asset.streets-infrastructure.general.neon-street-lamp
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:501
...
![neon street lamp reference render](neon-street-lamp.png)

## Intent

The **neon street lamp** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **neon street lamp** as a useful,
