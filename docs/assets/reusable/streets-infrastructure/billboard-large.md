...
---
asset_id: "asset.streets-infrastructure.general.billboard-large"
source_label: "billboard large"
...
- **Asset ID:** asset.streets-infrastructure.general.billboard-large
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:507
...
![billboard large reference render](billboard-large.png)

## Intent

The **billboard large** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **billboard large** as a useful,
