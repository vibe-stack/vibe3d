...
---
asset_id: "asset.streets-infrastructure.general.planter"
source_label: "planter"
...
- **Asset ID:** asset.streets-infrastructure.general.planter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:513
...
![planter reference render](planter.png)

## Intent

The **planter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **planter** as a useful,
