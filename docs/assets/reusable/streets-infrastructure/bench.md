...
---
asset_id: "asset.streets-infrastructure.general.bench"
source_label: "bench"
...
- **Asset ID:** asset.streets-infrastructure.general.bench
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:512
...
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **bench** as a useful,
