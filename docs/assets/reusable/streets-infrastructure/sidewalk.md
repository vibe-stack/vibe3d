...
---
asset_id: "asset.streets-infrastructure.general.sidewalk"
source_label: "sidewalk"
...
- **Asset ID:** asset.streets-infrastructure.general.sidewalk
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:485
...
![sidewalk reference render](sidewalk.png)

## Intent

The **sidewalk** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **sidewalk** as a useful,
