...
---
asset_id: "asset.streets-infrastructure.general.sewer-opening"
source_label: "sewer opening"
source_section: "Reusable / streets and city infrastructure"
source_group: "General"
source_line: 524
level: L2
status: planned
place_family: "Urban districts, settlements, roads, canals, and waterfronts"
owner: "Axiom Civic / local utilities"
---
...
- **Asset ID:** asset.streets-infrastructure.general.sewer-opening
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:524
- **Family:** Reusable / streets and city infrastructure
- **Place family:** Urban districts, settlements, roads, canals, and waterfronts
- **Owner / story role:** Axiom Civic / local utilities

## Reference render

![sewer opening reference render](sewer-opening.png)

## Intent

The **sewer opening** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **sewer opening** as a useful,
...
- MAT-12 — [canonical definition](../../../world/material-library.md).
