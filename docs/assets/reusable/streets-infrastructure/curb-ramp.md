...
---
asset_id: "asset.streets-infrastructure.general.curb-ramp"
source_label: "curb ramp"
...
- **Asset ID:** asset.streets-infrastructure.general.curb-ramp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:484
...
![curb ramp reference render](curb-ramp.png)

## Intent

The **curb ramp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **curb ramp** as a useful,
