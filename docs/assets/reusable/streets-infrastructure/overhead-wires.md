...
---
asset_id: "asset.streets-infrastructure.general.overhead-wires"
source_label: "overhead wires"
...
- **Asset ID:** asset.streets-infrastructure.general.overhead-wires
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:521
...
![overhead wires reference render](overhead-wires.png)

## Intent

The **overhead wires** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **overhead wires** as a useful,
