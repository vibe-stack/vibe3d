...
---
asset_id: "asset.streets-infrastructure.general.street-lamp"
source_label: "street lamp"
...
- **Asset ID:** asset.streets-infrastructure.general.street-lamp
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:497
...
![street lamp reference render](street-lamp.png)

## Intent

The **street lamp** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **street lamp** as a useful,
