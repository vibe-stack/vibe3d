...
---
asset_id: "asset.streets-infrastructure.general.electrical-substation"
source_label: "electrical substation"
...
- **Asset ID:** asset.streets-infrastructure.general.electrical-substation
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:522
...
![electrical substation reference render](electrical-substation.png)

## Intent

The **electrical substation** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **electrical substation** as a useful,
