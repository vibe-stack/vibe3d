...
---
asset_id: "asset.streets-infrastructure.general.traffic-cone"
source_label: "traffic cone"
...
- **Asset ID:** asset.streets-infrastructure.general.traffic-cone
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:496
...
![traffic cone reference render](traffic-cone.png)

## Intent

The **traffic cone** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **traffic cone** as a useful,
