...
---
asset_id: "asset.streets-infrastructure.general.pedestrian-canopy"
source_label: "pedestrian canopy"
...
- **Asset ID:** asset.streets-infrastructure.general.pedestrian-canopy
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:511
...
![pedestrian canopy reference render](pedestrian-canopy.png)

## Intent

The **pedestrian canopy** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **pedestrian canopy** as a useful,
