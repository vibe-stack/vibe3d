...
---
asset_id: "asset.streets-infrastructure.general.dock-bollard"
source_label: "dock bollard"
...
- **Asset ID:** asset.streets-infrastructure.general.dock-bollard
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:529
...
![dock bollard reference render](dock-bollard.png)

## Intent

The **dock bollard** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **dock bollard** as a useful,
