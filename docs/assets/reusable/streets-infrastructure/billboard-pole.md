...
---
asset_id: "asset.streets-infrastructure.general.billboard-pole"
source_label: "billboard pole"
...
- **Asset ID:** asset.streets-infrastructure.general.billboard-pole
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:506
...
![billboard pole reference render](billboard-pole.png)

## Intent

The **billboard pole** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **billboard pole** as a useful,
