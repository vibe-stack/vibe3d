...
---
asset_id: "asset.streets-infrastructure.general.trench-drain"
source_label: "trench drain"
...
- **Asset ID:** asset.streets-infrastructure.general.trench-drain
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:491
...
![trench drain reference render](trench-drain.png)

## Intent

The **trench drain** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **trench drain** as a useful,
