...
---
asset_id: "asset.streets-infrastructure.general.manhole"
source_label: "manhole"
...
- **Asset ID:** asset.streets-infrastructure.general.manhole
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:489
...
![manhole reference render](manhole.png)

## Intent

The **manhole** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **manhole** as a useful,
