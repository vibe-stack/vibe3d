...
---
asset_id: "asset.streets-infrastructure.general.industrial-lamp"
source_label: "industrial lamp"
...
- **Asset ID:** asset.streets-infrastructure.general.industrial-lamp
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:498
...
![industrial lamp reference render](industrial-lamp.png)

## Intent

The **industrial lamp** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
human-scale civic infrastructure that grounds large hero structures in daily life. Its primary read should be **industrial lamp** as a useful,
