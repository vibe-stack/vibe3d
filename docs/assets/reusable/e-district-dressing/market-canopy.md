...
---
asset_id: "asset.e-district-dressing.general.market-canopy"
source_label: "market canopy"
...
- **Asset ID:** asset.e-district-dressing.general.market-canopy
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:564
...
![market canopy reference render](market-canopy.png)

## Intent

The **market canopy** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **market canopy** as a useful,
