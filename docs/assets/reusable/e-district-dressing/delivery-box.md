...
---
asset_id: "asset.e-district-dressing.general.delivery-box"
source_label: "delivery box"
...
- **Asset ID:** asset.e-district-dressing.general.delivery-box
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:579
...
![delivery box reference render](delivery-box.png)

## Intent

The **delivery box** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **delivery box** as a useful,
