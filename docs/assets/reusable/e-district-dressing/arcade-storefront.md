...
---
asset_id: "asset.e-district-dressing.general.arcade-storefront"
source_label: "arcade storefront"
...
- **Asset ID:** asset.e-district-dressing.general.arcade-storefront
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:547
...
![arcade storefront reference render](arcade-storefront.png)

## Intent

The **arcade storefront** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **arcade storefront** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: arcade storefront. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
