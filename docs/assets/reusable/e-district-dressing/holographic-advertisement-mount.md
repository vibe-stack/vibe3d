...
---
asset_id: "asset.e-district-dressing.general.holographic-advertisement-mount"
source_label: "holographic advertisement mount"
...
# holographic advertisement mount

## Identity

- **Asset ID:** asset.e-district-dressing.general.holographic-advertisement-mount
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:560
...
![holographic advertisement mount reference render](holographic-advertisement-mount.png)

## Intent

The **holographic advertisement mount** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **holographic advertisement mount** as a useful,
