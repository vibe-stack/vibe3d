...
---
asset_id: "asset.e-district-dressing.general.rooftop-ac"
source_label: "rooftop AC"
...
- **Asset ID:** asset.e-district-dressing.general.rooftop-ac
- **Type:** architectural or traversal module
- **Source:** prop-list.md:585
...
![rooftop AC reference render](rooftop-ac.png)

## Intent

The **rooftop AC** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **rooftop AC** as a useful,
