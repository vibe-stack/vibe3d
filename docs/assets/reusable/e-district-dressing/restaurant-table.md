...
---
asset_id: "asset.e-district-dressing.general.restaurant-table"
...
- **Asset ID:** asset.e-district-dressing.general.restaurant-table
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:572
...
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **restaurant table** as a useful,
