...
---
asset_id: "asset.e-district-dressing.general.restaurant-chair"
source_label: "restaurant chair"
...
- **Asset ID:** asset.e-district-dressing.general.restaurant-chair
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:573
...
![restaurant chair reference render](restaurant-chair.png)

## Intent

The **restaurant chair** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **restaurant chair** as a useful,
