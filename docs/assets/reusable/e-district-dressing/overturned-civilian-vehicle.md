...
---
asset_id: "asset.e-district-dressing.general.overturned-civilian-vehicle"
source_label: "overturned civilian vehicle"
...
# overturned civilian vehicle

## Identity

- **Asset ID:** asset.e-district-dressing.general.overturned-civilian-vehicle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:593
...
![overturned civilian vehicle reference render](overturned-civilian-vehicle.png)

## Intent

The **overturned civilian vehicle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **overturned civilian vehicle** as a useful,
