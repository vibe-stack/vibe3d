...
---
asset_id: "asset.e-district-dressing.general.plastic-crate"
source_label: "plastic crate"
...
- **Asset ID:** asset.e-district-dressing.general.plastic-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:577
...
![plastic crate reference render](plastic-crate.png)

## Intent

The **plastic crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **plastic crate** as a useful,
