...
---
asset_id: "asset.e-district-dressing.general.protest-barricades"
source_label: "protest barricades"
...
- **Asset ID:** asset.e-district-dressing.general.protest-barricades
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:592
...
![protest barricades reference render](protest-barricades.png)

## Intent

The **protest barricades** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **protest barricades** as a useful,
