...
---
asset_id: "asset.e-district-dressing.general.alley-ac-unit"
source_label: "alley AC unit"
...
- **Asset ID:** asset.e-district-dressing.general.alley-ac-unit
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:583
...
![alley AC unit reference render](alley-ac-unit.png)

## Intent

The **alley AC unit** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **alley AC unit** as a useful,
