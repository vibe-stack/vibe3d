...
---
asset_id: "asset.e-district-dressing.general.projecting-wall-sign"
source_label: "projecting wall sign"
...
- **Asset ID:** asset.e-district-dressing.general.projecting-wall-sign
- **Type:** architectural or traversal module
- **Source:** prop-list.md:556
...
![projecting wall sign reference render](projecting-wall-sign.png)

## Intent

The **projecting wall sign** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **projecting wall sign** as a useful,
