...
---
asset_id: "asset.e-district-dressing.general.shop-shutter"
source_label: "shop shutter"
...
- **Asset ID:** asset.e-district-dressing.general.shop-shutter
- **Type:** architectural or traversal module
- **Source:** prop-list.md:548
...
![shop shutter reference render](shop-shutter.png)

## Intent

The **shop shutter** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **shop shutter** as a useful,
