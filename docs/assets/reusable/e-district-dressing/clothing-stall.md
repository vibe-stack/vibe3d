...
---
asset_id: "asset.e-district-dressing.general.clothing-stall"
source_label: "clothing stall"
...
- **Asset ID:** asset.e-district-dressing.general.clothing-stall
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:568
...
![clothing stall reference render](clothing-stall.png)

## Intent

The **clothing stall** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **clothing stall** as a useful,
