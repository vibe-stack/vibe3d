...
---
asset_id: "asset.e-district-dressing.general.vending-machine"
source_label: "vending machine"
...
- **Asset ID:** asset.e-district-dressing.general.vending-machine
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:549
...
![vending machine reference render](vending-machine.png)

## Intent

The **vending machine** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **vending machine** as a useful,
