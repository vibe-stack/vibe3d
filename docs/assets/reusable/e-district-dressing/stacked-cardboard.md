...
---
asset_id: "asset.e-district-dressing.general.stacked-cardboard"
source_label: "stacked cardboard"
...
- **Asset ID:** asset.e-district-dressing.general.stacked-cardboard
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:576
...
![stacked cardboard reference render](stacked-cardboard.png)

## Intent

The **stacked cardboard** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **stacked cardboard** as a useful,
