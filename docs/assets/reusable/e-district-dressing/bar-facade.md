...
---
asset_id: "asset.e-district-dressing.general.bar-facade"
source_label: "bar facade"
...
- **Asset ID:** asset.e-district-dressing.general.bar-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:543
...
![bar facade reference render](bar-facade.png)

## Intent

The **bar facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **bar facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: bar facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
