...
---
asset_id: "asset.e-district-dressing.general.bottle-crate"
source_label: "bottle crate"
...
- **Asset ID:** asset.e-district-dressing.general.bottle-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:578
...
![bottle crate reference render](bottle-crate.png)

## Intent

The **bottle crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **bottle crate** as a useful,
