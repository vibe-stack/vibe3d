...
---
asset_id: "asset.e-district-dressing.general.external-compressor"
source_label: "external compressor"
...
- **Asset ID:** asset.e-district-dressing.general.external-compressor
- **Type:** industrial service prop
- **Source:** prop-list.md:586
...
![external compressor reference render](external-compressor.png)

## Intent

The **external compressor** is a industrial service prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **external compressor** as a useful,
