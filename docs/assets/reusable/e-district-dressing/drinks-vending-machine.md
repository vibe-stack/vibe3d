...
---
asset_id: "asset.e-district-dressing.general.drinks-vending-machine"
source_label: "drinks vending machine"
...
- **Asset ID:** asset.e-district-dressing.general.drinks-vending-machine
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:550
...
![drinks vending machine reference render](drinks-vending-machine.png)

## Intent

The **drinks vending machine** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **drinks vending machine** as a useful,
