...
---
asset_id: "asset.e-district-dressing.general.standing-restaurant-sign"
source_label: "standing restaurant sign"
...
# standing restaurant sign

## Identity

- **Asset ID:** asset.e-district-dressing.general.standing-restaurant-sign
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:554
...
![standing restaurant sign reference render](standing-restaurant-sign.png)

## Intent

The **standing restaurant sign** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **standing restaurant sign** as a useful,
