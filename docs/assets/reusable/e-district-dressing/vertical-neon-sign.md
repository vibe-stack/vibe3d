...
---
asset_id: "asset.e-district-dressing.general.vertical-neon-sign"
source_label: "vertical neon sign"
...
- **Asset ID:** asset.e-district-dressing.general.vertical-neon-sign
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:557
...
![vertical neon sign reference render](vertical-neon-sign.png)

## Intent

The **vertical neon sign** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **vertical neon sign** as a useful,
