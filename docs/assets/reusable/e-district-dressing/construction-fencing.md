...
---
asset_id: "asset.e-district-dressing.general.construction-fencing"
source_label: "construction fencing"
...
- **Asset ID:** asset.e-district-dressing.general.construction-fencing
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:591
...
![construction fencing reference render](construction-fencing.png)

## Intent

The **construction fencing** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **construction fencing** as a useful,
