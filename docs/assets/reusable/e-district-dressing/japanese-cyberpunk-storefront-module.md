...
---
asset_id: "asset.e-district-dressing.general.japanese-cyberpunk-storefront-module"
source_label: "Japanese/cyberpunk storefront module"
...
# Japanese/cyberpunk storefront module

## Identity

- **Asset ID:** asset.e-district-dressing.general.japanese-cyberpunk-storefront-module
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:539
...
![Japanese/cyberpunk storefront module reference render](japanese-cyberpunk-storefront-module.png)

## Intent

The **Japanese/cyberpunk storefront module** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **Japanese/cyberpunk storefront module** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: Japanese/cyberpunk storefront module. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
