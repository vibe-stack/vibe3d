...
---
asset_id: "asset.e-district-dressing.general.trash-bags"
source_label: "trash bags"
...
- **Asset ID:** asset.e-district-dressing.general.trash-bags
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:575
...
![trash bags reference render](trash-bags.png)

## Intent

The **trash bags** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **trash bags** as a useful,
