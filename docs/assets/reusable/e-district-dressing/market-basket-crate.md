...
---
asset_id: "asset.e-district-dressing.general.market-basket-crate"
source_label: "market basket/crate"
...
- **Asset ID:** asset.e-district-dressing.general.market-basket-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:571
...
![market basket/crate reference render](market-basket-crate.png)

## Intent

The **market basket/crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **market basket/crate** as a useful,
