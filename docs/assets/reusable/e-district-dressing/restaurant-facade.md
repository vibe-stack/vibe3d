...
---
asset_id: "asset.e-district-dressing.general.restaurant-facade"
source_label: "restaurant facade"
...
- **Asset ID:** asset.e-district-dressing.general.restaurant-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:541
...
![restaurant facade reference render](restaurant-facade.png)

## Intent

The **restaurant facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **restaurant facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: restaurant facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
