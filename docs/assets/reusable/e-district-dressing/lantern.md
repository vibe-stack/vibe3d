...
---
asset_id: "asset.e-district-dressing.general.lantern"
source_label: "lantern"
...
- **Asset ID:** asset.e-district-dressing.general.lantern
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:561
...
![lantern reference render](lantern.png)

## Intent

The **lantern** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **lantern** as a useful,
