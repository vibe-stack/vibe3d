...
---
asset_id: "asset.e-district-dressing.general.produce-stall"
source_label: "produce stall"
...
- **Asset ID:** asset.e-district-dressing.general.produce-stall
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:567
...
![produce stall reference render](produce-stall.png)

## Intent

The **produce stall** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **produce stall** as a useful,
