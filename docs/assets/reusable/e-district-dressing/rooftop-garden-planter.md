...
---
asset_id: "asset.e-district-dressing.general.rooftop-garden-planter"
source_label: "rooftop garden planter"
...
# rooftop garden planter

## Identity

- **Asset ID:** asset.e-district-dressing.general.rooftop-garden-planter
- **Type:** architectural or traversal module
- **Source:** prop-list.md:589
...
![rooftop garden planter reference render](rooftop-garden-planter.png)

## Intent

The **rooftop garden planter** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **rooftop garden planter** as a useful,
