...
---
asset_id: "asset.e-district-dressing.general.glowing-menu-board"
source_label: "glowing menu board"
...
- **Asset ID:** asset.e-district-dressing.general.glowing-menu-board
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:552
...
![glowing menu board reference render](glowing-menu-board.png)

## Intent

The **glowing menu board** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **glowing menu board** as a useful,
