...
---
asset_id: "asset.e-district-dressing.general.display-shelf"
source_label: "display shelf"
...
- **Asset ID:** asset.e-district-dressing.general.display-shelf
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:570
...
![display shelf reference render](display-shelf.png)

## Intent

The **display shelf** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **display shelf** as a useful,
