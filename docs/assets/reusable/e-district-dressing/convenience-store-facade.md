...
---
asset_id: "asset.e-district-dressing.general.convenience-store-facade"
source_label: "convenience-store facade"
...
- **Asset ID:** asset.e-district-dressing.general.convenience-store-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:540
...
![convenience-store facade reference render](convenience-store-facade.png)

## Intent

The **convenience-store facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **convenience-store facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: convenience-store facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
