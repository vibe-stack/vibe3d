...
---
asset_id: "asset.e-district-dressing.general.nightclub-facade"
source_label: "nightclub facade"
...
- **Asset ID:** asset.e-district-dressing.general.nightclub-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:544
...
![nightclub facade reference render](nightclub-facade.png)

## Intent

The **nightclub facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **nightclub facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: nightclub facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
