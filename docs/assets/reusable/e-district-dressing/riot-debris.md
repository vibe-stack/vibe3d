...
---
asset_id: "asset.e-district-dressing.general.riot-debris"
source_label: "riot debris"
...
- **Asset ID:** asset.e-district-dressing.general.riot-debris
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:594
...
![riot debris reference render](riot-debris.png)

## Intent

The **riot debris** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **riot debris** as a useful,
