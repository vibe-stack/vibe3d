...
---
asset_id: "asset.e-district-dressing.general.animated-billboard-casing"
source_label: "animated billboard casing"
...
# animated billboard casing

## Identity

- **Asset ID:** asset.e-district-dressing.general.animated-billboard-casing
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:559
...
![animated billboard casing reference render](animated-billboard-casing.png)

## Intent

The **animated billboard casing** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **animated billboard casing** as a useful,
