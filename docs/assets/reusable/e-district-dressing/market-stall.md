...
---
asset_id: "asset.e-district-dressing.general.market-stall"
source_label: "market stall"
...
- **Asset ID:** asset.e-district-dressing.general.market-stall
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:565
...
![market stall reference render](market-stall.png)

## Intent

The **market stall** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **market stall** as a useful,
