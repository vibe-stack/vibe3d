...
---
asset_id: "asset.e-district-dressing.general.bar-stool"
source_label: "bar stool"
...
- **Asset ID:** asset.e-district-dressing.general.bar-stool
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:574
...
![bar stool reference render](bar-stool.png)

## Intent

The **bar stool** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **bar stool** as a useful,
