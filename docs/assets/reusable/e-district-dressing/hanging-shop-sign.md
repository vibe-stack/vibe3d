...
---
asset_id: "asset.e-district-dressing.general.hanging-shop-sign"
source_label: "hanging shop sign"
...
- **Asset ID:** asset.e-district-dressing.general.hanging-shop-sign
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:555
...
![hanging shop sign reference render](hanging-shop-sign.png)

## Intent

The **hanging shop sign** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **hanging shop sign** as a useful,
