...
---
asset_id: "asset.e-district-dressing.general.market-awning"
source_label: "market awning"
...
- **Asset ID:** asset.e-district-dressing.general.market-awning
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:563
...
![market awning reference render](market-awning.png)

## Intent

The **market awning** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **market awning** as a useful,
