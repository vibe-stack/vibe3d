...
---
asset_id: "asset.e-district-dressing.general.fire-escape"
source_label: "fire escape"
...
- **Asset ID:** asset.e-district-dressing.general.fire-escape
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:587
...
![fire escape reference render](fire-escape.png)

## Intent

The **fire escape** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **fire escape** as a useful,
