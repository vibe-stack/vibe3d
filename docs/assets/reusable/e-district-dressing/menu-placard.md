...
---
asset_id: "asset.e-district-dressing.general.menu-placard"
source_label: "menu placard"
...
- **Asset ID:** asset.e-district-dressing.general.menu-placard
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:553
...
![menu placard reference render](menu-placard.png)

## Intent

The **menu placard** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **menu placard** as a useful,
