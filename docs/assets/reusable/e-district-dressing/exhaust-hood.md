...
---
asset_id: "asset.e-district-dressing.general.exhaust-hood"
source_label: "exhaust hood"
...
- **Asset ID:** asset.e-district-dressing.general.exhaust-hood
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:582
...
![exhaust hood reference render](exhaust-hood.png)

## Intent

The **exhaust hood** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **exhaust hood** as a useful,
