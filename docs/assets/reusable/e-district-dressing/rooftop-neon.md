...
---
asset_id: "asset.e-district-dressing.general.rooftop-neon"
source_label: "rooftop neon"
...
- **Asset ID:** asset.e-district-dressing.general.rooftop-neon
- **Type:** architectural or traversal module
- **Source:** prop-list.md:558
...
![rooftop neon reference render](rooftop-neon.png)

## Intent

The **rooftop neon** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **rooftop neon** as a useful,
