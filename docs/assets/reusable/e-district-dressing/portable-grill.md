...
---
asset_id: "asset.e-district-dressing.general.portable-grill"
source_label: "portable grill"
...
- **Asset ID:** asset.e-district-dressing.general.portable-grill
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:581
...
![portable grill reference render](portable-grill.png)

## Intent

The **portable grill** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **portable grill** as a useful,
