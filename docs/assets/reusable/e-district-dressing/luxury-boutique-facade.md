...
---
asset_id: "asset.e-district-dressing.general.luxury-boutique-facade"
source_label: "luxury boutique facade"
...
- **Asset ID:** asset.e-district-dressing.general.luxury-boutique-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:546
...
![luxury boutique facade reference render](luxury-boutique-facade.png)

## Intent

The **luxury boutique facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **luxury boutique facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: luxury boutique facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
