...
---
asset_id: "asset.e-district-dressing.general.roof-water-tank"
source_label: "roof water tank"
...
- **Asset ID:** asset.e-district-dressing.general.roof-water-tank
- **Type:** architectural or traversal module
- **Source:** prop-list.md:588
...
![roof water tank reference render](roof-water-tank.png)

## Intent

The **roof water tank** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **roof water tank** as a useful,
