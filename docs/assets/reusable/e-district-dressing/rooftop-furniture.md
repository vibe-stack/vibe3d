...
---
asset_id: "asset.e-district-dressing.general.rooftop-furniture"
source_label: "rooftop furniture"
...
- **Asset ID:** asset.e-district-dressing.general.rooftop-furniture
- **Type:** architectural or traversal module
- **Source:** prop-list.md:590
...
![rooftop furniture reference render](rooftop-furniture.png)

## Intent

The **rooftop furniture** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **rooftop furniture** as a useful,
