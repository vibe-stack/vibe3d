...
---
asset_id: "asset.e-district-dressing.general.noodle-shop-facade"
source_label: "noodle shop facade"
...
- **Asset ID:** asset.e-district-dressing.general.noodle-shop-facade
- **Type:** reusable themed facade assembly
- **Source:** prop-list.md:542
...
![noodle shop facade reference render](noodle-shop-facade.png)

## Intent

The **noodle shop facade** is a reusable themed facade assembly for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **noodle shop facade** as a useful,
...
Use the storefront facade shell as the structural host, then apply the named local identity as a restrained dressing pass: noodle shop facade. Keep doors, glazing, service access, fascia, awning, and sign sockets compatible with the shared shell.
