...
---
asset_id: "asset.e-district-dressing.general.graffiti-surfaces"
source_label: "graffiti surfaces"
...
- **Asset ID:** asset.e-district-dressing.general.graffiti-surfaces
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:595
...
![graffiti surfaces reference render](graffiti-surfaces.png)

## Intent

The **graffiti surfaces** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **graffiti surfaces** as a useful,
