...
---
asset_id: "asset.e-district-dressing.general.counter"
...
- **Asset ID:** asset.e-district-dressing.general.counter
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:569
...
![counter reference render](counter.png)

## Intent

The **counter** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **counter** as a useful,
