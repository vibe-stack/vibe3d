...
---
asset_id: "asset.e-district-dressing.general.food-vending-machine"
source_label: "food vending machine"
...
- **Asset ID:** asset.e-district-dressing.general.food-vending-machine
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:551
...
![food vending machine reference render](food-vending-machine.png)

## Intent

The **food vending machine** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **food vending machine** as a useful,
