...
---
asset_id: "asset.e-district-dressing.general.wall-ac"
source_label: "wall AC"
...
- **Asset ID:** asset.e-district-dressing.general.wall-ac
- **Type:** architectural or traversal module
- **Source:** prop-list.md:584
...
![wall AC reference render](wall-ac.png)

## Intent

The **wall AC** is a architectural or traversal module for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **wall AC** as a useful,
