...
---
asset_id: "asset.e-district-dressing.general.food-stall"
source_label: "food stall"
...
- **Asset ID:** asset.e-district-dressing.general.food-stall
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:566
...
![food stall reference render](food-stall.png)

## Intent

The **food stall** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
social, layered, high-density dressing with a controlled night palette and strong wayfinding. Its primary read should be **food stall** as a useful,
