...
---
asset_id: "asset.destruction.general.collapsed-scaffold"
source_label: "collapsed scaffold"
...
- **Asset ID:** asset.destruction.general.collapsed-scaffold
- **Type:** architectural or traversal module
- **Source:** prop-list.md:780
...
![collapsed scaffold reference render](collapsed-scaffold.png)

## Intent

The **collapsed scaffold** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **collapsed scaffold** as a useful,
