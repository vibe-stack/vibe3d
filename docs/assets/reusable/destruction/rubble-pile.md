...
---
asset_id: "asset.destruction.general.rubble-pile"
source_label: "rubble pile"
...
- **Asset ID:** asset.destruction.general.rubble-pile
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:764
...
![rubble pile reference render](rubble-pile.png)

## Intent

The **rubble pile** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **rubble pile** as a useful,
