...
---
asset_id: "asset.destruction.general.broken-wall"
source_label: "broken wall"
...
- **Asset ID:** asset.destruction.general.broken-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:751
...
![broken wall reference render](broken-wall.png)

## Intent

The **broken wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken wall** as a useful,
