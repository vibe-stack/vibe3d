...
---
asset_id: "asset.destruction.general.broken-panel"
source_label: "broken panel"
...
- **Asset ID:** asset.destruction.general.broken-panel
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:770
...
![broken panel reference render](broken-panel.png)

## Intent

The **broken panel** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken panel** as a useful,
