...
---
asset_id: "asset.destruction.general.boarded-storefront"
source_label: "boarded storefront"
...
- **Asset ID:** asset.destruction.general.boarded-storefront
- **Type:** architectural or traversal module
- **Source:** prop-list.md:784
...
![boarded storefront reference render](boarded-storefront.png)

## Intent

The **boarded storefront** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **boarded storefront** as a useful,
