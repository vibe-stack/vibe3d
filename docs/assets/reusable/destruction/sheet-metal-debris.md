...
---
asset_id: "asset.destruction.general.sheet-metal-debris"
source_label: "sheet-metal debris"
...
- **Asset ID:** asset.destruction.general.sheet-metal-debris
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:768
...
![sheet-metal debris reference render](sheet-metal-debris.png)

## Intent

The **sheet-metal debris** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **sheet-metal debris** as a useful,
