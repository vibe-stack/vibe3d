...
---
asset_id: "asset.destruction.general.broken-beam"
source_label: "broken beam"
...
- **Asset ID:** asset.destruction.general.broken-beam
- **Type:** architectural or traversal module
- **Source:** prop-list.md:756
...
![broken beam reference render](broken-beam.png)

## Intent

The **broken beam** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken beam** as a useful,
