...
---
asset_id: "asset.destruction.general.leaking-pipe"
source_label: "leaking pipe"
...
- **Asset ID:** asset.destruction.general.leaking-pipe
- **Type:** industrial service prop
- **Source:** prop-list.md:760
...
![leaking pipe reference render](leaking-pipe.png)

## Intent

The **leaking pipe** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **leaking pipe** as a useful,
