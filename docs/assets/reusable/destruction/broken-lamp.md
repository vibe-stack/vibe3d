...
---
asset_id: "asset.destruction.general.broken-lamp"
source_label: "broken lamp"
...
- **Asset ID:** asset.destruction.general.broken-lamp
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:783
...
![broken lamp reference render](broken-lamp.png)

## Intent

The **broken lamp** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken lamp** as a useful,
