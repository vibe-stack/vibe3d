...
---
asset_id: "asset.destruction.general.severed-cable"
source_label: "severed cable"
...
- **Asset ID:** asset.destruction.general.severed-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:761
...
![severed cable reference render](severed-cable.png)

## Intent

The **severed cable** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **severed cable** as a useful,
...
- **Blockout envelope:** 1.0 m service segment; length and radius are explicit parameters, with 0.25 m clearance around fittings.
...
- **adjacent utility module:** [duct straight](../industrial/duct-straight.md).
