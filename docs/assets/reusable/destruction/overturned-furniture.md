...
---
asset_id: "asset.destruction.general.overturned-furniture"
source_label: "overturned furniture"
...
- **Asset ID:** asset.destruction.general.overturned-furniture
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:786
...
![overturned furniture reference render](overturned-furniture.png)

## Intent

The **overturned furniture** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **overturned furniture** as a useful,
