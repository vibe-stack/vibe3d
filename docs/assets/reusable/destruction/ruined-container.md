...
---
asset_id: "asset.destruction.general.ruined-container"
source_label: "ruined container"
source_section: "Reusable / destruction"
source_group: "General"
source_line: 775
level: L2
status: planned
place_family: "All damaged, abandoned, crashed, or contested spaces"
owner: "Incident history"
---
...
- **Asset ID:** asset.destruction.general.ruined-container
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:775
- **Family:** Reusable / destruction
- **Place family:** All damaged, abandoned, crashed, or contested spaces
- **Owner / story role:** Incident history

## Reference render

![ruined container reference render](ruined-container.png)

## Intent

The **ruined container** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **ruined container** as a useful,
...
- MAT-21 — [canonical definition](../../../world/material-library.md).
...
- **stacking/handling family:** [Titanfall-style cargo crate small](../cargo-logistics/titanfall-style-cargo-crate-small.md).
