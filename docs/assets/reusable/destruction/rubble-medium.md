...
---
asset_id: "asset.destruction.general.rubble-medium"
source_label: "rubble medium"
...
- **Asset ID:** asset.destruction.general.rubble-medium
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:763
...
![rubble medium reference render](rubble-medium.png)

## Intent

The **rubble medium** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **rubble medium** as a useful,
