...
---
asset_id: "asset.destruction.general.broken-roof"
source_label: "broken roof"
...
- **Asset ID:** asset.destruction.general.broken-roof
- **Type:** architectural or traversal module
- **Source:** prop-list.md:755
...
![broken roof reference render](broken-roof.png)

## Intent

The **broken roof** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken roof** as a useful,
