...
---
asset_id: "asset.destruction.general.concrete-chunk"
source_label: "concrete chunk"
...
- **Asset ID:** asset.destruction.general.concrete-chunk
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:765
...
![concrete chunk reference render](concrete-chunk.png)

## Intent

The **concrete chunk** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **concrete chunk** as a useful,
