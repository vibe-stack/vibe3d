...
---
asset_id: "asset.destruction.general.meteor-crater"
source_label: "meteor crater"
...
- **Asset ID:** asset.destruction.general.meteor-crater
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:779
...
![meteor crater reference render](meteor-crater.png)

## Intent

The **meteor crater** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **meteor crater** as a useful,
