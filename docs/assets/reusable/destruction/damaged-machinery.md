...
---
asset_id: "asset.destruction.general.damaged-machinery"
source_label: "damaged machinery"
...
- **Asset ID:** asset.destruction.general.damaged-machinery
- **Type:** industrial service prop
- **Source:** prop-list.md:772
...
![damaged machinery reference render](damaged-machinery.png)

## Intent

The **damaged machinery** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **damaged machinery** as a useful,
