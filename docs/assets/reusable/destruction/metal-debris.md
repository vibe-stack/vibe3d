...
---
asset_id: "asset.destruction.general.metal-debris"
source_label: "metal debris"
...
- **Asset ID:** asset.destruction.general.metal-debris
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:767
...
![metal debris reference render](metal-debris.png)

## Intent

The **metal debris** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **metal debris** as a useful,
