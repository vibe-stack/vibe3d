...
---
asset_id: "asset.destruction.general.wrecked-generator"
source_label: "wrecked generator"
...
- **Asset ID:** asset.destruction.general.wrecked-generator
- **Type:** industrial service prop
- **Source:** prop-list.md:773
...
![wrecked generator reference render](wrecked-generator.png)

## Intent

The **wrecked generator** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **wrecked generator** as a useful,
...
Use one strong mass, one functional interface, and one controlled state cue. Every visible part should explain use, mounting, maintenance, or wear.
