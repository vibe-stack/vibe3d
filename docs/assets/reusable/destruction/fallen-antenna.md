...
---
asset_id: "asset.destruction.general.fallen-antenna"
source_label: "fallen antenna"
...
- **Asset ID:** asset.destruction.general.fallen-antenna
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:781
...
![fallen antenna reference render](fallen-antenna.png)

## Intent

The **fallen antenna** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **fallen antenna** as a useful,
