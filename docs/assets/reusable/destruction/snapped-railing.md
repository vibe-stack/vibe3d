...
---
asset_id: "asset.destruction.general.snapped-railing"
source_label: "snapped railing"
...
- **Asset ID:** asset.destruction.general.snapped-railing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:758
...
![snapped railing reference render](snapped-railing.png)

## Intent

The **snapped railing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **snapped railing** as a useful,
