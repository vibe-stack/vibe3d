...
---
asset_id: "asset.destruction.general.glass-debris"
source_label: "glass debris"
...
- **Asset ID:** asset.destruction.general.glass-debris
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:769
...
![glass debris reference render](glass-debris.png)

## Intent

The **glass debris** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **glass debris** as a useful,
