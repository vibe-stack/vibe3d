...
---
asset_id: "asset.destruction.general.rubble-small"
source_label: "rubble small"
...
- **Asset ID:** asset.destruction.general.rubble-small
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:762
...
![rubble small reference render](rubble-small.png)

## Intent

The **rubble small** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **rubble small** as a useful,
