...
---
asset_id: "asset.destruction.general.fallen-sign"
source_label: "fallen sign"
...
- **Asset ID:** asset.destruction.general.fallen-sign
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:782
...
![fallen sign reference render](fallen-sign.png)

## Intent

The **fallen sign** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **fallen sign** as a useful,
