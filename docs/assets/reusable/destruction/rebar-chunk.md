...
---
asset_id: "asset.destruction.general.rebar-chunk"
source_label: "rebar chunk"
...
- **Asset ID:** asset.destruction.general.rebar-chunk
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:766
...
![rebar chunk reference render](rebar-chunk.png)

## Intent

The **rebar chunk** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **rebar chunk** as a useful,
