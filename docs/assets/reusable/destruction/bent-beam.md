...
---
asset_id: "asset.destruction.general.bent-beam"
source_label: "bent beam"
...
- **Asset ID:** asset.destruction.general.bent-beam
- **Type:** architectural or traversal module
- **Source:** prop-list.md:757
...
![bent beam reference render](bent-beam.png)

## Intent

The **bent beam** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **bent beam** as a useful,
