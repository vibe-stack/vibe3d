...
---
asset_id: "asset.destruction.general.broken-pipe"
source_label: "broken pipe"
...
- **Asset ID:** asset.destruction.general.broken-pipe
- **Type:** industrial service prop
- **Source:** prop-list.md:759
...
![broken pipe reference render](broken-pipe.png)

## Intent

The **broken pipe** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **broken pipe** as a useful,
