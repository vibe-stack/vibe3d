...
---
asset_id: "asset.destruction.general.burned-panel"
source_label: "burned panel"
...
- **Asset ID:** asset.destruction.general.burned-panel
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:771
...
![burned panel reference render](burned-panel.png)

## Intent

The **burned panel** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **burned panel** as a useful,
