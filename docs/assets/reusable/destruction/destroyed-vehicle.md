...
---
asset_id: "asset.destruction.general.destroyed-vehicle"
source_label: "destroyed vehicle"
...
- **Asset ID:** asset.destruction.general.destroyed-vehicle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:776
...
![destroyed vehicle reference render](destroyed-vehicle.png)

## Intent

The **destroyed vehicle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **destroyed vehicle** as a useful,
