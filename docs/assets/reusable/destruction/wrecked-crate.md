...
---
asset_id: "asset.destruction.general.wrecked-crate"
source_label: "wrecked crate"
...
- **Asset ID:** asset.destruction.general.wrecked-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:774
...
![wrecked crate reference render](wrecked-crate.png)

## Intent

The **wrecked crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **wrecked crate** as a useful,
