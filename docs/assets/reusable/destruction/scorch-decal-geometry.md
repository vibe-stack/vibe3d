...
---
asset_id: "asset.destruction.general.scorch-decal-geometry"
source_label: "scorch decal geometry"
...
# scorch decal geometry

## Identity

- **Asset ID:** asset.destruction.general.scorch-decal-geometry
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:777
...
![scorch decal geometry reference render](scorch-decal-geometry.png)

## Intent

The **scorch decal geometry** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **scorch decal geometry** as a useful,
