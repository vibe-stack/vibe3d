...
---
asset_id: "asset.destruction.general.collapsed-floor"
source_label: "collapsed floor"
...
- **Asset ID:** asset.destruction.general.collapsed-floor
- **Type:** architectural or traversal module
- **Source:** prop-list.md:754
...
![collapsed floor reference render](collapsed-floor.png)

## Intent

The **collapsed floor** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **collapsed floor** as a useful,
