...
---
asset_id: "asset.destruction.general.crater"
source_label: "crater"
...
- **Asset ID:** asset.destruction.general.crater
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:778
...
![crater reference render](crater.png)

## Intent

The **crater** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **crater** as a useful,
