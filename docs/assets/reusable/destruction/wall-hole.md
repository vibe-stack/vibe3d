...
---
asset_id: "asset.destruction.general.wall-hole"
source_label: "wall hole"
...
- **Asset ID:** asset.destruction.general.wall-hole
- **Type:** architectural or traversal module
- **Source:** prop-list.md:752
...
![wall hole reference render](wall-hole.png)

## Intent

The **wall hole** is a architectural or traversal module for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **wall hole** as a useful,
