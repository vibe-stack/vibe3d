...
---
asset_id: "asset.destruction.general.riot-barricade"
source_label: "riot barricade"
...
- **Asset ID:** asset.destruction.general.riot-barricade
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:785
...
![riot barricade reference render](riot-barricade.png)

## Intent

The **riot barricade** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **riot barricade** as a useful,
