...
---
asset_id: "asset.destruction.general.cracked-concrete"
source_label: "cracked concrete"
...
- **Asset ID:** asset.destruction.general.cracked-concrete
- **Type:** industrial service prop
- **Source:** prop-list.md:753
...
![cracked concrete reference render](cracked-concrete.png)

## Intent

The **cracked concrete** is a industrial service prop for the Axiom Relay kit. It exists to support
destruction that reveals construction logic, preserves gameplay readability, and tells a cause. Its primary read should be **cracked concrete** as a useful,
