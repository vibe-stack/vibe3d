...
---
asset_id: "asset.wildlife.general.leviathan-footprints-terrain-interaction"
source_label: "Leviathan footprints/terrain interaction"
source_section: "Reusable / wildlife"
source_group: "General"
source_line: 837
level: L2
status: planned
place_family: "Storm Point, Kings Canyon, and any controlled ecology zone"
owner: "Natural system / containment operators"
---

# Leviathan footprints/terrain interaction

## Identity

- **Asset ID:** asset.wildlife.general.leviathan-footprints-terrain-interaction
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:837
- **Family:** Reusable / wildlife
- **Place family:** Storm Point, Kings Canyon, and any controlled ecology zone
- **Owner / story role:** Natural system / containment operators

## Reference render

![Leviathan footprints/terrain interaction reference render](leviathan-footprints-terrain-interaction.png)

## Intent

The **Leviathan footprints/terrain interaction** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Leviathan footprints/terrain interaction** as a useful,
