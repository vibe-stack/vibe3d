...
---
asset_id: "asset.wildlife.general.flyer-cage"
source_label: "Flyer cage"
...
- **Asset ID:** asset.wildlife.general.flyer-cage
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:828
...
![Flyer cage reference render](flyer-cage.png)

## Intent

The **Flyer cage** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Flyer cage** as a useful,
