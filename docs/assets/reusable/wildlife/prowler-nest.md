...
---
asset_id: "asset.wildlife.general.prowler-nest"
source_label: "Prowler nest"
...
- **Asset ID:** asset.wildlife.general.prowler-nest
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:831
...
![Prowler nest reference render](prowler-nest.png)

## Intent

The **Prowler nest** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Prowler nest** as a useful,
