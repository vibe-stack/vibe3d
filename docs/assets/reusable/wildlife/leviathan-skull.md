...
---
asset_id: "asset.wildlife.general.leviathan-skull"
source_label: "Leviathan skull"
...
- **Asset ID:** asset.wildlife.general.leviathan-skull
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:839
...
![Leviathan skull reference render](leviathan-skull.png)

## Intent

The **Leviathan skull** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Leviathan skull** as a useful,
