...
---
asset_id: "asset.wildlife.general.spider-egg"
source_label: "Spider egg"
...
- **Asset ID:** asset.wildlife.general.spider-egg
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:833
...
![Spider egg reference render](spider-egg.png)

## Intent

The **Spider egg** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Spider egg** as a useful,
