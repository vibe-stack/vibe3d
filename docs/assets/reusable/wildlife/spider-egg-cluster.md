...
---
asset_id: "asset.wildlife.general.spider-egg-cluster"
source_label: "Spider egg cluster"
...
- **Asset ID:** asset.wildlife.general.spider-egg-cluster
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:834
...
![Spider egg cluster reference render](spider-egg-cluster.png)

## Intent

The **Spider egg cluster** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Spider egg cluster** as a useful,
