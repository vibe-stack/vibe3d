...
---
asset_id: "asset.wildlife.general.prowler"
source_label: "Prowler"
...
- **Asset ID:** asset.wildlife.general.prowler
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:829
...
![Prowler reference render](prowler.png)

## Intent

The **Prowler** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Prowler** as a useful,
