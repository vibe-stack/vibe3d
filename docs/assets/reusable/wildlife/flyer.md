...
---
asset_id: "asset.wildlife.general.flyer"
source_label: "Flyer"
...
- **Asset ID:** asset.wildlife.general.flyer
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:826
...
![Flyer reference render](flyer.png)

## Intent

The **Flyer** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Flyer** as a useful,
