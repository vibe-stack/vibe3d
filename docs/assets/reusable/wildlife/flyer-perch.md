...
---
asset_id: "asset.wildlife.general.flyer-perch"
source_label: "Flyer perch"
...
- **Asset ID:** asset.wildlife.general.flyer-perch
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:827
...
![Flyer perch reference render](flyer-perch.png)

## Intent

The **Flyer perch** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Flyer perch** as a useful,
