...
---
asset_id: "asset.wildlife.general.downed-beast-carcass"
source_label: "Downed Beast carcass"
...
# Downed Beast carcass

## Identity

- **Asset ID:** asset.wildlife.general.downed-beast-carcass
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:840
...
![Downed Beast carcass reference render](downed-beast-carcass.png)

## Intent

The **Downed Beast carcass** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Downed Beast carcass** as a useful,
