...
---
asset_id: "asset.wildlife.general.giant-leviathan-skeleton"
source_label: "giant Leviathan skeleton"
...
# giant Leviathan skeleton

## Identity

- **Asset ID:** asset.wildlife.general.giant-leviathan-skeleton
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:838
...
![giant Leviathan skeleton reference render](giant-leviathan-skeleton.png)

## Intent

The **giant Leviathan skeleton** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **giant Leviathan skeleton** as a useful,
