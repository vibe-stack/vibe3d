...
---
asset_id: "asset.wildlife.general.leviathan"
source_label: "Leviathan"
...
- **Asset ID:** asset.wildlife.general.leviathan
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:836
...
![Leviathan reference render](leviathan.png)

## Intent

The **Leviathan** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Leviathan** as a useful,
