...
---
asset_id: "asset.wildlife.general.prowler-den"
source_label: "Prowler den"
...
- **Asset ID:** asset.wildlife.general.prowler-den
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:830
...
![Prowler den reference render](prowler-den.png)

## Intent

The **Prowler den** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Prowler den** as a useful,
