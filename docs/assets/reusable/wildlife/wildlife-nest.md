...
---
asset_id: "asset.wildlife.general.wildlife-nest"
source_label: "wildlife nest"
...
- **Asset ID:** asset.wildlife.general.wildlife-nest
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:835
...
![wildlife nest reference render](wildlife-nest.png)

## Intent

The **wildlife nest** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **wildlife nest** as a useful,
