...
---
asset_id: "asset.wildlife.general.spider"
source_label: "Spider"
...
- **Asset ID:** asset.wildlife.general.spider
- **Type:** wildlife or ecological prop
- **Source:** prop-list.md:832
...
![Spider reference render](spider.png)

## Intent

The **Spider** is a wildlife or ecological prop for the Axiom Relay kit. It exists to support
wildlife and traces that make ecology legible without hijacking the manufactured world language. Its primary read should be **Spider** as a useful,
