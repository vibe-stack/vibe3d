...
---
asset_id: "asset.military.general.robot-maintenance-rack"
source_label: "robot maintenance rack"
...
# robot maintenance rack

## Identity

- **Asset ID:** asset.military.general.robot-maintenance-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:472
...
![robot maintenance rack reference render](robot-maintenance-rack.png)

## Intent

The **robot maintenance rack** is a industrial service prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **robot maintenance rack** as a useful,
