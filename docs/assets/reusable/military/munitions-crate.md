...
---
asset_id: "asset.military.general.munitions-crate"
source_label: "munitions crate"
...
- **Asset ID:** asset.military.general.munitions-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:468
...
![munitions crate reference render](munitions-crate.png)

## Intent

The **munitions crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **munitions crate** as a useful,
