...
---
asset_id: "asset.military.general.security-fence"
source_label: "security fence"
...
- **Asset ID:** asset.military.general.security-fence
- **Type:** architectural or traversal module
- **Source:** prop-list.md:451
...
![security fence reference render](security-fence.png)

## Intent

The **security fence** is a architectural or traversal module for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **security fence** as a useful,
