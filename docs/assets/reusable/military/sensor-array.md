...
---
asset_id: "asset.military.general.sensor-array"
source_label: "sensor array"
...
- **Asset ID:** asset.military.general.sensor-array
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:446
...
![sensor array reference render](sensor-array.png)

## Intent

The **sensor array** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **sensor array** as a useful,
