...
---
asset_id: "asset.military.general.checkpoint-booth"
source_label: "checkpoint booth"
...
- **Asset ID:** asset.military.general.checkpoint-booth
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:454
...
![checkpoint booth reference render](checkpoint-booth.png)

## Intent

The **checkpoint booth** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **checkpoint booth** as a useful,
