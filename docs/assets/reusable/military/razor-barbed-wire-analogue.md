...
---
asset_id: "asset.military.general.razor-barbed-wire-analogue"
source_label: "razor/barbed-wire analogue"
...
# razor/barbed-wire analogue

## Identity

- **Asset ID:** asset.military.general.razor-barbed-wire-analogue
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:452
...
![razor/barbed-wire analogue reference render](razor-barbed-wire-analogue.png)

## Intent

The **razor/barbed-wire analogue** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **razor/barbed-wire analogue** as a useful,
