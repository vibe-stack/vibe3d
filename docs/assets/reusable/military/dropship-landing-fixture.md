...
---
asset_id: "asset.military.general.dropship-landing-fixture"
source_label: "dropship landing fixture"
...
# dropship landing fixture

## Identity

- **Asset ID:** asset.military.general.dropship-landing-fixture
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:463
...
![dropship landing fixture reference render](dropship-landing-fixture.png)

## Intent

The **dropship landing fixture** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **dropship landing fixture** as a useful,
