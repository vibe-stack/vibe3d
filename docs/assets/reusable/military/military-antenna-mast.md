...
---
asset_id: "asset.military.general.military-antenna-mast"
source_label: "military antenna mast"
...
- **Asset ID:** asset.military.general.military-antenna-mast
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:443
...
![military antenna mast reference render](military-antenna-mast.png)

## Intent

The **military antenna mast** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **military antenna mast** as a useful,
