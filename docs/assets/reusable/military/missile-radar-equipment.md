...
---
asset_id: "asset.military.general.missile-radar-equipment"
source_label: "missile/radar equipment"
...
# missile/radar equipment

## Identity

- **Asset ID:** asset.military.general.missile-radar-equipment
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:461
...
![missile/radar equipment reference render](missile-radar-equipment.png)

## Intent

The **missile/radar equipment** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **missile/radar equipment** as a useful,
