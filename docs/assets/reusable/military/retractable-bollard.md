...
---
asset_id: "asset.military.general.retractable-bollard"
source_label: "retractable bollard"
...
- **Asset ID:** asset.military.general.retractable-bollard
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:456
...
![retractable bollard reference render](retractable-bollard.png)

## Intent

The **retractable bollard** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **retractable bollard** as a useful,
