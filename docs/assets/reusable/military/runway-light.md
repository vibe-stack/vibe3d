...
---
asset_id: "asset.military.general.runway-light"
source_label: "runway light"
...
- **Asset ID:** asset.military.general.runway-light
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:464
...
![runway light reference render](runway-light.png)

## Intent

The **runway light** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **runway light** as a useful,
