...
---
asset_id: "asset.military.general.imc-prefab-barracks"
source_label: "IMC prefab barracks"
...
- **Asset ID:** asset.military.general.imc-prefab-barracks
- **Type:** reusable military prefab assembly
- **Source:** prop-list.md:434
...
![IMC prefab barracks reference render](imc-prefab-barracks.png)

## Intent

The **IMC prefab barracks** is a reusable military prefab assembly for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **IMC prefab barracks** as a useful,
...
Use the small building shell as the structural host, then apply an IMC prefab barracks identity: disciplined wall rhythm, durable entry, narrow observation windows, roof service access, and restrained military markings. Keep all shell connectors reusable.
...
- **blocking: room shell** — [room shell](../architecture/building-prefab-assemblies/room-shell.md) — repeatable barracks room.
- **blocking: wall 4 m** — [wall 4 m](../architecture/walls/wall-4-m.md) — military perimeter run.
- **blocking: door bay** — [door bay](../architecture/modular-building-connectors/door-bay.md) — barracks entry.
- **blocking: window bay** — [window bay](../architecture/modular-building-connectors/window-bay.md) — observation opening.
...
- **optional: industrial corrugated wall** — [industrial corrugated wall](../architecture/walls/industrial-corrugated-wall.md) — local material dressing.
...
- **blocking component:** [room shell](../architecture/building-prefab-assemblies/room-shell.md) — repeatable barracks room.
- **blocking component:** [wall 4 m](../architecture/walls/wall-4-m.md) — military perimeter run.
- **blocking component:** [door bay](../architecture/modular-building-connectors/door-bay.md) — barracks entry.
- **blocking component:** [window bay](../architecture/modular-building-connectors/window-bay.md) — observation opening.
...
- **optional component:** [industrial corrugated wall](../architecture/walls/industrial-corrugated-wall.md) — local material dressing.
