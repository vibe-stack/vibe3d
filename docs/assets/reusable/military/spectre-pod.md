...
---
asset_id: "asset.military.general.spectre-pod"
source_label: "Spectre pod"
...
- **Asset ID:** asset.military.general.spectre-pod
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:471
...
![Spectre pod reference render](spectre-pod.png)

## Intent

The **Spectre pod** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **Spectre pod** as a useful,
