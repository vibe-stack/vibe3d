...
---
asset_id: "asset.military.general.blast-barrier"
source_label: "blast barrier"
...
- **Asset ID:** asset.military.general.blast-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:450
...
![blast barrier reference render](blast-barrier.png)

## Intent

The **blast barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **blast barrier** as a useful,
