...
---
asset_id: "asset.military.general.landing-pad"
...
- **Asset ID:** asset.military.general.landing-pad
- **Type:** architectural or traversal module
- **Source:** prop-list.md:462
...
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **landing pad** as a useful,
