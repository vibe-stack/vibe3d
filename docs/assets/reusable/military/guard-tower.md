...
---
asset_id: "asset.military.general.guard-tower"
source_label: "guard tower"
...
- **Asset ID:** asset.military.general.guard-tower
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:441
...
![guard tower reference render](guard-tower.png)

## Intent

The **guard tower** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **guard tower** as a useful,
