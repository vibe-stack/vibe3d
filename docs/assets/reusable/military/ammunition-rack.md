...
---
asset_id: "asset.military.general.ammunition-rack"
source_label: "ammunition rack"
...
- **Asset ID:** asset.military.general.ammunition-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:469
...
![ammunition rack reference render](ammunition-rack.png)

## Intent

The **ammunition rack** is a industrial service prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **ammunition rack** as a useful,
