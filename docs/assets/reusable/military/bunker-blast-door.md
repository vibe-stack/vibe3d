...
---
asset_id: "asset.military.general.bunker-blast-door"
source_label: "bunker blast door"
...
- **Asset ID:** asset.military.general.bunker-blast-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:439
...
![bunker blast door reference render](bunker-blast-door.png)

## Intent

The **bunker blast door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **bunker blast door** as a useful,
