...
---
asset_id: "asset.military.general.imc-control-building"
source_label: "IMC control building"
...
# IMC control building

## Identity

- **Asset ID:** asset.military.general.imc-control-building
- **Type:** reusable military prefab assembly
- **Source:** prop-list.md:436
...
![IMC control building reference render](imc-control-building.png)

## Intent

The **IMC control building** is a reusable military prefab assembly for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **IMC control building** as a useful,
...
Use the small building shell as an IMC control-building host with a readable operator face, reinforced service spine, controlled glazing, roof-mounted communications, and a clear cable/power relationship to surrounding infrastructure.
...
- **blocking: room shell** — [room shell](../architecture/building-prefab-assemblies/room-shell.md) — control room volume.
- **blocking: door bay** — [door bay](../architecture/modular-building-connectors/door-bay.md) — operator/service entry.
- **blocking: window bay** — [window bay](../architecture/modular-building-connectors/window-bay.md) — observation glazing.
- **blocking: wall with vent** — [wall with vent](../architecture/walls/wall-with-vent.md) — cooling/service wall.
...
- **optional: wall terminal** — [wall terminal](../industrial/wall-terminal.md) — operator interface.
- **optional: control cabinet** — [control cabinet](../industrial/control-cabinet.md) — service equipment.
...
- **blocking component:** [room shell](../architecture/building-prefab-assemblies/room-shell.md) — control room volume.
- **blocking component:** [door bay](../architecture/modular-building-connectors/door-bay.md) — operator/service entry.
- **blocking component:** [window bay](../architecture/modular-building-connectors/window-bay.md) — observation glazing.
- **blocking component:** [wall with vent](../architecture/walls/wall-with-vent.md) — cooling/service wall.
...
- **optional component:** [wall terminal](../industrial/wall-terminal.md) — operator interface.
- **optional component:** [control cabinet](../industrial/control-cabinet.md) — service equipment.
