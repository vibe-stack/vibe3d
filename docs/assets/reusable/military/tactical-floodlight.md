...
---
asset_id: "asset.military.general.tactical-floodlight"
source_label: "tactical floodlight"
...
- **Asset ID:** asset.military.general.tactical-floodlight
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:466
...
![tactical floodlight reference render](tactical-floodlight.png)

## Intent

The **tactical floodlight** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **tactical floodlight** as a useful,
