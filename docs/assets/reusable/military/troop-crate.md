...
---
asset_id: "asset.military.general.troop-crate"
source_label: "troop crate"
...
- **Asset ID:** asset.military.general.troop-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:467
...
![troop crate reference render](troop-crate.png)

## Intent

The **troop crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **troop crate** as a useful,
