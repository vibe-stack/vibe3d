...
---
asset_id: "asset.military.general.sentry-emplacement"
source_label: "sentry emplacement"
...
- **Asset ID:** asset.military.general.sentry-emplacement
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:459
...
![sentry emplacement reference render](sentry-emplacement.png)

## Intent

The **sentry emplacement** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **sentry emplacement** as a useful,
