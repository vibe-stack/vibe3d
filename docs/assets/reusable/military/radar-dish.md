...
---
asset_id: "asset.military.general.radar-dish"
source_label: "radar dish"
...
- **Asset ID:** asset.military.general.radar-dish
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:444
...
![radar dish reference render](radar-dish.png)

## Intent

The **radar dish** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **radar dish** as a useful,
