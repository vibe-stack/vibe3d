...
---
asset_id: "asset.military.general.concrete-barrier"
source_label: "concrete barrier"
...
- **Asset ID:** asset.military.general.concrete-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:449
...
![concrete barrier reference render](concrete-barrier.png)

## Intent

The **concrete barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **concrete barrier** as a useful,
