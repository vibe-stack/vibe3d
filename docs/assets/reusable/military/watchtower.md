...
---
asset_id: "asset.military.general.watchtower"
source_label: "watchtower"
...
- **Asset ID:** asset.military.general.watchtower
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:440
...
![watchtower reference render](watchtower.png)

## Intent

The **watchtower** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **watchtower** as a useful,
