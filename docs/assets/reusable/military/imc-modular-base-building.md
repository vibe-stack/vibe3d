...
---
asset_id: "asset.military.general.imc-modular-base-building"
source_label: "IMC modular base building"
...
# IMC modular base building

## Identity

- **Asset ID:** asset.military.general.imc-modular-base-building
- **Type:** reusable military prefab assembly
- **Source:** prop-list.md:435
...
![IMC modular base building reference render](imc-modular-base-building.png)

## Intent

The **IMC modular base building** is a reusable military prefab assembly for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **IMC modular base building** as a useful,
...
Use the small building shell as a modular IMC base-building host: repeatable bays, a clear public/service split, durable corners, controlled openings, rooftop service access, and a repairable military skin. The building must be placeable as a complete shell and expandable through its sockets.
...
- **blocking: room shell** — [room shell](../architecture/building-prefab-assemblies/room-shell.md) — interior module.
- **blocking: wall 4 m** — [wall 4 m](../architecture/walls/wall-4-m.md) — long perimeter run.
- **blocking: interior wall corner** — [interior wall corner](../architecture/modular-building-connectors/interior-wall-corner.md) — room closure.
- **blocking: exterior wall corner** — [exterior wall corner](../architecture/modular-building-connectors/exterior-wall-corner.md) — outer closure.
- **blocking: door bay** — [door bay](../architecture/modular-building-connectors/door-bay.md) — access opening.
- **blocking: window bay** — [window bay](../architecture/modular-building-connectors/window-bay.md) — controlled glazing.
- **blocking: foundation interface** — [foundation interface](../architecture/modular-building-connectors/foundation-interface.md) — base anchoring.
- **blocking: roof/floor edge module** — [roof/floor edge module](../architecture/modular-building-connectors/roof-floor-edge-module.md) — roof closure.
- **optional: wall with vent** — [wall with vent](../architecture/walls/wall-with-vent.md) — service skin.
...
- **blocking component:** [room shell](../architecture/building-prefab-assemblies/room-shell.md) — interior module.
- **blocking component:** [wall 4 m](../architecture/walls/wall-4-m.md) — long perimeter run.
- **blocking component:** [interior wall corner](../architecture/modular-building-connectors/interior-wall-corner.md) — room closure.
- **blocking component:** [exterior wall corner](../architecture/modular-building-connectors/exterior-wall-corner.md) — outer closure.
- **blocking component:** [door bay](../architecture/modular-building-connectors/door-bay.md) — access opening.
- **blocking component:** [window bay](../architecture/modular-building-connectors/window-bay.md) — controlled glazing.
- **blocking component:** [foundation interface](../architecture/modular-building-connectors/foundation-interface.md) — base anchoring.
- **blocking component:** [roof/floor edge module](../architecture/modular-building-connectors/roof-floor-edge-module.md) — roof closure.
- **optional component:** [wall with vent](../architecture/walls/wall-with-vent.md) — service skin.
