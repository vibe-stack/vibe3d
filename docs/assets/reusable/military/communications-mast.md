...
---
asset_id: "asset.military.general.communications-mast"
source_label: "communications mast"
...
- **Asset ID:** asset.military.general.communications-mast
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:447
...
![communications mast reference render](communications-mast.png)

## Intent

The **communications mast** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **communications mast** as a useful,
