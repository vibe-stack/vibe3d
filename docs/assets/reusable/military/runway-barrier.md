...
---
asset_id: "asset.military.general.runway-barrier"
source_label: "runway barrier"
...
- **Asset ID:** asset.military.general.runway-barrier
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:465
...
![runway barrier reference render](runway-barrier.png)

## Intent

The **runway barrier** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **runway barrier** as a useful,
