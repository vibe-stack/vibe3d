...
---
asset_id: "asset.military.general.spectre-rack"
source_label: "Spectre rack"
...
- **Asset ID:** asset.military.general.spectre-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:470
...
![Spectre rack reference render](spectre-rack.png)

## Intent

The **Spectre rack** is a industrial service prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **Spectre rack** as a useful,
