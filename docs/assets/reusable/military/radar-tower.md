...
---
asset_id: "asset.military.general.radar-tower"
source_label: "radar tower"
...
- **Asset ID:** asset.military.general.radar-tower
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:445
...
![radar tower reference render](radar-tower.png)

## Intent

The **radar tower** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **radar tower** as a useful,
