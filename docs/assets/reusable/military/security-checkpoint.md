...
---
asset_id: "asset.military.general.security-checkpoint"
source_label: "security checkpoint"
...
- **Asset ID:** asset.military.general.security-checkpoint
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:453
...
![security checkpoint reference render](security-checkpoint.png)

## Intent

The **security checkpoint** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **security checkpoint** as a useful,
