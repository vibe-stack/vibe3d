...
---
asset_id: "asset.military.general.checkpoint-gate"
source_label: "checkpoint gate"
...
- **Asset ID:** asset.military.general.checkpoint-gate
- **Type:** architectural or traversal module
- **Source:** prop-list.md:455
...
![checkpoint gate reference render](checkpoint-gate.png)

## Intent

The **checkpoint gate** is a architectural or traversal module for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **checkpoint gate** as a useful,
