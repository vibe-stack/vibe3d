...
---
asset_id: "asset.military.general.weapon-emplacement-foundation"
source_label: "weapon emplacement foundation"
...
# weapon emplacement foundation

## Identity

- **Asset ID:** asset.military.general.weapon-emplacement-foundation
- **Type:** architectural or traversal module
- **Source:** prop-list.md:460
...
![weapon emplacement foundation reference render](weapon-emplacement-foundation.png)

## Intent

The **weapon emplacement foundation** is a architectural or traversal module for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **weapon emplacement foundation** as a useful,
