...
---
asset_id: "asset.military.general.defensive-wall"
source_label: "defensive wall"
...
- **Asset ID:** asset.military.general.defensive-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:448
...
![defensive wall reference render](defensive-wall.png)

## Intent

The **defensive wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **defensive wall** as a useful,
