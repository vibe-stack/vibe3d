...
---
asset_id: "asset.military.general.road-blocker"
source_label: "road blocker"
...
- **Asset ID:** asset.military.general.road-blocker
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:457
...
![road blocker reference render](road-blocker.png)

## Intent

The **road blocker** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **road blocker** as a useful,
