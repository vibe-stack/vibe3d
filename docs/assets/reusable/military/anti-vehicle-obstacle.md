...
---
asset_id: "asset.military.general.anti-vehicle-obstacle"
source_label: "anti-vehicle obstacle"
...
- **Asset ID:** asset.military.general.anti-vehicle-obstacle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:458
...
![anti-vehicle obstacle reference render](anti-vehicle-obstacle.png)

## Intent

The **anti-vehicle obstacle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
robust defense infrastructure with clear fields of fire, access control, and repair history. Its primary read should be **anti-vehicle obstacle** as a useful,
