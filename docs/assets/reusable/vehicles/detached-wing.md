...
---
asset_id: "asset.vehicles.general.detached-wing"
source_label: "detached wing"
...
- **Asset ID:** asset.vehicles.general.detached-wing
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:817
...
![detached wing reference render](detached-wing.png)

## Intent

The **detached wing** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **detached wing** as a useful,
