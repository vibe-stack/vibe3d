...
---
asset_id: "asset.vehicles.general.utility-cart"
source_label: "utility cart"
...
- **Asset ID:** asset.vehicles.general.utility-cart
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:803
...
![utility cart reference render](utility-cart.png)

## Intent

The **utility cart** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **utility cart** as a useful,
