...
---
asset_id: "asset.vehicles.general.cargo-truck"
source_label: "cargo truck"
...
- **Asset ID:** asset.vehicles.general.cargo-truck
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:801
...
![cargo truck reference render](cargo-truck.png)

## Intent

The **cargo truck** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **cargo truck** as a useful,
