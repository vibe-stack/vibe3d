...
---
asset_id: "asset.vehicles.general.service-truck"
source_label: "service truck"
...
- **Asset ID:** asset.vehicles.general.service-truck
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:802
...
![service truck reference render](service-truck.png)

## Intent

The **service truck** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **service truck** as a useful,
