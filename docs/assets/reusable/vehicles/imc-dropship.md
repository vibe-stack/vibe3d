...
---
asset_id: "asset.vehicles.general.imc-dropship"
source_label: "IMC dropship"
...
- **Asset ID:** asset.vehicles.general.imc-dropship
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:792
...
![IMC dropship reference render](imc-dropship.png)

## Intent

The **IMC dropship** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **IMC dropship** as a useful,
