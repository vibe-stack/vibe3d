...
---
asset_id: "asset.vehicles.general.locomotive"
...
- **Asset ID:** asset.vehicles.general.locomotive
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:810
...
The **locomotive** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **locomotive** as a useful,
