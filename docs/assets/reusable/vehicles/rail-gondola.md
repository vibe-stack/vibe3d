...
---
asset_id: "asset.vehicles.general.rail-gondola"
source_label: "rail gondola"
...
- **Asset ID:** asset.vehicles.general.rail-gondola
- **Type:** architectural or traversal module
- **Source:** prop-list.md:808
...
![rail gondola reference render](rail-gondola.png)

## Intent

The **rail gondola** is a architectural or traversal module for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **rail gondola** as a useful,
