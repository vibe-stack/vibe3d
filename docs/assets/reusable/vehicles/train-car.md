...
---
asset_id: "asset.vehicles.general.train-car"
source_label: "train car"
...
- **Asset ID:** asset.vehicles.general.train-car
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:809
...
![train car reference render](train-car.png)

## Intent

The **train car** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **train car** as a useful,
