...
---
asset_id: "asset.vehicles.general.detached-engine"
source_label: "detached engine"
...
- **Asset ID:** asset.vehicles.general.detached-engine
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:816
...
![detached engine reference render](detached-engine.png)

## Intent

The **detached engine** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **detached engine** as a useful,
