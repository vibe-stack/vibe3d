...
---
asset_id: "asset.vehicles.general.landing-gear"
source_label: "landing gear"
...
- **Asset ID:** asset.vehicles.general.landing-gear
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:818
...
![landing gear reference render](landing-gear.png)

## Intent

The **landing gear** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **landing gear** as a useful,
