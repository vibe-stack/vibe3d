...
---
asset_id: "asset.vehicles.general.forklift"
source_label: "forklift"
...
- **Asset ID:** asset.vehicles.general.forklift
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:804
...
![forklift reference render](forklift.png)

## Intent

The **forklift** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **forklift** as a useful,
