...
---
asset_id: "asset.vehicles.general.supply-ship"
source_label: "Supply Ship"
...
- **Asset ID:** asset.vehicles.general.supply-ship
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:793
...
![Supply Ship reference render](supply-ship.png)

## Intent

The **Supply Ship** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **Supply Ship** as a useful,
