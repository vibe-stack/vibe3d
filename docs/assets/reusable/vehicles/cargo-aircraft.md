...
---
asset_id: "asset.vehicles.general.cargo-aircraft"
source_label: "cargo aircraft"
...
- **Asset ID:** asset.vehicles.general.cargo-aircraft
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:795
...
![cargo aircraft reference render](cargo-aircraft.png)

## Intent

The **cargo aircraft** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **cargo aircraft** as a useful,
