...
---
asset_id: "asset.vehicles.general.crashed-dropship"
source_label: "crashed dropship"
...
- **Asset ID:** asset.vehicles.general.crashed-dropship
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:813
...
![crashed dropship reference render](crashed-dropship.png)

## Intent

The **crashed dropship** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **crashed dropship** as a useful,
