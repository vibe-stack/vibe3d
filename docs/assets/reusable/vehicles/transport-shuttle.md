...
---
asset_id: "asset.vehicles.general.transport-shuttle"
source_label: "transport shuttle"
...
- **Asset ID:** asset.vehicles.general.transport-shuttle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:797
...
![transport shuttle reference render](transport-shuttle.png)

## Intent

The **transport shuttle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **transport shuttle** as a useful,
