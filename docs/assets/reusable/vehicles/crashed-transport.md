...
---
asset_id: "asset.vehicles.general.crashed-transport"
source_label: "crashed transport"
...
- **Asset ID:** asset.vehicles.general.crashed-transport
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:814
...
![crashed transport reference render](crashed-transport.png)

## Intent

The **crashed transport** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **crashed transport** as a useful,
