...
---
asset_id: "asset.vehicles.general.maintenance-vehicle"
source_label: "maintenance vehicle"
...
- **Asset ID:** asset.vehicles.general.maintenance-vehicle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:798
...
![maintenance vehicle reference render](maintenance-vehicle.png)

## Intent

The **maintenance vehicle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **maintenance vehicle** as a useful,
