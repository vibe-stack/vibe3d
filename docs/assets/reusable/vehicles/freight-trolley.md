...
---
asset_id: "asset.vehicles.general.freight-trolley"
source_label: "freight trolley"
...
- **Asset ID:** asset.vehicles.general.freight-trolley
- **Type:** industrial service prop
- **Source:** prop-list.md:807
...
![freight trolley reference render](freight-trolley.png)

## Intent

The **freight trolley** is a industrial service prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **freight trolley** as a useful,
