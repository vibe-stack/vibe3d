...
---
asset_id: "asset.vehicles.general.small-shuttle"
source_label: "small shuttle"
...
- **Asset ID:** asset.vehicles.general.small-shuttle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:796
...
![small shuttle reference render](small-shuttle.png)

## Intent

The **small shuttle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **small shuttle** as a useful,
