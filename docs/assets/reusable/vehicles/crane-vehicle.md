...
---
asset_id: "asset.vehicles.general.crane-vehicle"
source_label: "crane vehicle"
...
- **Asset ID:** asset.vehicles.general.crane-vehicle
- **Type:** industrial service prop
- **Source:** prop-list.md:806
...
![crane vehicle reference render](crane-vehicle.png)

## Intent

The **crane vehicle** is a industrial service prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **crane vehicle** as a useful,
