...
---
asset_id: "asset.vehicles.general.civilian-van"
source_label: "civilian van"
...
- **Asset ID:** asset.vehicles.general.civilian-van
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:800
...
![civilian van reference render](civilian-van.png)

## Intent

The **civilian van** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **civilian van** as a useful,
