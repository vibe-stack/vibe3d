...
---
asset_id: "asset.vehicles.general.construction-vehicle"
source_label: "construction vehicle"
...
- **Asset ID:** asset.vehicles.general.construction-vehicle
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:805
...
![construction vehicle reference render](construction-vehicle.png)

## Intent

The **construction vehicle** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **construction vehicle** as a useful,
