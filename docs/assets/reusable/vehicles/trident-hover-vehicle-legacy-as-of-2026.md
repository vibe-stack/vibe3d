...
---
asset_id: "asset.vehicles.general.trident-hover-vehicle-legacy-as-of-2026"
source_label: "Trident hover vehicle — legacy as of 2026"
source_section: "Reusable / vehicles and vehicle-like dressing"
source_group: "General"
source_line: 811
level: L2
status: planned
place_family: "Roads, docks, hangars, landing pads, rail, and crash sites"
owner: "Axiom transport / local civilian operators"
---

# Trident hover vehicle — legacy as of 2026

## Identity

- **Asset ID:** asset.vehicles.general.trident-hover-vehicle-legacy-as-of-2026
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:811
- **Family:** Reusable / vehicles and vehicle-like dressing
- **Place family:** Roads, docks, hangars, landing pads, rail, and crash sites
- **Owner / story role:** Axiom transport / local civilian operators

## Reference render

![Trident hover vehicle — legacy as of 2026 reference render](trident-hover-vehicle-legacy-as-of-2026.png)

## Intent

The **Trident hover vehicle — legacy as of 2026** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **Trident hover vehicle — legacy as of 2026** as a useful,
...
Preserve the source label as a production reference, but use the neutral Axiom mark set for new graphics and avoid reproducing third-party logos or exact branded geometry.
...
Establish the resting mass and wheel/landing/rail contact first, then service access, glazing, cargo, and damage seams. The parked state should tell the viewer how the vehicle normally moves.
