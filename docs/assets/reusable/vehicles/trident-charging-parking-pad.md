...
---
asset_id: "asset.vehicles.general.trident-charging-parking-pad"
source_label: "Trident charging/parking pad"
...
# Trident charging/parking pad

## Identity

- **Asset ID:** asset.vehicles.general.trident-charging-parking-pad
- **Type:** architectural or traversal module
- **Source:** prop-list.md:812
...
![Trident charging/parking pad reference render](trident-charging-parking-pad.png)

## Intent

The **Trident charging/parking pad** is a architectural or traversal module for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **Trident charging/parking pad** as a useful,
