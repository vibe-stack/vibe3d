...
---
asset_id: "asset.vehicles.general.futuristic-civilian-car"
source_label: "futuristic civilian car"
...
# futuristic civilian car

## Identity

- **Asset ID:** asset.vehicles.general.futuristic-civilian-car
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:799
...
![futuristic civilian car reference render](futuristic-civilian-car.png)

## Intent

The **futuristic civilian car** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **futuristic civilian car** as a useful,
