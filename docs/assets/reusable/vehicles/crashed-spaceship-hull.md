...
---
asset_id: "asset.vehicles.general.crashed-spaceship-hull"
source_label: "crashed spaceship hull"
...
- **Asset ID:** asset.vehicles.general.crashed-spaceship-hull
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:815
...
![crashed spaceship hull reference render](crashed-spaceship-hull.png)

## Intent

The **crashed spaceship hull** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **crashed spaceship hull** as a useful,
