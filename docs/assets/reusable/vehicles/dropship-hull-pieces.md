...
---
asset_id: "asset.vehicles.general.dropship-hull-pieces"
source_label: "Dropship hull pieces"
...
# Dropship hull pieces

## Identity

- **Asset ID:** asset.vehicles.general.dropship-hull-pieces
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:794
...
![Dropship hull pieces reference render](dropship-hull-pieces.png)

## Intent

The **Dropship hull pieces** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
large-scale mobility objects with a clear mass, service access, and believable resting state. Its primary read should be **Dropship hull pieces** as a useful,
