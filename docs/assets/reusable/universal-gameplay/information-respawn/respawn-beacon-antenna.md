...
---
asset_id: "asset.universal-gameplay.information-respawn.respawn-beacon-antenna"
source_label: "Respawn Beacon antenna"
...
# Respawn Beacon antenna

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.respawn-beacon-antenna
- **Type:** gameplay system prop
- **Source:** prop-list.md:46
...
![Respawn Beacon antenna reference render](respawn-beacon-antenna.png)

## Intent

The **Respawn Beacon antenna** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Respawn Beacon antenna** as a useful,
