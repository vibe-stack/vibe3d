...
---
asset_id: "asset.universal-gameplay.information-respawn.ring-console-terminal"
source_label: "Ring Console terminal"
...
# Ring Console terminal

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.ring-console-terminal
- **Type:** gameplay system prop
- **Source:** prop-list.md:54
...
![Ring Console terminal reference render](ring-console-terminal.png)

## Intent

The **Ring Console terminal** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ring Console terminal** as a useful,
