...
---
asset_id: "asset.universal-gameplay.information-respawn.mobile-respawn-beacon-deployed"
source_label: "Mobile Respawn Beacon deployed"
...
# Mobile Respawn Beacon deployed

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.mobile-respawn-beacon-deployed
- **Type:** gameplay system prop
- **Source:** prop-list.md:48
...
![Mobile Respawn Beacon deployed reference render](mobile-respawn-beacon-deployed.png)

## Intent

The **Mobile Respawn Beacon deployed** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Mobile Respawn Beacon deployed** as a useful,
