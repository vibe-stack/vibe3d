...
---
asset_id: "asset.universal-gameplay.information-respawn.survey-beacon"
source_label: "Survey Beacon"
...
- **Asset ID:** asset.universal-gameplay.information-respawn.survey-beacon
- **Type:** gameplay system prop
- **Source:** prop-list.md:50
...
![Survey Beacon reference render](survey-beacon.png)

## Intent

The **Survey Beacon** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Survey Beacon** as a useful,
