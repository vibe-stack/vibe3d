...
---
asset_id: "asset.universal-gameplay.information-respawn.ring-console-antenna-radar-module"
source_label: "Ring Console antenna/radar module"
source_section: "Reusable / universal gameplay"
source_group: "Information / respawn"
source_line: 55
level: L2
status: planned
...
# Ring Console antenna/radar module

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.ring-console-antenna-radar-module
- **Type:** gameplay system prop
- **Source:** prop-list.md:55
...
![Ring Console antenna/radar module reference render](ring-console-antenna-radar-module.png)

## Intent

The **Ring Console antenna/radar module** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ring Console antenna/radar module** as a useful,
...
Frame the information surface with a physical bezel, mount, cable/power path, and a restrained graphic hierarchy. The graphic must remain readable as a block before text is legible.

The construction follows the shared **chassis → service → signal** order.
Show power/data entry, ventilation or heat rejection, access panel seams, and an operator-facing interface. Avoid a black screen unless the inactive state is intentional. Keep the strongest value break on the
