...
---
asset_id: "asset.universal-gameplay.information-respawn.respawn-beacon-holographic-projector"
source_label: "Respawn Beacon holographic projector"
...
# Respawn Beacon holographic projector

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.respawn-beacon-holographic-projector
- **Type:** gameplay system prop
- **Source:** prop-list.md:47
...
![Respawn Beacon holographic projector reference render](respawn-beacon-holographic-projector.png)

## Intent

The **Respawn Beacon holographic projector** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Respawn Beacon holographic projector** as a useful,
