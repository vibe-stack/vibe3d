...
---
asset_id: "asset.universal-gameplay.information-respawn.mobile-respawn-beacon-antenna"
source_label: "Mobile Respawn Beacon antenna"
...
# Mobile Respawn Beacon antenna

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.mobile-respawn-beacon-antenna
- **Type:** gameplay system prop
- **Source:** prop-list.md:49
...
![Mobile Respawn Beacon antenna reference render](mobile-respawn-beacon-antenna.png)

## Intent

The **Mobile Respawn Beacon antenna** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Mobile Respawn Beacon antenna** as a useful,
