...
---
asset_id: "asset.universal-gameplay.information-respawn.ring-console"
source_label: "Ring Console"
...
- **Asset ID:** asset.universal-gameplay.information-respawn.ring-console
- **Type:** gameplay system prop
- **Source:** prop-list.md:53
...
![Ring Console reference render](ring-console.png)

## Intent

The **Ring Console** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ring Console** as a useful,
