...
---
asset_id: "asset.universal-gameplay.information-respawn.survey-beacon-dish"
source_label: "Survey Beacon dish"
...
- **Asset ID:** asset.universal-gameplay.information-respawn.survey-beacon-dish
- **Type:** gameplay system prop
- **Source:** prop-list.md:51
...
![Survey Beacon dish reference render](survey-beacon-dish.png)

## Intent

The **Survey Beacon dish** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Survey Beacon dish** as a useful,
