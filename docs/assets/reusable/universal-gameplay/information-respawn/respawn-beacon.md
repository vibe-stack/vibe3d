...
---
asset_id: "asset.universal-gameplay.information-respawn.respawn-beacon"
source_label: "Respawn Beacon"
...
- **Asset ID:** asset.universal-gameplay.information-respawn.respawn-beacon
- **Type:** gameplay system prop
- **Source:** prop-list.md:45
...
![Respawn Beacon reference render](respawn-beacon.png)

## Intent

The **Respawn Beacon** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Respawn Beacon** as a useful,
