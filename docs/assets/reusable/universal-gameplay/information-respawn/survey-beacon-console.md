...
---
asset_id: "asset.universal-gameplay.information-respawn.survey-beacon-console"
source_label: "Survey Beacon console"
...
# Survey Beacon console

## Identity

- **Asset ID:** asset.universal-gameplay.information-respawn.survey-beacon-console
- **Type:** gameplay system prop
- **Source:** prop-list.md:52
...
![Survey Beacon console reference render](survey-beacon-console.png)

## Intent

The **Survey Beacon console** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Survey Beacon console** as a useful,
