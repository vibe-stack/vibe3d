...
---
asset_id: "asset.universal-gameplay.traversal.freestanding-zipline-tower"
source_label: "freestanding zipline tower"
...
# freestanding zipline tower

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.freestanding-zipline-tower
- **Type:** gameplay system prop
- **Source:** prop-list.md:66
...
![freestanding zipline tower reference render](freestanding-zipline-tower.png)

## Intent

The **freestanding zipline tower** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **freestanding zipline tower** as a useful,
