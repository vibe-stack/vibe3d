...
---
asset_id: "asset.universal-gameplay.traversal.zipline-anchor-a"
source_label: "zipline anchor A"
...
- **Asset ID:** asset.universal-gameplay.traversal.zipline-anchor-a
- **Type:** gameplay system prop
- **Source:** prop-list.md:63
...
![zipline anchor A reference render](zipline-anchor-a.png)

## Intent

The **zipline anchor A** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **zipline anchor A** as a useful,
