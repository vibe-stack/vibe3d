...
---
asset_id: "asset.universal-gameplay.traversal.jump-tower-base"
source_label: "Jump Tower base"
...
- **Asset ID:** asset.universal-gameplay.traversal.jump-tower-base
- **Type:** gameplay system prop
- **Source:** prop-list.md:68
...
![Jump Tower base reference render](jump-tower-base.png)

## Intent

The **Jump Tower base** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Jump Tower base** as a useful,
