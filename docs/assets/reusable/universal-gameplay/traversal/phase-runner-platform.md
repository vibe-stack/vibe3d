...
---
asset_id: "asset.universal-gameplay.traversal.phase-runner-platform"
source_label: "Phase Runner platform"
...
# Phase Runner platform

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.phase-runner-platform
- **Type:** architectural or traversal module
- **Source:** prop-list.md:89
...
![Phase Runner platform reference render](phase-runner-platform.png)

## Intent

The **Phase Runner platform** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Phase Runner platform** as a useful,
