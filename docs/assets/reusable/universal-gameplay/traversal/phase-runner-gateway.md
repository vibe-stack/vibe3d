...
---
asset_id: "asset.universal-gameplay.traversal.phase-runner-gateway"
source_label: "Phase Runner gateway"
...
# Phase Runner gateway

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.phase-runner-gateway
- **Type:** architectural or traversal module
- **Source:** prop-list.md:86
...
![Phase Runner gateway reference render](phase-runner-gateway.png)

## Intent

The **Phase Runner gateway** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Phase Runner gateway** as a useful,
