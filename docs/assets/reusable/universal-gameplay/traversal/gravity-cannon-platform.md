...
---
asset_id: "asset.universal-gameplay.traversal.gravity-cannon-platform"
source_label: "Gravity Cannon platform"
...
# Gravity Cannon platform

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.gravity-cannon-platform
- **Type:** architectural or traversal module
- **Source:** prop-list.md:74
...
![Gravity Cannon platform reference render](gravity-cannon-platform.png)

## Intent

The **Gravity Cannon platform** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Cannon platform** as a useful,
