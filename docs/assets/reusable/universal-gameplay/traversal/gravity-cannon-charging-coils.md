...
---
asset_id: "asset.universal-gameplay.traversal.gravity-cannon-charging-coils"
source_label: "Gravity Cannon charging coils"
...
# Gravity Cannon charging coils

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.gravity-cannon-charging-coils
- **Type:** gameplay system prop
- **Source:** prop-list.md:75
...
![Gravity Cannon charging coils reference render](gravity-cannon-charging-coils.png)

## Intent

The **Gravity Cannon charging coils** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Cannon charging coils** as a useful,
