...
---
asset_id: "asset.universal-gameplay.traversal.ziprail-track-segment-straight"
source_label: "Ziprail track segment straight"
...
# Ziprail track segment straight

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.ziprail-track-segment-straight
- **Type:** architectural or traversal module
- **Source:** prop-list.md:82
...
![Ziprail track segment straight reference render](ziprail-track-segment-straight.png)

## Intent

The **Ziprail track segment straight** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ziprail track segment straight** as a useful,
