...
---
asset_id: "asset.universal-gameplay.traversal.jump-tower-cable"
source_label: "Jump Tower cable"
...
- **Asset ID:** asset.universal-gameplay.traversal.jump-tower-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:71
...
![Jump Tower cable reference render](jump-tower-cable.png)

## Intent

The **Jump Tower cable** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Jump Tower cable** as a useful,
