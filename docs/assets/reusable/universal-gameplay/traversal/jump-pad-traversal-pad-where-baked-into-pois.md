...
---
asset_id: "asset.universal-gameplay.traversal.jump-pad-traversal-pad-where-baked-into-pois"
source_label: "jump pad / traversal pad where baked into POIs"
...
# jump pad / traversal pad where baked into POIs

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.jump-pad-traversal-pad-where-baked-into-pois
- **Type:** architectural or traversal module
- **Source:** prop-list.md:90
...
![jump pad / traversal pad where baked into POIs reference render](jump-pad-traversal-pad-where-baked-into-pois.png)

## Intent

The **jump pad / traversal pad where baked into POIs** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **jump pad / traversal pad where baked into POIs** as a useful,
