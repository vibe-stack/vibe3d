...
---
asset_id: "asset.universal-gameplay.traversal.gravity-launcher-generator"
source_label: "Gravity Launcher generator"
...
# Gravity Launcher generator

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.gravity-launcher-generator
- **Type:** industrial service prop
- **Source:** prop-list.md:79
...
![Gravity Launcher generator reference render](gravity-launcher-generator.png)

## Intent

The **Gravity Launcher generator** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Launcher generator** as a useful,
