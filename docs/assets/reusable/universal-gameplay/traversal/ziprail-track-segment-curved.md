...
---
asset_id: "asset.universal-gameplay.traversal.ziprail-track-segment-curved"
source_label: "Ziprail track segment curved"
...
# Ziprail track segment curved

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.ziprail-track-segment-curved
- **Type:** architectural or traversal module
- **Source:** prop-list.md:83
...
![Ziprail track segment curved reference render](ziprail-track-segment-curved.png)

## Intent

The **Ziprail track segment curved** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ziprail track segment curved** as a useful,
