...
---
asset_id: "asset.universal-gameplay.traversal.gravity-cannon"
source_label: "Gravity Cannon"
...
- **Asset ID:** asset.universal-gameplay.traversal.gravity-cannon
- **Type:** gameplay system prop
- **Source:** prop-list.md:73
...
![Gravity Cannon reference render](gravity-cannon.png)

## Intent

The **Gravity Cannon** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Cannon** as a useful,
