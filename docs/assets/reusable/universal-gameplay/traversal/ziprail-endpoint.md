...
---
asset_id: "asset.universal-gameplay.traversal.ziprail-endpoint"
source_label: "Ziprail endpoint"
...
- **Asset ID:** asset.universal-gameplay.traversal.ziprail-endpoint
- **Type:** architectural or traversal module
- **Source:** prop-list.md:85
...
![Ziprail endpoint reference render](ziprail-endpoint.png)

## Intent

The **Ziprail endpoint** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ziprail endpoint** as a useful,
