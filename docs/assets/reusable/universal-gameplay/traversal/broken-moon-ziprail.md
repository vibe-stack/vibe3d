...
---
asset_id: "asset.universal-gameplay.traversal.broken-moon-ziprail"
source_label: "Broken Moon Ziprail"
...
- **Asset ID:** asset.universal-gameplay.traversal.broken-moon-ziprail
- **Type:** architectural or traversal module
- **Source:** prop-list.md:80
...
![Broken Moon Ziprail reference render](broken-moon-ziprail.png)

## Intent

The **Broken Moon Ziprail** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Broken Moon Ziprail** as a useful,
