...
---
asset_id: "asset.universal-gameplay.traversal.jump-tower-mast"
source_label: "Jump Tower mast"
...
- **Asset ID:** asset.universal-gameplay.traversal.jump-tower-mast
- **Type:** gameplay system prop
- **Source:** prop-list.md:69
...
![Jump Tower mast reference render](jump-tower-mast.png)

## Intent

The **Jump Tower mast** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Jump Tower mast** as a useful,
