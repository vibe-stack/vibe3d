...
---
asset_id: "asset.universal-gameplay.traversal.cable-pulley"
source_label: "cable pulley"
...
- **Asset ID:** asset.universal-gameplay.traversal.cable-pulley
- **Type:** industrial service prop
- **Source:** prop-list.md:67
...
![cable pulley reference render](cable-pulley.png)

## Intent

The **cable pulley** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **cable pulley** as a useful,
