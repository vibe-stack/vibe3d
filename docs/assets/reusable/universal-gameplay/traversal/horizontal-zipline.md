...
---
asset_id: "asset.universal-gameplay.traversal.horizontal-zipline"
source_label: "horizontal Zipline"
...
- **Asset ID:** asset.universal-gameplay.traversal.horizontal-zipline
- **Type:** gameplay system prop
- **Source:** prop-list.md:62
...
![horizontal Zipline reference render](horizontal-zipline.png)

## Intent

The **horizontal Zipline** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **horizontal Zipline** as a useful,
