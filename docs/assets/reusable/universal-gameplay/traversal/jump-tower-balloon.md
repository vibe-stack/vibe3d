...
---
asset_id: "asset.universal-gameplay.traversal.jump-tower-balloon"
source_label: "Jump Tower balloon"
...
- **Asset ID:** asset.universal-gameplay.traversal.jump-tower-balloon
- **Type:** gameplay system prop
- **Source:** prop-list.md:70
...
![Jump Tower balloon reference render](jump-tower-balloon.png)

## Intent

The **Jump Tower balloon** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Jump Tower balloon** as a useful,
