...
---
asset_id: "asset.universal-gameplay.traversal.ziprail-station"
source_label: "Ziprail station"
...
- **Asset ID:** asset.universal-gameplay.traversal.ziprail-station
- **Type:** architectural or traversal module
- **Source:** prop-list.md:84
...
![Ziprail station reference render](ziprail-station.png)

## Intent

The **Ziprail station** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ziprail station** as a useful,
