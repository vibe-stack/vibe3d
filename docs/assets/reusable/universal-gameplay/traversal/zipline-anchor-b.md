...
---
asset_id: "asset.universal-gameplay.traversal.zipline-anchor-b"
source_label: "zipline anchor B"
...
- **Asset ID:** asset.universal-gameplay.traversal.zipline-anchor-b
- **Type:** gameplay system prop
- **Source:** prop-list.md:64
...
![zipline anchor B reference render](zipline-anchor-b.png)

## Intent

The **zipline anchor B** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **zipline anchor B** as a useful,
