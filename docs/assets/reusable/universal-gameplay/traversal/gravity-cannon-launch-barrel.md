...
---
asset_id: "asset.universal-gameplay.traversal.gravity-cannon-launch-barrel"
source_label: "Gravity Cannon launch barrel"
...
# Gravity Cannon launch barrel

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.gravity-cannon-launch-barrel
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:76
...
![Gravity Cannon launch barrel reference render](gravity-cannon-launch-barrel.png)

## Intent

The **Gravity Cannon launch barrel** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Cannon launch barrel** as a useful,
...
Give the vessel a legible container silhouette, a top/bottom service relationship, and a visible pressure, fill, or access cue. Avoid perfectly blank cylinders.
...
Use VIOLET-500 as the dominant signal token and CYAN-400 only
