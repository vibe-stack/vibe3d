...
---
asset_id: "asset.universal-gameplay.traversal.phase-runner-ring"
source_label: "Phase Runner ring"
...
- **Asset ID:** asset.universal-gameplay.traversal.phase-runner-ring
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:87
...
![Phase Runner ring reference render](phase-runner-ring.png)

## Intent

The **Phase Runner ring** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Phase Runner ring** as a useful,
