...
---
asset_id: "asset.universal-gameplay.traversal.roof-zipline-pole"
source_label: "roof zipline pole"
...
- **Asset ID:** asset.universal-gameplay.traversal.roof-zipline-pole
- **Type:** architectural or traversal module
- **Source:** prop-list.md:65
...
![roof zipline pole reference render](roof-zipline-pole.png)

## Intent

The **roof zipline pole** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **roof zipline pole** as a useful,
