...
---
asset_id: "asset.universal-gameplay.traversal.standard-vertical-zipline-cable"
source_label: "standard vertical Zipline cable"
source_section: "Reusable / universal gameplay"
source_group: "Traversal"
source_line: 61
level: L2
status: planned
...
# standard vertical Zipline cable

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.standard-vertical-zipline-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:61
- **Family:** Reusable / universal gameplay
- **Place family:** All place families
- **Owner / story role:** Axiom systems

## Reference render

![standard vertical Zipline cable reference render](standard-vertical-zipline-cable.png)

## Intent

The **standard vertical Zipline cable** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **standard vertical Zipline cable** as a useful,
...
Use CYAN-400 as the dominant signal token and COBALT-500 only
...
1. **Default / Reset** — recognition state and public contract.
2. **Active / Available** — state-bearing geometry, signal, decal, and collision change.
3. **Depleted Or Disabled** — reuse the chassis with a focused dressing or service pass.
