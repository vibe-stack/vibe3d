...
---
asset_id: "asset.universal-gameplay.traversal.gravity-launcher-pad"
source_label: "Gravity Launcher pad"
...
# Gravity Launcher pad

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.gravity-launcher-pad
- **Type:** architectural or traversal module
- **Source:** prop-list.md:78
...
![Gravity Launcher pad reference render](gravity-launcher-pad.png)

## Intent

The **Gravity Launcher pad** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Gravity Launcher pad** as a useful,
