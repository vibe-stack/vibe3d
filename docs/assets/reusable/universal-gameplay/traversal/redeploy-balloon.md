...
---
asset_id: "asset.universal-gameplay.traversal.redeploy-balloon"
source_label: "redeploy balloon"
...
- **Asset ID:** asset.universal-gameplay.traversal.redeploy-balloon
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:72
...
![redeploy balloon reference render](redeploy-balloon.png)

## Intent

The **redeploy balloon** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **redeploy balloon** as a useful,
