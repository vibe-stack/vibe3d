...
---
asset_id: "asset.universal-gameplay.traversal.e-district-gravity-launcher"
source_label: "E-District Gravity Launcher"
...
# E-District Gravity Launcher

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.e-district-gravity-launcher
- **Type:** gameplay system prop
- **Source:** prop-list.md:77
...
![E-District Gravity Launcher reference render](e-district-gravity-launcher.png)

## Intent

The **E-District Gravity Launcher** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **E-District Gravity Launcher** as a useful,
