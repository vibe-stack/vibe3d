...
---
asset_id: "asset.universal-gameplay.traversal.ziprail-support-pole"
source_label: "Ziprail support pole"
...
# Ziprail support pole

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.ziprail-support-pole
- **Type:** architectural or traversal module
- **Source:** prop-list.md:81
...
![Ziprail support pole reference render](ziprail-support-pole.png)

## Intent

The **Ziprail support pole** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Ziprail support pole** as a useful,
...
- **base supply-bin state:** [standard Supply Bin](../loot/standard-supply-bin.md).
