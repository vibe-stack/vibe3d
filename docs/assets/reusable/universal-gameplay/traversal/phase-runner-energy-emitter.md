...
---
asset_id: "asset.universal-gameplay.traversal.phase-runner-energy-emitter"
source_label: "Phase Runner energy emitter"
...
# Phase Runner energy emitter

## Identity

- **Asset ID:** asset.universal-gameplay.traversal.phase-runner-energy-emitter
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:88
...
![Phase Runner energy emitter reference render](phase-runner-energy-emitter.png)

## Intent

The **Phase Runner energy emitter** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Phase Runner energy emitter** as a useful,
