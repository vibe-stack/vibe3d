...
---
asset_id: "asset.universal-gameplay.loot.grenade-loot-spawn"
source_label: "grenade loot spawn"
...
- **Asset ID:** asset.universal-gameplay.loot.grenade-loot-spawn
- **Type:** gameplay system prop
- **Source:** prop-list.md:20
...
![grenade loot spawn reference render](grenade-loot-spawn.png)

## Intent

The **grenade loot spawn** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **grenade loot spawn** as a useful,
