...
---
asset_id: "asset.universal-gameplay.loot.standard-supply-bin"
source_label: "standard Supply Bin"
...
- **Asset ID:** asset.universal-gameplay.loot.standard-supply-bin
- **Type:** gameplay system prop
- **Source:** prop-list.md:11
...
![standard Supply Bin reference render](standard-supply-bin.png)

## Intent

The **standard Supply Bin** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **standard Supply Bin** as a useful,
