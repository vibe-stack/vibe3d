...
---
asset_id: "asset.universal-gameplay.loot.care-package-pod"
source_label: "Care Package pod"
...
- **Asset ID:** asset.universal-gameplay.loot.care-package-pod
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:23
...
![Care Package pod reference render](care-package-pod.png)

## Intent

The **Care Package pod** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Care Package pod** as a useful,
