...
---
asset_id: "asset.universal-gameplay.loot.death-box-cosmetic-shell-variants"
source_label: "Death Box cosmetic shell variants"
...
# Death Box cosmetic shell variants

## Identity

- **Asset ID:** asset.universal-gameplay.loot.death-box-cosmetic-shell-variants
- **Type:** architectural or traversal module
- **Source:** prop-list.md:29
...
![Death Box cosmetic shell variants reference render](death-box-cosmetic-shell-variants.png)

## Intent

The **Death Box cosmetic shell variants** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Death Box cosmetic shell variants** as a useful,
