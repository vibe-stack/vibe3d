...
---
asset_id: "asset.universal-gameplay.loot.care-package-doors"
source_label: "Care Package doors"
...
- **Asset ID:** asset.universal-gameplay.loot.care-package-doors
- **Type:** architectural or traversal module
- **Source:** prop-list.md:24
...
![Care Package doors reference render](care-package-doors.png)

## Intent

The **Care Package doors** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Care Package doors** as a useful,
