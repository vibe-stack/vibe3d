...
---
asset_id: "asset.universal-gameplay.loot.open-supply-bin"
source_label: "open Supply Bin"
...
- **Asset ID:** asset.universal-gameplay.loot.open-supply-bin
- **Type:** gameplay system prop
- **Source:** prop-list.md:12
...
![open Supply Bin reference render](open-supply-bin.png)

## Intent

The **open Supply Bin** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **open Supply Bin** as a useful,
