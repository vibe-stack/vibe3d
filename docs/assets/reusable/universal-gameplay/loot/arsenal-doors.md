...
---
asset_id: "asset.universal-gameplay.loot.arsenal-doors"
source_label: "Arsenal doors"
...
- **Asset ID:** asset.universal-gameplay.loot.arsenal-doors
- **Type:** architectural or traversal module
- **Source:** prop-list.md:35
...
![Arsenal doors reference render](arsenal-doors.png)

## Intent

The **Arsenal doors** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Arsenal doors** as a useful,
