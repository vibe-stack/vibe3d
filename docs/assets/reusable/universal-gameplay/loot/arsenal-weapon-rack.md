...
---
asset_id: "asset.universal-gameplay.loot.arsenal-weapon-rack"
source_label: "Arsenal weapon rack"
...
- **Asset ID:** asset.universal-gameplay.loot.arsenal-weapon-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:32
...
![Arsenal weapon rack reference render](arsenal-weapon-rack.png)

## Intent

The **Arsenal weapon rack** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Arsenal weapon rack** as a useful,
