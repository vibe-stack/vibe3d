...
---
asset_id: "asset.universal-gameplay.loot.care-package-landing-feet"
source_label: "Care Package landing feet"
...
# Care Package landing feet

## Identity

- **Asset ID:** asset.universal-gameplay.loot.care-package-landing-feet
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:26
...
![Care Package landing feet reference render](care-package-landing-feet.png)

## Intent

The **Care Package landing feet** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Care Package landing feet** as a useful,
