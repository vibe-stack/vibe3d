...
---
asset_id: "asset.universal-gameplay.loot.replicator-hologram-projector"
source_label: "Replicator hologram/projector"
...
# Replicator hologram/projector

## Identity

- **Asset ID:** asset.universal-gameplay.loot.replicator-hologram-projector
- **Type:** gameplay system prop
- **Source:** prop-list.md:38
...
![Replicator hologram/projector reference render](replicator-hologram-projector.png)

## Intent

The **Replicator hologram/projector** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Replicator hologram/projector** as a useful,
