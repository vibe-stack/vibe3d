...
---
asset_id: "asset.universal-gameplay.loot.replicator-material-canister"
source_label: "Replicator material canister"
...
# Replicator material canister

## Identity

- **Asset ID:** asset.universal-gameplay.loot.replicator-material-canister
- **Type:** gameplay system prop
- **Source:** prop-list.md:39
...
![Replicator material canister reference render](replicator-material-canister.png)

## Intent

The **Replicator material canister** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Replicator material canister** as a useful,
