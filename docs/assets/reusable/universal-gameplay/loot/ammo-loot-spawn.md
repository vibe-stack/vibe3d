...
---
asset_id: "asset.universal-gameplay.loot.ammo-loot-spawn"
source_label: "ammo loot spawn"
...
- **Asset ID:** asset.universal-gameplay.loot.ammo-loot-spawn
- **Type:** gameplay system prop
- **Source:** prop-list.md:18
...
![ammo loot spawn reference render](ammo-loot-spawn.png)

## Intent

The **ammo loot spawn** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **ammo loot spawn** as a useful,
