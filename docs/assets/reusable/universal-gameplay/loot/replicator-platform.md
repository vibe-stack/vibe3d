...
---
asset_id: "asset.universal-gameplay.loot.replicator-platform"
source_label: "Replicator platform"
...
- **Asset ID:** asset.universal-gameplay.loot.replicator-platform
- **Type:** architectural or traversal module
- **Source:** prop-list.md:37
...
![Replicator platform reference render](replicator-platform.png)

## Intent

The **Replicator platform** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Replicator platform** as a useful,
