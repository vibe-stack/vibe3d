...
---
asset_id: "asset.universal-gameplay.loot.replicator-crafter"
source_label: "Replicator/Crafter"
...
- **Asset ID:** asset.universal-gameplay.loot.replicator-crafter
- **Type:** gameplay system prop
- **Source:** prop-list.md:36
...
![Replicator/Crafter reference render](replicator-crafter.png)

## Intent

The **Replicator/Crafter** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Replicator/Crafter** as a useful,
