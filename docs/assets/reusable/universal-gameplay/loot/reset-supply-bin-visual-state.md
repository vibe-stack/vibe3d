...
---
asset_id: "asset.universal-gameplay.loot.reset-supply-bin-visual-state"
source_label: "reset Supply Bin visual state"
...
# reset Supply Bin visual state

## Identity

- **Asset ID:** asset.universal-gameplay.loot.reset-supply-bin-visual-state
- **Type:** gameplay system prop
- **Source:** prop-list.md:13
...
![reset Supply Bin visual state reference render](reset-supply-bin-visual-state.png)

## Intent

The **reset Supply Bin visual state** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **reset Supply Bin visual state** as a useful,
