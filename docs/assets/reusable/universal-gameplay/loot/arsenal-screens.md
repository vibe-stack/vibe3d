...
---
asset_id: "asset.universal-gameplay.loot.arsenal-screens"
source_label: "Arsenal screens"
...
- **Asset ID:** asset.universal-gameplay.loot.arsenal-screens
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:34
...
![Arsenal screens reference render](arsenal-screens.png)

## Intent

The **Arsenal screens** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Arsenal screens** as a useful,
