...
---
asset_id: "asset.universal-gameplay.loot.legendary-supply-bin"
source_label: "Legendary Supply Bin"
...
# Legendary Supply Bin

## Identity

- **Asset ID:** asset.universal-gameplay.loot.legendary-supply-bin
- **Type:** gameplay system prop
- **Source:** prop-list.md:14
...
![Legendary Supply Bin reference render](legendary-supply-bin.png)

## Intent

The **Legendary Supply Bin** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Legendary Supply Bin** as a useful,
