...
---
asset_id: "asset.universal-gameplay.loot.floor-loot-display-pedestal-where-applicable"
source_label: "floor-loot display pedestal where applicable"
...
# floor-loot display pedestal where applicable

## Identity

- **Asset ID:** asset.universal-gameplay.loot.floor-loot-display-pedestal-where-applicable
- **Type:** architectural or traversal module
- **Source:** prop-list.md:30
...
![floor-loot display pedestal where applicable reference render](floor-loot-display-pedestal-where-applicable.png)

## Intent

The **floor-loot display pedestal where applicable** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **floor-loot display pedestal where applicable** as a useful,
