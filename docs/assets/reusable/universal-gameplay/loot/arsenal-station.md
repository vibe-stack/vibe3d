...
---
asset_id: "asset.universal-gameplay.loot.arsenal-station"
source_label: "Arsenal Station"
...
- **Asset ID:** asset.universal-gameplay.loot.arsenal-station
- **Type:** gameplay system prop
- **Source:** prop-list.md:31
...
![Arsenal Station reference render](arsenal-station.png)

## Intent

The **Arsenal Station** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Arsenal Station** as a useful,
