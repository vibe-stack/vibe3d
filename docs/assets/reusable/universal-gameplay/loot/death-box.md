...
---
asset_id: "asset.universal-gameplay.loot.death-box"
source_label: "Death Box"
...
- **Asset ID:** asset.universal-gameplay.loot.death-box
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:28
...
![Death Box reference render](death-box.png)

## Intent

The **Death Box** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Death Box** as a useful,
