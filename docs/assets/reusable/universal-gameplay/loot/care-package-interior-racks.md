...
---
asset_id: "asset.universal-gameplay.loot.care-package-interior-racks"
source_label: "Care Package interior racks"
...
# Care Package interior racks

## Identity

- **Asset ID:** asset.universal-gameplay.loot.care-package-interior-racks
- **Type:** industrial service prop
- **Source:** prop-list.md:25
...
![Care Package interior racks reference render](care-package-interior-racks.png)

## Intent

The **Care Package interior racks** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Care Package interior racks** as a useful,
