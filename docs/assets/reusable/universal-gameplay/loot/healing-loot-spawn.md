...
---
asset_id: "asset.universal-gameplay.loot.healing-loot-spawn"
source_label: "healing loot spawn"
...
- **Asset ID:** asset.universal-gameplay.loot.healing-loot-spawn
- **Type:** gameplay system prop
- **Source:** prop-list.md:21
...
![healing loot spawn reference render](healing-loot-spawn.png)

## Intent

The **healing loot spawn** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **healing loot spawn** as a useful,
