...
---
asset_id: "asset.universal-gameplay.loot.attachment-loot-spawn"
source_label: "attachment loot spawn"
...
# attachment loot spawn

## Identity

- **Asset ID:** asset.universal-gameplay.loot.attachment-loot-spawn
- **Type:** gameplay system prop
- **Source:** prop-list.md:19
...
![attachment loot spawn reference render](attachment-loot-spawn.png)

## Intent

The **attachment loot spawn** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **attachment loot spawn** as a useful,
