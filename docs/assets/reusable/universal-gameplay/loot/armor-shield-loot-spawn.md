...
---
asset_id: "asset.universal-gameplay.loot.armor-shield-loot-spawn"
source_label: "armor/shield loot spawn"
...
# armor/shield loot spawn

## Identity

- **Asset ID:** asset.universal-gameplay.loot.armor-shield-loot-spawn
- **Type:** gameplay system prop
- **Source:** prop-list.md:22
...
![armor/shield loot spawn reference render](armor-shield-loot-spawn.png)

## Intent

The **armor/shield loot spawn** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **armor/shield loot spawn** as a useful,
