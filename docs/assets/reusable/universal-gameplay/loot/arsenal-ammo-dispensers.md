...
---
asset_id: "asset.universal-gameplay.loot.arsenal-ammo-dispensers"
source_label: "Arsenal ammo dispensers"
...
# Arsenal ammo dispensers

## Identity

- **Asset ID:** asset.universal-gameplay.loot.arsenal-ammo-dispensers
- **Type:** gameplay system prop
- **Source:** prop-list.md:33
...
![Arsenal ammo dispensers reference render](arsenal-ammo-dispensers.png)

## Intent

The **Arsenal ammo dispensers** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Arsenal ammo dispensers** as a useful,
