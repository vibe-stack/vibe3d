...
---
asset_id: "asset.universal-gameplay.loot.care-package-beacon-light"
source_label: "Care Package beacon/light"
...
# Care Package beacon/light

## Identity

- **Asset ID:** asset.universal-gameplay.loot.care-package-beacon-light
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:27
...
![Care Package beacon/light reference render](care-package-beacon-light.png)

## Intent

The **Care Package beacon/light** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Care Package beacon/light** as a useful,
