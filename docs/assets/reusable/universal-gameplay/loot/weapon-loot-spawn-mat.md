...
---
asset_id: "asset.universal-gameplay.loot.weapon-loot-spawn-mat"
source_label: "weapon loot spawn mat"
...
# weapon loot spawn mat

## Identity

- **Asset ID:** asset.universal-gameplay.loot.weapon-loot-spawn-mat
- **Type:** gameplay system prop
- **Source:** prop-list.md:17
...
![weapon loot spawn mat reference render](weapon-loot-spawn-mat.png)

## Intent

The **weapon loot spawn mat** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **weapon loot spawn mat** as a useful,
