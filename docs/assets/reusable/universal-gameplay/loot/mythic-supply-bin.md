...
---
asset_id: "asset.universal-gameplay.loot.mythic-supply-bin"
source_label: "Mythic Supply Bin"
...
- **Asset ID:** asset.universal-gameplay.loot.mythic-supply-bin
- **Type:** gameplay system prop
- **Source:** prop-list.md:15
...
![Mythic Supply Bin reference render](mythic-supply-bin.png)

## Intent

The **Mythic Supply Bin** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Mythic Supply Bin** as a useful,
