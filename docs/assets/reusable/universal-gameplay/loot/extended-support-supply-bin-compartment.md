...
---
asset_id: "asset.universal-gameplay.loot.extended-support-supply-bin-compartment"
source_label: "extended Support Supply Bin compartment"
...
# extended Support Supply Bin compartment

## Identity

- **Asset ID:** asset.universal-gameplay.loot.extended-support-supply-bin-compartment
- **Type:** gameplay system prop
- **Source:** prop-list.md:16
...
![extended Support Supply Bin compartment reference render](extended-support-supply-bin-compartment.png)

## Intent

The **extended Support Supply Bin compartment** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **extended Support Supply Bin compartment** as a useful,
...
- **base supply-bin state:** [standard Supply Bin](./standard-supply-bin.md).
