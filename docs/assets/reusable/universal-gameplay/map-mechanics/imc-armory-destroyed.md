...
---
asset_id: "asset.universal-gameplay.map-mechanics.imc-armory-destroyed"
source_label: "IMC Armory destroyed"
...
# IMC Armory destroyed

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.imc-armory-destroyed
- **Type:** gameplay system prop
- **Source:** prop-list.md:104
...
![IMC Armory destroyed reference render](imc-armory-destroyed.png)

## Intent

The **IMC Armory destroyed** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **IMC Armory destroyed** as a useful,
