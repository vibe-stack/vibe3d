...
---
asset_id: "asset.universal-gameplay.map-mechanics.explosive-hold-blast-door"
source_label: "Explosive Hold blast door"
...
# Explosive Hold blast door

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.explosive-hold-blast-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:100
...
![Explosive Hold blast door reference render](explosive-hold-blast-door.png)

## Intent

The **Explosive Hold blast door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Explosive Hold blast door** as a useful,
...
- **Blockout envelope:** 1.6 m W × 0.30 m D × 2.6 m H; double variants expand to 2.8 m W.
...
- **shared door frame:** [door frame](../../architecture/doors/door-frame.md).
