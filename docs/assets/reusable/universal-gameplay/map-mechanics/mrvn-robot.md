...
---
asset_id: "asset.universal-gameplay.map-mechanics.mrvn-robot"
source_label: "MRVN robot"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.mrvn-robot
- **Type:** gameplay system prop
- **Source:** prop-list.md:112
...
![MRVN robot reference render](mrvn-robot.png)

## Intent

The **MRVN robot** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **MRVN robot** as a useful,
