...
---
asset_id: "asset.universal-gameplay.map-mechanics.cargo-bot-loot-sphere"
source_label: "Cargo Bot loot sphere"
...
# Cargo Bot loot sphere

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.cargo-bot-loot-sphere
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:110
...
![Cargo Bot loot sphere reference render](cargo-bot-loot-sphere.png)

## Intent

The **Cargo Bot loot sphere** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Cargo Bot loot sphere** as a useful,
