...
---
asset_id: "asset.universal-gameplay.map-mechanics.blast-wall-mechanism"
source_label: "blast wall mechanism"
...
# blast wall mechanism

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.blast-wall-mechanism
- **Type:** architectural or traversal module
- **Source:** prop-list.md:117
...
![blast wall mechanism reference render](blast-wall-mechanism.png)

## Intent

The **blast wall mechanism** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **blast wall mechanism** as a useful,
