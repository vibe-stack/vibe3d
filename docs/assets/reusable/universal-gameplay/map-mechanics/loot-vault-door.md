...
---
asset_id: "asset.universal-gameplay.map-mechanics.loot-vault-door"
source_label: "loot vault door"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.loot-vault-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:115
...
![loot vault door reference render](loot-vault-door.png)

## Intent

The **loot vault door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **loot vault door** as a useful,
