...
---
asset_id: "asset.universal-gameplay.map-mechanics.cargo-bot"
source_label: "Cargo Bot"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.cargo-bot
- **Type:** vehicle or vehicle-like prop
- **Source:** prop-list.md:109
...
![Cargo Bot reference render](cargo-bot.png)

## Intent

The **Cargo Bot** is a vehicle or vehicle-like prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Cargo Bot** as a useful,
