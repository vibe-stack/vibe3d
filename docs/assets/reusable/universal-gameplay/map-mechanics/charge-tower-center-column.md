...
---
asset_id: "asset.universal-gameplay.map-mechanics.charge-tower-center-column"
source_label: "Charge Tower center column"
...
# Charge Tower center column

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.charge-tower-center-column
- **Type:** architectural or traversal module
- **Source:** prop-list.md:97
...
![Charge Tower center column reference render](charge-tower-center-column.png)

## Intent

The **Charge Tower center column** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Charge Tower center column** as a useful,
