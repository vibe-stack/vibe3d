...
---
asset_id: "asset.universal-gameplay.map-mechanics.armory-roof"
source_label: "Armory roof"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.armory-roof
- **Type:** architectural or traversal module
- **Source:** prop-list.md:105
...
![Armory roof reference render](armory-roof.png)

## Intent

The **Armory roof** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Armory roof** as a useful,
