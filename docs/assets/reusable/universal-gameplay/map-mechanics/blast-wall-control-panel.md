...
---
asset_id: "asset.universal-gameplay.map-mechanics.blast-wall-control-panel"
source_label: "blast wall control panel"
...
# blast wall control panel

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.blast-wall-control-panel
- **Type:** architectural or traversal module
- **Source:** prop-list.md:118
...
![blast wall control panel reference render](blast-wall-control-panel.png)

## Intent

The **blast wall control panel** is a architectural or traversal module for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **blast wall control panel** as a useful,
