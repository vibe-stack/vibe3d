...
---
asset_id: "asset.universal-gameplay.map-mechanics.explosive-hold-locking-panel"
source_label: "Explosive Hold locking panel"
...
# Explosive Hold locking panel

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.explosive-hold-locking-panel
- **Type:** gameplay system prop
- **Source:** prop-list.md:102
...
![Explosive Hold locking panel reference render](explosive-hold-locking-panel.png)

## Intent

The **Explosive Hold locking panel** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Explosive Hold locking panel** as a useful,
