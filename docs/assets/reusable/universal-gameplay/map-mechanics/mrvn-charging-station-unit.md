...
---
asset_id: "asset.universal-gameplay.map-mechanics.mrvn-charging-station-unit"
source_label: "MRVN charging/station unit"
...
# MRVN charging/station unit

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.mrvn-charging-station-unit
- **Type:** gameplay system prop
- **Source:** prop-list.md:113
...
![MRVN charging/station unit reference render](mrvn-charging-station-unit.png)

## Intent

The **MRVN charging/station unit** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **MRVN charging/station unit** as a useful,
