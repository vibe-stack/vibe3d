...
---
asset_id: "asset.universal-gameplay.map-mechanics.explosive-hold-exterior"
source_label: "Explosive Hold exterior"
...
# Explosive Hold exterior

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.explosive-hold-exterior
- **Type:** gameplay system prop
- **Source:** prop-list.md:99
...
![Explosive Hold exterior reference render](explosive-hold-exterior.png)

## Intent

The **Explosive Hold exterior** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Explosive Hold exterior** as a useful,
