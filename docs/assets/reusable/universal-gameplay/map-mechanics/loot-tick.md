...
---
asset_id: "asset.universal-gameplay.map-mechanics.loot-tick"
source_label: "Loot Tick"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.loot-tick
- **Type:** gameplay system prop
- **Source:** prop-list.md:111
...
![Loot Tick reference render](loot-tick.png)

## Intent

The **Loot Tick** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Loot Tick** as a useful,
