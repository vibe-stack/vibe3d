...
---
asset_id: "asset.universal-gameplay.map-mechanics.armory-control-terminal"
source_label: "Armory control terminal"
...
# Armory control terminal

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.armory-control-terminal
- **Type:** gameplay system prop
- **Source:** prop-list.md:108
...
![Armory control terminal reference render](armory-control-terminal.png)

## Intent

The **Armory control terminal** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Armory control terminal** as a useful,
