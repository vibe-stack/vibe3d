...
---
asset_id: "asset.universal-gameplay.map-mechanics.armory-weapon-racks"
source_label: "Armory weapon racks"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.armory-weapon-racks
- **Type:** industrial service prop
- **Source:** prop-list.md:106
...
![Armory weapon racks reference render](armory-weapon-racks.png)

## Intent

The **Armory weapon racks** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Armory weapon racks** as a useful,
