...
---
asset_id: "asset.universal-gameplay.map-mechanics.charge-tower"
source_label: "Charge Tower"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.charge-tower
- **Type:** gameplay system prop
- **Source:** prop-list.md:96
...
![Charge Tower reference render](charge-tower.png)

## Intent

The **Charge Tower** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Charge Tower** as a useful,
