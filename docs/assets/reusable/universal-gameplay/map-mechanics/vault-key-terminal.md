...
---
asset_id: "asset.universal-gameplay.map-mechanics.vault-key-terminal"
source_label: "vault key terminal"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.vault-key-terminal
- **Type:** gameplay system prop
- **Source:** prop-list.md:116
...
![vault key terminal reference render](vault-key-terminal.png)

## Intent

The **vault key terminal** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **vault key terminal** as a useful,
