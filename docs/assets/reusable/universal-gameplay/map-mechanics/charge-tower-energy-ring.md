...
---
asset_id: "asset.universal-gameplay.map-mechanics.charge-tower-energy-ring"
source_label: "Charge Tower energy ring"
...
# Charge Tower energy ring

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.charge-tower-energy-ring
- **Type:** gameplay system prop
- **Source:** prop-list.md:98
...
![Charge Tower energy ring reference render](charge-tower-energy-ring.png)

## Intent

The **Charge Tower energy ring** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Charge Tower energy ring** as a useful,
