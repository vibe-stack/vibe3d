...
---
asset_id: "asset.universal-gameplay.map-mechanics.armory-spectre-pods"
source_label: "Armory Spectre pods"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.armory-spectre-pods
- **Type:** gameplay system prop
- **Source:** prop-list.md:107
...
![Armory Spectre pods reference render](armory-spectre-pods.png)

## Intent

The **Armory Spectre pods** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Armory Spectre pods** as a useful,
