...
---
asset_id: "asset.universal-gameplay.map-mechanics.explosive-hold-interior-racks"
source_label: "Explosive Hold interior racks"
source_section: "Reusable / universal gameplay"
source_group: "Map mechanics"
source_line: 101
level: L2
status: planned
...
# Explosive Hold interior racks

## Identity

- **Asset ID:** asset.universal-gameplay.map-mechanics.explosive-hold-interior-racks
- **Type:** industrial service prop
- **Source:** prop-list.md:101
...
![Explosive Hold interior racks reference render](explosive-hold-interior-racks.png)

## Intent

The **Explosive Hold interior racks** is a industrial service prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **Explosive Hold interior racks** as a useful,
