...
---
asset_id: "asset.universal-gameplay.map-mechanics.interactive-terminal"
source_label: "interactive terminal"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.interactive-terminal
- **Type:** gameplay system prop
- **Source:** prop-list.md:114
...
![interactive terminal reference render](interactive-terminal.png)

## Intent

The **interactive terminal** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **interactive terminal** as a useful,
