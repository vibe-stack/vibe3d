...
---
asset_id: "asset.universal-gameplay.map-mechanics.imc-armory-intact"
source_label: "IMC Armory intact"
...
- **Asset ID:** asset.universal-gameplay.map-mechanics.imc-armory-intact
- **Type:** gameplay system prop
- **Source:** prop-list.md:103
...
![IMC Armory intact reference render](imc-armory-intact.png)

## Intent

The **IMC Armory intact** is a gameplay system prop for the Axiom Relay kit. It exists to support
player-facing systems must be readable, stateful, and consistent across every map. Its primary read should be **IMC Armory intact** as a useful,
