...
---
asset_id: "asset.cargo-logistics.general.cargo-net"
source_label: "cargo net"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-net
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:419
...
![cargo net reference render](cargo-net.png)

## Intent

The **cargo net** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo net** as a useful,
