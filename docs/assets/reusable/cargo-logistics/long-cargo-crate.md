...
---
asset_id: "asset.cargo-logistics.general.long-cargo-crate"
source_label: "long cargo crate"
...
- **Asset ID:** asset.cargo-logistics.general.long-cargo-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:391
...
![long cargo crate reference render](long-cargo-crate.png)

## Intent

The **long cargo crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **long cargo crate** as a useful,
