...
---
asset_id: "asset.cargo-logistics.general.freight-cart"
source_label: "freight cart"
...
- **Asset ID:** asset.cargo-logistics.general.freight-cart
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:422
...
![freight cart reference render](freight-cart.png)

## Intent

The **freight cart** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **freight cart** as a useful,
