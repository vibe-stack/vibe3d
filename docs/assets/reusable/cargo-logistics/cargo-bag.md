...
---
asset_id: "asset.cargo-logistics.general.cargo-bag"
source_label: "cargo bag"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-bag
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:418
...
![cargo bag reference render](cargo-bag.png)

## Intent

The **cargo bag** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo bag** as a useful,
