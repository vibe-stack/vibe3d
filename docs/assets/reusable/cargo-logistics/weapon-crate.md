...
---
asset_id: "asset.cargo-logistics.general.weapon-crate"
source_label: "weapon crate"
...
- **Asset ID:** asset.cargo-logistics.general.weapon-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:396
...
![weapon crate reference render](weapon-crate.png)

## Intent

The **weapon crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **weapon crate** as a useful,
