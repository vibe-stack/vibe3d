...
---
asset_id: "asset.cargo-logistics.general.gas-bottles"
source_label: "gas bottles"
...
- **Asset ID:** asset.cargo-logistics.general.gas-bottles
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:416
...
![gas bottles reference render](gas-bottles.png)

## Intent

The **gas bottles** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **gas bottles** as a useful,
