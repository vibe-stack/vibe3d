...
---
asset_id: "asset.cargo-logistics.general.metal-pallet"
source_label: "metal pallet"
...
- **Asset ID:** asset.cargo-logistics.general.metal-pallet
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:409
...
![metal pallet reference render](metal-pallet.png)

## Intent

The **metal pallet** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **metal pallet** as a useful,
