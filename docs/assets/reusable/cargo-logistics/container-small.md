...
---
asset_id: "asset.cargo-logistics.general.container-small"
source_label: "container small"
...
- **Asset ID:** asset.cargo-logistics.general.container-small
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:401
...
![container small reference render](container-small.png)

## Intent

The **container small** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **container small** as a useful,
