...
---
asset_id: "asset.cargo-logistics.general.stacked-drums"
source_label: "stacked drums"
...
- **Asset ID:** asset.cargo-logistics.general.stacked-drums
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:415
...
![stacked drums reference render](stacked-drums.png)

## Intent

The **stacked drums** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **stacked drums** as a useful,
