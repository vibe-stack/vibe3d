...
---
asset_id: "asset.cargo-logistics.general.square-cargo-crate"
source_label: "square cargo crate"
...
- **Asset ID:** asset.cargo-logistics.general.square-cargo-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:392
...
![square cargo crate reference render](square-cargo-crate.png)

## Intent

The **square cargo crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **square cargo crate** as a useful,
