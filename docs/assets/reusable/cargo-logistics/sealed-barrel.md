...
---
asset_id: "asset.cargo-logistics.general.sealed-barrel"
source_label: "sealed barrel"
...
- **Asset ID:** asset.cargo-logistics.general.sealed-barrel
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:412
...
![sealed barrel reference render](sealed-barrel.png)

## Intent

The **sealed barrel** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **sealed barrel** as a useful,
