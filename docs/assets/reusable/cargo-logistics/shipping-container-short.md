...
---
asset_id: "asset.cargo-logistics.general.shipping-container-short"
source_label: "shipping container short"
...
- **Asset ID:** asset.cargo-logistics.general.shipping-container-short
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:403
...
![shipping container short reference render](shipping-container-short.png)

## Intent

The **shipping container short** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **shipping container short** as a useful,
