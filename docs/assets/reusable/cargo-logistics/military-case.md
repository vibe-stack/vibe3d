...
---
asset_id: "asset.cargo-logistics.general.military-case"
source_label: "military case"
...
- **Asset ID:** asset.cargo-logistics.general.military-case
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:399
...
![military case reference render](military-case.png)

## Intent

The **military case** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **military case** as a useful,
