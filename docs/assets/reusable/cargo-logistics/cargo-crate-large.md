...
---
asset_id: "asset.cargo-logistics.general.cargo-crate-large"
source_label: "cargo crate large"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-crate-large
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:390
...
![cargo crate large reference render](cargo-crate-large.png)

## Intent

The **cargo crate large** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo crate large** as a useful,
...
- **Blockout envelope:** 2.5 m W × 2.0 m D × 2.5 m H starting envelope
