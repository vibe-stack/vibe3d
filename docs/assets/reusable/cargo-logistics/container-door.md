...
---
asset_id: "asset.cargo-logistics.general.container-door"
source_label: "container door"
...
- **Asset ID:** asset.cargo-logistics.general.container-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:406
...
![container door reference render](container-door.png)

## Intent

The **container door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **container door** as a useful,
