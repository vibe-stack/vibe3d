...
---
asset_id: "asset.cargo-logistics.general.stacked-crates"
source_label: "stacked crates"
...
- **Asset ID:** asset.cargo-logistics.general.stacked-crates
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:395
...
![stacked crates reference render](stacked-crates.png)

## Intent

The **stacked crates** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **stacked crates** as a useful,
