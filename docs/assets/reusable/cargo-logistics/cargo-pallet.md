...
---
asset_id: "asset.cargo-logistics.general.cargo-pallet"
source_label: "cargo pallet"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-pallet
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:408
...
![cargo pallet reference render](cargo-pallet.png)

## Intent

The **cargo pallet** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo pallet** as a useful,
