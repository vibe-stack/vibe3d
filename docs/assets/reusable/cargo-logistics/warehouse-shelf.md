...
---
asset_id: "asset.cargo-logistics.general.warehouse-shelf"
source_label: "warehouse shelf"
...
- **Asset ID:** asset.cargo-logistics.general.warehouse-shelf
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:426
...
![warehouse shelf reference render](warehouse-shelf.png)

## Intent

The **warehouse shelf** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **warehouse shelf** as a useful,
