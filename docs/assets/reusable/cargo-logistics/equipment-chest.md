...
---
asset_id: "asset.cargo-logistics.general.equipment-chest"
source_label: "equipment chest"
...
- **Asset ID:** asset.cargo-logistics.general.equipment-chest
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:397
...
![equipment chest reference render](equipment-chest.png)

## Intent

The **equipment chest** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **equipment chest** as a useful,
