...
---
asset_id: "asset.cargo-logistics.general.armored-cargo-crate"
source_label: "armored cargo crate"
...
- **Asset ID:** asset.cargo-logistics.general.armored-cargo-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:393
...
![armored cargo crate reference render](armored-cargo-crate.png)

## Intent

The **armored cargo crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **armored cargo crate** as a useful,
