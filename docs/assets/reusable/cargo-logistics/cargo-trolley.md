...
---
asset_id: "asset.cargo-logistics.general.cargo-trolley"
source_label: "cargo trolley"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-trolley
- **Type:** industrial service prop
- **Source:** prop-list.md:421
...
![cargo trolley reference render](cargo-trolley.png)

## Intent

The **cargo trolley** is a industrial service prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo trolley** as a useful,
