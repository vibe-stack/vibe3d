...
---
asset_id: "asset.cargo-logistics.general.storage-rack"
source_label: "storage rack"
...
- **Asset ID:** asset.cargo-logistics.general.storage-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:427
...
![storage rack reference render](storage-rack.png)

## Intent

The **storage rack** is a industrial service prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **storage rack** as a useful,
