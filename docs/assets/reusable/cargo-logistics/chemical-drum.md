...
---
asset_id: "asset.cargo-logistics.general.chemical-drum"
source_label: "chemical drum"
...
- **Asset ID:** asset.cargo-logistics.general.chemical-drum
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:414
...
![chemical drum reference render](chemical-drum.png)

## Intent

The **chemical drum** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **chemical drum** as a useful,
