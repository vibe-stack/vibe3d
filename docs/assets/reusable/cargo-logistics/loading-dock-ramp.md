...
---
asset_id: "asset.cargo-logistics.general.loading-dock-ramp"
source_label: "loading dock ramp"
...
- **Asset ID:** asset.cargo-logistics.general.loading-dock-ramp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:425
...
![loading dock ramp reference render](loading-dock-ramp.png)

## Intent

The **loading dock ramp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **loading dock ramp** as a useful,
