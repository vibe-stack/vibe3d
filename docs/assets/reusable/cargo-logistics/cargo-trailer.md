...
---
asset_id: "asset.cargo-logistics.general.cargo-trailer"
source_label: "cargo trailer"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-trailer
- **Type:** architectural or traversal module
- **Source:** prop-list.md:423
...
![cargo trailer reference render](cargo-trailer.png)

## Intent

The **cargo trailer** is a architectural or traversal module for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo trailer** as a useful,
