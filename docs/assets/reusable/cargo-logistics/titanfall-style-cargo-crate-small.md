...
---
asset_id: "asset.cargo-logistics.general.titanfall-style-cargo-crate-small"
source_label: "Titanfall-style cargo crate small"
...
# Titanfall-style cargo crate small

## Identity

- **Asset ID:** asset.cargo-logistics.general.titanfall-style-cargo-crate-small
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:388
...
![Titanfall-style cargo crate small reference render](titanfall-style-cargo-crate-small.png)

## Intent

The **Titanfall-style cargo crate small** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **Titanfall-style cargo crate small** as a useful,
...
- **Blockout envelope:** 0.75 m W × 0.75 m D × 1.0 m H starting envelope
...
- **stacking/handling family:** [cargo crate medium](./cargo-crate-medium.md).
