...
---
asset_id: "asset.cargo-logistics.general.cargo-crate-medium"
source_label: "cargo crate medium"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-crate-medium
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:389
...
![cargo crate medium reference render](cargo-crate-medium.png)

## Intent

The **cargo crate medium** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo crate medium** as a useful,
...
- **Blockout envelope:** 1.5 m W × 1.5 m D × 2.0 m H starting envelope
