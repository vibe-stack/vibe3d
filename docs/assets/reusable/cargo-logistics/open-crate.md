...
---
asset_id: "asset.cargo-logistics.general.open-crate"
source_label: "open crate"
...
- **Asset ID:** asset.cargo-logistics.general.open-crate
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:394
...
![open crate reference render](open-crate.png)

## Intent

The **open crate** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **open crate** as a useful,
