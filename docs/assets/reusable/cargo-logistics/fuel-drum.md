...
---
asset_id: "asset.cargo-logistics.general.fuel-drum"
source_label: "fuel drum"
...
- **Asset ID:** asset.cargo-logistics.general.fuel-drum
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:413
...
![fuel drum reference render](fuel-drum.png)

## Intent

The **fuel drum** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **fuel drum** as a useful,
