...
---
asset_id: "asset.cargo-logistics.general.hard-equipment-case"
source_label: "hard equipment case"
...
- **Asset ID:** asset.cargo-logistics.general.hard-equipment-case
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:398
...
![hard equipment case reference render](hard-equipment-case.png)

## Intent

The **hard equipment case** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **hard equipment case** as a useful,
