...
---
asset_id: "asset.cargo-logistics.general.container-stack"
source_label: "container stack"
...
- **Asset ID:** asset.cargo-logistics.general.container-stack
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:407
...
![container stack reference render](container-stack.png)

## Intent

The **container stack** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **container stack** as a useful,
