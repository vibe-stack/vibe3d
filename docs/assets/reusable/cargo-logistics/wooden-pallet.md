...
---
asset_id: "asset.cargo-logistics.general.wooden-pallet"
source_label: "wooden pallet"
...
- **Asset ID:** asset.cargo-logistics.general.wooden-pallet
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:410
...
![wooden pallet reference render](wooden-pallet.png)

## Intent

The **wooden pallet** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **wooden pallet** as a useful,
