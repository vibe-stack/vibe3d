...
---
asset_id: "asset.cargo-logistics.general.sacks"
source_label: "sacks"
...
- **Asset ID:** asset.cargo-logistics.general.sacks
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:417
...
![sacks reference render](sacks.png)

## Intent

The **sacks** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **sacks** as a useful,
