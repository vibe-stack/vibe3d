...
---
asset_id: "asset.cargo-logistics.general.barrel"
source_label: "barrel"
...
- **Asset ID:** asset.cargo-logistics.general.barrel
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:411
...
![barrel reference render](barrel.png)

## Intent

The **barrel** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **barrel** as a useful,
