...
---
asset_id: "asset.cargo-logistics.general.polymer-case"
source_label: "polymer case"
...
- **Asset ID:** asset.cargo-logistics.general.polymer-case
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:400
...
![polymer case reference render](polymer-case.png)

## Intent

The **polymer case** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **polymer case** as a useful,
