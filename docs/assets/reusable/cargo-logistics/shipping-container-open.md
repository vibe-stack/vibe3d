...
---
asset_id: "asset.cargo-logistics.general.shipping-container-open"
source_label: "shipping container open"
source_section: "Reusable / cargo and logistics"
source_group: "General"
source_line: 404
level: L2
status: planned
place_family: "Docks, warehouses, roads, military yards, and combat cover"
owner: "Axiom Works / local freight operators"
---
...
- **Asset ID:** asset.cargo-logistics.general.shipping-container-open
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:404
- **Family:** Reusable / cargo and logistics
- **Place family:** Docks, warehouses, roads, military yards, and combat cover
- **Owner / story role:** Axiom Works / local freight operators

## Reference render

![shipping container open reference render](shipping-container-open.png)

## Intent

The **shipping container open** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **shipping container open** as a useful,
...
- **Blockout envelope:** Module-scale starting envelope: 1.0 m W × 1.0 m D × 1.8 m H; confirm the final envelope in the placement pass.
...
Make the load boundary and handling points obvious: corners, latches, feet, fork gaps, handles, straps, or stack guides. The silhouette should support cover and repeatable stacking.

The construction follows the shared **chassis → service → signal** order.
Expose handling points and the load path. Stack variants need stable contact faces and repeatable orientation so clutter remains authored rather than random. Keep the strongest value break on the
...
- MAT-07 — [canonical definition](../../../world/material-library.md).
...
1. **Stowed / Default** — recognition state and public contract.
2. **Active Or Open** — state-bearing geometry, signal, decal, and collision change.
3. **Reset / Maintenance** — reuse the chassis with a focused dressing or service pass.
...
- **base supply-bin state:** [standard Supply Bin](../universal-gameplay/loot/standard-supply-bin.md).
- **stacking/handling family:** [Titanfall-style cargo crate small](./titanfall-style-cargo-crate-small.md).
