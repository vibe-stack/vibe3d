...
---
asset_id: "asset.cargo-logistics.general.cargo-strap"
source_label: "cargo strap"
...
- **Asset ID:** asset.cargo-logistics.general.cargo-strap
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:420
...
![cargo strap reference render](cargo-strap.png)

## Intent

The **cargo strap** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **cargo strap** as a useful,
