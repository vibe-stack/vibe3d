...
---
asset_id: "asset.cargo-logistics.general.loading-dock-bumper"
source_label: "loading dock bumper"
...
- **Asset ID:** asset.cargo-logistics.general.loading-dock-bumper
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:424
...
![loading dock bumper reference render](loading-dock-bumper.png)

## Intent

The **loading dock bumper** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **loading dock bumper** as a useful,
