...
---
asset_id: "asset.cargo-logistics.general.damaged-container"
source_label: "damaged container"
...
- **Asset ID:** asset.cargo-logistics.general.damaged-container
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:405
...
![damaged container reference render](damaged-container.png)

## Intent

The **damaged container** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **damaged container** as a useful,
...
1. **Intact Or Default** — recognition state and public contract.
2. **Damaged** — state-bearing geometry, signal, decal, and collision change.
3. **Destroyed / Debris Pass** — reuse the chassis with a focused dressing or service pass.
