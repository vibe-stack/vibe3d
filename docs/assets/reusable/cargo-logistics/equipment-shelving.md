...
---
asset_id: "asset.cargo-logistics.general.equipment-shelving"
source_label: "equipment shelving"
...
- **Asset ID:** asset.cargo-logistics.general.equipment-shelving
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:428
...
![equipment shelving reference render](equipment-shelving.png)

## Intent

The **equipment shelving** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **equipment shelving** as a useful,
