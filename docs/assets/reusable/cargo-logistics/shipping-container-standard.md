...
---
asset_id: "asset.cargo-logistics.general.shipping-container-standard"
source_label: "shipping container standard"
...
- **Asset ID:** asset.cargo-logistics.general.shipping-container-standard
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:402
...
![shipping container standard reference render](shipping-container-standard.png)

## Intent

The **shipping container standard** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
stackable, cover-friendly logistics objects that reveal a believable freight system. Its primary read should be **shipping container standard** as a useful,
