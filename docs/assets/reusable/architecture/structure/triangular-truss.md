...
---
asset_id: "asset.architecture.structure.triangular-truss"
source_label: "triangular truss"
...
- **Asset ID:** asset.architecture.structure.triangular-truss
- **Type:** architectural or traversal module
- **Source:** prop-list.md:238
...
![triangular truss reference render](triangular-truss.png)

## Intent

The **triangular truss** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **triangular truss** as a useful,
