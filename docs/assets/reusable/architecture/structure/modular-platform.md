...
---
asset_id: "asset.architecture.structure.modular-platform"
source_label: "modular platform"
...
- **Asset ID:** asset.architecture.structure.modular-platform
- **Type:** architectural or traversal module
- **Source:** prop-list.md:249
...
![modular platform reference render](modular-platform.png)

## Intent

The **modular platform** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **modular platform** as a useful,
