...
---
asset_id: "asset.architecture.structure.diagonal-brace"
source_label: "diagonal brace"
...
- **Asset ID:** asset.architecture.structure.diagonal-brace
- **Type:** architectural or traversal module
- **Source:** prop-list.md:243
...
![diagonal brace reference render](diagonal-brace.png)

## Intent

The **diagonal brace** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **diagonal brace** as a useful,
