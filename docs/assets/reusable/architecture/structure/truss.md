...
---
asset_id: "asset.architecture.structure.truss"
source_label: "truss"
...
- **Asset ID:** asset.architecture.structure.truss
- **Type:** architectural or traversal module
- **Source:** prop-list.md:237
...
![truss reference render](truss.png)

## Intent

The **truss** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **truss** as a useful,
