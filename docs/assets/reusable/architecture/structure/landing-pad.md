...
---
asset_id: "asset.architecture.structure.landing-pad"
source_label: "landing pad"
...
- **Asset ID:** asset.architecture.structure.landing-pad
- **Type:** architectural or traversal module
- **Source:** prop-list.md:251
...
![landing pad reference render](landing-pad.png)

## Intent

The **landing pad** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **landing pad** as a useful,
