...
---
asset_id: "asset.architecture.structure.tension-cable"
source_label: "tension cable"
...
- **Asset ID:** asset.architecture.structure.tension-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:244
...
![tension cable reference render](tension-cable.png)

## Intent

The **tension cable** is a industrial service prop for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **tension cable** as a useful,
