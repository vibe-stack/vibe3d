...
---
asset_id: "asset.architecture.structure.column"
source_label: "column"
...
- **Asset ID:** asset.architecture.structure.column
- **Type:** architectural or traversal module
- **Source:** prop-list.md:240
...
![column reference render](column.png)

## Intent

The **column** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **column** as a useful,
