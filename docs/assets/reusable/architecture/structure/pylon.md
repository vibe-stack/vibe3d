...
---
asset_id: "asset.architecture.structure.pylon"
source_label: "pylon"
...
- **Asset ID:** asset.architecture.structure.pylon
- **Type:** architectural or traversal module
- **Source:** prop-list.md:245
...
![pylon reference render](pylon.png)

## Intent

The **pylon** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **pylon** as a useful,
