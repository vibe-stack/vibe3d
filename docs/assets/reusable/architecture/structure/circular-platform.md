...
---
asset_id: "asset.architecture.structure.circular-platform"
source_label: "circular platform"
...
- **Asset ID:** asset.architecture.structure.circular-platform
- **Type:** architectural or traversal module
- **Source:** prop-list.md:250
...
![circular platform reference render](circular-platform.png)

## Intent

The **circular platform** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **circular platform** as a useful,
