...
---
asset_id: "asset.architecture.structure.box-beam"
source_label: "box beam"
...
- **Asset ID:** asset.architecture.structure.box-beam
- **Type:** architectural or traversal module
- **Source:** prop-list.md:239
...
![box beam reference render](box-beam.png)

## Intent

The **box beam** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **box beam** as a useful,
