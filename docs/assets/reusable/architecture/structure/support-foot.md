...
---
asset_id: "asset.architecture.structure.support-foot"
source_label: "support foot"
...
- **Asset ID:** asset.architecture.structure.support-foot
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:247
...
![support foot reference render](support-foot.png)

## Intent

The **support foot** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **support foot** as a useful,
