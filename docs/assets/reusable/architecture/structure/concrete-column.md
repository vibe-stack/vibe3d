...
---
asset_id: "asset.architecture.structure.concrete-column"
source_label: "concrete column"
...
- **Asset ID:** asset.architecture.structure.concrete-column
- **Type:** architectural or traversal module
- **Source:** prop-list.md:241
...
![concrete column reference render](concrete-column.png)

## Intent

The **concrete column** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **concrete column** as a useful,
