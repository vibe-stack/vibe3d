...
---
asset_id: "asset.architecture.structure.telescoping-support"
source_label: "telescoping support"
...
- **Asset ID:** asset.architecture.structure.telescoping-support
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:242
...
![telescoping support reference render](telescoping-support.png)

## Intent

The **telescoping support** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **telescoping support** as a useful,
