...
---
asset_id: "asset.architecture.structure.h-beam"
source_label: "H-beam"
...
- **Asset ID:** asset.architecture.structure.h-beam
- **Type:** architectural or traversal module
- **Source:** prop-list.md:236
...
![H-beam reference render](h-beam.png)

## Intent

The **H-beam** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **H-beam** as a useful,
