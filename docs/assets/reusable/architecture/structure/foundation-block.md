...
---
asset_id: "asset.architecture.structure.foundation-block"
source_label: "foundation block"
...
- **Asset ID:** asset.architecture.structure.foundation-block
- **Type:** architectural or traversal module
- **Source:** prop-list.md:248
...
![foundation block reference render](foundation-block.png)

## Intent

The **foundation block** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **foundation block** as a useful,
