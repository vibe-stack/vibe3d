...
---
asset_id: "asset.architecture.structure.buttress"
source_label: "buttress"
...
- **Asset ID:** asset.architecture.structure.buttress
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:246
...
![buttress reference render](buttress.png)

## Intent

The **buttress** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **buttress** as a useful,
