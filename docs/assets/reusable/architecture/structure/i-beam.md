...
---
asset_id: "asset.architecture.structure.i-beam"
source_label: "I-beam"
...
- **Asset ID:** asset.architecture.structure.i-beam
- **Type:** architectural or traversal module
- **Source:** prop-list.md:235
...
![I-beam reference render](i-beam.png)

## Intent

The **I-beam** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **I-beam** as a useful,
