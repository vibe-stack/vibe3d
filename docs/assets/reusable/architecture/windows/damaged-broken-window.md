...
---
asset_id: "asset.architecture.windows.damaged-broken-window"
source_label: "damaged/broken window"
...
- **Asset ID:** asset.architecture.windows.damaged-broken-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:185
...
![damaged/broken window reference render](damaged-broken-window.png)

## Intent

The **damaged/broken window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **damaged/broken window** as a useful,
...
- **Blockout envelope:** 1.5 m W × 0.20 m D × 1.4 m H; long and curtain variants tile on the 1 m grid.
