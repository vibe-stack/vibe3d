...
---
asset_id: "asset.architecture.windows.high-rise-curtain-glazing"
source_label: "high-rise curtain glazing"
...
- **Asset ID:** asset.architecture.windows.high-rise-curtain-glazing
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:183
...
![high-rise curtain glazing reference render](high-rise-curtain-glazing.png)

## Intent

The **high-rise curtain glazing** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **high-rise curtain glazing** as a useful,
