...
---
asset_id: "asset.architecture.windows.storefront-glazing"
source_label: "storefront glazing"
...
- **Asset ID:** asset.architecture.windows.storefront-glazing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:182
...
![storefront glazing reference render](storefront-glazing.png)

## Intent

The **storefront glazing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **storefront glazing** as a useful,
