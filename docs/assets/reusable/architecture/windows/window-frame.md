...
---
asset_id: "asset.architecture.windows.window-frame"
source_label: "window frame"
...
- **Asset ID:** asset.architecture.windows.window-frame
- **Type:** architectural or traversal module
- **Source:** prop-list.md:186
...
![window frame reference render](window-frame.png)

## Intent

The **window frame** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **window frame** as a useful,
