...
---
asset_id: "asset.architecture.windows.small-industrial-window"
source_label: "small industrial window"
...
- **Asset ID:** asset.architecture.windows.small-industrial-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:177
...
![small industrial window reference render](small-industrial-window.png)

## Intent

The **small industrial window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **small industrial window** as a useful,
