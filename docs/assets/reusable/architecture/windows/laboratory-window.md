...
---
asset_id: "asset.architecture.windows.laboratory-window"
source_label: "laboratory window"
...
- **Asset ID:** asset.architecture.windows.laboratory-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:181
...
![laboratory window reference render](laboratory-window.png)

## Intent

The **laboratory window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **laboratory window** as a useful,
