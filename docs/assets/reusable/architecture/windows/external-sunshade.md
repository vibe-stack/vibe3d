...
---
asset_id: "asset.architecture.windows.external-sunshade"
source_label: "external sunshade"
...
- **Asset ID:** asset.architecture.windows.external-sunshade
- **Type:** architectural or traversal module
- **Source:** prop-list.md:188
...
![external sunshade reference render](external-sunshade.png)

## Intent

The **external sunshade** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **external sunshade** as a useful,
