...
---
asset_id: "asset.architecture.windows.window-shutter"
source_label: "window shutter"
...
- **Asset ID:** asset.architecture.windows.window-shutter
- **Type:** architectural or traversal module
- **Source:** prop-list.md:187
...
![window shutter reference render](window-shutter.png)

## Intent

The **window shutter** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **window shutter** as a useful,
