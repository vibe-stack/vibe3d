...
---
asset_id: "asset.architecture.windows.luxury-residential-window"
source_label: "luxury residential window"
...
- **Asset ID:** asset.architecture.windows.luxury-residential-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:184
...
![luxury residential window reference render](luxury-residential-window.png)

## Intent

The **luxury residential window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **luxury residential window** as a useful,
