...
---
asset_id: "asset.architecture.windows.observation-window"
source_label: "observation window"
...
- **Asset ID:** asset.architecture.windows.observation-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:180
...
![observation window reference render](observation-window.png)

## Intent

The **observation window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **observation window** as a useful,
