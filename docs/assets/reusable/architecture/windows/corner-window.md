...
---
asset_id: "asset.architecture.windows.corner-window"
source_label: "corner window"
...
- **Asset ID:** asset.architecture.windows.corner-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:179
...
![corner window reference render](corner-window.png)

## Intent

The **corner window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **corner window** as a useful,
