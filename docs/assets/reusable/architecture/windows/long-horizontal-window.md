...
---
asset_id: "asset.architecture.windows.long-horizontal-window"
source_label: "long horizontal window"
...
- **Asset ID:** asset.architecture.windows.long-horizontal-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:178
...
![long horizontal window reference render](long-horizontal-window.png)

## Intent

The **long horizontal window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **long horizontal window** as a useful,
