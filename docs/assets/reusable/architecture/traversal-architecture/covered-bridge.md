...
---
asset_id: "asset.architecture.traversal-architecture.covered-bridge"
source_label: "covered bridge"
...
- **Asset ID:** asset.architecture.traversal-architecture.covered-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:219
...
![covered bridge reference render](covered-bridge.png)

## Intent

The **covered bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **covered bridge** as a useful,
