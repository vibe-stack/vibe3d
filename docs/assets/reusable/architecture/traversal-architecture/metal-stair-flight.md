...
---
asset_id: "asset.architecture.traversal-architecture.metal-stair-flight"
source_label: "metal stair flight"
...
- **Asset ID:** asset.architecture.traversal-architecture.metal-stair-flight
- **Type:** architectural or traversal module
- **Source:** prop-list.md:205
...
![metal stair flight reference render](metal-stair-flight.png)

## Intent

The **metal stair flight** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **metal stair flight** as a useful,
