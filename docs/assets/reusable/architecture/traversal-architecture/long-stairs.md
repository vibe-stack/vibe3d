...
---
asset_id: "asset.architecture.traversal-architecture.long-stairs"
source_label: "long stairs"
...
- **Asset ID:** asset.architecture.traversal-architecture.long-stairs
- **Type:** architectural or traversal module
- **Source:** prop-list.md:208
...
![long stairs reference render](long-stairs.png)

## Intent

The **long stairs** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **long stairs** as a useful,
