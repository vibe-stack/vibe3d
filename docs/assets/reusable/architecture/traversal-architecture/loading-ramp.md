...
---
asset_id: "asset.architecture.traversal-architecture.loading-ramp"
source_label: "loading ramp"
...
- **Asset ID:** asset.architecture.traversal-architecture.loading-ramp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:222
...
![loading ramp reference render](loading-ramp.png)

## Intent

The **loading ramp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **loading ramp** as a useful,
