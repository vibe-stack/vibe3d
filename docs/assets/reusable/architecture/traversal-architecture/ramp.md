...
---
asset_id: "asset.architecture.traversal-architecture.ramp"
source_label: "ramp"
...
- **Asset ID:** asset.architecture.traversal-architecture.ramp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:220
...
![ramp reference render](ramp.png)

## Intent

The **ramp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **ramp** as a useful,
