...
---
asset_id: "asset.architecture.traversal-architecture.grated-walkway"
source_label: "grated walkway"
...
- **Asset ID:** asset.architecture.traversal-architecture.grated-walkway
- **Type:** architectural or traversal module
- **Source:** prop-list.md:214
...
![grated walkway reference render](grated-walkway.png)

## Intent

The **grated walkway** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **grated walkway** as a useful,
