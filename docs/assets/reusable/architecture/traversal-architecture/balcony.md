...
---
asset_id: "asset.architecture.traversal-architecture.balcony"
source_label: "balcony"
...
- **Asset ID:** asset.architecture.traversal-architecture.balcony
- **Type:** architectural or traversal module
- **Source:** prop-list.md:226
...
![balcony reference render](balcony.png)

## Intent

The **balcony** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **balcony** as a useful,
