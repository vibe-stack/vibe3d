...
---
asset_id: "asset.architecture.traversal-architecture.scaffold-stair"
source_label: "scaffold stair"
...
- **Asset ID:** asset.architecture.traversal-architecture.scaffold-stair
- **Type:** architectural or traversal module
- **Source:** prop-list.md:230
...
![scaffold stair reference render](scaffold-stair.png)

## Intent

The **scaffold stair** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **scaffold stair** as a useful,
