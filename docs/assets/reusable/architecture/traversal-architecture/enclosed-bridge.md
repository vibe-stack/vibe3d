...
---
asset_id: "asset.architecture.traversal-architecture.enclosed-bridge"
source_label: "enclosed bridge"
...
- **Asset ID:** asset.architecture.traversal-architecture.enclosed-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:217
...
![enclosed bridge reference render](enclosed-bridge.png)

## Intent

The **enclosed bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **enclosed bridge** as a useful,
