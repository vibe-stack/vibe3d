...
---
asset_id: "asset.architecture.traversal-architecture.maintenance-ramp"
source_label: "maintenance ramp"
...
- **Asset ID:** asset.architecture.traversal-architecture.maintenance-ramp
- **Type:** architectural or traversal module
- **Source:** prop-list.md:221
...
![maintenance ramp reference render](maintenance-ramp.png)

## Intent

The **maintenance ramp** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **maintenance ramp** as a useful,
