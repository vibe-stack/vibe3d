...
---
asset_id: "asset.architecture.traversal-architecture.ladder"
source_label: "ladder"
...
- **Asset ID:** asset.architecture.traversal-architecture.ladder
- **Type:** architectural or traversal module
- **Source:** prop-list.md:211
...
![ladder reference render](ladder.png)

## Intent

The **ladder** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **ladder** as a useful,
