...
---
asset_id: "asset.architecture.traversal-architecture.spiral-stair"
source_label: "spiral stair"
...
- **Asset ID:** asset.architecture.traversal-architecture.spiral-stair
- **Type:** architectural or traversal module
- **Source:** prop-list.md:210
...
![spiral stair reference render](spiral-stair.png)

## Intent

The **spiral stair** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **spiral stair** as a useful,
