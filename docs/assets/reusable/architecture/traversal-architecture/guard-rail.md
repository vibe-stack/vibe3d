...
---
asset_id: "asset.architecture.traversal-architecture.guard-rail"
source_label: "guard rail"
...
- **Asset ID:** asset.architecture.traversal-architecture.guard-rail
- **Type:** architectural or traversal module
- **Source:** prop-list.md:224
...
![guard rail reference render](guard-rail.png)

## Intent

The **guard rail** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **guard rail** as a useful,
