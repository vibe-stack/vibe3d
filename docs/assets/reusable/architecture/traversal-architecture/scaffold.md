...
---
asset_id: "asset.architecture.traversal-architecture.scaffold"
source_label: "scaffold"
...
- **Asset ID:** asset.architecture.traversal-architecture.scaffold
- **Type:** architectural or traversal module
- **Source:** prop-list.md:228
...
![scaffold reference render](scaffold.png)

## Intent

The **scaffold** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **scaffold** as a useful,
