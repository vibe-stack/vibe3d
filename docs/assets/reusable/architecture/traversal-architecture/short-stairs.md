...
---
asset_id: "asset.architecture.traversal-architecture.short-stairs"
source_label: "short stairs"
...
- **Asset ID:** asset.architecture.traversal-architecture.short-stairs
- **Type:** architectural or traversal module
- **Source:** prop-list.md:207
...
![short stairs reference render](short-stairs.png)

## Intent

The **short stairs** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **short stairs** as a useful,
