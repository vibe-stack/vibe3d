...
---
asset_id: "asset.architecture.traversal-architecture.bridge"
source_label: "bridge"
...
- **Asset ID:** asset.architecture.traversal-architecture.bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:215
...
![bridge reference render](bridge.png)

## Intent

The **bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **bridge** as a useful,
