...
---
asset_id: "asset.architecture.traversal-architecture.catwalk"
source_label: "catwalk"
...
- **Asset ID:** asset.architecture.traversal-architecture.catwalk
- **Type:** architectural or traversal module
- **Source:** prop-list.md:213
...
![catwalk reference render](catwalk.png)

## Intent

The **catwalk** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **catwalk** as a useful,
