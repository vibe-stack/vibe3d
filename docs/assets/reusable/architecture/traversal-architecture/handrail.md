...
---
asset_id: "asset.architecture.traversal-architecture.handrail"
source_label: "handrail"
...
- **Asset ID:** asset.architecture.traversal-architecture.handrail
- **Type:** architectural or traversal module
- **Source:** prop-list.md:223
...
![handrail reference render](handrail.png)

## Intent

The **handrail** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **handrail** as a useful,
