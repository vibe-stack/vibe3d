...
---
asset_id: "asset.architecture.traversal-architecture.glass-bridge"
source_label: "glass bridge"
...
- **Asset ID:** asset.architecture.traversal-architecture.glass-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:218
...
![glass bridge reference render](glass-bridge.png)

## Intent

The **glass bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **glass bridge** as a useful,
