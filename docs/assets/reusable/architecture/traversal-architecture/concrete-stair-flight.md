...
---
asset_id: "asset.architecture.traversal-architecture.concrete-stair-flight"
source_label: "concrete stair flight"
...
- **Asset ID:** asset.architecture.traversal-architecture.concrete-stair-flight
- **Type:** architectural or traversal module
- **Source:** prop-list.md:206
...
![concrete stair flight reference render](concrete-stair-flight.png)

## Intent

The **concrete stair flight** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **concrete stair flight** as a useful,
