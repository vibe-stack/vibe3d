...
---
asset_id: "asset.architecture.traversal-architecture.stair-landing"
source_label: "stair landing"
...
- **Asset ID:** asset.architecture.traversal-architecture.stair-landing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:209
...
![stair landing reference render](stair-landing.png)

## Intent

The **stair landing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **stair landing** as a useful,
