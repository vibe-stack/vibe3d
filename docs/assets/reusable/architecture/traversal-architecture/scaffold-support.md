...
---
asset_id: "asset.architecture.traversal-architecture.scaffold-support"
source_label: "scaffold support"
...
- **Asset ID:** asset.architecture.traversal-architecture.scaffold-support
- **Type:** architectural or traversal module
- **Source:** prop-list.md:231
...
![scaffold support reference render](scaffold-support.png)

## Intent

The **scaffold support** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **scaffold support** as a useful,
