...
---
asset_id: "asset.architecture.traversal-architecture.balcony-railing"
source_label: "balcony railing"
...
- **Asset ID:** asset.architecture.traversal-architecture.balcony-railing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:227
...
![balcony railing reference render](balcony-railing.png)

## Intent

The **balcony railing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **balcony railing** as a useful,
