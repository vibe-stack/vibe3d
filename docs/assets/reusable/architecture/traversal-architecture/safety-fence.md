...
---
asset_id: "asset.architecture.traversal-architecture.safety-fence"
source_label: "safety fence"
...
- **Asset ID:** asset.architecture.traversal-architecture.safety-fence
- **Type:** architectural or traversal module
- **Source:** prop-list.md:225
...
![safety fence reference render](safety-fence.png)

## Intent

The **safety fence** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **safety fence** as a useful,
