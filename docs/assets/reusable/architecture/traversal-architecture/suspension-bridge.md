...
---
asset_id: "asset.architecture.traversal-architecture.suspension-bridge"
source_label: "suspension bridge"
...
- **Asset ID:** asset.architecture.traversal-architecture.suspension-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:216
...
![suspension bridge reference render](suspension-bridge.png)

## Intent

The **suspension bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **suspension bridge** as a useful,
