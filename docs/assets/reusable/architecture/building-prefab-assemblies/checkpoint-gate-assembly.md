...
---
asset_id: "asset.architecture.building-prefab-assemblies.checkpoint-gate-assembly"
source_label: "checkpoint gate assembly"
...
- **Asset ID:** asset.architecture.building-prefab-assemblies.checkpoint-gate-assembly
- **Type:** reusable prefab assembly
- **Source:** prop-list.md:278
...
![checkpoint gate assembly reference render](checkpoint-gate-assembly.png)

## Intent

The **checkpoint gate assembly** is a reusable prefab assembly for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **checkpoint gate assembly** as a useful,
...
- **Blockout envelope:** 12.0 m W × 6.0 m D × 4.0 m H checkpoint frontage; standard vehicle lane is 4.0 m clear.
...
Compose a complete checkpoint frontage from gate posts, lintel, wall returns, a vehicle threshold, operator booth, barriers, control hardware, and restrained identity graphics. The kit must read as an access-control place, not a freestanding gate prop.
...
- **blocking: road module** — [road module](../../streets-infrastructure/road-module.md) — vehicle approach.
- **blocking: building threshold** — [building threshold](../modular-building-connectors/building-threshold.md) — lane transition.
- **blocking: gate post pair** — [gate post pair](../gate-closure/gate-post-pair.md) — primary jamb structure.
- **blocking: gate lintel** — [gate lintel](../gate-closure/gate-lintel.md) — gate header.
- **blocking: gate wall return** — [gate wall return](../gate-closure/gate-wall-return.md) — perimeter continuity.
- **blocking: checkpoint booth** — [checkpoint booth](../../military/checkpoint-booth.md) — operator station.
- **blocking: door control panel** — [door control panel](../doors/door-control-panel.md) — gate control interface.
- **blocking: security fence** — [security fence](../../military/security-fence.md) — side containment.
- **optional: road blocker** — [road blocker](../../military/road-blocker.md) — secondary denial state.
- **optional: directional sign** — [directional sign](../../streets-infrastructure/directional-sign.md) — wayfinding.
...
- **blocking component:** [road module](../../streets-infrastructure/road-module.md) — vehicle approach.
- **blocking component:** [building threshold](../modular-building-connectors/building-threshold.md) — lane transition.
- **blocking component:** [gate post pair](../gate-closure/gate-post-pair.md) — primary jamb structure.
- **blocking component:** [gate lintel](../gate-closure/gate-lintel.md) — gate header.
- **blocking component:** [gate wall return](../gate-closure/gate-wall-return.md) — perimeter continuity.
- **blocking component:** [checkpoint booth](../../military/checkpoint-booth.md) — operator station.
- **blocking component:** [door control panel](../doors/door-control-panel.md) — gate control interface.
- **blocking component:** [security fence](../../military/security-fence.md) — side containment.
- **optional component:** [road blocker](../../military/road-blocker.md) — secondary denial state.
- **optional component:** [directional sign](../../streets-infrastructure/directional-sign.md) — wayfinding.
