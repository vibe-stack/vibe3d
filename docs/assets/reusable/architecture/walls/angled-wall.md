...
---
asset_id: "asset.architecture.walls.angled-wall"
source_label: "angled wall"
...
- **Asset ID:** asset.architecture.walls.angled-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:141
...
![angled wall reference render](angled-wall.png)

## Intent

The **angled wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **angled wall** as a useful,
