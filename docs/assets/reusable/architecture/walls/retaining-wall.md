...
---
asset_id: "asset.architecture.walls.retaining-wall"
source_label: "retaining wall"
...
- **Asset ID:** asset.architecture.walls.retaining-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:143
...
![retaining wall reference render](retaining-wall.png)

## Intent

The **retaining wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **retaining wall** as a useful,
