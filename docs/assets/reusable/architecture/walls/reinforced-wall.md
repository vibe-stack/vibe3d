...
---
asset_id: "asset.architecture.walls.reinforced-wall"
source_label: "reinforced wall"
...
- **Asset ID:** asset.architecture.walls.reinforced-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:138
...
![reinforced wall reference render](reinforced-wall.png)

## Intent

The **reinforced wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **reinforced wall** as a useful,
