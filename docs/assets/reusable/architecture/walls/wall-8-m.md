...
---
asset_id: "asset.architecture.walls.wall-8-m"
source_label: "wall 8 m"
...
- **Asset ID:** asset.architecture.walls.wall-8-m
- **Type:** architectural or traversal module
- **Source:** prop-list.md:133
...
![wall 8 m reference render](wall-8-m.png)

## Intent

The **wall 8 m** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall 8 m** as a useful,
...
- **Blockout envelope:** 8.0 m W × 0.25 m D × 3.0 m H
