...
---
asset_id: "asset.architecture.walls.curved-wall"
source_label: "curved wall"
...
- **Asset ID:** asset.architecture.walls.curved-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:140
...
![curved wall reference render](curved-wall.png)

## Intent

The **curved wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **curved wall** as a useful,
