...
---
asset_id: "asset.architecture.walls.wall-2-m"
source_label: "wall 2 m"
...
- **Asset ID:** asset.architecture.walls.wall-2-m
- **Type:** architectural or traversal module
- **Source:** prop-list.md:131
...
![wall 2 m reference render](wall-2-m.png)

## Intent

The **wall 2 m** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall 2 m** as a useful,
...
- **Blockout envelope:** 2.0 m W × 0.25 m D × 3.0 m H
