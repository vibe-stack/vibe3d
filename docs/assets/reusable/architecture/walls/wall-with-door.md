...
---
asset_id: "asset.architecture.walls.wall-with-door"
source_label: "wall with door"
...
- **Asset ID:** asset.architecture.walls.wall-with-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:135
...
![wall with door reference render](wall-with-door.png)

## Intent

The **wall with door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall with door** as a useful,
