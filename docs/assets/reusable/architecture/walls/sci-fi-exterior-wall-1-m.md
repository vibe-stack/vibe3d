...
---
asset_id: "asset.architecture.walls.sci-fi-exterior-wall-1-m"
source_label: "sci-fi exterior wall 1 m"
...
# sci-fi exterior wall 1 m

## Identity

- **Asset ID:** asset.architecture.walls.sci-fi-exterior-wall-1-m
- **Type:** architectural or traversal module
- **Source:** prop-list.md:130
...
![sci-fi exterior wall 1 m reference render](sci-fi-exterior-wall-1-m.png)

## Intent

The **sci-fi exterior wall 1 m** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **sci-fi exterior wall 1 m** as a useful,
...
- **Blockout envelope:** 1.0 m W × 0.25 m D × 3.0 m H
