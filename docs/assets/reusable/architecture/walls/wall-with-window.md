...
---
asset_id: "asset.architecture.walls.wall-with-window"
source_label: "wall with window"
...
- **Asset ID:** asset.architecture.walls.wall-with-window
- **Type:** architectural or traversal module
- **Source:** prop-list.md:134
...
![wall with window reference render](wall-with-window.png)

## Intent

The **wall with window** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall with window** as a useful,
