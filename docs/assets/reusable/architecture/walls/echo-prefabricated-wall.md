...
---
asset_id: "asset.architecture.walls.echo-prefabricated-wall"
source_label: "ECHO prefabricated wall"
...
# ECHO prefabricated wall

## Identity

- **Asset ID:** asset.architecture.walls.echo-prefabricated-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:151
...
![ECHO prefabricated wall reference render](echo-prefabricated-wall.png)

## Intent

The **ECHO prefabricated wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **ECHO prefabricated wall** as a useful,
