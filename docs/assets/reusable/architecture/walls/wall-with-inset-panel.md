...
---
asset_id: "asset.architecture.walls.wall-with-inset-panel"
source_label: "wall with inset panel"
...
- **Asset ID:** asset.architecture.walls.wall-with-inset-panel
- **Type:** architectural or traversal module
- **Source:** prop-list.md:137
...
![wall with inset panel reference render](wall-with-inset-panel.png)

## Intent

The **wall with inset panel** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall with inset panel** as a useful,
