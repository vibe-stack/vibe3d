...
---
asset_id: "asset.architecture.walls.lunar-broken-moon-wall"
source_label: "lunar Broken Moon wall"
...
# lunar Broken Moon wall

## Identity

- **Asset ID:** asset.architecture.walls.lunar-broken-moon-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:152
...
![lunar Broken Moon wall reference render](lunar-broken-moon-wall.png)

## Intent

The **lunar Broken Moon wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **lunar Broken Moon wall** as a useful,
