...
---
asset_id: "asset.architecture.walls.blast-wall"
source_label: "blast wall"
...
- **Asset ID:** asset.architecture.walls.blast-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:139
...
![blast wall reference render](blast-wall.png)

## Intent

The **blast wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **blast wall** as a useful,
