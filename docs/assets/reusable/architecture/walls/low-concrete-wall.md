...
---
asset_id: "asset.architecture.walls.low-concrete-wall"
source_label: "low concrete wall"
...
- **Asset ID:** asset.architecture.walls.low-concrete-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:142
...
![low concrete wall reference render](low-concrete-wall.png)

## Intent

The **low concrete wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **low concrete wall** as a useful,
