...
---
asset_id: "asset.architecture.walls.wall-with-vent"
source_label: "wall with vent"
...
- **Asset ID:** asset.architecture.walls.wall-with-vent
- **Type:** architectural or traversal module
- **Source:** prop-list.md:136
...
![wall with vent reference render](wall-with-vent.png)

## Intent

The **wall with vent** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall with vent** as a useful,
