...
---
asset_id: "asset.architecture.walls.imc-military-wall"
source_label: "IMC military wall"
...
- **Asset ID:** asset.architecture.walls.imc-military-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:150
...
![IMC military wall reference render](imc-military-wall.png)

## Intent

The **IMC military wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **IMC military wall** as a useful,
