...
---
asset_id: "asset.architecture.walls.luxury-panel-wall"
source_label: "luxury panel wall"
...
- **Asset ID:** asset.architecture.walls.luxury-panel-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:147
...
![luxury panel wall reference render](luxury-panel-wall.png)

## Intent

The **luxury panel wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **luxury panel wall** as a useful,
