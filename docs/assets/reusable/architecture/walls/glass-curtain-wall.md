...
---
asset_id: "asset.architecture.walls.glass-curtain-wall"
source_label: "glass curtain wall"
...
- **Asset ID:** asset.architecture.walls.glass-curtain-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:146
...
![glass curtain wall reference render](glass-curtain-wall.png)

## Intent

The **glass curtain wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **glass curtain wall** as a useful,
