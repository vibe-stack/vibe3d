...
---
asset_id: "asset.architecture.walls.hammond-white-blue-wall"
source_label: "Hammond white/blue wall"
...
# Hammond white/blue wall

## Identity

- **Asset ID:** asset.architecture.walls.hammond-white-blue-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:149
...
![Hammond white/blue wall reference render](hammond-white-blue-wall.png)

## Intent

The **Hammond white/blue wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **Hammond white/blue wall** as a useful,
