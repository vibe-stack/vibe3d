...
---
asset_id: "asset.architecture.walls.wall-4-m"
source_label: "wall 4 m"
...
- **Asset ID:** asset.architecture.walls.wall-4-m
- **Type:** architectural or traversal module
- **Source:** prop-list.md:132
...
![wall 4 m reference render](wall-4-m.png)

## Intent

The **wall 4 m** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall 4 m** as a useful,
...
- **Blockout envelope:** 4.0 m W × 0.25 m D × 3.0 m H
