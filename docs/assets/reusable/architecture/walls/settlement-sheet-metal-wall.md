...
---
asset_id: "asset.architecture.walls.settlement-sheet-metal-wall"
source_label: "settlement sheet-metal wall"
...
- **Asset ID:** asset.architecture.walls.settlement-sheet-metal-wall
- **Type:** architectural or traversal module
- **Source:** prop-list.md:145
...
![settlement sheet-metal wall reference render](settlement-sheet-metal-wall.png)

## Intent

The **settlement sheet-metal wall** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **settlement sheet-metal wall** as a useful,
