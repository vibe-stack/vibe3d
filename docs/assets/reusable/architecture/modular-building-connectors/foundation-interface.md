...
---
asset_id: "asset.architecture.modular-building-connectors.foundation-interface"
source_label: "foundation interface"
...
- **Asset ID:** asset.architecture.modular-building-connectors.foundation-interface
- **Type:** architectural connector
- **Source:** prop-list.md:266
...
![foundation interface reference render](foundation-interface.png)

## Intent

The **foundation interface** is a architectural connector for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **foundation interface** as a useful,
...
- **Blockout envelope:** 2.0 m W × 2.0 m D × 0.40 m H foundation pad; accepts floor, wall, and terrain contacts.
...
Build the quiet but essential base interface: a structural pad with anchor points, a recessed service/drain channel, and a clean terrain contact. It should support a building without becoming another hero prop.

The construction follows the shared **chassis → service → signal** order.
Make load transfer, leveling, drainage, and utility entry physically legible. Keep the strongest value break on the
...
1. Block the pad, anchor points, and terrain contact patch.
2. Add leveling feet, drain/service recess, and utility entry sockets.
3. Validate on flat terrain, raised platforms, slopes, and damaged foundations.
