...
---
asset_id: "asset.architecture.modular-building-connectors.roof-floor-edge-module"
source_label: "roof/floor edge module"
...
- **Asset ID:** asset.architecture.modular-building-connectors.roof-floor-edge-module
- **Type:** architectural connector
- **Source:** prop-list.md:265
...
![roof/floor edge module reference render](roof-floor-edge-module.png)

## Intent

The **roof/floor edge module** is a architectural connector for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof/floor edge module** as a useful,
...
- **Blockout envelope:** 2.0 m W × 0.50 m D × 0.35 m H edge module; accepts wall, floor, and roof snap faces.
...
Make the edge module solve the transition between a horizontal slab and a vertical wall. Use a shallow fascia, weather seal, service recess, and a controlled parapet attachment.

The construction follows the shared **chassis → service → signal** order.
Show drainage, flashing, cable access, and the structural load path across the edge. Keep the strongest value break on the
...
1. Block the wall-to-slab edge and its snap faces.
2. Add fascia, flashing, drain path, and parapet attachment.
3. Validate flat roofs, roof parapets, and open balcony edges.
