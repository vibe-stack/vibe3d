...
---
asset_id: "asset.architecture.modular-building-connectors.door-bay"
source_label: "door bay"
...
- **Asset ID:** asset.architecture.modular-building-connectors.door-bay
- **Type:** architectural connector
- **Source:** prop-list.md:262
...
![door bay reference render](door-bay.png)

## Intent

The **door bay** is a architectural connector for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **door bay** as a useful,
...
- **Blockout envelope:** 2.0 m W × 0.30 m D × 3.0 m H opening module; standard clear opening 1.6 m W × 2.6 m H.
...
Make the complete opening bay—not just the moving door—with jambs, lintel, gasket, track or hinge seat, control recess, and a clear side-wall interface.

The construction follows the shared **chassis → service → signal** order.
Show the frame, gasket, moving-part hard stop, power/data entry, and safe clearance zone. The bay must accept multiple existing door leaves. Keep the strongest value break on the
...
1. Block the wall-sized opening and standard clear passage.
2. Add jambs, lintel, frame recess, control socket, and threshold seat.
3. Validate double sliding, single sliding, blast, bunker, and commercial door variants.

## Component inventory

- **blocking: door frame** — [door frame](../doors/door-frame.md) — shared frame insert.
- **blocking: building threshold** — [building threshold](./building-threshold.md) — lower clearance and seal.
...
- **blocking component:** [door frame](../doors/door-frame.md) — shared frame insert.
- **blocking component:** [building threshold](./building-threshold.md) — lower clearance and seal.
- **shared door frame:** [door frame](../doors/door-frame.md).
