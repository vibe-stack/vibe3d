...
---
asset_id: "asset.architecture.modular-building-connectors.wall-t-junction"
source_label: "wall T-junction"
...
- **Asset ID:** asset.architecture.modular-building-connectors.wall-t-junction
- **Type:** architectural connector
- **Source:** prop-list.md:259
...
![wall T-junction reference render](wall-t-junction.png)

## Intent

The **wall T-junction** is a architectural connector for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **wall T-junction** as a useful,
...
- **Blockout envelope:** 2.0 m W × 2.0 m D × 3.0 m H T-junction module; accepts three 0.25 m wall runs.
...
Create a three-way wall junction with a compact structural spine, a recessed service chase, and a clear branch opening. It should let rooms and corridors branch without bespoke boolean cuts.

The construction follows the shared **chassis → service → signal** order.
Carry a cable/pipe branch through the spine and leave a removable access face on the non-player side. Keep the strongest value break on the
...
1. Block the three perpendicular wall interfaces on the 1 m grid.
2. Add the structural spine, service chase, and branch seam.
3. Validate corridor widths and door/window bay compatibility.
