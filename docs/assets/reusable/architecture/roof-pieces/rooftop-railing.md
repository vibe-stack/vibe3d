...
---
asset_id: "asset.architecture.roof-pieces.rooftop-railing"
source_label: "rooftop railing"
...
- **Asset ID:** asset.architecture.roof-pieces.rooftop-railing
- **Type:** architectural or traversal module
- **Source:** prop-list.md:201
...
![rooftop railing reference render](rooftop-railing.png)

## Intent

The **rooftop railing** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **rooftop railing** as a useful,
