...
---
asset_id: "asset.architecture.roof-pieces.flat-roof"
source_label: "flat roof"
...
- **Asset ID:** asset.architecture.roof-pieces.flat-roof
- **Type:** architectural or traversal module
- **Source:** prop-list.md:192
...
![flat roof reference render](flat-roof.png)

## Intent

The **flat roof** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **flat roof** as a useful,
