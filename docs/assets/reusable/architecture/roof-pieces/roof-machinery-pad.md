...
---
asset_id: "asset.architecture.roof-pieces.roof-machinery-pad"
source_label: "roof machinery pad"
source_section: "Reusable / core architecture"
source_group: "Roof pieces"
source_line: 197
level: L1
status: planned
...
- **Asset ID:** asset.architecture.roof-pieces.roof-machinery-pad
- **Type:** architectural or traversal module
- **Source:** prop-list.md:197
...
![roof machinery pad reference render](roof-machinery-pad.png)

## Intent

The **roof machinery pad** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof machinery pad** as a useful,
