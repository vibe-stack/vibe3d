...
---
asset_id: "asset.architecture.roof-pieces.vented-roof-panel"
source_label: "vented roof panel"
...
- **Asset ID:** asset.architecture.roof-pieces.vented-roof-panel
- **Type:** architectural or traversal module
- **Source:** prop-list.md:195
...
![vented roof panel reference render](vented-roof-panel.png)

## Intent

The **vented roof panel** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **vented roof panel** as a useful,
