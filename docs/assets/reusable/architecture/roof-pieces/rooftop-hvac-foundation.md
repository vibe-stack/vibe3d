...
---
asset_id: "asset.architecture.roof-pieces.rooftop-hvac-foundation"
source_label: "rooftop HVAC foundation"
...
- **Asset ID:** asset.architecture.roof-pieces.rooftop-hvac-foundation
- **Type:** architectural or traversal module
- **Source:** prop-list.md:200
...
![rooftop HVAC foundation reference render](rooftop-hvac-foundation.png)

## Intent

The **rooftop HVAC foundation** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **rooftop HVAC foundation** as a useful,
