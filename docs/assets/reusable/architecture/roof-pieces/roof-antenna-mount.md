...
---
asset_id: "asset.architecture.roof-pieces.roof-antenna-mount"
source_label: "roof antenna mount"
...
- **Asset ID:** asset.architecture.roof-pieces.roof-antenna-mount
- **Type:** architectural or traversal module
- **Source:** prop-list.md:199
...
![roof antenna mount reference render](roof-antenna-mount.png)

## Intent

The **roof antenna mount** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof antenna mount** as a useful,
