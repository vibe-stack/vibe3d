...
---
asset_id: "asset.architecture.roof-pieces.roof-skylight"
source_label: "roof skylight"
...
- **Asset ID:** asset.architecture.roof-pieces.roof-skylight
- **Type:** architectural or traversal module
- **Source:** prop-list.md:198
...
![roof skylight reference render](roof-skylight.png)

## Intent

The **roof skylight** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof skylight** as a useful,
