...
---
asset_id: "asset.architecture.roof-pieces.sloped-sci-fi-roof"
source_label: "sloped sci-fi roof"
...
- **Asset ID:** asset.architecture.roof-pieces.sloped-sci-fi-roof
- **Type:** architectural or traversal module
- **Source:** prop-list.md:194
...
![sloped sci-fi roof reference render](sloped-sci-fi-roof.png)

## Intent

The **sloped sci-fi roof** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **sloped sci-fi roof** as a useful,
