...
---
asset_id: "asset.architecture.roof-pieces.roof-parapet"
source_label: "roof parapet"
...
- **Asset ID:** asset.architecture.roof-pieces.roof-parapet
- **Type:** architectural or traversal module
- **Source:** prop-list.md:193
...
![roof parapet reference render](roof-parapet.png)

## Intent

The **roof parapet** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof parapet** as a useful,
