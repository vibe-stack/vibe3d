...
---
asset_id: "asset.architecture.roof-pieces.roof-access-box"
source_label: "roof access box"
...
- **Asset ID:** asset.architecture.roof-pieces.roof-access-box
- **Type:** architectural or traversal module
- **Source:** prop-list.md:196
...
![roof access box reference render](roof-access-box.png)

## Intent

The **roof access box** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof access box** as a useful,
