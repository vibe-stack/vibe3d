...
---
asset_id: "asset.architecture.doors.maintenance-hatch"
source_label: "maintenance hatch"
...
- **Asset ID:** asset.architecture.doors.maintenance-hatch
- **Type:** architectural or traversal module
- **Source:** prop-list.md:168
...
![maintenance hatch reference render](maintenance-hatch.png)

## Intent

The **maintenance hatch** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **maintenance hatch** as a useful,
