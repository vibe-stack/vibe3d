...
---
asset_id: "asset.architecture.doors.floor-hatch"
source_label: "floor hatch"
...
- **Asset ID:** asset.architecture.doors.floor-hatch
- **Type:** architectural or traversal module
- **Source:** prop-list.md:169
...
![floor hatch reference render](floor-hatch.png)

## Intent

The **floor hatch** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **floor hatch** as a useful,
