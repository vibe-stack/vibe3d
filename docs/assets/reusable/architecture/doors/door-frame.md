...
---
asset_id: "asset.architecture.doors.door-frame"
source_label: "door frame"
...
- **Asset ID:** asset.architecture.doors.door-frame
- **Type:** architectural or traversal module
- **Source:** prop-list.md:172
...
![door frame reference render](door-frame.png)

## Intent

The **door frame** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **door frame** as a useful,
