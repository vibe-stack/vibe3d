...
---
asset_id: "asset.architecture.doors.glass-commercial-door"
source_label: "glass commercial door"
...
- **Asset ID:** asset.architecture.doors.glass-commercial-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:165
...
![glass commercial door reference render](glass-commercial-door.png)

## Intent

The **glass commercial door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **glass commercial door** as a useful,
