...
---
asset_id: "asset.architecture.doors.roof-hatch"
source_label: "roof hatch"
...
- **Asset ID:** asset.architecture.doors.roof-hatch
- **Type:** architectural or traversal module
- **Source:** prop-list.md:170
...
![roof hatch reference render](roof-hatch.png)

## Intent

The **roof hatch** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **roof hatch** as a useful,
