...
---
asset_id: "asset.architecture.doors.blast-door"
source_label: "blast door"
...
- **Asset ID:** asset.architecture.doors.blast-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:162
...
![blast door reference render](blast-door.png)

## Intent

The **blast door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **blast door** as a useful,
