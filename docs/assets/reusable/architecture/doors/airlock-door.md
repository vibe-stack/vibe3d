...
---
asset_id: "asset.architecture.doors.airlock-door"
source_label: "airlock door"
...
- **Asset ID:** asset.architecture.doors.airlock-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:167
...
![airlock door reference render](airlock-door.png)

## Intent

The **airlock door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **airlock door** as a useful,
