...
---
asset_id: "asset.architecture.doors.reinforced-double-door"
source_label: "reinforced double door"
...
- **Asset ID:** asset.architecture.doors.reinforced-double-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:159
...
![reinforced double door reference render](reinforced-double-door.png)

## Intent

The **reinforced double door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **reinforced double door** as a useful,
