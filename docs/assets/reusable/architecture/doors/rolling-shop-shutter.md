...
---
asset_id: "asset.architecture.doors.rolling-shop-shutter"
source_label: "rolling shop shutter"
...
# rolling shop shutter

## Identity

- **Asset ID:** asset.architecture.doors.rolling-shop-shutter
- **Type:** architectural or traversal module
- **Source:** prop-list.md:161
...
![rolling shop shutter reference render](rolling-shop-shutter.png)

## Intent

The **rolling shop shutter** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **rolling shop shutter** as a useful,
