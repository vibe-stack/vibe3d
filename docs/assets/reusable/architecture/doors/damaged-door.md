...
---
asset_id: "asset.architecture.doors.damaged-door"
source_label: "damaged door"
...
- **Asset ID:** asset.architecture.doors.damaged-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:171
...
![damaged door reference render](damaged-door.png)

## Intent

The **damaged door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **damaged door** as a useful,
...
- **shared door frame:** [door frame](./door-frame.md).
