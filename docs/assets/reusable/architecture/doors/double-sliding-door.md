...
---
asset_id: "asset.architecture.doors.double-sliding-door"
source_label: "double sliding door"
...
- **Asset ID:** asset.architecture.doors.double-sliding-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:157
...
![double sliding door reference render](double-sliding-door.png)

## Intent

The **double sliding door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **double sliding door** as a useful,
