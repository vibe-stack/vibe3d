...
---
asset_id: "asset.architecture.doors.door-control-panel"
source_label: "door control panel"
...
- **Asset ID:** asset.architecture.doors.door-control-panel
- **Type:** architectural or traversal module
- **Source:** prop-list.md:173
...
![door control panel reference render](door-control-panel.png)

## Intent

The **door control panel** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **door control panel** as a useful,
