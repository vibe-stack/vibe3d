...
---
asset_id: "asset.architecture.doors.single-sliding-door"
source_label: "single sliding door"
...
- **Asset ID:** asset.architecture.doors.single-sliding-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:158
...
![single sliding door reference render](single-sliding-door.png)

## Intent

The **single sliding door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **single sliding door** as a useful,
