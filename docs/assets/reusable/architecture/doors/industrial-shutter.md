...
---
asset_id: "asset.architecture.doors.industrial-shutter"
source_label: "industrial shutter"
...
- **Asset ID:** asset.architecture.doors.industrial-shutter
- **Type:** architectural or traversal module
- **Source:** prop-list.md:160
...
![industrial shutter reference render](industrial-shutter.png)

## Intent

The **industrial shutter** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **industrial shutter** as a useful,
