...
---
asset_id: "asset.architecture.doors.laboratory-door"
source_label: "laboratory door"
...
- **Asset ID:** asset.architecture.doors.laboratory-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:166
...
![laboratory door reference render](laboratory-door.png)

## Intent

The **laboratory door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **laboratory door** as a useful,
