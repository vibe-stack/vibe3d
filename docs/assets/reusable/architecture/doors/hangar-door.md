...
---
asset_id: "asset.architecture.doors.hangar-door"
source_label: "hangar door"
...
- **Asset ID:** asset.architecture.doors.hangar-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:164
...
![hangar door reference render](hangar-door.png)

## Intent

The **hangar door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **hangar door** as a useful,
