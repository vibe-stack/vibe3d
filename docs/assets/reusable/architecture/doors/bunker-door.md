...
---
asset_id: "asset.architecture.doors.bunker-door"
source_label: "bunker door"
...
- **Asset ID:** asset.architecture.doors.bunker-door
- **Type:** architectural or traversal module
- **Source:** prop-list.md:163
...
![bunker door reference render](bunker-door.png)

## Intent

The **bunker door** is a architectural or traversal module for the Axiom Relay kit. It exists to support
the grid-aligned chassis that lets every district feel related while retaining local dressing. Its primary read should be **bunker door** as a useful,
