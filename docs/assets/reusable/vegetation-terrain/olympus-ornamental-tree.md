...
---
asset_id: "asset.vegetation-terrain.general.olympus-ornamental-tree"
source_label: "Olympus ornamental tree"
...
# Olympus ornamental tree

## Identity

- **Asset ID:** asset.vegetation-terrain.general.olympus-ornamental-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:719
...
![Olympus ornamental tree reference render](olympus-ornamental-tree.png)

## Intent

The **Olympus ornamental tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **Olympus ornamental tree** as a useful,
