...
---
asset_id: "asset.vegetation-terrain.general.rock-pile"
source_label: "rock pile"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-pile
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:703
...
![rock pile reference render](rock-pile.png)

## Intent

The **rock pile** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock pile** as a useful,
