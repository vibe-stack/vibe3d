...
---
asset_id: "asset.vegetation-terrain.general.hanging-vine"
source_label: "hanging vine"
...
- **Asset ID:** asset.vegetation-terrain.general.hanging-vine
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:733
...
![hanging vine reference render](hanging-vine.png)

## Intent

The **hanging vine** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **hanging vine** as a useful,
