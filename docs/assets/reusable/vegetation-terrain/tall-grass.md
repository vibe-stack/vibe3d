...
---
asset_id: "asset.vegetation-terrain.general.tall-grass"
source_label: "tall grass"
...
- **Asset ID:** asset.vegetation-terrain.general.tall-grass
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:729
...
![tall grass reference render](tall-grass.png)

## Intent

The **tall grass** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **tall grass** as a useful,
