...
---
asset_id: "asset.vegetation-terrain.general.frozen-rock"
source_label: "frozen rock"
...
- **Asset ID:** asset.vegetation-terrain.general.frozen-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:707
...
![frozen rock reference render](frozen-rock.png)

## Intent

The **frozen rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **frozen rock** as a useful,
...
- MAT-20 — [canonical definition](../../../world/material-library.md).
