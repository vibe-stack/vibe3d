...
---
asset_id: "asset.vegetation-terrain.general.palm"
source_label: "palm"
...
- **Asset ID:** asset.vegetation-terrain.general.palm
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:723
...
![palm reference render](palm.png)

## Intent

The **palm** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **palm** as a useful,
