...
---
asset_id: "asset.vegetation-terrain.general.dead-tree"
source_label: "dead tree"
...
- **Asset ID:** asset.vegetation-terrain.general.dead-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:717
...
![dead tree reference render](dead-tree.png)

## Intent

The **dead tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **dead tree** as a useful,
