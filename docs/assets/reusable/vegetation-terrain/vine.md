...
---
asset_id: "asset.vegetation-terrain.general.vine"
source_label: "vine"
...
- **Asset ID:** asset.vegetation-terrain.general.vine
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:732
...
![vine reference render](vine.png)

## Intent

The **vine** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **vine** as a useful,
