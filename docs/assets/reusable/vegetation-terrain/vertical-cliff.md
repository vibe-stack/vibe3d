...
---
asset_id: "asset.vegetation-terrain.general.vertical-cliff"
source_label: "vertical cliff"
...
- **Asset ID:** asset.vegetation-terrain.general.vertical-cliff
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:699
...
![vertical cliff reference render](vertical-cliff.png)

## Intent

The **vertical cliff** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **vertical cliff** as a useful,
