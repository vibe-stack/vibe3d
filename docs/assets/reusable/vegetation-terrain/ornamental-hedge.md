...
---
asset_id: "asset.vegetation-terrain.general.ornamental-hedge"
source_label: "ornamental hedge"
...
- **Asset ID:** asset.vegetation-terrain.general.ornamental-hedge
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:727
...
![ornamental hedge reference render](ornamental-hedge.png)

## Intent

The **ornamental hedge** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **ornamental hedge** as a useful,
