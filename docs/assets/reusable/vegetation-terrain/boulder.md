...
---
asset_id: "asset.vegetation-terrain.general.boulder"
source_label: "boulder"
...
- **Asset ID:** asset.vegetation-terrain.general.boulder
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:702
...
![boulder reference render](boulder.png)

## Intent

The **boulder** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **boulder** as a useful,
