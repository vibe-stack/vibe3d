...
---
asset_id: "asset.vegetation-terrain.general.hedge"
source_label: "hedge"
...
- **Asset ID:** asset.vegetation-terrain.general.hedge
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:726
...
![hedge reference render](hedge.png)

## Intent

The **hedge** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **hedge** as a useful,
