...
---
asset_id: "asset.vegetation-terrain.general.stalactite"
source_label: "stalactite"
...
- **Asset ID:** asset.vegetation-terrain.general.stalactite
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:712
...
![stalactite reference render](stalactite.png)

## Intent

The **stalactite** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **stalactite** as a useful,
