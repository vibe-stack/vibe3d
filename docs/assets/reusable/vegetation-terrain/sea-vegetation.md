...
---
asset_id: "asset.vegetation-terrain.general.sea-vegetation"
source_label: "sea vegetation"
...
- **Asset ID:** asset.vegetation-terrain.general.sea-vegetation
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:742
...
![sea vegetation reference render](sea-vegetation.png)

## Intent

The **sea vegetation** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **sea vegetation** as a useful,
