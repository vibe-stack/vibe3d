...
---
asset_id: "asset.vegetation-terrain.general.mushrooms-fungal-plants"
source_label: "mushrooms/fungal plants"
...
# mushrooms/fungal plants

## Identity

- **Asset ID:** asset.vegetation-terrain.general.mushrooms-fungal-plants
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:737
...
![mushrooms/fungal plants reference render](mushrooms-fungal-plants.png)

## Intent

The **mushrooms/fungal plants** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **mushrooms/fungal plants** as a useful,
