...
---
asset_id: "asset.vegetation-terrain.general.jungle-bush"
source_label: "jungle bush"
...
- **Asset ID:** asset.vegetation-terrain.general.jungle-bush
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:725
...
![jungle bush reference render](jungle-bush.png)

## Intent

The **jungle bush** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **jungle bush** as a useful,
