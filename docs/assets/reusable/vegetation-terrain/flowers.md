...
---
asset_id: "asset.vegetation-terrain.general.flowers"
source_label: "flowers"
...
- **Asset ID:** asset.vegetation-terrain.general.flowers
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:734
...
![flowers reference render](flowers.png)

## Intent

The **flowers** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **flowers** as a useful,
