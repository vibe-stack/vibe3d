...
---
asset_id: "asset.vegetation-terrain.general.overhang-cliff"
source_label: "overhang cliff"
...
- **Asset ID:** asset.vegetation-terrain.general.overhang-cliff
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:700
...
![overhang cliff reference render](overhang-cliff.png)

## Intent

The **overhang cliff** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **overhang cliff** as a useful,
