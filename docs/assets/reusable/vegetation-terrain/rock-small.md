...
---
asset_id: "asset.vegetation-terrain.general.rock-small"
source_label: "rock small"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-small
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:695
...
![rock small reference render](rock-small.png)

## Intent

The **rock small** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock small** as a useful,
