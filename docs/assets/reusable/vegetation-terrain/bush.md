...
---
asset_id: "asset.vegetation-terrain.general.bush"
source_label: "bush"
...
- **Asset ID:** asset.vegetation-terrain.general.bush
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:724
...
![bush reference render](bush.png)

## Intent

The **bush** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **bush** as a useful,
