...
---
asset_id: "asset.vegetation-terrain.general.jungle-tree"
source_label: "jungle tree"
...
- **Asset ID:** asset.vegetation-terrain.general.jungle-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:716
...
![jungle tree reference render](jungle-tree.png)

## Intent

The **jungle tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **jungle tree** as a useful,
