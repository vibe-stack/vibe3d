...
---
asset_id: "asset.vegetation-terrain.general.roots"
source_label: "roots"
...
- **Asset ID:** asset.vegetation-terrain.general.roots
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:738
...
![roots reference render](roots.png)

## Intent

The **roots** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **roots** as a useful,
