...
---
asset_id: "asset.vegetation-terrain.general.rock-medium"
source_label: "rock medium"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-medium
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:696
...
![rock medium reference render](rock-medium.png)

## Intent

The **rock medium** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock medium** as a useful,
