...
---
asset_id: "asset.vegetation-terrain.general.river-rock"
source_label: "river rock"
...
- **Asset ID:** asset.vegetation-terrain.general.river-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:710
...
![river rock reference render](river-rock.png)

## Intent

The **river rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **river rock** as a useful,
