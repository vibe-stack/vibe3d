...
---
asset_id: "asset.vegetation-terrain.general.e-district-street-tree"
source_label: "E-District street tree"
...
# E-District street tree

## Identity

- **Asset ID:** asset.vegetation-terrain.general.e-district-street-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:721
...
![E-District street tree reference render](e-district-street-tree.png)

## Intent

The **E-District street tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **E-District street tree** as a useful,
