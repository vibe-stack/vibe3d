...
---
asset_id: "asset.vegetation-terrain.general.grass-clump"
source_label: "grass clump"
...
- **Asset ID:** asset.vegetation-terrain.general.grass-clump
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:728
...
![grass clump reference render](grass-clump.png)

## Intent

The **grass clump** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **grass clump** as a useful,
