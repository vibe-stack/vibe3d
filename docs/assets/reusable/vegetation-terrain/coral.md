...
---
asset_id: "asset.vegetation-terrain.general.coral"
source_label: "coral"
...
- **Asset ID:** asset.vegetation-terrain.general.coral
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:741
...
![coral reference render](coral.png)

## Intent

The **coral** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **coral** as a useful,
