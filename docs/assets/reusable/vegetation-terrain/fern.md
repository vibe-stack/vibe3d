...
---
asset_id: "asset.vegetation-terrain.general.fern"
source_label: "fern"
...
- **Asset ID:** asset.vegetation-terrain.general.fern
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:731
...
![fern reference render](fern.png)

## Intent

The **fern** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **fern** as a useful,
