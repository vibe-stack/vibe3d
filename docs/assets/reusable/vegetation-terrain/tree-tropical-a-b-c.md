...
---
asset_id: "asset.vegetation-terrain.general.tree-tropical-a-b-c"
source_label: "tree tropical A/B/C"
...
- **Asset ID:** asset.vegetation-terrain.general.tree-tropical-a-b-c
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:714
...
![tree tropical A/B/C reference render](tree-tropical-a-b-c.png)

## Intent

The **tree tropical A/B/C** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **tree tropical A/B/C** as a useful,
