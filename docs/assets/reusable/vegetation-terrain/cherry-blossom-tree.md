...
---
asset_id: "asset.vegetation-terrain.general.cherry-blossom-tree"
source_label: "cherry blossom tree"
...
- **Asset ID:** asset.vegetation-terrain.general.cherry-blossom-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:720
...
![cherry blossom tree reference render](cherry-blossom-tree.png)

## Intent

The **cherry blossom tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **cherry blossom tree** as a useful,
