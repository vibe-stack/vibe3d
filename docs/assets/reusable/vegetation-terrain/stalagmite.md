...
---
asset_id: "asset.vegetation-terrain.general.stalagmite"
source_label: "stalagmite"
...
- **Asset ID:** asset.vegetation-terrain.general.stalagmite
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:711
...
![stalagmite reference render](stalagmite.png)

## Intent

The **stalagmite** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **stalagmite** as a useful,
