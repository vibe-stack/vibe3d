...
---
asset_id: "asset.vegetation-terrain.general.rock-arch"
source_label: "rock arch"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-arch
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:701
...
![rock arch reference render](rock-arch.png)

## Intent

The **rock arch** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock arch** as a useful,
