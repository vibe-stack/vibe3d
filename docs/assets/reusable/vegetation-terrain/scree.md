...
---
asset_id: "asset.vegetation-terrain.general.scree"
source_label: "scree"
...
- **Asset ID:** asset.vegetation-terrain.general.scree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:704
...
![scree reference render](scree.png)

## Intent

The **scree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **scree** as a useful,
