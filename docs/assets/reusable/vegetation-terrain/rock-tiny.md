...
---
asset_id: "asset.vegetation-terrain.general.rock-tiny"
source_label: "rock tiny"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-tiny
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:694
...
![rock tiny reference render](rock-tiny.png)

## Intent

The **rock tiny** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock tiny** as a useful,
