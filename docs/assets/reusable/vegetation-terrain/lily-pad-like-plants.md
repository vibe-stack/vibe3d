...
---
asset_id: "asset.vegetation-terrain.general.lily-pad-like-plants"
source_label: "lily-pad-like plants"
...
- **Asset ID:** asset.vegetation-terrain.general.lily-pad-like-plants
- **Type:** architectural or traversal module
- **Source:** prop-list.md:736
...
![lily-pad-like plants reference render](lily-pad-like-plants.png)

## Intent

The **lily-pad-like plants** is a architectural or traversal module for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **lily-pad-like plants** as a useful,
