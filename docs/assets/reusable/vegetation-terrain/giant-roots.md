...
---
asset_id: "asset.vegetation-terrain.general.giant-roots"
source_label: "giant roots"
...
- **Asset ID:** asset.vegetation-terrain.general.giant-roots
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:739
...
![giant roots reference render](giant-roots.png)

## Intent

The **giant roots** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **giant roots** as a useful,
