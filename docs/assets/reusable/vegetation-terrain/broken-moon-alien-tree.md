...
---
asset_id: "asset.vegetation-terrain.general.broken-moon-alien-tree"
source_label: "Broken Moon alien tree"
...
# Broken Moon alien tree

## Identity

- **Asset ID:** asset.vegetation-terrain.general.broken-moon-alien-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:722
...
![Broken Moon alien tree reference render](broken-moon-alien-tree.png)

## Intent

The **Broken Moon alien tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **Broken Moon alien tree** as a useful,
