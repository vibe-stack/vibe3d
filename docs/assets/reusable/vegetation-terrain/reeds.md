...
---
asset_id: "asset.vegetation-terrain.general.reeds"
source_label: "reeds"
...
- **Asset ID:** asset.vegetation-terrain.general.reeds
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:730
...
![reeds reference render](reeds.png)

## Intent

The **reeds** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **reeds** as a useful,
