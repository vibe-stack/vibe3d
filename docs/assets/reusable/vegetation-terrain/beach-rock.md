...
---
asset_id: "asset.vegetation-terrain.general.beach-rock"
source_label: "beach rock"
...
- **Asset ID:** asset.vegetation-terrain.general.beach-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:709
...
![beach rock reference render](beach-rock.png)

## Intent

The **beach rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **beach rock** as a useful,
