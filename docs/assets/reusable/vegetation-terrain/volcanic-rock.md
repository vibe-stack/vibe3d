...
---
asset_id: "asset.vegetation-terrain.general.volcanic-rock"
source_label: "volcanic rock"
...
- **Asset ID:** asset.vegetation-terrain.general.volcanic-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:705
...
![volcanic rock reference render](volcanic-rock.png)

## Intent

The **volcanic rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **volcanic rock** as a useful,
...
- MAT-19 — [canonical definition](../../../world/material-library.md).
