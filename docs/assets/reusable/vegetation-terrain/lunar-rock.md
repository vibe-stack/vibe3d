...
---
asset_id: "asset.vegetation-terrain.general.lunar-rock"
source_label: "lunar rock"
...
- **Asset ID:** asset.vegetation-terrain.general.lunar-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:708
...
![lunar rock reference render](lunar-rock.png)

## Intent

The **lunar rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **lunar rock** as a useful,
