...
---
asset_id: "asset.vegetation-terrain.general.cliff-module"
source_label: "cliff module"
...
- **Asset ID:** asset.vegetation-terrain.general.cliff-module
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:698
...
![cliff module reference render](cliff-module.png)

## Intent

The **cliff module** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **cliff module** as a useful,
