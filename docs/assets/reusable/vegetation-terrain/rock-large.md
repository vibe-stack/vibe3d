...
---
asset_id: "asset.vegetation-terrain.general.rock-large"
source_label: "rock large"
...
- **Asset ID:** asset.vegetation-terrain.general.rock-large
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:697
...
![rock large reference render](rock-large.png)

## Intent

The **rock large** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **rock large** as a useful,
