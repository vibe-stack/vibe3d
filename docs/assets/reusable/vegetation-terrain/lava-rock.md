...
---
asset_id: "asset.vegetation-terrain.general.lava-rock"
source_label: "lava rock"
...
- **Asset ID:** asset.vegetation-terrain.general.lava-rock
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:706
...
![lava rock reference render](lava-rock.png)

## Intent

The **lava rock** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **lava rock** as a useful,
