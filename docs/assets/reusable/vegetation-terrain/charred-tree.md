...
---
asset_id: "asset.vegetation-terrain.general.charred-tree"
source_label: "charred tree"
...
- **Asset ID:** asset.vegetation-terrain.general.charred-tree
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:718
...
![charred tree reference render](charred-tree.png)

## Intent

The **charred tree** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **charred tree** as a useful,
