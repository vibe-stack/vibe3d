...
---
asset_id: "asset.vegetation-terrain.general.alien-flowers"
source_label: "alien flowers"
...
- **Asset ID:** asset.vegetation-terrain.general.alien-flowers
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:735
...
![alien flowers reference render](alien-flowers.png)

## Intent

The **alien flowers** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **alien flowers** as a useful,
