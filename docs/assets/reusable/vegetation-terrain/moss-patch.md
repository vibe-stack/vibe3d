...
---
asset_id: "asset.vegetation-terrain.general.moss-patch"
source_label: "moss patch"
...
- **Asset ID:** asset.vegetation-terrain.general.moss-patch
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:740
...
![moss patch reference render](moss-patch.png)

## Intent

The **moss patch** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **moss patch** as a useful,
