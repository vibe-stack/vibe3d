...
---
asset_id: "asset.vegetation-terrain.general.driftwood"
source_label: "driftwood"
...
- **Asset ID:** asset.vegetation-terrain.general.driftwood
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:743
...
![driftwood reference render](driftwood.png)

## Intent

The **driftwood** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **driftwood** as a useful,
...
- MAT-16 — [canonical definition](../../../world/material-library.md).
