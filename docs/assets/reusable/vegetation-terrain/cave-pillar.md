...
---
asset_id: "asset.vegetation-terrain.general.cave-pillar"
source_label: "cave pillar"
...
- **Asset ID:** asset.vegetation-terrain.general.cave-pillar
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:713
...
![cave pillar reference render](cave-pillar.png)

## Intent

The **cave pillar** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
biome-specific natural forms that integrate with manufactured foundations and sightlines. Its primary read should be **cave pillar** as a useful,
