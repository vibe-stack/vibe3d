...
---
asset_id: "asset.industrial.general.tool-chest"
source_label: "tool chest"
...
- **Asset ID:** asset.industrial.general.tool-chest
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:378
...
![tool chest reference render](tool-chest.png)

## Intent

The **tool chest** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tool chest** as a useful,
