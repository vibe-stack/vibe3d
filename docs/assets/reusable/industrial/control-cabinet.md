...
---
asset_id: "asset.industrial.general.control-cabinet"
source_label: "control cabinet"
...
- **Asset ID:** asset.industrial.general.control-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:295
...
![control cabinet reference render](control-cabinet.png)

## Intent

The **control cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **control cabinet** as a useful,
