...
---
asset_id: "asset.industrial.general.duct-elbow"
source_label: "duct elbow"
...
- **Asset ID:** asset.industrial.general.duct-elbow
- **Type:** industrial service prop
- **Source:** prop-list.md:322
...
![duct elbow reference render](duct-elbow.png)

## Intent

The **duct elbow** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **duct elbow** as a useful,
