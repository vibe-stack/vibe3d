...
---
asset_id: "asset.industrial.general.control-screen"
source_label: "control screen"
...
- **Asset ID:** asset.industrial.general.control-screen
- **Type:** vegetation or terrain prop
- **Source:** prop-list.md:300
...
![control screen reference render](control-screen.png)

## Intent

The **control screen** is a vegetation or terrain prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **control screen** as a useful,
