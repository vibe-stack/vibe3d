...
---
asset_id: "asset.industrial.general.hose"
source_label: "hose"
...
- **Asset ID:** asset.industrial.general.hose
- **Type:** industrial service prop
- **Source:** prop-list.md:344
...
![hose reference render](hose.png)

## Intent

The **hose** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **hose** as a useful,
