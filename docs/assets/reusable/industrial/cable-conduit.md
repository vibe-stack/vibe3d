...
---
asset_id: "asset.industrial.general.cable-conduit"
source_label: "cable conduit"
...
- **Asset ID:** asset.industrial.general.cable-conduit
- **Type:** industrial service prop
- **Source:** prop-list.md:339
...
![cable conduit reference render](cable-conduit.png)

## Intent

The **cable conduit** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **cable conduit** as a useful,
