...
---
asset_id: "asset.industrial.general.coolant-unit"
source_label: "coolant unit"
...
- **Asset ID:** asset.industrial.general.coolant-unit
- **Type:** industrial service prop
- **Source:** prop-list.md:307
...
![coolant unit reference render](coolant-unit.png)

## Intent

The **coolant unit** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **coolant unit** as a useful,
