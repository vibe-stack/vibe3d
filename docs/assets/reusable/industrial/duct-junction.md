...
---
asset_id: "asset.industrial.general.duct-junction"
source_label: "duct junction"
...
- **Asset ID:** asset.industrial.general.duct-junction
- **Type:** architectural or traversal module
- **Source:** prop-list.md:323
...
![duct junction reference render](duct-junction.png)

## Intent

The **duct junction** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **duct junction** as a useful,
