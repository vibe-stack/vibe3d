...
---
asset_id: "asset.industrial.general.pallet-jack"
source_label: "pallet jack"
...
- **Asset ID:** asset.industrial.general.pallet-jack
- **Type:** cargo or logistics prop
- **Source:** prop-list.md:373
...
![pallet jack reference render](pallet-jack.png)

## Intent

The **pallet jack** is a cargo or logistics prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pallet jack** as a useful,
