...
---
asset_id: "asset.industrial.general.server-cabinet"
source_label: "server cabinet"
...
- **Asset ID:** asset.industrial.general.server-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:296
...
![server cabinet reference render](server-cabinet.png)

## Intent

The **server cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **server cabinet** as a useful,
