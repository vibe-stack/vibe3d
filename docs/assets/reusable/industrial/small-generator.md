...
---
asset_id: "asset.industrial.general.small-generator"
source_label: "small generator"
...
- **Asset ID:** asset.industrial.general.small-generator
- **Type:** industrial service prop
- **Source:** prop-list.md:288
...
![small generator reference render](small-generator.png)

## Intent

The **small generator** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **small generator** as a useful,
