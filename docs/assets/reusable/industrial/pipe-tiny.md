...
---
asset_id: "asset.industrial.general.pipe-tiny"
source_label: "pipe tiny"
...
- **Asset ID:** asset.industrial.general.pipe-tiny
- **Type:** industrial service prop
- **Source:** prop-list.md:325
...
![pipe tiny reference render](pipe-tiny.png)

## Intent

The **pipe tiny** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe tiny** as a useful,
