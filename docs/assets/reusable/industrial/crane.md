...
---
asset_id: "asset.industrial.general.crane"
source_label: "crane"
...
- **Asset ID:** asset.industrial.general.crane
- **Type:** industrial service prop
- **Source:** prop-list.md:364
...
![crane reference render](crane.png)

## Intent

The **crane** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **crane** as a useful,
