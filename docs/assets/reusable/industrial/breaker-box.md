...
---
asset_id: "asset.industrial.general.breaker-box"
source_label: "breaker box"
...
- **Asset ID:** asset.industrial.general.breaker-box
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:303
...
![breaker box reference render](breaker-box.png)

## Intent

The **breaker box** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **breaker box** as a useful,
