...
---
asset_id: "asset.industrial.general.portable-generator"
source_label: "portable generator"
...
- **Asset ID:** asset.industrial.general.portable-generator
- **Type:** industrial service prop
- **Source:** prop-list.md:290
...
![portable generator reference render](portable-generator.png)

## Intent

The **portable generator** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **portable generator** as a useful,
