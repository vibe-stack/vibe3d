...
---
asset_id: "asset.industrial.general.duct-hood"
source_label: "duct hood"
...
- **Asset ID:** asset.industrial.general.duct-hood
- **Type:** industrial service prop
- **Source:** prop-list.md:324
...
![duct hood reference render](duct-hood.png)

## Intent

The **duct hood** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **duct hood** as a useful,
