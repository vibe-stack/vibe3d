...
---
asset_id: "asset.industrial.general.hanging-cable"
source_label: "hanging cable"
...
- **Asset ID:** asset.industrial.general.hanging-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:341
...
![hanging cable reference render](hanging-cable.png)

## Intent

The **hanging cable** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **hanging cable** as a useful,
