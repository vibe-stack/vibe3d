...
---
asset_id: "asset.industrial.general.equipment-rack"
source_label: "equipment rack"
...
- **Asset ID:** asset.industrial.general.equipment-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:380
...
![equipment rack reference render](equipment-rack.png)

## Intent

The **equipment rack** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **equipment rack** as a useful,
