...
---
asset_id: "asset.industrial.general.crane-cable"
source_label: "crane cable"
...
- **Asset ID:** asset.industrial.general.crane-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:369
...
![crane cable reference render](crane-cable.png)

## Intent

The **crane cable** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **crane cable** as a useful,
