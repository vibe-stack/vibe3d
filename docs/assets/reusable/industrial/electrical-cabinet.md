...
---
asset_id: "asset.industrial.general.electrical-cabinet"
source_label: "electrical cabinet"
...
- **Asset ID:** asset.industrial.general.electrical-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:292
...
![electrical cabinet reference render](electrical-cabinet.png)

## Intent

The **electrical cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **electrical cabinet** as a useful,
