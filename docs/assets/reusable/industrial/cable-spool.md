...
---
asset_id: "asset.industrial.general.cable-spool"
source_label: "cable spool"
...
- **Asset ID:** asset.industrial.general.cable-spool
- **Type:** industrial service prop
- **Source:** prop-list.md:343
...
![cable spool reference render](cable-spool.png)

## Intent

The **cable spool** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **cable spool** as a useful,
