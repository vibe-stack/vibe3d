...
---
asset_id: "asset.industrial.general.vent-grille"
source_label: "vent grille"
...
- **Asset ID:** asset.industrial.general.vent-grille
- **Type:** industrial service prop
- **Source:** prop-list.md:320
...
![vent grille reference render](vent-grille.png)

## Intent

The **vent grille** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **vent grille** as a useful,
