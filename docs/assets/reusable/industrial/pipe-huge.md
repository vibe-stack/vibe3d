...
---
asset_id: "asset.industrial.general.pipe-huge"
source_label: "pipe huge"
...
- **Asset ID:** asset.industrial.general.pipe-huge
- **Type:** industrial service prop
- **Source:** prop-list.md:328
...
![pipe huge reference render](pipe-huge.png)

## Intent

The **pipe huge** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe huge** as a useful,
