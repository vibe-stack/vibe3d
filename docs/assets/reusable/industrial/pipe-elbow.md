...
---
asset_id: "asset.industrial.general.pipe-elbow"
source_label: "pipe elbow"
...
- **Asset ID:** asset.industrial.general.pipe-elbow
- **Type:** industrial service prop
- **Source:** prop-list.md:330
...
![pipe elbow reference render](pipe-elbow.png)

## Intent

The **pipe elbow** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe elbow** as a useful,
