...
---
asset_id: "asset.industrial.general.pipe-bridge"
source_label: "pipe bridge"
...
- **Asset ID:** asset.industrial.general.pipe-bridge
- **Type:** architectural or traversal module
- **Source:** prop-list.md:338
...
![pipe bridge reference render](pipe-bridge.png)

## Intent

The **pipe bridge** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe bridge** as a useful,
