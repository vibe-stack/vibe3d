...
---
asset_id: "asset.industrial.general.pipe-flange"
source_label: "pipe flange"
...
- **Asset ID:** asset.industrial.general.pipe-flange
- **Type:** industrial service prop
- **Source:** prop-list.md:333
...
![pipe flange reference render](pipe-flange.png)

## Intent

The **pipe flange** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe flange** as a useful,
