...
---
asset_id: "asset.industrial.general.hopper"
source_label: "hopper"
...
- **Asset ID:** asset.industrial.general.hopper
- **Type:** industrial service prop
- **Source:** prop-list.md:355
...
![hopper reference render](hopper.png)

## Intent

The **hopper** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **hopper** as a useful,
