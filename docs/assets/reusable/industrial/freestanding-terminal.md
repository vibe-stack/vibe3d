...
---
asset_id: "asset.industrial.general.freestanding-terminal"
source_label: "freestanding terminal"
...
# freestanding terminal

## Identity

- **Asset ID:** asset.industrial.general.freestanding-terminal
- **Type:** gameplay system prop
- **Source:** prop-list.md:301
...
![freestanding terminal reference render](freestanding-terminal.png)

## Intent

The **freestanding terminal** is a gameplay system prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **freestanding terminal** as a useful,
