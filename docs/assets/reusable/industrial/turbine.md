...
---
asset_id: "asset.industrial.general.turbine"
source_label: "turbine"
...
- **Asset ID:** asset.industrial.general.turbine
- **Type:** industrial service prop
- **Source:** prop-list.md:311
...
![turbine reference render](turbine.png)

## Intent

The **turbine** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **turbine** as a useful,
