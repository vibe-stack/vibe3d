...
---
asset_id: "asset.industrial.general.heat-exchanger"
source_label: "heat exchanger"
...
- **Asset ID:** asset.industrial.general.heat-exchanger
- **Type:** industrial service prop
- **Source:** prop-list.md:308
...
![heat exchanger reference render](heat-exchanger.png)

## Intent

The **heat exchanger** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **heat exchanger** as a useful,
