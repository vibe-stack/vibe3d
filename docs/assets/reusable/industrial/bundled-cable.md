...
---
asset_id: "asset.industrial.general.bundled-cable"
source_label: "bundled cable"
...
- **Asset ID:** asset.industrial.general.bundled-cable
- **Type:** industrial service prop
- **Source:** prop-list.md:342
...
![bundled cable reference render](bundled-cable.png)

## Intent

The **bundled cable** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **bundled cable** as a useful,
