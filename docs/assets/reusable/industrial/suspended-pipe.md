...
---
asset_id: "asset.industrial.general.suspended-pipe"
source_label: "suspended pipe"
...
- **Asset ID:** asset.industrial.general.suspended-pipe
- **Type:** industrial service prop
- **Source:** prop-list.md:337
...
![suspended pipe reference render](suspended-pipe.png)

## Intent

The **suspended pipe** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **suspended pipe** as a useful,
