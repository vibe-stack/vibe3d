...
---
asset_id: "asset.industrial.general.pipe-manifold"
source_label: "pipe manifold"
...
- **Asset ID:** asset.industrial.general.pipe-manifold
- **Type:** industrial service prop
- **Source:** prop-list.md:332
...
![pipe manifold reference render](pipe-manifold.png)

## Intent

The **pipe manifold** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe manifold** as a useful,
