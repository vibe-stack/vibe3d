...
---
asset_id: "asset.industrial.general.air-intake"
source_label: "air intake"
...
- **Asset ID:** asset.industrial.general.air-intake
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:318
...
![air intake reference render](air-intake.png)

## Intent

The **air intake** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **air intake** as a useful,
