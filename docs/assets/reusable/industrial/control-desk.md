...
---
asset_id: "asset.industrial.general.control-desk"
source_label: "control desk"
...
- **Asset ID:** asset.industrial.general.control-desk
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:299
...
![control desk reference render](control-desk.png)

## Intent

The **control desk** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **control desk** as a useful,
