...
---
asset_id: "asset.industrial.general.welding-station"
source_label: "welding station"
...
- **Asset ID:** asset.industrial.general.welding-station
- **Type:** industrial service prop
- **Source:** prop-list.md:375
...
![welding station reference render](welding-station.png)

## Intent

The **welding station** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **welding station** as a useful,
