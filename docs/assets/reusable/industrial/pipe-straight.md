...
---
asset_id: "asset.industrial.general.pipe-straight"
source_label: "pipe straight"
...
- **Asset ID:** asset.industrial.general.pipe-straight
- **Type:** industrial service prop
- **Source:** prop-list.md:329
...
![pipe straight reference render](pipe-straight.png)

## Intent

The **pipe straight** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe straight** as a useful,
