...
---
asset_id: "asset.industrial.general.industrial-computer"
source_label: "industrial computer"
...
- **Asset ID:** asset.industrial.general.industrial-computer
- **Type:** interior or furnishing prop
- **Source:** prop-list.md:297
...
![industrial computer reference render](industrial-computer.png)

## Intent

The **industrial computer** is a interior or furnishing prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **industrial computer** as a useful,
