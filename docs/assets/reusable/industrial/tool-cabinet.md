...
---
asset_id: "asset.industrial.general.tool-cabinet"
source_label: "tool cabinet"
...
- **Asset ID:** asset.industrial.general.tool-cabinet
- **Type:** industrial service prop
- **Source:** prop-list.md:377
...
![tool cabinet reference render](tool-cabinet.png)

## Intent

The **tool cabinet** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tool cabinet** as a useful,
