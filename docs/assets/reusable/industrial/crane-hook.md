...
---
asset_id: "asset.industrial.general.crane-hook"
source_label: "crane hook"
...
- **Asset ID:** asset.industrial.general.crane-hook
- **Type:** industrial service prop
- **Source:** prop-list.md:367
...
![crane hook reference render](crane-hook.png)

## Intent

The **crane hook** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **crane hook** as a useful,
