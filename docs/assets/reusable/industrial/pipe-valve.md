...
---
asset_id: "asset.industrial.general.pipe-valve"
source_label: "pipe valve"
...
- **Asset ID:** asset.industrial.general.pipe-valve
- **Type:** industrial service prop
- **Source:** prop-list.md:334
...
![pipe valve reference render](pipe-valve.png)

## Intent

The **pipe valve** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe valve** as a useful,
