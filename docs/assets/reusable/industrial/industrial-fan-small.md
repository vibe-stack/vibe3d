...
---
asset_id: "asset.industrial.general.industrial-fan-small"
source_label: "industrial fan small"
...
# industrial fan small

## Identity

- **Asset ID:** asset.industrial.general.industrial-fan-small
- **Type:** industrial service prop
- **Source:** prop-list.md:314
...
![industrial fan small reference render](industrial-fan-small.png)

## Intent

The **industrial fan small** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **industrial fan small** as a useful,
