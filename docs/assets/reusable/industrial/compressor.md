...
---
asset_id: "asset.industrial.general.compressor"
source_label: "compressor"
...
- **Asset ID:** asset.industrial.general.compressor
- **Type:** industrial service prop
- **Source:** prop-list.md:310
...
![compressor reference render](compressor.png)

## Intent

The **compressor** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **compressor** as a useful,
