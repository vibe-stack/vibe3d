...
---
asset_id: "asset.industrial.general.silo"
source_label: "silo"
...
- **Asset ID:** asset.industrial.general.silo
- **Type:** industrial service prop
- **Source:** prop-list.md:354
...
![silo reference render](silo.png)

## Intent

The **silo** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **silo** as a useful,
