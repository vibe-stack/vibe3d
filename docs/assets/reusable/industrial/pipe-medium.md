...
---
asset_id: "asset.industrial.general.pipe-medium"
source_label: "pipe medium"
...
- **Asset ID:** asset.industrial.general.pipe-medium
- **Type:** industrial service prop
- **Source:** prop-list.md:327
...
![pipe medium reference render](pipe-medium.png)

## Intent

The **pipe medium** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe medium** as a useful,
