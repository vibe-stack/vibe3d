...
---
asset_id: "asset.industrial.general.electrical-switchboard"
source_label: "electrical switchboard"
...
- **Asset ID:** asset.industrial.general.electrical-switchboard
- **Type:** industrial service prop
- **Source:** prop-list.md:293
...
![electrical switchboard reference render](electrical-switchboard.png)

## Intent

The **electrical switchboard** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **electrical switchboard** as a useful,
