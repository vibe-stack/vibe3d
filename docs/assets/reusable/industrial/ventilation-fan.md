...
---
asset_id: "asset.industrial.general.ventilation-fan"
source_label: "ventilation fan"
...
- **Asset ID:** asset.industrial.general.ventilation-fan
- **Type:** industrial service prop
- **Source:** prop-list.md:317
...
![ventilation fan reference render](ventilation-fan.png)

## Intent

The **ventilation fan** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **ventilation fan** as a useful,
