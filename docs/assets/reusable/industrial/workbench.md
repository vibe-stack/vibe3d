...
---
asset_id: "asset.industrial.general.workbench"
...
- **Asset ID:** asset.industrial.general.workbench
- **Type:** industrial service prop
- **Source:** prop-list.md:379
...
![workbench reference render](workbench.png)

## Intent

The **workbench** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **workbench** as a useful,
