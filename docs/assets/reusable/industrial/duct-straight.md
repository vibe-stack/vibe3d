...
---
asset_id: "asset.industrial.general.duct-straight"
source_label: "duct straight"
...
- **Asset ID:** asset.industrial.general.duct-straight
- **Type:** industrial service prop
- **Source:** prop-list.md:321
...
![duct straight reference render](duct-straight.png)

## Intent

The **duct straight** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **duct straight** as a useful,
...
- **adjacent utility module:** [duct elbow](./duct-elbow.md).
