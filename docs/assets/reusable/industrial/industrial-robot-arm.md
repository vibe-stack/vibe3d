...
---
asset_id: "asset.industrial.general.industrial-robot-arm"
source_label: "industrial robot arm"
...
- **Asset ID:** asset.industrial.general.industrial-robot-arm
- **Type:** industrial service prop
- **Source:** prop-list.md:374
...
![industrial robot arm reference render](industrial-robot-arm.png)

## Intent

The **industrial robot arm** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **industrial robot arm** as a useful,
