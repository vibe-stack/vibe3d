...
---
asset_id: "asset.industrial.general.cable-tray"
source_label: "cable tray"
...
- **Asset ID:** asset.industrial.general.cable-tray
- **Type:** industrial service prop
- **Source:** prop-list.md:340
...
![cable tray reference render](cable-tray.png)

## Intent

The **cable tray** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **cable tray** as a useful,
