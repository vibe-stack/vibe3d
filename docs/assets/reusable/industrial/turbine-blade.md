...
---
asset_id: "asset.industrial.general.turbine-blade"
source_label: "turbine blade"
...
- **Asset ID:** asset.industrial.general.turbine-blade
- **Type:** industrial service prop
- **Source:** prop-list.md:313
...
![turbine blade reference render](turbine-blade.png)

## Intent

The **turbine blade** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **turbine blade** as a useful,
