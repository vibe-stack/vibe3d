...
---
asset_id: "asset.industrial.general.industrial-fan-huge"
source_label: "industrial fan huge"
...
- **Asset ID:** asset.industrial.general.industrial-fan-huge
- **Type:** industrial service prop
- **Source:** prop-list.md:316
...
![industrial fan huge reference render](industrial-fan-huge.png)

## Intent

The **industrial fan huge** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **industrial fan huge** as a useful,
