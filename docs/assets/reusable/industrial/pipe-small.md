...
---
asset_id: "asset.industrial.general.pipe-small"
source_label: "pipe small"
...
- **Asset ID:** asset.industrial.general.pipe-small
- **Type:** industrial service prop
- **Source:** prop-list.md:326
...
![pipe small reference render](pipe-small.png)

## Intent

The **pipe small** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe small** as a useful,
