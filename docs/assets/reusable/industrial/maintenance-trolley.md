...
---
asset_id: "asset.industrial.general.maintenance-trolley"
source_label: "maintenance trolley"
...
- **Asset ID:** asset.industrial.general.maintenance-trolley
- **Type:** industrial service prop
- **Source:** prop-list.md:376
...
![maintenance trolley reference render](maintenance-trolley.png)

## Intent

The **maintenance trolley** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **maintenance trolley** as a useful,
