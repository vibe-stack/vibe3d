...
---
asset_id: "asset.industrial.general.fuse-box"
source_label: "fuse box"
...
- **Asset ID:** asset.industrial.general.fuse-box
- **Type:** industrial service prop
- **Source:** prop-list.md:294
...
![fuse box reference render](fuse-box.png)

## Intent

The **fuse box** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **fuse box** as a useful,
