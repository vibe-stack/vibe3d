...
---
asset_id: "asset.industrial.general.crane-trolley"
source_label: "crane trolley"
...
- **Asset ID:** asset.industrial.general.crane-trolley
- **Type:** industrial service prop
- **Source:** prop-list.md:368
...
![crane trolley reference render](crane-trolley.png)

## Intent

The **crane trolley** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **crane trolley** as a useful,
