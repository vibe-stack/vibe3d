...
---
asset_id: "asset.industrial.general.fuel-hose"
source_label: "fuel hose"
source_section: "Reusable / industrial"
source_group: "General"
source_line: 346
level: L2
status: planned
place_family: "Industrial, thermal, military, and infrastructure spaces"
owner: "Axiom Works"
---
...
- **Asset ID:** asset.industrial.general.fuel-hose
- **Type:** industrial service prop
- **Source:** prop-list.md:346
- **Family:** Reusable / industrial
- **Place family:** Industrial, thermal, military, and infrastructure spaces
- **Owner / story role:** Axiom Works

## Reference render

![fuel hose reference render](fuel-hose.png)

## Intent

The **fuel hose** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **fuel hose** as a useful,
...
- **adjacent utility module:** [duct straight](./duct-straight.md).
