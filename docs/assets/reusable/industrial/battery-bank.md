...
---
asset_id: "asset.industrial.general.battery-bank"
source_label: "battery bank"
...
- **Asset ID:** asset.industrial.general.battery-bank
- **Type:** industrial service prop
- **Source:** prop-list.md:304
...
![battery bank reference render](battery-bank.png)

## Intent

The **battery bank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **battery bank** as a useful,
