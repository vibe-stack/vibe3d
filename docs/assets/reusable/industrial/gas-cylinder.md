...
---
asset_id: "asset.industrial.general.gas-cylinder"
source_label: "gas cylinder"
...
- **Asset ID:** asset.industrial.general.gas-cylinder
- **Type:** industrial service prop
- **Source:** prop-list.md:351
...
![gas cylinder reference render](gas-cylinder.png)

## Intent

The **gas cylinder** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **gas cylinder** as a useful,
