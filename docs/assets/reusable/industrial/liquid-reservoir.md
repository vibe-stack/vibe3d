...
---
asset_id: "asset.industrial.general.liquid-reservoir"
source_label: "liquid reservoir"
...
- **Asset ID:** asset.industrial.general.liquid-reservoir
- **Type:** industrial service prop
- **Source:** prop-list.md:356
...
![liquid reservoir reference render](liquid-reservoir.png)

## Intent

The **liquid reservoir** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **liquid reservoir** as a useful,
