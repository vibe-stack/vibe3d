...
---
asset_id: "asset.industrial.general.chemical-tank"
source_label: "chemical tank"
...
- **Asset ID:** asset.industrial.general.chemical-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:359
...
![chemical tank reference render](chemical-tank.png)

## Intent

The **chemical tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **chemical tank** as a useful,
