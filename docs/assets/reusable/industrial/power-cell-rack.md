...
---
asset_id: "asset.industrial.general.power-cell-rack"
source_label: "power-cell rack"
...
- **Asset ID:** asset.industrial.general.power-cell-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:306
...
![power-cell rack reference render](power-cell-rack.png)

## Intent

The **power-cell rack** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **power-cell rack** as a useful,
