...
---
asset_id: "asset.industrial.general.pressure-gauge"
source_label: "pressure gauge"
...
- **Asset ID:** asset.industrial.general.pressure-gauge
- **Type:** industrial service prop
- **Source:** prop-list.md:335
...
![pressure gauge reference render](pressure-gauge.png)

## Intent

The **pressure gauge** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pressure gauge** as a useful,
