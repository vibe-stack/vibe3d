...
---
asset_id: "asset.industrial.general.cylinder-rack"
source_label: "cylinder rack"
...
- **Asset ID:** asset.industrial.general.cylinder-rack
- **Type:** industrial service prop
- **Source:** prop-list.md:352
...
![cylinder rack reference render](cylinder-rack.png)

## Intent

The **cylinder rack** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **cylinder rack** as a useful,
