...
---
asset_id: "asset.industrial.general.gantry-crane"
source_label: "gantry crane"
...
- **Asset ID:** asset.industrial.general.gantry-crane
- **Type:** industrial service prop
- **Source:** prop-list.md:365
...
![gantry crane reference render](gantry-crane.png)

## Intent

The **gantry crane** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **gantry crane** as a useful,
