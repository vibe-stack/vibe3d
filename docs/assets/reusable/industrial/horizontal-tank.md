...
---
asset_id: "asset.industrial.general.horizontal-tank"
source_label: "horizontal tank"
...
- **Asset ID:** asset.industrial.general.horizontal-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:348
...
![horizontal tank reference render](horizontal-tank.png)

## Intent

The **horizontal tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **horizontal tank** as a useful,
