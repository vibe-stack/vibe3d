...
---
asset_id: "asset.industrial.general.coolant-tank"
source_label: "coolant tank"
...
- **Asset ID:** asset.industrial.general.coolant-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:358
...
![coolant tank reference render](coolant-tank.png)

## Intent

The **coolant tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **coolant tank** as a useful,
