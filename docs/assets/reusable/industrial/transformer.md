...
---
asset_id: "asset.industrial.general.transformer"
...
- **Asset ID:** asset.industrial.general.transformer
- **Type:** industrial service prop
- **Source:** prop-list.md:291
...
![transformer reference render](transformer.png)

## Intent

The **transformer** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **transformer** as a useful,
