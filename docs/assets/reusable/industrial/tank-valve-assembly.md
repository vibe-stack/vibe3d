...
---
asset_id: "asset.industrial.general.tank-valve-assembly"
source_label: "tank valve assembly"
...
- **Asset ID:** asset.industrial.general.tank-valve-assembly
- **Type:** industrial service prop
- **Source:** prop-list.md:363
...
![tank valve assembly reference render](tank-valve-assembly.png)

## Intent

The **tank valve assembly** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tank valve assembly** as a useful,
