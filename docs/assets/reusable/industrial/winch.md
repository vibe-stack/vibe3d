...
---
asset_id: "asset.industrial.general.winch"
source_label: "winch"
...
- **Asset ID:** asset.industrial.general.winch
- **Type:** industrial service prop
- **Source:** prop-list.md:370
...
![winch reference render](winch.png)

## Intent

The **winch** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **winch** as a useful,
