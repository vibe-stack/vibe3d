...
---
asset_id: "asset.industrial.general.pump"
source_label: "pump"
...
- **Asset ID:** asset.industrial.general.pump
- **Type:** industrial service prop
- **Source:** prop-list.md:309
...
![pump reference render](pump.png)

## Intent

The **pump** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pump** as a useful,
