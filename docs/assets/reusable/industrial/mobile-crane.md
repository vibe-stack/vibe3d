...
---
asset_id: "asset.industrial.general.mobile-crane"
source_label: "mobile crane"
...
- **Asset ID:** asset.industrial.general.mobile-crane
- **Type:** industrial service prop
- **Source:** prop-list.md:366
...
![mobile crane reference render](mobile-crane.png)

## Intent

The **mobile crane** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **mobile crane** as a useful,
