...
---
asset_id: "asset.industrial.general.turbine-housing"
source_label: "turbine housing"
...
- **Asset ID:** asset.industrial.general.turbine-housing
- **Type:** industrial service prop
- **Source:** prop-list.md:312
...
![turbine housing reference render](turbine-housing.png)

## Intent

The **turbine housing** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **turbine housing** as a useful,
