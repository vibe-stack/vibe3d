...
---
asset_id: "asset.industrial.general.large-generator"
source_label: "large generator"
...
- **Asset ID:** asset.industrial.general.large-generator
- **Type:** industrial service prop
- **Source:** prop-list.md:289
...
![large generator reference render](large-generator.png)

## Intent

The **large generator** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **large generator** as a useful,
