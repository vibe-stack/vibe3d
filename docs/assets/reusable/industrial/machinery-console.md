...
---
asset_id: "asset.industrial.general.machinery-console"
source_label: "machinery console"
...
- **Asset ID:** asset.industrial.general.machinery-console
- **Type:** industrial service prop
- **Source:** prop-list.md:298
...
![machinery console reference render](machinery-console.png)

## Intent

The **machinery console** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **machinery console** as a useful,
