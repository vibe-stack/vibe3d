...
---
asset_id: "asset.industrial.general.power-cell"
source_label: "power cell"
...
- **Asset ID:** asset.industrial.general.power-cell
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:305
...
![power cell reference render](power-cell.png)

## Intent

The **power cell** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **power cell** as a useful,
