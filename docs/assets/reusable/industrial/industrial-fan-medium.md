...
---
asset_id: "asset.industrial.general.industrial-fan-medium"
source_label: "industrial fan medium"
...
# industrial fan medium

## Identity

- **Asset ID:** asset.industrial.general.industrial-fan-medium
- **Type:** industrial service prop
- **Source:** prop-list.md:315
...
![industrial fan medium reference render](industrial-fan-medium.png)

## Intent

The **industrial fan medium** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **industrial fan medium** as a useful,
