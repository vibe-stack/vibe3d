...
---
asset_id: "asset.industrial.general.pressure-vessel"
source_label: "pressure vessel"
...
- **Asset ID:** asset.industrial.general.pressure-vessel
- **Type:** industrial service prop
- **Source:** prop-list.md:353
...
![pressure vessel reference render](pressure-vessel.png)

## Intent

The **pressure vessel** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pressure vessel** as a useful,
