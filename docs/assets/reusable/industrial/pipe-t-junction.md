...
---
asset_id: "asset.industrial.general.pipe-t-junction"
source_label: "pipe T-junction"
...
- **Asset ID:** asset.industrial.general.pipe-t-junction
- **Type:** architectural or traversal module
- **Source:** prop-list.md:331
...
![pipe T-junction reference render](pipe-t-junction.png)

## Intent

The **pipe T-junction** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe T-junction** as a useful,
