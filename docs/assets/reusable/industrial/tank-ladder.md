...
---
asset_id: "asset.industrial.general.tank-ladder"
source_label: "tank ladder"
...
- **Asset ID:** asset.industrial.general.tank-ladder
- **Type:** architectural or traversal module
- **Source:** prop-list.md:361
...
![tank ladder reference render](tank-ladder.png)

## Intent

The **tank ladder** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tank ladder** as a useful,
