...
---
asset_id: "asset.industrial.general.spherical-tank"
source_label: "spherical tank"
...
- **Asset ID:** asset.industrial.general.spherical-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:350
...
![spherical tank reference render](spherical-tank.png)

## Intent

The **spherical tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **spherical tank** as a useful,
