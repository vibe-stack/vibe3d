...
---
asset_id: "asset.industrial.general.cylindrical-tank"
source_label: "cylindrical tank"
...
- **Asset ID:** asset.industrial.general.cylindrical-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:347
...
![cylindrical tank reference render](cylindrical-tank.png)

## Intent

The **cylindrical tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **cylindrical tank** as a useful,
