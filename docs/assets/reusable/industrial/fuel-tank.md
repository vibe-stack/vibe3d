...
---
asset_id: "asset.industrial.general.fuel-tank"
source_label: "fuel tank"
...
- **Asset ID:** asset.industrial.general.fuel-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:357
...
![fuel tank reference render](fuel-tank.png)

## Intent

The **fuel tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **fuel tank** as a useful,
