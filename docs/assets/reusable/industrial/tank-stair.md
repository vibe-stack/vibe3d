...
---
asset_id: "asset.industrial.general.tank-stair"
source_label: "tank stair"
...
- **Asset ID:** asset.industrial.general.tank-stair
- **Type:** architectural or traversal module
- **Source:** prop-list.md:360
...
![tank stair reference render](tank-stair.png)

## Intent

The **tank stair** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tank stair** as a useful,
