...
---
asset_id: "asset.industrial.general.tank-catwalk"
source_label: "tank catwalk"
...
- **Asset ID:** asset.industrial.general.tank-catwalk
- **Type:** architectural or traversal module
- **Source:** prop-list.md:362
...
![tank catwalk reference render](tank-catwalk.png)

## Intent

The **tank catwalk** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **tank catwalk** as a useful,
