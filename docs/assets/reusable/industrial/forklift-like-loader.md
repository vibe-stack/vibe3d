...
---
asset_id: "asset.industrial.general.forklift-like-loader"
source_label: "forklift-like loader"
...
# forklift-like loader

## Identity

- **Asset ID:** asset.industrial.general.forklift-like-loader
- **Type:** world dressing or functional prop
- **Source:** prop-list.md:372
...
![forklift-like loader reference render](forklift-like-loader.png)

## Intent

The **forklift-like loader** is a world dressing or functional prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **forklift-like loader** as a useful,
