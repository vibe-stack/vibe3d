...
---
asset_id: "asset.industrial.general.exhaust-vent"
source_label: "exhaust vent"
...
- **Asset ID:** asset.industrial.general.exhaust-vent
- **Type:** industrial service prop
- **Source:** prop-list.md:319
...
![exhaust vent reference render](exhaust-vent.png)

## Intent

The **exhaust vent** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **exhaust vent** as a useful,
