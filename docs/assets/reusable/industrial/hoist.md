...
---
asset_id: "asset.industrial.general.hoist"
source_label: "hoist"
...
- **Asset ID:** asset.industrial.general.hoist
- **Type:** industrial service prop
- **Source:** prop-list.md:371
...
![hoist reference render](hoist.png)

## Intent

The **hoist** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **hoist** as a useful,
