...
---
asset_id: "asset.industrial.general.pipe-support"
source_label: "pipe support"
...
- **Asset ID:** asset.industrial.general.pipe-support
- **Type:** industrial service prop
- **Source:** prop-list.md:336
...
![pipe support reference render](pipe-support.png)

## Intent

The **pipe support** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **pipe support** as a useful,
