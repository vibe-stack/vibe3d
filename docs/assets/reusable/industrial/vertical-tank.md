...
---
asset_id: "asset.industrial.general.vertical-tank"
source_label: "vertical tank"
...
- **Asset ID:** asset.industrial.general.vertical-tank
- **Type:** industrial service prop
- **Source:** prop-list.md:349
...
![vertical tank reference render](vertical-tank.png)

## Intent

The **vertical tank** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **vertical tank** as a useful,
