...
---
asset_id: "asset.industrial.general.wall-terminal"
source_label: "wall terminal"
...
- **Asset ID:** asset.industrial.general.wall-terminal
- **Type:** architectural or traversal module
- **Source:** prop-list.md:302
...
![wall terminal reference render](wall-terminal.png)

## Intent

The **wall terminal** is a architectural or traversal module for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **wall terminal** as a useful,
