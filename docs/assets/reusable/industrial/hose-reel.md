...
---
asset_id: "asset.industrial.general.hose-reel"
source_label: "hose reel"
...
- **Asset ID:** asset.industrial.general.hose-reel
- **Type:** industrial service prop
- **Source:** prop-list.md:345
...
![hose reel reference render](hose-reel.png)

## Intent

The **hose reel** is a industrial service prop for the Axiom Relay kit. It exists to support
functional machinery with visible service access, load paths, cooling, and maintenance logic. Its primary read should be **hose reel** as a useful,
