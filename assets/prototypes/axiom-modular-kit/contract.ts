...
export const AXIOM_KIT = Object.freeze({
  ...
  floorSurfaceY: 0.44,
  doorClearWidth: 1.56,
  doorClearHeight: 2.16,
  windowClearWidth: 1.9,
  windowClearHeight: 1.28,
  gateClearWidth: 4,
  previewFront: '+Z',
...
export const MODULE_SPECS = {
  ...
  'door-bay': { label: 'Door Bay', family: 'connector', width: 2, depth: 0.67, height: 3, reference: `${REF}/modular-building-connectors/door-bay.png`, notes: 'Uses the same 1.56 x 2.16 m clipped opening authored by the prefab layout builder.' },
  ...
  'window-bay': { label: 'Window Bay', family: 'connector', width: 2.5, depth: 0.67, height: 3, reference: `${REF}/modular-building-connectors/window-bay.png`, notes: 'Full-height insert using the prefab layout builder\'s 1.9 m clear window and shared sill/head datums.' },
  ...
  'room-shell': { label: 'Room Shell', family: 'prefab', width: 5, depth: 5, height: 3.5, reference: `${REF}/building-prefab-assemblies/room-shell.png`, notes: 'Single-bay Axiom layout; supersedes the legacy hand-authored 4 m shell.' },
